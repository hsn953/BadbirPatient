     ...
     <ItemTemplate>
        <fieldset>
            <ol>
                ...
                <li>
                    <asp:Label ID="lbldataQueryTypeId" runat="server" Text="Query Type:" AssociatedControlID="dataQueryTypeId" CssClass="queryFieldsLabel"/>
                    <span>
                        ...
                        <data:BbQueryTypelkpDataSource ID="QueryTypeIdBbQueryTypelkpDataSource" runat="server"
                            SelectMethod="QueryTypelkp_GetAllForCentre" />
                    </span></li>
                <li>
                    <asp:Label ID="Label1" runat="server" Text="Description:" AssociatedControlID="dataQueryTypeId" CssClass="queryFieldsLabel queryFieldsLabelTA"/>
                    <span>
                ...
                <li runat="server" visible='<%# (Eval("Createddate") != null ? true : false) %>'>
                    <span class="literal">
                        <asp:Label ID="Label2" runat="server" Font-Italic="true" CssClass="queryFieldsLabel">
                            This query was generated on <%# Eval("Createddate","{0:dd MMMM yyyy HH:mm}")%> by <%# Eval("Createdbyname")%>
                        </asp:Label>
