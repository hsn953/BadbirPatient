                ...
                <li><span class="literal">
                    ...
                    <span>
                        ...
                        <data:BbQueryTypelkpDataSource ID="QueryTypeIdBbQueryTypelkpDataSource" runat="server"
                            SelectMethod="QueryTypelkp_GetAllForAdmin" />
                    </span></li>
                <li><span class="literal">
                    <asp:Label ID="Label4" runat="server" Text="Inbox Type:" AssociatedControlID="RadioButtonList1" CssClass="queryFieldsLabel"/></span>
                    <asp:RadioButtonList runat="server" ID="dataAuditQuery" SelectedValue='<%# Bind("IsAuditQuery") %>'> 
                        <asp:ListItem Value="False" Text='<i class="fas fa-minus fa-fw"></i> Admin' Selected="True"></asp:ListItem>
                        <asp:ListItem Value="True" Text='<i class="fas fa-check-double fa-fw"></i> Audit' ></asp:ListItem>
                    </asp:RadioButtonList>
                </li>
                <li><span class="literal">
