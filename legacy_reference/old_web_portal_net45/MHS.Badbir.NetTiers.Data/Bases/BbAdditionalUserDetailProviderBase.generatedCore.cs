...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbAdditionalUserDetailProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbAdditionalUserDetailProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail, MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetailKey>
	{		
		#region Get from Many To Many Relationship Functions
		#region GetByCentreidFromBbAdditionalUserAndCentre
		
		/// <summary>
		///		Gets bbAdditionalUserDetail objects from the datasource by Centreid in the
		///		bbAdditionalUserAndCentre table. Table bbAdditionalUserDetail is related to table bbCentre
		///		through the (M:N) relationship defined in the bbAdditionalUserAndCentre table.
		/// </summary>
		/// <param name="_centreid">Centre</param>
		/// <returns>Returns a typed collection of BbAdditionalUserDetail objects.</returns>
		public TList<BbAdditionalUserDetail> GetByCentreidFromBbAdditionalUserAndCentre(int _centreid)
		{
			int count = -1;
			return GetByCentreidFromBbAdditionalUserAndCentre(null,_centreid, 0, int.MaxValue, out count);
			
		}
		
		/// <summary>
		///		Gets MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail objects from the datasource by Centreid in the
		///		bbAdditionalUserAndCentre table. Table bbAdditionalUserDetail is related to table bbCentre
		///		through the (M:N) relationship defined in the bbAdditionalUserAndCentre table.
		/// </summary>
		...
		/// <param name="_centreid">Centre</param>
		/// <remarks></remarks>
		/// <returns>Returns a TList of BbAdditionalUserDetail objects.</returns>
		public TList<BbAdditionalUserDetail> GetByCentreidFromBbAdditionalUserAndCentre(int _centreid, int start, int pageLength)
		{
			int count = -1;
			return GetByCentreidFromBbAdditionalUserAndCentre(null, _centreid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbAdditionalUserDetail objects.</returns>
		public TList<BbAdditionalUserDetail> GetByCentreidFromBbAdditionalUserAndCentre(TransactionManager transactionManager, int _centreid)
		{
			int count = -1;
			return GetByCentreidFromBbAdditionalUserAndCentre(transactionManager, _centreid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbAdditionalUserDetail objects.</returns>
		public TList<BbAdditionalUserDetail> GetByCentreidFromBbAdditionalUserAndCentre(TransactionManager transactionManager, int _centreid,int start, int pageLength)
		{
			int count = -1;
			return GetByCentreidFromBbAdditionalUserAndCentre(transactionManager, _centreid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbAdditionalUserDetail objects.</returns>
		public TList<BbAdditionalUserDetail> GetByCentreidFromBbAdditionalUserAndCentre(int _centreid,int start, int pageLength, out int count)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a TList of BbAdditionalUserDetail objects.</returns>
		public abstract TList<BbAdditionalUserDetail> GetByCentreidFromBbAdditionalUserAndCentre(TransactionManager transactionManager,int _centreid, int start, int pageLength, out int count);
		
		#endregion GetByCentreidFromBbAdditionalUserAndCentre
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetailKey key)
		{
		...
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_userid">User Id. Primary Key.</param>
		...
		public override MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetailKey key, int start, int pageLength)
		{
			return GetByUserid(transactionManager, key.Userid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key BAdbiruseridIndex index.
		/// </summary>
		/// <param name="_badbiRuserid">BADBIR user Id</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> class.</returns>
		public TList<BbAdditionalUserDetail> GetByBadbiRuserid(int _badbiRuserid)
		{
			int count = -1;
			return GetByBadbiRuserid(null,_badbiRuserid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the BAdbiruseridIndex index.
		/// </summary>
		/// <param name="_badbiRuserid">BADBIR user Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> class.</returns>
		public TList<BbAdditionalUserDetail> GetByBadbiRuserid(int _badbiRuserid, int start, int pageLength)
		{
			int count = -1;
			return GetByBadbiRuserid(null, _badbiRuserid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> class.</returns>
		public TList<BbAdditionalUserDetail> GetByBadbiRuserid(TransactionManager transactionManager, int _badbiRuserid)
		{
			int count = -1;
			return GetByBadbiRuserid(transactionManager, _badbiRuserid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> class.</returns>
		public TList<BbAdditionalUserDetail> GetByBadbiRuserid(TransactionManager transactionManager, int _badbiRuserid, int start, int pageLength)
		{
			int count = -1;
			return GetByBadbiRuserid(transactionManager, _badbiRuserid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> class.</returns>
		public TList<BbAdditionalUserDetail> GetByBadbiRuserid(int _badbiRuserid, int start, int pageLength, out int count)
		{
			return GetByBadbiRuserid(null, _badbiRuserid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> class.</returns>
		public abstract TList<BbAdditionalUserDetail> GetByBadbiRuserid(TransactionManager transactionManager, int _badbiRuserid, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key pk_AdditionalUserDetail_uid index.
		/// </summary>
		/// <param name="_userid">User Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail GetByUserid(System.Guid _userid)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the pk_AdditionalUserDetail_uid index.
		/// </summary>
		/// <param name="_userid">User Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail GetByUserid(System.Guid _userid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail GetByUserid(TransactionManager transactionManager, System.Guid _userid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail GetByUserid(TransactionManager transactionManager, System.Guid _userid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail GetByUserid(System.Guid _userid, int start, int pageLength, out int count)
		{
			return GetByUserid(null, _userid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail GetByUserid(TransactionManager transactionManager, System.Guid _userid, int start, int pageLength, out int count);
		...
		/// <param name="centreid"> A <c>System.Int32?</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> instance.</returns>
		public TList<BbAdditionalUserDetail> AdditionalUserDetail_getNonAdminUsersByCentreID(System.Int32? centreid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> instance.</returns>
		public TList<BbAdditionalUserDetail> AdditionalUserDetail_getNonAdminUsersByCentreID(int start, int pageLength, System.Int32? centreid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> instance.</returns>
		public TList<BbAdditionalUserDetail> AdditionalUserDetail_getNonAdminUsersByCentreID(TransactionManager transactionManager, System.Int32? centreid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> instance.</returns>
		public abstract TList<BbAdditionalUserDetail> AdditionalUserDetail_getNonAdminUsersByCentreID(TransactionManager transactionManager, int start, int pageLength , System.Int32? centreid);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> instance.</returns>
		public TList<BbAdditionalUserDetail> AdditionalUserDetail_getValidUsers()
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> instance.</returns>
		public TList<BbAdditionalUserDetail> AdditionalUserDetail_getValidUsers(int start, int pageLength)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> instance.</returns>
		public TList<BbAdditionalUserDetail> AdditionalUserDetail_getValidUsers(TransactionManager transactionManager)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbAdditionalUserDetail&gt;"/> instance.</returns>
		public abstract TList<BbAdditionalUserDetail> AdditionalUserDetail_getValidUsers(TransactionManager transactionManager, int start, int pageLength );
		...
		/// <summary>
		/// Fill a TList&lt;BbAdditionalUserDetail&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbAdditionalUserDetail&gt;"/></returns>
		public static TList<BbAdditionalUserDetail> Fill(IDataReader reader, TList<BbAdditionalUserDetail> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbAdditionalUserDetail")
					.Append("|").Append((System.Guid)reader[((int)BbAdditionalUserDetailColumn.Userid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbAdditionalUserDetail>(
					key.ToString(), // EntityTrackingKey
					"BbAdditionalUserDetail",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail();
				}
					...
					))
				{
					...
					c.Userid = (System.Guid)reader[((int)BbAdditionalUserDetailColumn.Userid - 1)];
					c.OriginalUserid = c.Userid;
					c.BadbiRuserid = (int)reader[((int)BbAdditionalUserDetailColumn.BadbiRuserid - 1)];
					c.Title = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Title - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.Title - 1)];
					c.FName = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.FName - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.FName - 1)];
					c.LName = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.LName - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.LName - 1)];
					c.Position = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Position - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.Position - 1)];
					c.Phone = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Phone - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.Phone - 1)];
					c.Hospital = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Hospital - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.Hospital - 1)];
					c.Createdbyid = (int)reader[((int)BbAdditionalUserDetailColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbAdditionalUserDetailColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbAdditionalUserDetailColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbAdditionalUserDetailColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbAdditionalUserDetailColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbAdditionalUserDetailColumn.Lastupdateddate - 1)];
					c.BaselineTrainingDate = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.BaselineTrainingDate - 1)))?null:(System.DateTime?)reader[((int)BbAdditionalUserDetailColumn.BaselineTrainingDate - 1)];
					c.BaselineTrainingBy = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.BaselineTrainingBy - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.BaselineTrainingBy - 1)];
					c.BaselineTrainingNotes = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.BaselineTrainingNotes - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.BaselineTrainingNotes - 1)];
					c.FupTrainingDate = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.FupTrainingDate - 1)))?null:(System.DateTime?)reader[((int)BbAdditionalUserDetailColumn.FupTrainingDate - 1)];
					c.FupTrainingBy = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.FupTrainingBy - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.FupTrainingBy - 1)];
					c.FupTrainingNotes = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.FupTrainingNotes - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.FupTrainingNotes - 1)];
					c.Require2Fa = (bool)reader[((int)BbAdditionalUserDetailColumn.Require2Fa - 1)];
					c.Flag1PersonalData = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Flag1PersonalData - 1)))?null:(System.Boolean?)reader[((int)BbAdditionalUserDetailColumn.Flag1PersonalData - 1)];
					c.Flag2EmailResearch = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Flag2EmailResearch - 1)))?null:(System.Boolean?)reader[((int)BbAdditionalUserDetailColumn.Flag2EmailResearch - 1)];
					c.Flag3EmailNewsletter = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Flag3EmailNewsletter - 1)))?null:(System.Boolean?)reader[((int)BbAdditionalUserDetailColumn.Flag3EmailNewsletter - 1)];
					c.Flag4EmailCentreRpt = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Flag4EmailCentreRpt - 1)))?null:(System.Boolean?)reader[((int)BbAdditionalUserDetailColumn.Flag4EmailCentreRpt - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail entity)
		{
			if (!reader.Read()) return;
			
			entity.Userid = (System.Guid)reader[((int)BbAdditionalUserDetailColumn.Userid - 1)];
			entity.OriginalUserid = (System.Guid)reader["userid"];
			entity.BadbiRuserid = (int)reader[((int)BbAdditionalUserDetailColumn.BadbiRuserid - 1)];
			entity.Title = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Title - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.Title - 1)];
			entity.FName = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.FName - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.FName - 1)];
			entity.LName = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.LName - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.LName - 1)];
			entity.Position = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Position - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.Position - 1)];
			entity.Phone = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Phone - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.Phone - 1)];
			entity.Hospital = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Hospital - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.Hospital - 1)];
			entity.Createdbyid = (int)reader[((int)BbAdditionalUserDetailColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbAdditionalUserDetailColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbAdditionalUserDetailColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbAdditionalUserDetailColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbAdditionalUserDetailColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbAdditionalUserDetailColumn.Lastupdateddate - 1)];
			entity.BaselineTrainingDate = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.BaselineTrainingDate - 1)))?null:(System.DateTime?)reader[((int)BbAdditionalUserDetailColumn.BaselineTrainingDate - 1)];
			entity.BaselineTrainingBy = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.BaselineTrainingBy - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.BaselineTrainingBy - 1)];
			entity.BaselineTrainingNotes = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.BaselineTrainingNotes - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.BaselineTrainingNotes - 1)];
			entity.FupTrainingDate = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.FupTrainingDate - 1)))?null:(System.DateTime?)reader[((int)BbAdditionalUserDetailColumn.FupTrainingDate - 1)];
			entity.FupTrainingBy = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.FupTrainingBy - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.FupTrainingBy - 1)];
			entity.FupTrainingNotes = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.FupTrainingNotes - 1)))?null:(string)reader[((int)BbAdditionalUserDetailColumn.FupTrainingNotes - 1)];
			entity.Require2Fa = (bool)reader[((int)BbAdditionalUserDetailColumn.Require2Fa - 1)];
			entity.Flag1PersonalData = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Flag1PersonalData - 1)))?null:(System.Boolean?)reader[((int)BbAdditionalUserDetailColumn.Flag1PersonalData - 1)];
			entity.Flag2EmailResearch = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Flag2EmailResearch - 1)))?null:(System.Boolean?)reader[((int)BbAdditionalUserDetailColumn.Flag2EmailResearch - 1)];
			entity.Flag3EmailNewsletter = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Flag3EmailNewsletter - 1)))?null:(System.Boolean?)reader[((int)BbAdditionalUserDetailColumn.Flag3EmailNewsletter - 1)];
			entity.Flag4EmailCentreRpt = (reader.IsDBNull(((int)BbAdditionalUserDetailColumn.Flag4EmailCentreRpt - 1)))?null:(System.Boolean?)reader[((int)BbAdditionalUserDetailColumn.Flag4EmailCentreRpt - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Userid = (System.Guid)dataRow["userid"];
			entity.OriginalUserid = (System.Guid)dataRow["userid"];
			entity.BadbiRuserid = (int)dataRow["BADBIRuserid"];
			entity.Title = Convert.IsDBNull(dataRow["title"]) ? null : (string)dataRow["title"];
			entity.FName = Convert.IsDBNull(dataRow["fName"]) ? null : (string)dataRow["fName"];
			entity.LName = Convert.IsDBNull(dataRow["lName"]) ? null : (string)dataRow["lName"];
			entity.Position = Convert.IsDBNull(dataRow["position"]) ? null : (string)dataRow["position"];
			entity.Phone = Convert.IsDBNull(dataRow["phone"]) ? null : (string)dataRow["phone"];
			entity.Hospital = Convert.IsDBNull(dataRow["hospital"]) ? null : (string)dataRow["hospital"];
			...
			entity.BaselineTrainingDate = Convert.IsDBNull(dataRow["baselineTrainingDate"]) ? null : (System.DateTime?)dataRow["baselineTrainingDate"];
			entity.BaselineTrainingBy = Convert.IsDBNull(dataRow["baselineTrainingBy"]) ? null : (string)dataRow["baselineTrainingBy"];
			entity.BaselineTrainingNotes = Convert.IsDBNull(dataRow["baselineTrainingNotes"]) ? null : (string)dataRow["baselineTrainingNotes"];
			entity.FupTrainingDate = Convert.IsDBNull(dataRow["fupTrainingDate"]) ? null : (System.DateTime?)dataRow["fupTrainingDate"];
			entity.FupTrainingBy = Convert.IsDBNull(dataRow["fupTrainingBy"]) ? null : (string)dataRow["fupTrainingBy"];
			entity.FupTrainingNotes = Convert.IsDBNull(dataRow["fupTrainingNotes"]) ? null : (string)dataRow["fupTrainingNotes"];
			entity.Require2Fa = (bool)dataRow["require2FA"];
			entity.Flag1PersonalData = Convert.IsDBNull(dataRow["flag1PersonalData"]) ? null : (System.Boolean?)dataRow["flag1PersonalData"];
			entity.Flag2EmailResearch = Convert.IsDBNull(dataRow["flag2EmailResearch"]) ? null : (System.Boolean?)dataRow["flag2EmailResearch"];
			entity.Flag3EmailNewsletter = Convert.IsDBNull(dataRow["flag3EmailNewsletter"]) ? null : (System.Boolean?)dataRow["flag3EmailNewsletter"];
			entity.Flag4EmailCentreRpt = Convert.IsDBNull(dataRow["flag4EmailCentreRpt"]) ? null : (System.Boolean?)dataRow["flag4EmailCentreRpt"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbAdditionalUserDetailChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbAdditionalUserDetail</c>
	///</summary>
	public enum BbAdditionalUserDetailChildEntityTypes
	{
	}
	
	#endregion BbAdditionalUserDetailChildEntityTypes
	
	#region BbAdditionalUserDetailFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbAdditionalUserDetailColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbAdditionalUserDetail"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbAdditionalUserDetailFilterBuilder : SqlFilterBuilder<BbAdditionalUserDetailColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbAdditionalUserDetailFilterBuilder class.
		/// </summary>
		public BbAdditionalUserDetailFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbAdditionalUserDetailFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbAdditionalUserDetailFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbAdditionalUserDetailFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbAdditionalUserDetailFilterBuilder
	
	#region BbAdditionalUserDetailParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbAdditionalUserDetailColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbAdditionalUserDetail"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbAdditionalUserDetailParameterBuilder : ParameterizedSqlFilterBuilder<BbAdditionalUserDetailColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbAdditionalUserDetailParameterBuilder class.
		/// </summary>
		public BbAdditionalUserDetailParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbAdditionalUserDetailParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbAdditionalUserDetailParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbAdditionalUserDetailParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbAdditionalUserDetailParameterBuilder
	
	#region BbAdditionalUserDetailSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbAdditionalUserDetailColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbAdditionalUserDetail"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbAdditionalUserDetailSortBuilder : SqlSortBuilder<BbAdditionalUserDetailColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbAdditionalUserDetailSqlSortBuilder class.
		/// </summary>
		public BbAdditionalUserDetailSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbAdditionalUserDetailSortBuilder
