...
{	
	...
	///</summary>
	public abstract partial class BbPappPatientCohortTrackingProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking, MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTrackingKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTrackingKey key)
		{
			return Delete(transactionManager, key.PappFupId);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_pappFupId">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _pappFupId)
		{
			return Delete(null, _pappFupId);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _pappFupId);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappPatientCohortTracking_bbPatient key.
		///		FK_bbPappPatientCohortTracking_bbPatient Description: 
		/// </summary>
		/// <param name="_patientId"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByPatientId(int _patientId)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		/// <remarks></remarks>
		public TList<BbPappPatientCohortTracking> GetByPatientId(TransactionManager transactionManager, int _patientId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByPatientId(TransactionManager transactionManager, int _patientId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappPatientCohortTracking_bbPatient key.
		///		fkBbPappPatientCohortTrackingBbPatient Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_patientId"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByPatientId(int _patientId, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByPatientId(int _patientId, int start, int pageLength,out int count)
		{
			return GetByPatientId(null, _patientId, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public abstract TList<BbPappPatientCohortTracking> GetByPatientId(TransactionManager transactionManager, int _patientId, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappPatientCohortTracking_bbPatientCohortTracking key.
		///		FK_bbPappPatientCohortTracking_bbPatientCohortTracking Description: 
		/// </summary>
		/// <param name="_importedFupId"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByImportedFupId(System.Int32? _importedFupId)
		{
			int count = -1;
			return GetByImportedFupId(_importedFupId, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		/// <remarks></remarks>
		public TList<BbPappPatientCohortTracking> GetByImportedFupId(TransactionManager transactionManager, System.Int32? _importedFupId)
		{
			int count = -1;
			return GetByImportedFupId(transactionManager, _importedFupId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByImportedFupId(TransactionManager transactionManager, System.Int32? _importedFupId, int start, int pageLength)
		{
			int count = -1;
			return GetByImportedFupId(transactionManager, _importedFupId, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappPatientCohortTracking_bbPatientCohortTracking key.
		///		fkBbPappPatientCohortTrackingBbPatientCohortTracking Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_importedFupId"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByImportedFupId(System.Int32? _importedFupId, int start, int pageLength)
		{
			int count =  -1;
			return GetByImportedFupId(null, _importedFupId, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByImportedFupId(System.Int32? _importedFupId, int start, int pageLength,out int count)
		{
			return GetByImportedFupId(null, _importedFupId, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public abstract TList<BbPappPatientCohortTracking> GetByImportedFupId(TransactionManager transactionManager, System.Int32? _importedFupId, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappPatientCohortTracking_clinicAttendance key.
		///		FK_bbPappPatientCohortTracking_clinicAttendance Description: 
		/// </summary>
		/// <param name="_clinicAttendance"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByClinicAttendance(System.Int32? _clinicAttendance)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		/// <remarks></remarks>
		public TList<BbPappPatientCohortTracking> GetByClinicAttendance(TransactionManager transactionManager, System.Int32? _clinicAttendance)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByClinicAttendance(TransactionManager transactionManager, System.Int32? _clinicAttendance, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappPatientCohortTracking_clinicAttendance key.
		///		fkBbPappPatientCohortTrackingClinicAttendance Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_clinicAttendance"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByClinicAttendance(System.Int32? _clinicAttendance, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public TList<BbPappPatientCohortTracking> GetByClinicAttendance(System.Int32? _clinicAttendance, int start, int pageLength,out int count)
		{
			return GetByClinicAttendance(null, _clinicAttendance, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking objects.</returns>
		public abstract TList<BbPappPatientCohortTracking> GetByClinicAttendance(TransactionManager transactionManager, System.Int32? _clinicAttendance, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTrackingKey key, int start, int pageLength)
		{
			return GetByPappFupId(transactionManager, key.PappFupId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbPappPatientCohortTracking index.
		/// </summary>
		/// <param name="_pappFupId"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking GetByPappFupId(int _pappFupId)
		{
			int count = -1;
			return GetByPappFupId(null,_pappFupId, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbPappPatientCohortTracking index.
		/// </summary>
		/// <param name="_pappFupId"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking GetByPappFupId(int _pappFupId, int start, int pageLength)
		{
			int count = -1;
			return GetByPappFupId(null, _pappFupId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking GetByPappFupId(TransactionManager transactionManager, int _pappFupId)
		{
			int count = -1;
			return GetByPappFupId(transactionManager, _pappFupId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking GetByPappFupId(TransactionManager transactionManager, int _pappFupId, int start, int pageLength)
		{
			int count = -1;
			return GetByPappFupId(transactionManager, _pappFupId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking GetByPappFupId(int _pappFupId, int start, int pageLength, out int count)
		{
			return GetByPappFupId(null, _pappFupId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking GetByPappFupId(TransactionManager transactionManager, int _pappFupId, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbPappPatientCohortTracking&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPappPatientCohortTracking&gt;"/></returns>
		public static TList<BbPappPatientCohortTracking> Fill(IDataReader reader, TList<BbPappPatientCohortTracking> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPappPatientCohortTracking")
					.Append("|").Append((int)reader[((int)BbPappPatientCohortTrackingColumn.PappFupId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPappPatientCohortTracking>(
					key.ToString(), // EntityTrackingKey
					"BbPappPatientCohortTracking",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking();
				}
					...
					))
				{
					...
					c.PappFupId = (int)reader[((int)BbPappPatientCohortTrackingColumn.PappFupId - 1)];
					c.PatientId = (int)reader[((int)BbPappPatientCohortTrackingColumn.PatientId - 1)];
					c.PotentialFupCode = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.PotentialFupCode - 1)))?null:(System.Int32?)reader[((int)BbPappPatientCohortTrackingColumn.PotentialFupCode - 1)];
					c.ImportedFupId = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.ImportedFupId - 1)))?null:(System.Int32?)reader[((int)BbPappPatientCohortTrackingColumn.ImportedFupId - 1)];
					c.Visitdate = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.Visitdate - 1)))?null:(System.DateTime?)reader[((int)BbPappPatientCohortTrackingColumn.Visitdate - 1)];
					c.ClinicAttendance = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.ClinicAttendance - 1)))?null:(System.Int32?)reader[((int)BbPappPatientCohortTrackingColumn.ClinicAttendance - 1)];
					c.Dateentered = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.Dateentered - 1)))?null:(System.DateTime?)reader[((int)BbPappPatientCohortTrackingColumn.Dateentered - 1)];
					c.Comments = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.Comments - 1)))?null:(string)reader[((int)BbPappPatientCohortTrackingColumn.Comments - 1)];
					c.PappFupStatus = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.PappFupStatus - 1)))?null:(System.Int32?)reader[((int)BbPappPatientCohortTrackingColumn.PappFupStatus - 1)];
					c.Createdbyid = (int)reader[((int)BbPappPatientCohortTrackingColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPappPatientCohortTrackingColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPappPatientCohortTrackingColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPappPatientCohortTrackingColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPappPatientCohortTrackingColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPappPatientCohortTrackingColumn.Lastupdateddate - 1)];
					c.Checkedbyid = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.Checkedbyid - 1)))?null:(System.Int32?)reader[((int)BbPappPatientCohortTrackingColumn.Checkedbyid - 1)];
					c.Checkedbyname = (string)reader[((int)BbPappPatientCohortTrackingColumn.Checkedbyname - 1)];
					c.Checkedbydate = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.Checkedbydate - 1)))?null:(System.DateTime?)reader[((int)BbPappPatientCohortTrackingColumn.Checkedbydate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking entity)
		{
			if (!reader.Read()) return;
			
			entity.PappFupId = (int)reader[((int)BbPappPatientCohortTrackingColumn.PappFupId - 1)];
			entity.PatientId = (int)reader[((int)BbPappPatientCohortTrackingColumn.PatientId - 1)];
			entity.PotentialFupCode = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.PotentialFupCode - 1)))?null:(System.Int32?)reader[((int)BbPappPatientCohortTrackingColumn.PotentialFupCode - 1)];
			entity.ImportedFupId = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.ImportedFupId - 1)))?null:(System.Int32?)reader[((int)BbPappPatientCohortTrackingColumn.ImportedFupId - 1)];
			entity.Visitdate = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.Visitdate - 1)))?null:(System.DateTime?)reader[((int)BbPappPatientCohortTrackingColumn.Visitdate - 1)];
			entity.ClinicAttendance = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.ClinicAttendance - 1)))?null:(System.Int32?)reader[((int)BbPappPatientCohortTrackingColumn.ClinicAttendance - 1)];
			entity.Dateentered = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.Dateentered - 1)))?null:(System.DateTime?)reader[((int)BbPappPatientCohortTrackingColumn.Dateentered - 1)];
			entity.Comments = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.Comments - 1)))?null:(string)reader[((int)BbPappPatientCohortTrackingColumn.Comments - 1)];
			entity.PappFupStatus = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.PappFupStatus - 1)))?null:(System.Int32?)reader[((int)BbPappPatientCohortTrackingColumn.PappFupStatus - 1)];
			entity.Createdbyid = (int)reader[((int)BbPappPatientCohortTrackingColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPappPatientCohortTrackingColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPappPatientCohortTrackingColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPappPatientCohortTrackingColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPappPatientCohortTrackingColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPappPatientCohortTrackingColumn.Lastupdateddate - 1)];
			entity.Checkedbyid = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.Checkedbyid - 1)))?null:(System.Int32?)reader[((int)BbPappPatientCohortTrackingColumn.Checkedbyid - 1)];
			entity.Checkedbyname = (string)reader[((int)BbPappPatientCohortTrackingColumn.Checkedbyname - 1)];
			entity.Checkedbydate = (reader.IsDBNull(((int)BbPappPatientCohortTrackingColumn.Checkedbydate - 1)))?null:(System.DateTime?)reader[((int)BbPappPatientCohortTrackingColumn.Checkedbydate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.PappFupId = (int)dataRow["PappFupId"];
			entity.PatientId = (int)dataRow["PatientId"];
			entity.PotentialFupCode = Convert.IsDBNull(dataRow["potentialFupCode"]) ? null : (System.Int32?)dataRow["potentialFupCode"];
			entity.ImportedFupId = Convert.IsDBNull(dataRow["importedFupId"]) ? null : (System.Int32?)dataRow["importedFupId"];
			entity.Visitdate = Convert.IsDBNull(dataRow["visitdate"]) ? null : (System.DateTime?)dataRow["visitdate"];
			...
			entity.PappFupStatus = Convert.IsDBNull(dataRow["pappFupStatus"]) ? null : (System.Int32?)dataRow["pappFupStatus"];
			...
			entity.Checkedbyname = (string)dataRow["checkedbyname"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			#region ImportedFupIdSource	
			if (CanDeepLoad(entity, "BbPatientCohortTracking|ImportedFupIdSource", deepLoadType, innerList) 
				&& entity.ImportedFupIdSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.ImportedFupId ?? (int)0);
				...
				if (tmpEntity != null)
					entity.ImportedFupIdSource = tmpEntity;
				else
					entity.ImportedFupIdSource = DataRepository.BbPatientCohortTrackingProvider.GetByFupId(transactionManager, (entity.ImportedFupId ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'ImportedFupIdSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.ImportedFupIdSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbPatientCohortTrackingProvider.DeepLoad(transactionManager, entity.ImportedFupIdSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion ImportedFupIdSource
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region ImportedFupIdSource
			if (CanDeepSave(entity, "BbPatientCohortTracking|ImportedFupIdSource", deepSaveType, innerList) 
				&& entity.ImportedFupIdSource != null)
			{
				DataRepository.BbPatientCohortTrackingProvider.Save(transactionManager, entity.ImportedFupIdSource);
				entity.ImportedFupId = entity.ImportedFupIdSource.FupId;
			}
			#endregion 
	...
	#region BbPappPatientCohortTrackingChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPappPatientCohortTracking</c>
	///</summary>
	public enum BbPappPatientCohortTrackingChildEntityTypes
	{
		...
		///<summary>
		/// Composite Property for <c>BbPatientCohortTracking</c> at ImportedFupIdSource
		///</summary>
	...
	#endregion BbPappPatientCohortTrackingChildEntityTypes
	
	#region BbPappPatientCohortTrackingFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPappPatientCohortTrackingColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientCohortTracking"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPappPatientCohortTrackingFilterBuilder : SqlFilterBuilder<BbPappPatientCohortTrackingColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientCohortTrackingFilterBuilder class.
		/// </summary>
		public BbPappPatientCohortTrackingFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPappPatientCohortTrackingFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPappPatientCohortTrackingFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPappPatientCohortTrackingFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPappPatientCohortTrackingFilterBuilder
	
	#region BbPappPatientCohortTrackingParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPappPatientCohortTrackingColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientCohortTracking"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPappPatientCohortTrackingParameterBuilder : ParameterizedSqlFilterBuilder<BbPappPatientCohortTrackingColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientCohortTrackingParameterBuilder class.
		/// </summary>
		public BbPappPatientCohortTrackingParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPappPatientCohortTrackingParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPappPatientCohortTrackingParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPappPatientCohortTrackingParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPappPatientCohortTrackingParameterBuilder
	
	#region BbPappPatientCohortTrackingSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPappPatientCohortTrackingColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientCohortTracking"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPappPatientCohortTrackingSortBuilder : SqlSortBuilder<BbPappPatientCohortTrackingColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientCohortTrackingSqlSortBuilder class.
		/// </summary>
		public BbPappPatientCohortTrackingSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPappPatientCohortTrackingSortBuilder
