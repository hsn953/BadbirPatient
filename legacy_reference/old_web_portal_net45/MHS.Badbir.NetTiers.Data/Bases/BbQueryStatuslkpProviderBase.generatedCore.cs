...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbQueryStatuslkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbQueryStatuslkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp, MHS.Badbir.NetTiers.Entities.BbQueryStatuslkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryStatuslkpKey key)
		{
			return Delete(transactionManager, key.QueryStatusId);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_queryStatusId">Query Status Lookup ID. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _queryStatusId)
		{
			return Delete(null, _queryStatusId);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _queryStatusId);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryStatuslkpKey key, int start, int pageLength)
		{
			return GetByQueryStatusId(transactionManager, key.QueryStatusId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbQueryStatuslkp index.
		/// </summary>
		/// <param name="_queryStatusId">Query Status Lookup ID</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp GetByQueryStatusId(int _queryStatusId)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbQueryStatuslkp index.
		/// </summary>
		/// <param name="_queryStatusId">Query Status Lookup ID</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp GetByQueryStatusId(int _queryStatusId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp GetByQueryStatusId(TransactionManager transactionManager, int _queryStatusId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp GetByQueryStatusId(TransactionManager transactionManager, int _queryStatusId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp GetByQueryStatusId(int _queryStatusId, int start, int pageLength, out int count)
		{
			return GetByQueryStatusId(null, _queryStatusId, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp GetByQueryStatusId(TransactionManager transactionManager, int _queryStatusId, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbQueryStatuslkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbQueryStatuslkp&gt;"/></returns>
		public static TList<BbQueryStatuslkp> Fill(IDataReader reader, TList<BbQueryStatuslkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbQueryStatuslkp")
					.Append("|").Append((int)reader[((int)BbQueryStatuslkpColumn.QueryStatusId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbQueryStatuslkp>(
					key.ToString(), // EntityTrackingKey
					"BbQueryStatuslkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp();
				}
					...
					))
				{
					...
					c.QueryStatusId = (int)reader[((int)BbQueryStatuslkpColumn.QueryStatusId - 1)];
					c.QueryStatus = (reader.IsDBNull(((int)BbQueryStatuslkpColumn.QueryStatus - 1)))?null:(string)reader[((int)BbQueryStatuslkpColumn.QueryStatus - 1)];
					c.Createdbyid = (int)reader[((int)BbQueryStatuslkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbQueryStatuslkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbQueryStatuslkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbQueryStatuslkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbQueryStatuslkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbQueryStatuslkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp entity)
		{
			if (!reader.Read()) return;
			
			entity.QueryStatusId = (int)reader[((int)BbQueryStatuslkpColumn.QueryStatusId - 1)];
			entity.QueryStatus = (reader.IsDBNull(((int)BbQueryStatuslkpColumn.QueryStatus - 1)))?null:(string)reader[((int)BbQueryStatuslkpColumn.QueryStatus - 1)];
			entity.Createdbyid = (int)reader[((int)BbQueryStatuslkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbQueryStatuslkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbQueryStatuslkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbQueryStatuslkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbQueryStatuslkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbQueryStatuslkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.QueryStatusId = (int)dataRow["QueryStatusId"];
			entity.QueryStatus = Convert.IsDBNull(dataRow["QueryStatus"]) ? null : (string)dataRow["QueryStatus"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByQueryStatusId methods when available
			...
			if (CanDeepLoad(entity, "List<BbQuery>|BbQueryCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbQueryCollection = DataRepository.BbQueryProvider.GetByQueryStatusId(transactionManager, entity.QueryStatusId);
			...
			if (CanDeepLoad(entity, "List<BbQueryForCentre>|BbQueryForCentreCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbQueryForCentreCollection = DataRepository.BbQueryForCentreProvider.GetByQueryStatusId(transactionManager, entity.QueryStatusId);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbQuery>
				...
				{	
					...
					{
						if(child.QueryStatusIdSource != null)
						{
							child.QueryStatusId = child.QueryStatusIdSource.QueryStatusId;
						}
						else
						{
							child.QueryStatusId = entity.QueryStatusId;
						}
	...
	#region BbQueryStatuslkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbQueryStatuslkp</c>
	///</summary>
	public enum BbQueryStatuslkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbQueryStatuslkp</c> as OneToMany for BbQueryCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbQuery>))]
		BbQueryCollection,
		///<summary>
		/// Collection of <c>BbQueryStatuslkp</c> as OneToMany for BbQueryForCentreCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbQueryForCentre>))]
		BbQueryForCentreCollection,
	}
	
	#endregion BbQueryStatuslkpChildEntityTypes
	
	#region BbQueryStatuslkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbQueryStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryStatuslkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryStatuslkpFilterBuilder : SqlFilterBuilder<BbQueryStatuslkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryStatuslkpFilterBuilder class.
		/// </summary>
		public BbQueryStatuslkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryStatuslkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryStatuslkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbQueryStatuslkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryStatuslkpFilterBuilder
	
	#region BbQueryStatuslkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbQueryStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryStatuslkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryStatuslkpParameterBuilder : ParameterizedSqlFilterBuilder<BbQueryStatuslkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryStatuslkpParameterBuilder class.
		/// </summary>
		public BbQueryStatuslkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryStatuslkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryStatuslkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbQueryStatuslkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryStatuslkpParameterBuilder
	
	#region BbQueryStatuslkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbQueryStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryStatuslkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbQueryStatuslkpSortBuilder : SqlSortBuilder<BbQueryStatuslkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryStatuslkpSqlSortBuilder class.
		/// </summary>
		public BbQueryStatuslkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbQueryStatuslkpSortBuilder
