...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbNotificationProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbNotificationProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbNotification, MHS.Badbir.NetTiers.Entities.BbNotificationKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbNotificationKey key)
		{
			return Delete(transactionManager, key.Nid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_nid">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _nid)
		{
			return Delete(null, _nid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _nid);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbNotification_bbNotificationTypelkp key.
		///		FK_bbNotification_bbNotificationTypelkp Description: 
		/// </summary>
		/// <param name="_typeId"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbNotification objects.</returns>
		public TList<BbNotification> GetByTypeId(int _typeId)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbNotification objects.</returns>
		/// <remarks></remarks>
		public TList<BbNotification> GetByTypeId(TransactionManager transactionManager, int _typeId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbNotification objects.</returns>
		public TList<BbNotification> GetByTypeId(TransactionManager transactionManager, int _typeId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbNotification_bbNotificationTypelkp key.
		///		fkBbNotificationBbNotificationTypelkp Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_typeId"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbNotification objects.</returns>
		public TList<BbNotification> GetByTypeId(int _typeId, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbNotification objects.</returns>
		public TList<BbNotification> GetByTypeId(int _typeId, int start, int pageLength,out int count)
		{
			return GetByTypeId(null, _typeId, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbNotification objects.</returns>
		public abstract TList<BbNotification> GetByTypeId(TransactionManager transactionManager, int _typeId, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbNotification Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbNotificationKey key, int start, int pageLength)
		{
			return GetByNid(transactionManager, key.Nid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbNotification index.
		/// </summary>
		/// <param name="_nid"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbNotification GetByNid(int _nid)
		{
			int count = -1;
			return GetByNid(null,_nid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbNotification index.
		/// </summary>
		/// <param name="_nid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbNotification GetByNid(int _nid, int start, int pageLength)
		{
			int count = -1;
			return GetByNid(null, _nid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbNotification GetByNid(TransactionManager transactionManager, int _nid)
		{
			int count = -1;
			return GetByNid(transactionManager, _nid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbNotification GetByNid(TransactionManager transactionManager, int _nid, int start, int pageLength)
		{
			int count = -1;
			return GetByNid(transactionManager, _nid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbNotification GetByNid(int _nid, int start, int pageLength, out int count)
		{
			return GetByNid(null, _nid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbNotification GetByNid(TransactionManager transactionManager, int _nid, int start, int pageLength, out int count);
		...
		/// <param name="dateTo"> A <c>System.DateTime?</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbNotification&gt;"/> instance.</returns>
		public TList<BbNotification> Notification_GetSolved_Custom(System.Int32? showAdminInbox, System.Int32? showPvInbox, System.Int32? showSuperInbox, System.String typeList, System.Int32? studyId, System.DateTime? dateFrom, System.DateTime? dateTo)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbNotification&gt;"/> instance.</returns>
		public TList<BbNotification> Notification_GetSolved_Custom(int start, int pageLength, System.Int32? showAdminInbox, System.Int32? showPvInbox, System.Int32? showSuperInbox, System.String typeList, System.Int32? studyId, System.DateTime? dateFrom, System.DateTime? dateTo)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbNotification&gt;"/> instance.</returns>
		public TList<BbNotification> Notification_GetSolved_Custom(TransactionManager transactionManager, System.Int32? showAdminInbox, System.Int32? showPvInbox, System.Int32? showSuperInbox, System.String typeList, System.Int32? studyId, System.DateTime? dateFrom, System.DateTime? dateTo)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbNotification&gt;"/> instance.</returns>
		public abstract TList<BbNotification> Notification_GetSolved_Custom(TransactionManager transactionManager, int start, int pageLength , System.Int32? showAdminInbox, System.Int32? showPvInbox, System.Int32? showSuperInbox, System.String typeList, System.Int32? studyId, System.DateTime? dateFrom, System.DateTime? dateTo);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbNotification&gt;"/> instance.</returns>
		public TList<BbNotification> Notification_GetSolved_ByInboxID(System.Int32? inboxId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbNotification&gt;"/> instance.</returns>
		public TList<BbNotification> Notification_GetSolved_ByInboxID(int start, int pageLength, System.Int32? inboxId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbNotification&gt;"/> instance.</returns>
		public TList<BbNotification> Notification_GetSolved_ByInboxID(TransactionManager transactionManager, System.Int32? inboxId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbNotification&gt;"/> instance.</returns>
		public abstract TList<BbNotification> Notification_GetSolved_ByInboxID(TransactionManager transactionManager, int start, int pageLength , System.Int32? inboxId);
		...
		/// <summary>
		/// Fill a TList&lt;BbNotification&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbNotification&gt;"/></returns>
		public static TList<BbNotification> Fill(IDataReader reader, TList<BbNotification> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbNotification c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbNotification")
					.Append("|").Append((int)reader[((int)BbNotificationColumn.Nid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbNotification>(
					key.ToString(), // EntityTrackingKey
					"BbNotification",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbNotification();
				}
					...
					))
				{
					...
					c.Nid = (int)reader[((int)BbNotificationColumn.Nid - 1)];
					c.InboxId = (byte)reader[((int)BbNotificationColumn.InboxId - 1)];
					c.TypeId = (int)reader[((int)BbNotificationColumn.TypeId - 1)];
					c.Unread = (bool)reader[((int)BbNotificationColumn.Unread - 1)];
					c.DateRead = (reader.IsDBNull(((int)BbNotificationColumn.DateRead - 1)))?null:(System.DateTime?)reader[((int)BbNotificationColumn.DateRead - 1)];
					c.StatusId = (bool)reader[((int)BbNotificationColumn.StatusId - 1)];
					c.DateArchived = (reader.IsDBNull(((int)BbNotificationColumn.DateArchived - 1)))?null:(System.DateTime?)reader[((int)BbNotificationColumn.DateArchived - 1)];
					c.GroupId = (reader.IsDBNull(((int)BbNotificationColumn.GroupId - 1)))?null:(System.Int32?)reader[((int)BbNotificationColumn.GroupId - 1)];
					c.Chid = (reader.IsDBNull(((int)BbNotificationColumn.Chid - 1)))?null:(System.Int32?)reader[((int)BbNotificationColumn.Chid - 1)];
					c.BadbirUserId = (reader.IsDBNull(((int)BbNotificationColumn.BadbirUserId - 1)))?null:(System.Int32?)reader[((int)BbNotificationColumn.BadbirUserId - 1)];
					c.HighPriority = (bool)reader[((int)BbNotificationColumn.HighPriority - 1)];
					c.Ntext = (reader.IsDBNull(((int)BbNotificationColumn.Ntext - 1)))?null:(string)reader[((int)BbNotificationColumn.Ntext - 1)];
					c.Include = (bool)reader[((int)BbNotificationColumn.Include - 1)];
					c.Createdbyid = (int)reader[((int)BbNotificationColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbNotificationColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbNotificationColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbNotificationColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbNotificationColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbNotificationColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbNotification entity)
		{
			if (!reader.Read()) return;
			
			entity.Nid = (int)reader[((int)BbNotificationColumn.Nid - 1)];
			entity.InboxId = (byte)reader[((int)BbNotificationColumn.InboxId - 1)];
			entity.TypeId = (int)reader[((int)BbNotificationColumn.TypeId - 1)];
			entity.Unread = (bool)reader[((int)BbNotificationColumn.Unread - 1)];
			entity.DateRead = (reader.IsDBNull(((int)BbNotificationColumn.DateRead - 1)))?null:(System.DateTime?)reader[((int)BbNotificationColumn.DateRead - 1)];
			entity.StatusId = (bool)reader[((int)BbNotificationColumn.StatusId - 1)];
			entity.DateArchived = (reader.IsDBNull(((int)BbNotificationColumn.DateArchived - 1)))?null:(System.DateTime?)reader[((int)BbNotificationColumn.DateArchived - 1)];
			entity.GroupId = (reader.IsDBNull(((int)BbNotificationColumn.GroupId - 1)))?null:(System.Int32?)reader[((int)BbNotificationColumn.GroupId - 1)];
			entity.Chid = (reader.IsDBNull(((int)BbNotificationColumn.Chid - 1)))?null:(System.Int32?)reader[((int)BbNotificationColumn.Chid - 1)];
			entity.BadbirUserId = (reader.IsDBNull(((int)BbNotificationColumn.BadbirUserId - 1)))?null:(System.Int32?)reader[((int)BbNotificationColumn.BadbirUserId - 1)];
			entity.HighPriority = (bool)reader[((int)BbNotificationColumn.HighPriority - 1)];
			entity.Ntext = (reader.IsDBNull(((int)BbNotificationColumn.Ntext - 1)))?null:(string)reader[((int)BbNotificationColumn.Ntext - 1)];
			entity.Include = (bool)reader[((int)BbNotificationColumn.Include - 1)];
			entity.Createdbyid = (int)reader[((int)BbNotificationColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbNotificationColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbNotificationColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbNotificationColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbNotificationColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbNotificationColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbNotification entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Nid = (int)dataRow["Nid"];
			entity.InboxId = (byte)dataRow["InboxID"];
			entity.TypeId = (int)dataRow["TypeID"];
			entity.Unread = (bool)dataRow["Unread"];
			entity.DateRead = Convert.IsDBNull(dataRow["DateRead"]) ? null : (System.DateTime?)dataRow["DateRead"];
			entity.StatusId = (bool)dataRow["StatusID"];
			entity.DateArchived = Convert.IsDBNull(dataRow["DateArchived"]) ? null : (System.DateTime?)dataRow["DateArchived"];
			entity.GroupId = Convert.IsDBNull(dataRow["GroupID"]) ? null : (System.Int32?)dataRow["GroupID"];
			entity.Chid = Convert.IsDBNull(dataRow["Chid"]) ? null : (System.Int32?)dataRow["Chid"];
			entity.BadbirUserId = Convert.IsDBNull(dataRow["BADBIRUserID"]) ? null : (System.Int32?)dataRow["BADBIRUserID"];
			entity.HighPriority = (bool)dataRow["HighPriority"];
			entity.Ntext = Convert.IsDBNull(dataRow["NText"]) ? null : (string)dataRow["NText"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbNotification"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbNotification Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbNotification entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region TypeIdSource	
			if (CanDeepLoad(entity, "BbNotificationTypelkp|TypeIdSource", deepLoadType, innerList) 
				&& entity.TypeIdSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.TypeId;
				BbNotificationTypelkp tmpEntity = EntityManager.LocateEntity<BbNotificationTypelkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbNotificationTypelkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.TypeIdSource = tmpEntity;
				else
					entity.TypeIdSource = DataRepository.BbNotificationTypelkpProvider.GetByNtypeId(transactionManager, entity.TypeId);		
				...
				if (deep && entity.TypeIdSource != null)
				{
					...
					DataRepository.BbNotificationTypelkpProvider.DeepLoad(transactionManager, entity.TypeIdSource, deep, deepLoadType, childTypes, innerList);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbNotification object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbNotification instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbNotification Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbNotification entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region TypeIdSource
			if (CanDeepSave(entity, "BbNotificationTypelkp|TypeIdSource", deepSaveType, innerList) 
				&& entity.TypeIdSource != null)
			{
				DataRepository.BbNotificationTypelkpProvider.Save(transactionManager, entity.TypeIdSource);
				entity.TypeId = entity.TypeIdSource.NtypeId;
			}
			#endregion 
	...
	#region BbNotificationChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbNotification</c>
	///</summary>
	public enum BbNotificationChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbNotificationTypelkp</c> at TypeIdSource
		///</summary>
		[ChildEntityType(typeof(BbNotificationTypelkp))]
		BbNotificationTypelkp,
	}
	
	#endregion BbNotificationChildEntityTypes
	
	#region BbNotificationFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbNotificationColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbNotification"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbNotificationFilterBuilder : SqlFilterBuilder<BbNotificationColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbNotificationFilterBuilder class.
		/// </summary>
		public BbNotificationFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbNotificationFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbNotificationFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbNotificationFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbNotificationFilterBuilder
	
	#region BbNotificationParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbNotificationColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbNotification"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbNotificationParameterBuilder : ParameterizedSqlFilterBuilder<BbNotificationColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbNotificationParameterBuilder class.
		/// </summary>
		public BbNotificationParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbNotificationParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbNotificationParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbNotificationParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbNotificationParameterBuilder
	
	#region BbNotificationSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbNotificationColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbNotification"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbNotificationSortBuilder : SqlSortBuilder<BbNotificationColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbNotificationSqlSortBuilder class.
		/// </summary>
		public BbNotificationSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbNotificationSortBuilder
