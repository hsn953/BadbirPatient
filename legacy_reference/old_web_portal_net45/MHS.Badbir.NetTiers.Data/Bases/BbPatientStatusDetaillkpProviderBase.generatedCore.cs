...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPatientStatusDetaillkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPatientStatusDetaillkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp, MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkpKey key)
		{
			return Delete(transactionManager, key.Pstatusdetailid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_pstatusdetailid">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Int32 _pstatusdetailid)
		{
			return Delete(null, _pstatusdetailid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Int32 _pstatusdetailid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkpKey key, int start, int pageLength)
		{
			return GetByPstatusdetailid(transactionManager, key.Pstatusdetailid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key pk_PatientDetailStatus_pid index.
		/// </summary>
		/// <param name="_pstatusdetailid"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp GetByPstatusdetailid(System.Int32 _pstatusdetailid)
		{
			int count = -1;
			return GetByPstatusdetailid(null,_pstatusdetailid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the pk_PatientDetailStatus_pid index.
		/// </summary>
		/// <param name="_pstatusdetailid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp GetByPstatusdetailid(System.Int32 _pstatusdetailid, int start, int pageLength)
		{
			int count = -1;
			return GetByPstatusdetailid(null, _pstatusdetailid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp GetByPstatusdetailid(TransactionManager transactionManager, System.Int32 _pstatusdetailid)
		{
			int count = -1;
			return GetByPstatusdetailid(transactionManager, _pstatusdetailid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp GetByPstatusdetailid(TransactionManager transactionManager, System.Int32 _pstatusdetailid, int start, int pageLength)
		{
			int count = -1;
			return GetByPstatusdetailid(transactionManager, _pstatusdetailid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp GetByPstatusdetailid(System.Int32 _pstatusdetailid, int start, int pageLength, out int count)
		{
			return GetByPstatusdetailid(null, _pstatusdetailid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp GetByPstatusdetailid(TransactionManager transactionManager, System.Int32 _pstatusdetailid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbPatientStatusDetaillkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPatientStatusDetaillkp&gt;"/></returns>
		public static TList<BbPatientStatusDetaillkp> Fill(IDataReader reader, TList<BbPatientStatusDetaillkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPatientStatusDetaillkp")
					.Append("|").Append((System.Int32)reader[((int)BbPatientStatusDetaillkpColumn.Pstatusdetailid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPatientStatusDetaillkp>(
					key.ToString(), // EntityTrackingKey
					"BbPatientStatusDetaillkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp();
				}
					...
					))
				{
					...
					c.Pstatusdetailid = (System.Int32)reader[((int)BbPatientStatusDetaillkpColumn.Pstatusdetailid - 1)];
					c.Pstatusdetail = (reader.IsDBNull(((int)BbPatientStatusDetaillkpColumn.Pstatusdetail - 1)))?null:(System.String)reader[((int)BbPatientStatusDetaillkpColumn.Pstatusdetail - 1)];
					c.Createdbyid = (System.Int32)reader[((int)BbPatientStatusDetaillkpColumn.Createdbyid - 1)];
					c.Createdbyname = (System.String)reader[((int)BbPatientStatusDetaillkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPatientStatusDetaillkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (System.Int32)reader[((int)BbPatientStatusDetaillkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (System.String)reader[((int)BbPatientStatusDetaillkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPatientStatusDetaillkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Pstatusdetailid = (System.Int32)reader[((int)BbPatientStatusDetaillkpColumn.Pstatusdetailid - 1)];
			entity.Pstatusdetail = (reader.IsDBNull(((int)BbPatientStatusDetaillkpColumn.Pstatusdetail - 1)))?null:(System.String)reader[((int)BbPatientStatusDetaillkpColumn.Pstatusdetail - 1)];
			entity.Createdbyid = (System.Int32)reader[((int)BbPatientStatusDetaillkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (System.String)reader[((int)BbPatientStatusDetaillkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPatientStatusDetaillkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (System.Int32)reader[((int)BbPatientStatusDetaillkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (System.String)reader[((int)BbPatientStatusDetaillkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPatientStatusDetaillkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Pstatusdetailid = (System.Int32)dataRow["pstatusdetailid"];
			entity.Pstatusdetail = Convert.IsDBNull(dataRow["pstatusdetail"]) ? null : (System.String)dataRow["pstatusdetail"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByPstatusdetailid methods when available
			...
			if (CanDeepLoad(entity, "List<BbPatient>|BbPatientCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPatientCollection = DataRepository.BbPatientProvider.GetByStatusdetailid(transactionManager, entity.Pstatusdetailid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbPatient>
				...
				{	
					...
					{
						if(child.StatusdetailidSource != null)
						{
							child.Statusdetailid = child.StatusdetailidSource.Pstatusdetailid;
						}
						else
						{
							child.Statusdetailid = entity.Pstatusdetailid;
						}
	...
	#region BbPatientStatusDetaillkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPatientStatusDetaillkp</c>
	///</summary>
	public enum BbPatientStatusDetaillkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbPatientStatusDetaillkp</c> as OneToMany for BbPatientCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatient>))]
		BbPatientCollection,
	}
	
	#endregion BbPatientStatusDetaillkpChildEntityTypes
	
	#region BbPatientStatusDetaillkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPatientStatusDetaillkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientStatusDetaillkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientStatusDetaillkpFilterBuilder : SqlFilterBuilder<BbPatientStatusDetaillkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientStatusDetaillkpFilterBuilder class.
		/// </summary>
		public BbPatientStatusDetaillkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientStatusDetaillkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientStatusDetaillkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPatientStatusDetaillkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientStatusDetaillkpFilterBuilder
	
	#region BbPatientStatusDetaillkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPatientStatusDetaillkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientStatusDetaillkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientStatusDetaillkpParameterBuilder : ParameterizedSqlFilterBuilder<BbPatientStatusDetaillkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientStatusDetaillkpParameterBuilder class.
		/// </summary>
		public BbPatientStatusDetaillkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientStatusDetaillkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientStatusDetaillkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPatientStatusDetaillkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientStatusDetaillkpParameterBuilder
	
	#region BbPatientStatusDetaillkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPatientStatusDetaillkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientStatusDetaillkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPatientStatusDetaillkpSortBuilder : SqlSortBuilder<BbPatientStatusDetaillkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientStatusDetaillkpSqlSortBuilder class.
		/// </summary>
		public BbPatientStatusDetaillkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPatientStatusDetaillkpSortBuilder
