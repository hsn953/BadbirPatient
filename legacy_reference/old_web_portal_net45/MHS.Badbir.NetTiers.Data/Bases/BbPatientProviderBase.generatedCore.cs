...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPatientProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPatientProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPatient, MHS.Badbir.NetTiers.Entities.BbPatientKey>
	{		
		#region Get from Many To Many Relationship Functions
		#region GetByExternalStudyIdFromBbPatientExternalStudyLink
		
		/// <summary>
		///		Gets bbPatient objects from the datasource by externalStudyID in the
		///		bbPatientExternalStudyLink table. Table bbPatient is related to table bbExternalStudyLkp
		///		through the (M:N) relationship defined in the bbPatientExternalStudyLink table.
		/// </summary>
		/// <param name="_externalStudyId"></param>
		/// <returns>Returns a typed collection of BbPatient objects.</returns>
		public TList<BbPatient> GetByExternalStudyIdFromBbPatientExternalStudyLink(System.Int32 _externalStudyId)
		{
			int count = -1;
			return GetByExternalStudyIdFromBbPatientExternalStudyLink(null,_externalStudyId, 0, int.MaxValue, out count);
			
		}
		
		/// <summary>
		///		Gets MHS.Badbir.NetTiers.Entities.BbPatient objects from the datasource by externalStudyID in the
		///		bbPatientExternalStudyLink table. Table bbPatient is related to table bbExternalStudyLkp
		///		through the (M:N) relationship defined in the bbPatientExternalStudyLink table.
		/// </summary>
		...
		/// <param name="_externalStudyId"></param>
		/// <remarks></remarks>
		/// <returns>Returns a TList of BbPatient objects.</returns>
		public TList<BbPatient> GetByExternalStudyIdFromBbPatientExternalStudyLink(System.Int32 _externalStudyId, int start, int pageLength)
		{
			int count = -1;
			return GetByExternalStudyIdFromBbPatientExternalStudyLink(null, _externalStudyId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbPatient objects.</returns>
		public TList<BbPatient> GetByExternalStudyIdFromBbPatientExternalStudyLink(TransactionManager transactionManager, System.Int32 _externalStudyId)
		{
			int count = -1;
			return GetByExternalStudyIdFromBbPatientExternalStudyLink(transactionManager, _externalStudyId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbPatient objects.</returns>
		public TList<BbPatient> GetByExternalStudyIdFromBbPatientExternalStudyLink(TransactionManager transactionManager, System.Int32 _externalStudyId,int start, int pageLength)
		{
			int count = -1;
			return GetByExternalStudyIdFromBbPatientExternalStudyLink(transactionManager, _externalStudyId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbPatient objects.</returns>
		public TList<BbPatient> GetByExternalStudyIdFromBbPatientExternalStudyLink(System.Int32 _externalStudyId,int start, int pageLength, out int count)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a TList of BbPatient objects.</returns>
		public abstract TList<BbPatient> GetByExternalStudyIdFromBbPatientExternalStudyLink(TransactionManager transactionManager,System.Int32 _externalStudyId, int start, int pageLength, out int count);
		
		#endregion GetByExternalStudyIdFromBbPatientExternalStudyLink
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientKey key)
		{
			return Delete(transactionManager, key.Patientid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_patientid">Patient Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _patientid)
		{
			return Delete(null, _patientid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _patientid);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatient_bbPatientStatusDetaillkp key.
		///		FK_bbPatient_bbPatientStatusDetaillkp Description: 
		/// </summary>
		/// <param name="_statusdetailid"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByStatusdetailid(int _statusdetailid)
		{
			int count = -1;
			return GetByStatusdetailid(_statusdetailid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		/// <remarks></remarks>
		public TList<BbPatient> GetByStatusdetailid(TransactionManager transactionManager, int _statusdetailid)
		{
			int count = -1;
			return GetByStatusdetailid(transactionManager, _statusdetailid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByStatusdetailid(TransactionManager transactionManager, int _statusdetailid, int start, int pageLength)
		{
			int count = -1;
			return GetByStatusdetailid(transactionManager, _statusdetailid, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatient_bbPatientStatusDetaillkp key.
		///		fkBbPatientBbPatientStatusDetaillkp Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_statusdetailid"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByStatusdetailid(int _statusdetailid, int start, int pageLength)
		{
			int count =  -1;
			return GetByStatusdetailid(null, _statusdetailid, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByStatusdetailid(int _statusdetailid, int start, int pageLength,out int count)
		{
			return GetByStatusdetailid(null, _statusdetailid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public abstract TList<BbPatient> GetByStatusdetailid(TransactionManager transactionManager, int _statusdetailid, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatient_bbPatientStatuslkp key.
		///		FK_bbPatient_bbPatientStatuslkp Description: 
		/// </summary>
		/// <param name="_statusid">Status</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByStatusid(System.Int32? _statusid)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		/// <remarks></remarks>
		public TList<BbPatient> GetByStatusid(TransactionManager transactionManager, System.Int32? _statusid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByStatusid(TransactionManager transactionManager, System.Int32? _statusid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatient_bbPatientStatuslkp key.
		///		fkBbPatientBbPatientStatuslkp Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_statusid">Status</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByStatusid(System.Int32? _statusid, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByStatusid(System.Int32? _statusid, int start, int pageLength,out int count)
		{
			return GetByStatusid(null, _statusid, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public abstract TList<BbPatient> GetByStatusid(TransactionManager transactionManager, System.Int32? _statusid, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_tblPatients_tblGender_lookup key.
		///		FK_tblPatients_tblGender_lookup Description: 
		/// </summary>
		/// <param name="_genderid">Gender</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByGenderid(System.Int32? _genderid)
		{
			int count = -1;
			return GetByGenderid(_genderid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		/// <remarks></remarks>
		public TList<BbPatient> GetByGenderid(TransactionManager transactionManager, System.Int32? _genderid)
		{
			int count = -1;
			return GetByGenderid(transactionManager, _genderid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByGenderid(TransactionManager transactionManager, System.Int32? _genderid, int start, int pageLength)
		{
			int count = -1;
			return GetByGenderid(transactionManager, _genderid, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_tblPatients_tblGender_lookup key.
		///		fkTblPatientsTblGenderLookup Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_genderid">Gender</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByGenderid(System.Int32? _genderid, int start, int pageLength)
		{
			int count =  -1;
			return GetByGenderid(null, _genderid, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public TList<BbPatient> GetByGenderid(System.Int32? _genderid, int start, int pageLength,out int count)
		{
			return GetByGenderid(null, _genderid, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatient objects.</returns>
		public abstract TList<BbPatient> GetByGenderid(TransactionManager transactionManager, System.Int32? _genderid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbPatient Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientKey key, int start, int pageLength)
		{
			return GetByPatientid(transactionManager, key.Patientid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_tblPatients index.
		/// </summary>
		/// <param name="_patientid">Patient Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatient GetByPatientid(int _patientid)
		{
			int count = -1;
			return GetByPatientid(null,_patientid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_tblPatients index.
		/// </summary>
		/// <param name="_patientid">Patient Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatient GetByPatientid(int _patientid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatient GetByPatientid(TransactionManager transactionManager, int _patientid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatient GetByPatientid(TransactionManager transactionManager, int _patientid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatient GetByPatientid(int _patientid, int start, int pageLength, out int count)
		{
			return GetByPatientid(null, _patientid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPatient GetByPatientid(TransactionManager transactionManager, int _patientid, int start, int pageLength, out int count);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> DelegationLog_mergeAnonymousAccountWithNewAccount(System.Int32? oldBadbirUserId, System.Int32? newBadbirUserId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> DelegationLog_mergeAnonymousAccountWithNewAccount(int start, int pageLength, System.Int32? oldBadbirUserId, System.Int32? newBadbirUserId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> DelegationLog_mergeAnonymousAccountWithNewAccount(TransactionManager transactionManager, System.Int32? oldBadbirUserId, System.Int32? newBadbirUserId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public abstract TList<BbPatient> DelegationLog_mergeAnonymousAccountWithNewAccount(TransactionManager transactionManager, int start, int pageLength , System.Int32? oldBadbirUserId, System.Int32? newBadbirUserId);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> Patient_Get_List_byCentre(System.Int32? centreid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> Patient_Get_List_byCentre(int start, int pageLength, System.Int32? centreid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> Patient_Get_List_byCentre(TransactionManager transactionManager, System.Int32? centreid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public abstract TList<BbPatient> Patient_Get_List_byCentre(TransactionManager transactionManager, int start, int pageLength , System.Int32? centreid);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> Patient_Get_List_byCentre_InEditWindow(System.Int32? centreid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> Patient_Get_List_byCentre_InEditWindow(int start, int pageLength, System.Int32? centreid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> Patient_Get_List_byCentre_InEditWindow(TransactionManager transactionManager, System.Int32? centreid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public abstract TList<BbPatient> Patient_Get_List_byCentre_InEditWindow(TransactionManager transactionManager, int start, int pageLength , System.Int32? centreid);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> Patient_Get_NHSICNotSent()
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> Patient_Get_NHSICNotSent(int start, int pageLength)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public TList<BbPatient> Patient_Get_NHSICNotSent(TransactionManager transactionManager)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatient&gt;"/> instance.</returns>
		public abstract TList<BbPatient> Patient_Get_NHSICNotSent(TransactionManager transactionManager, int start, int pageLength );
		...
		/// <summary>
		/// Fill a TList&lt;BbPatient&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPatient&gt;"/></returns>
		public static TList<BbPatient> Fill(IDataReader reader, TList<BbPatient> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPatient c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPatient")
					.Append("|").Append((int)reader[((int)BbPatientColumn.Patientid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPatient>(
					key.ToString(), // EntityTrackingKey
					"BbPatient",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPatient();
				}
					...
					))
				{
					...
					c.Patientid = (int)reader[((int)BbPatientColumn.Patientid - 1)];
					c.Firststudyno = (reader.IsDBNull(((int)BbPatientColumn.Firststudyno - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Firststudyno - 1)];
					c.Studyidlastfive = (reader.IsDBNull(((int)BbPatientColumn.Studyidlastfive - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Studyidlastfive - 1)];
					c.Dateconsented = (reader.IsDBNull(((int)BbPatientColumn.Dateconsented - 1)))?null:(System.DateTime?)reader[((int)BbPatientColumn.Dateconsented - 1)];
					c.Consentformreceived = (reader.IsDBNull(((int)BbPatientColumn.Consentformreceived - 1)))?null:(System.DateTime?)reader[((int)BbPatientColumn.Consentformreceived - 1)];
					c.Phrn = (reader.IsDBNull(((int)BbPatientColumn.Phrn - 1)))?null:(string)reader[((int)BbPatientColumn.Phrn - 1)];
					c.Pnhs = (reader.IsDBNull(((int)BbPatientColumn.Pnhs - 1)))?null:(string)reader[((int)BbPatientColumn.Pnhs - 1)];
					c.Genderid = (reader.IsDBNull(((int)BbPatientColumn.Genderid - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Genderid - 1)];
					c.Dateofbirth = (reader.IsDBNull(((int)BbPatientColumn.Dateofbirth - 1)))?null:(System.DateTime?)reader[((int)BbPatientColumn.Dateofbirth - 1)];
					c.Title = (reader.IsDBNull(((int)BbPatientColumn.Title - 1)))?null:(string)reader[((int)BbPatientColumn.Title - 1)];
					c.Surname = (reader.IsDBNull(((int)BbPatientColumn.Surname - 1)))?null:(string)reader[((int)BbPatientColumn.Surname - 1)];
					c.Forenames = (reader.IsDBNull(((int)BbPatientColumn.Forenames - 1)))?null:(string)reader[((int)BbPatientColumn.Forenames - 1)];
					c.Address1 = (reader.IsDBNull(((int)BbPatientColumn.Address1 - 1)))?null:(string)reader[((int)BbPatientColumn.Address1 - 1)];
					c.Address2 = (reader.IsDBNull(((int)BbPatientColumn.Address2 - 1)))?null:(string)reader[((int)BbPatientColumn.Address2 - 1)];
					c.Address3 = (reader.IsDBNull(((int)BbPatientColumn.Address3 - 1)))?null:(string)reader[((int)BbPatientColumn.Address3 - 1)];
					c.AddressTown = (reader.IsDBNull(((int)BbPatientColumn.AddressTown - 1)))?null:(string)reader[((int)BbPatientColumn.AddressTown - 1)];
					c.AddressCounty = (reader.IsDBNull(((int)BbPatientColumn.AddressCounty - 1)))?null:(string)reader[((int)BbPatientColumn.AddressCounty - 1)];
					c.AddressPostcode = (reader.IsDBNull(((int)BbPatientColumn.AddressPostcode - 1)))?null:(string)reader[((int)BbPatientColumn.AddressPostcode - 1)];
					c.Phone = (reader.IsDBNull(((int)BbPatientColumn.Phone - 1)))?null:(string)reader[((int)BbPatientColumn.Phone - 1)];
					c.Emailaddress = (reader.IsDBNull(((int)BbPatientColumn.Emailaddress - 1)))?null:(string)reader[((int)BbPatientColumn.Emailaddress - 1)];
					c.Countryresidence = (reader.IsDBNull(((int)BbPatientColumn.Countryresidence - 1)))?null:(string)reader[((int)BbPatientColumn.Countryresidence - 1)];
					c.Statusid = (reader.IsDBNull(((int)BbPatientColumn.Statusid - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Statusid - 1)];
					c.LosttoFup = (reader.IsDBNull(((int)BbPatientColumn.LosttoFup - 1)))?null:(System.Boolean?)reader[((int)BbPatientColumn.LosttoFup - 1)];
					c.Registrationcohortid = (reader.IsDBNull(((int)BbPatientColumn.Registrationcohortid - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Registrationcohortid - 1)];
					c.Createdbyid = (int)reader[((int)BbPatientColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPatientColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPatientColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPatientColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPatientColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPatientColumn.Lastupdateddate - 1)];
					c.Tempstudyno = (reader.IsDBNull(((int)BbPatientColumn.Tempstudyno - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Tempstudyno - 1)];
					c.Consentversion = (reader.IsDBNull(((int)BbPatientColumn.Consentversion - 1)))?null:(System.Double?)reader[((int)BbPatientColumn.Consentversion - 1)];
					c.Statusdetailid = (int)reader[((int)BbPatientColumn.Statusdetailid - 1)];
					c.Consentfileaddress = (reader.IsDBNull(((int)BbPatientColumn.Consentfileaddress - 1)))?null:(string)reader[((int)BbPatientColumn.Consentfileaddress - 1)];
					c.Deathdate = (reader.IsDBNull(((int)BbPatientColumn.Deathdate - 1)))?null:(System.DateTime?)reader[((int)BbPatientColumn.Deathdate - 1)];
					c.AltStudyId234Digits = (reader.IsDBNull(((int)BbPatientColumn.AltStudyId234Digits - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.AltStudyId234Digits - 1)];
					c.AltDeathDate = (reader.IsDBNull(((int)BbPatientColumn.AltDeathDate - 1)))?null:(System.DateTime?)reader[((int)BbPatientColumn.AltDeathDate - 1)];
					c.ConsentedByBadbirUserId = (reader.IsDBNull(((int)BbPatientColumn.ConsentedByBadbirUserId - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.ConsentedByBadbirUserId - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPatient entity)
		{
			if (!reader.Read()) return;
			
			entity.Patientid = (int)reader[((int)BbPatientColumn.Patientid - 1)];
			entity.Firststudyno = (reader.IsDBNull(((int)BbPatientColumn.Firststudyno - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Firststudyno - 1)];
			entity.Studyidlastfive = (reader.IsDBNull(((int)BbPatientColumn.Studyidlastfive - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Studyidlastfive - 1)];
			entity.Dateconsented = (reader.IsDBNull(((int)BbPatientColumn.Dateconsented - 1)))?null:(System.DateTime?)reader[((int)BbPatientColumn.Dateconsented - 1)];
			entity.Consentformreceived = (reader.IsDBNull(((int)BbPatientColumn.Consentformreceived - 1)))?null:(System.DateTime?)reader[((int)BbPatientColumn.Consentformreceived - 1)];
			entity.Phrn = (reader.IsDBNull(((int)BbPatientColumn.Phrn - 1)))?null:(string)reader[((int)BbPatientColumn.Phrn - 1)];
			entity.Pnhs = (reader.IsDBNull(((int)BbPatientColumn.Pnhs - 1)))?null:(string)reader[((int)BbPatientColumn.Pnhs - 1)];
			entity.Genderid = (reader.IsDBNull(((int)BbPatientColumn.Genderid - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Genderid - 1)];
			entity.Dateofbirth = (reader.IsDBNull(((int)BbPatientColumn.Dateofbirth - 1)))?null:(System.DateTime?)reader[((int)BbPatientColumn.Dateofbirth - 1)];
			entity.Title = (reader.IsDBNull(((int)BbPatientColumn.Title - 1)))?null:(string)reader[((int)BbPatientColumn.Title - 1)];
			entity.Surname = (reader.IsDBNull(((int)BbPatientColumn.Surname - 1)))?null:(string)reader[((int)BbPatientColumn.Surname - 1)];
			entity.Forenames = (reader.IsDBNull(((int)BbPatientColumn.Forenames - 1)))?null:(string)reader[((int)BbPatientColumn.Forenames - 1)];
			entity.Address1 = (reader.IsDBNull(((int)BbPatientColumn.Address1 - 1)))?null:(string)reader[((int)BbPatientColumn.Address1 - 1)];
			entity.Address2 = (reader.IsDBNull(((int)BbPatientColumn.Address2 - 1)))?null:(string)reader[((int)BbPatientColumn.Address2 - 1)];
			entity.Address3 = (reader.IsDBNull(((int)BbPatientColumn.Address3 - 1)))?null:(string)reader[((int)BbPatientColumn.Address3 - 1)];
			entity.AddressTown = (reader.IsDBNull(((int)BbPatientColumn.AddressTown - 1)))?null:(string)reader[((int)BbPatientColumn.AddressTown - 1)];
			entity.AddressCounty = (reader.IsDBNull(((int)BbPatientColumn.AddressCounty - 1)))?null:(string)reader[((int)BbPatientColumn.AddressCounty - 1)];
			entity.AddressPostcode = (reader.IsDBNull(((int)BbPatientColumn.AddressPostcode - 1)))?null:(string)reader[((int)BbPatientColumn.AddressPostcode - 1)];
			entity.Phone = (reader.IsDBNull(((int)BbPatientColumn.Phone - 1)))?null:(string)reader[((int)BbPatientColumn.Phone - 1)];
			entity.Emailaddress = (reader.IsDBNull(((int)BbPatientColumn.Emailaddress - 1)))?null:(string)reader[((int)BbPatientColumn.Emailaddress - 1)];
			entity.Countryresidence = (reader.IsDBNull(((int)BbPatientColumn.Countryresidence - 1)))?null:(string)reader[((int)BbPatientColumn.Countryresidence - 1)];
			entity.Statusid = (reader.IsDBNull(((int)BbPatientColumn.Statusid - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Statusid - 1)];
			entity.LosttoFup = (reader.IsDBNull(((int)BbPatientColumn.LosttoFup - 1)))?null:(System.Boolean?)reader[((int)BbPatientColumn.LosttoFup - 1)];
			entity.Registrationcohortid = (reader.IsDBNull(((int)BbPatientColumn.Registrationcohortid - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Registrationcohortid - 1)];
			entity.Createdbyid = (int)reader[((int)BbPatientColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPatientColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPatientColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPatientColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPatientColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPatientColumn.Lastupdateddate - 1)];
			entity.Tempstudyno = (reader.IsDBNull(((int)BbPatientColumn.Tempstudyno - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.Tempstudyno - 1)];
			entity.Consentversion = (reader.IsDBNull(((int)BbPatientColumn.Consentversion - 1)))?null:(System.Double?)reader[((int)BbPatientColumn.Consentversion - 1)];
			entity.Statusdetailid = (int)reader[((int)BbPatientColumn.Statusdetailid - 1)];
			entity.Consentfileaddress = (reader.IsDBNull(((int)BbPatientColumn.Consentfileaddress - 1)))?null:(string)reader[((int)BbPatientColumn.Consentfileaddress - 1)];
			entity.Deathdate = (reader.IsDBNull(((int)BbPatientColumn.Deathdate - 1)))?null:(System.DateTime?)reader[((int)BbPatientColumn.Deathdate - 1)];
			entity.AltStudyId234Digits = (reader.IsDBNull(((int)BbPatientColumn.AltStudyId234Digits - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.AltStudyId234Digits - 1)];
			entity.AltDeathDate = (reader.IsDBNull(((int)BbPatientColumn.AltDeathDate - 1)))?null:(System.DateTime?)reader[((int)BbPatientColumn.AltDeathDate - 1)];
			entity.ConsentedByBadbirUserId = (reader.IsDBNull(((int)BbPatientColumn.ConsentedByBadbirUserId - 1)))?null:(System.Int32?)reader[((int)BbPatientColumn.ConsentedByBadbirUserId - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPatient entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Patientid = (int)dataRow["patientid"];
			entity.Firststudyno = Convert.IsDBNull(dataRow["firststudyno"]) ? null : (System.Int32?)dataRow["firststudyno"];
			entity.Studyidlastfive = Convert.IsDBNull(dataRow["studyidlastfive"]) ? null : (System.Int32?)dataRow["studyidlastfive"];
			entity.Dateconsented = Convert.IsDBNull(dataRow["dateconsented"]) ? null : (System.DateTime?)dataRow["dateconsented"];
			entity.Consentformreceived = Convert.IsDBNull(dataRow["consentformreceived"]) ? null : (System.DateTime?)dataRow["consentformreceived"];
			entity.Phrn = Convert.IsDBNull(dataRow["phrn"]) ? null : (string)dataRow["phrn"];
			entity.Pnhs = Convert.IsDBNull(dataRow["pnhs"]) ? null : (string)dataRow["pnhs"];
			entity.Genderid = Convert.IsDBNull(dataRow["genderid"]) ? null : (System.Int32?)dataRow["genderid"];
			entity.Dateofbirth = Convert.IsDBNull(dataRow["dateofbirth"]) ? null : (System.DateTime?)dataRow["dateofbirth"];
			entity.Title = Convert.IsDBNull(dataRow["title"]) ? null : (string)dataRow["title"];
			entity.Surname = Convert.IsDBNull(dataRow["surname"]) ? null : (string)dataRow["surname"];
			entity.Forenames = Convert.IsDBNull(dataRow["forenames"]) ? null : (string)dataRow["forenames"];
			entity.Address1 = Convert.IsDBNull(dataRow["address1"]) ? null : (string)dataRow["address1"];
			entity.Address2 = Convert.IsDBNull(dataRow["address2"]) ? null : (string)dataRow["address2"];
			entity.Address3 = Convert.IsDBNull(dataRow["address3"]) ? null : (string)dataRow["address3"];
			entity.AddressTown = Convert.IsDBNull(dataRow["address_town"]) ? null : (string)dataRow["address_town"];
			entity.AddressCounty = Convert.IsDBNull(dataRow["address_county"]) ? null : (string)dataRow["address_county"];
			entity.AddressPostcode = Convert.IsDBNull(dataRow["address_postcode"]) ? null : (string)dataRow["address_postcode"];
			entity.Phone = Convert.IsDBNull(dataRow["phone"]) ? null : (string)dataRow["phone"];
			entity.Emailaddress = Convert.IsDBNull(dataRow["emailaddress"]) ? null : (string)dataRow["emailaddress"];
			entity.Countryresidence = Convert.IsDBNull(dataRow["countryresidence"]) ? null : (string)dataRow["countryresidence"];
			entity.Statusid = Convert.IsDBNull(dataRow["statusid"]) ? null : (System.Int32?)dataRow["statusid"];
			entity.LosttoFup = Convert.IsDBNull(dataRow["losttoFUP"]) ? null : (System.Boolean?)dataRow["losttoFUP"];
			entity.Registrationcohortid = Convert.IsDBNull(dataRow["registrationcohortid"]) ? null : (System.Int32?)dataRow["registrationcohortid"];
			...
			entity.Tempstudyno = Convert.IsDBNull(dataRow["tempstudyno"]) ? null : (System.Int32?)dataRow["tempstudyno"];
			entity.Consentversion = Convert.IsDBNull(dataRow["consentversion"]) ? null : (System.Double?)dataRow["consentversion"];
			entity.Statusdetailid = (int)dataRow["statusdetailid"];
			entity.Consentfileaddress = Convert.IsDBNull(dataRow["consentfileaddress"]) ? null : (string)dataRow["consentfileaddress"];
			entity.Deathdate = Convert.IsDBNull(dataRow["deathdate"]) ? null : (System.DateTime?)dataRow["deathdate"];
			entity.AltStudyId234Digits = Convert.IsDBNull(dataRow["altStudyID234Digits"]) ? null : (System.Int32?)dataRow["altStudyID234Digits"];
			entity.AltDeathDate = Convert.IsDBNull(dataRow["altDeathDate"]) ? null : (System.DateTime?)dataRow["altDeathDate"];
			entity.ConsentedByBadbirUserId = Convert.IsDBNull(dataRow["consentedByBadbirUserID"]) ? null : (System.Int32?)dataRow["consentedByBadbirUserID"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatient"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatient Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatient entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region StatusdetailidSource	
			if (CanDeepLoad(entity, "BbPatientStatusDetaillkp|StatusdetailidSource", deepLoadType, innerList) 
				&& entity.StatusdetailidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.Statusdetailid;
				BbPatientStatusDetaillkp tmpEntity = EntityManager.LocateEntity<BbPatientStatusDetaillkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbPatientStatusDetaillkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.StatusdetailidSource = tmpEntity;
				else
					entity.StatusdetailidSource = DataRepository.BbPatientStatusDetaillkpProvider.GetByPstatusdetailid(transactionManager, entity.Statusdetailid);		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'StatusdetailidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.StatusdetailidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbPatientStatusDetaillkpProvider.DeepLoad(transactionManager, entity.StatusdetailidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion StatusdetailidSource

			#region StatusidSource	
			if (CanDeepLoad(entity, "BbPatientStatuslkp|StatusidSource", deepLoadType, innerList) 
				&& entity.StatusidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.Statusid ?? (int)6);
				BbPatientStatuslkp tmpEntity = EntityManager.LocateEntity<BbPatientStatuslkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbPatientStatuslkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.StatusidSource = tmpEntity;
				else
					entity.StatusidSource = DataRepository.BbPatientStatuslkpProvider.GetByPstatusid(transactionManager, (entity.Statusid ?? (int)6));		
				...
				{
					innerList.SkipChildren = true;
					DataRepository.BbPatientStatuslkpProvider.DeepLoad(transactionManager, entity.StatusidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
			...
			#region GenderidSource	
			if (CanDeepLoad(entity, "BbGenderlkp|GenderidSource", deepLoadType, innerList) 
				&& entity.GenderidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.Genderid ?? (int)0);
				BbGenderlkp tmpEntity = EntityManager.LocateEntity<BbGenderlkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbGenderlkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.GenderidSource = tmpEntity;
				else
					entity.GenderidSource = DataRepository.BbGenderlkpProvider.GetByGenderid(transactionManager, (entity.Genderid ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'GenderidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.GenderidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbGenderlkpProvider.DeepLoad(transactionManager, entity.GenderidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion GenderidSource
			
			//used to hold DeepLoad method delegates and fire after all the local children have been loaded.
			Dictionary<string, KeyValuePair<Delegate, object>> deepHandles = new Dictionary<string, KeyValuePair<Delegate, object>>();
			// Deep load child collections  - Call GetByPatientid methods when available
			...
			if (CanDeepLoad(entity, "List<BbPappPatientCohortTracking>|BbPappPatientCohortTrackingCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPappPatientCohortTrackingCollection = DataRepository.BbPappPatientCohortTrackingProvider.GetByPatientId(transactionManager, entity.Patientid);
			...
			if (CanDeepLoad(entity, "List<BbPatientCohortHistory>|BbPatientCohortHistoryCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPatientCohortHistoryCollection = DataRepository.BbPatientCohortHistoryProvider.GetByPatientid(transactionManager, entity.Patientid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPatient object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPatient instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatient Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatient entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region StatusdetailidSource
			if (CanDeepSave(entity, "BbPatientStatusDetaillkp|StatusdetailidSource", deepSaveType, innerList) 
				&& entity.StatusdetailidSource != null)
			{
				DataRepository.BbPatientStatusDetaillkpProvider.Save(transactionManager, entity.StatusdetailidSource);
				entity.Statusdetailid = entity.StatusdetailidSource.Pstatusdetailid;
			}
			#endregion 
			
			#region StatusidSource
			if (CanDeepSave(entity, "BbPatientStatuslkp|StatusidSource", deepSaveType, innerList) 
				&& entity.StatusidSource != null)
			{
				DataRepository.BbPatientStatuslkpProvider.Save(transactionManager, entity.StatusidSource);
				entity.Statusid = entity.StatusidSource.Pstatusid;
			}
			#endregion 
			
			#region GenderidSource
			if (CanDeepSave(entity, "BbGenderlkp|GenderidSource", deepSaveType, innerList) 
				&& entity.GenderidSource != null)
			{
				DataRepository.BbGenderlkpProvider.Save(transactionManager, entity.GenderidSource);
				entity.Genderid = entity.GenderidSource.Genderid;
			}
			#endregion 
			...
			#region List<BbPappPatientCohortTracking>
				...
				{	
					...
					foreach(BbPappPatientCohortTracking child in entity.BbPappPatientCohortTrackingCollection)
					{
						...
						{
							child.PatientId = child.PatientIdSource.Patientid;
						}
						else
						{
							child.PatientId = entity.Patientid;
						}
	...
	#region BbPatientChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPatient</c>
	///</summary>
	public enum BbPatientChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbPatientStatusDetaillkp</c> at StatusdetailidSource
		///</summary>
		[ChildEntityType(typeof(BbPatientStatusDetaillkp))]
		BbPatientStatusDetaillkp,
		
		///<summary>
		/// Composite Property for <c>BbPatientStatuslkp</c> at StatusidSource
		///</summary>
		[ChildEntityType(typeof(BbPatientStatuslkp))]
		BbPatientStatuslkp,
		
		///<summary>
		/// Composite Property for <c>BbGenderlkp</c> at GenderidSource
		///</summary>
		[ChildEntityType(typeof(BbGenderlkp))]
		BbGenderlkp,
		///<summary>
		/// Collection of <c>BbPatient</c> as OneToMany for BbPappPatientCohortTrackingCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPappPatientCohortTracking>))]
		BbPappPatientCohortTrackingCollection,
		///<summary>
		/// Collection of <c>BbPatient</c> as OneToMany for BbPatientCohortHistoryCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientCohortHistory>))]
		BbPatientCohortHistoryCollection,
	}
	
	#endregion BbPatientChildEntityTypes
	
	#region BbPatientFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPatientColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatient"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientFilterBuilder : SqlFilterBuilder<BbPatientColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientFilterBuilder class.
		/// </summary>
		public BbPatientFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPatientFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientFilterBuilder
	
	#region BbPatientParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPatientColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatient"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientParameterBuilder : ParameterizedSqlFilterBuilder<BbPatientColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientParameterBuilder class.
		/// </summary>
		public BbPatientParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPatientParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientParameterBuilder
	
	#region BbPatientSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPatientColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatient"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPatientSortBuilder : SqlSortBuilder<BbPatientColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientSqlSortBuilder class.
		/// </summary>
		public BbPatientSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPatientSortBuilder
