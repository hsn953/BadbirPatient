...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbQueryForCentreProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbQueryForCentreProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbQueryForCentre, MHS.Badbir.NetTiers.Entities.BbQueryForCentreKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryForCentreKey key)
		{
		...
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_qid">Unique ID for each row of this table. Primary Key.</param>
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbQueryForCentre_bbCentre key.
		///		FK_bbQueryForCentre_bbCentre Description: Links to the centre table to determine which centre this query belongs to. This is redundent information and kept for faster processing
		/// </summary>
		/// <param name="_centreid">Centre ID to separate queries by centre</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByCentreid(int _centreid)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		/// <remarks></remarks>
		public TList<BbQueryForCentre> GetByCentreid(TransactionManager transactionManager, int _centreid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByCentreid(TransactionManager transactionManager, int _centreid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbQueryForCentre_bbCentre key.
		///		fkBbQueryForCentreBbCentre Description: Links to the centre table to determine which centre this query belongs to. This is redundent information and kept for faster processing
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_centreid">Centre ID to separate queries by centre</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByCentreid(int _centreid, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByCentreid(int _centreid, int start, int pageLength,out int count)
		{
			return GetByCentreid(null, _centreid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public abstract TList<BbQueryForCentre> GetByCentreid(TransactionManager transactionManager, int _centreid, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbQueryForCentre_bbQueryStatuslkp key.
		///		FK_bbQueryForCentre_bbQueryStatuslkp Description: Links to the query status table to determine the current status of the query
		/// </summary>
		/// <param name="_queryStatusId">Query Status ID (Foreign Key) Links to the table that contain all query statuses</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByQueryStatusId(int _queryStatusId)
		{
			int count = -1;
			return GetByQueryStatusId(_queryStatusId, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		/// <remarks></remarks>
		public TList<BbQueryForCentre> GetByQueryStatusId(TransactionManager transactionManager, int _queryStatusId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByQueryStatusId(TransactionManager transactionManager, int _queryStatusId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbQueryForCentre_bbQueryStatuslkp key.
		///		fkBbQueryForCentreBbQueryStatuslkp Description: Links to the query status table to determine the current status of the query
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_queryStatusId">Query Status ID (Foreign Key) Links to the table that contain all query statuses</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByQueryStatusId(int _queryStatusId, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByQueryStatusId(int _queryStatusId, int start, int pageLength,out int count)
		{
			return GetByQueryStatusId(null, _queryStatusId, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public abstract TList<BbQueryForCentre> GetByQueryStatusId(TransactionManager transactionManager, int _queryStatusId, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbQueryForCentre_bbQueryTypelkp key.
		///		FK_bbQueryForCentre_bbQueryTypelkp Description: Links to the query type table to determine the type or category of the query
		/// </summary>
		/// <param name="_queryTypeId">Query Type ID (Foreign Key) Links to the table that contains all query types</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByQueryTypeId(int _queryTypeId)
		{
			int count = -1;
			return GetByQueryTypeId(_queryTypeId, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		/// <remarks></remarks>
		public TList<BbQueryForCentre> GetByQueryTypeId(TransactionManager transactionManager, int _queryTypeId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByQueryTypeId(TransactionManager transactionManager, int _queryTypeId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbQueryForCentre_bbQueryTypelkp key.
		///		fkBbQueryForCentreBbQueryTypelkp Description: Links to the query type table to determine the type or category of the query
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_queryTypeId">Query Type ID (Foreign Key) Links to the table that contains all query types</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByQueryTypeId(int _queryTypeId, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public TList<BbQueryForCentre> GetByQueryTypeId(int _queryTypeId, int start, int pageLength,out int count)
		{
			return GetByQueryTypeId(null, _queryTypeId, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentre objects.</returns>
		public abstract TList<BbQueryForCentre> GetByQueryTypeId(TransactionManager transactionManager, int _queryTypeId, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbQueryForCentre Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryForCentreKey key, int start, int pageLength)
		{
			return GetByQid(transactionManager, key.Qid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbQueryForCentre index.
		/// </summary>
		/// <param name="_qid">Unique ID for each row of this table</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryForCentre GetByQid(int _qid)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbQueryForCentre index.
		/// </summary>
		/// <param name="_qid">Unique ID for each row of this table</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryForCentre GetByQid(int _qid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryForCentre GetByQid(TransactionManager transactionManager, int _qid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryForCentre GetByQid(TransactionManager transactionManager, int _qid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryForCentre GetByQid(int _qid, int start, int pageLength, out int count)
		{
			return GetByQid(null, _qid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbQueryForCentre GetByQid(TransactionManager transactionManager, int _qid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbQueryForCentre&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbQueryForCentre&gt;"/></returns>
		public static TList<BbQueryForCentre> Fill(IDataReader reader, TList<BbQueryForCentre> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbQueryForCentre c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbQueryForCentre")
					.Append("|").Append((int)reader[((int)BbQueryForCentreColumn.Qid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbQueryForCentre>(
					key.ToString(), // EntityTrackingKey
					"BbQueryForCentre",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbQueryForCentre();
				}
					...
					))
				{
					...
					c.Qid = (int)reader[((int)BbQueryForCentreColumn.Qid - 1)];
					c.Centreid = (int)reader[((int)BbQueryForCentreColumn.Centreid - 1)];
					c.Messagecount = (int)reader[((int)BbQueryForCentreColumn.Messagecount - 1)];
					c.Adminunread = (bool)reader[((int)BbQueryForCentreColumn.Adminunread - 1)];
					c.Clinicianunread = (bool)reader[((int)BbQueryForCentreColumn.Clinicianunread - 1)];
					c.QueryTypeId = (int)reader[((int)BbQueryForCentreColumn.QueryTypeId - 1)];
					c.QueryStatusId = (int)reader[((int)BbQueryForCentreColumn.QueryStatusId - 1)];
					c.Include = (bool)reader[((int)BbQueryForCentreColumn.Include - 1)];
					c.Createdbyid = (int)reader[((int)BbQueryForCentreColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbQueryForCentreColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbQueryForCentreColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbQueryForCentreColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbQueryForCentreColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbQueryForCentreColumn.Lastupdateddate - 1)];
					c.Subject = (reader.IsDBNull(((int)BbQueryForCentreColumn.Subject - 1)))?null:(string)reader[((int)BbQueryForCentreColumn.Subject - 1)];
					c.SecondRequest = (reader.IsDBNull(((int)BbQueryForCentreColumn.SecondRequest - 1)))?null:(System.Boolean?)reader[((int)BbQueryForCentreColumn.SecondRequest - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbQueryForCentre entity)
		{
			if (!reader.Read()) return;
			
			entity.Qid = (int)reader[((int)BbQueryForCentreColumn.Qid - 1)];
			entity.Centreid = (int)reader[((int)BbQueryForCentreColumn.Centreid - 1)];
			entity.Messagecount = (int)reader[((int)BbQueryForCentreColumn.Messagecount - 1)];
			entity.Adminunread = (bool)reader[((int)BbQueryForCentreColumn.Adminunread - 1)];
			entity.Clinicianunread = (bool)reader[((int)BbQueryForCentreColumn.Clinicianunread - 1)];
			entity.QueryTypeId = (int)reader[((int)BbQueryForCentreColumn.QueryTypeId - 1)];
			entity.QueryStatusId = (int)reader[((int)BbQueryForCentreColumn.QueryStatusId - 1)];
			entity.Include = (bool)reader[((int)BbQueryForCentreColumn.Include - 1)];
			entity.Createdbyid = (int)reader[((int)BbQueryForCentreColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbQueryForCentreColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbQueryForCentreColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbQueryForCentreColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbQueryForCentreColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbQueryForCentreColumn.Lastupdateddate - 1)];
			entity.Subject = (reader.IsDBNull(((int)BbQueryForCentreColumn.Subject - 1)))?null:(string)reader[((int)BbQueryForCentreColumn.Subject - 1)];
			entity.SecondRequest = (reader.IsDBNull(((int)BbQueryForCentreColumn.SecondRequest - 1)))?null:(System.Boolean?)reader[((int)BbQueryForCentreColumn.SecondRequest - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbQueryForCentre entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentre"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQueryForCentre Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryForCentre entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			if (CanDeepLoad(entity, "List<BbQueryForCentreMessage>|BbQueryForCentreMessageCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbQueryForCentreMessageCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbQueryForCentreMessageCollection = DataRepository.BbQueryForCentreMessageProvider.GetByQid(transactionManager, entity.Qid);

				if (deep && entity.BbQueryForCentreMessageCollection.Count > 0)
				{
					deepHandles.Add("BbQueryForCentreMessageCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbQueryForCentreMessage>) DataRepository.BbQueryForCentreMessageProvider.DeepLoad,
						new object[] { transactionManager, entity.BbQueryForCentreMessageCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbQueryForCentre object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbQueryForCentre instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQueryForCentre Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryForCentre entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbQueryForCentreMessage>
				if (CanDeepSave(entity.BbQueryForCentreMessageCollection, "List<BbQueryForCentreMessage>|BbQueryForCentreMessageCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbQueryForCentreMessage child in entity.BbQueryForCentreMessageCollection)
					{
					...
					if (entity.BbQueryForCentreMessageCollection.Count > 0 || entity.BbQueryForCentreMessageCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbQueryForCentreMessageProvider.Save(transactionManager, entity.BbQueryForCentreMessageCollection);
						
						deepHandles.Add("BbQueryForCentreMessageCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbQueryForCentreMessage >) DataRepository.BbQueryForCentreMessageProvider.DeepSave,
							new object[] { transactionManager, entity.BbQueryForCentreMessageCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	#region BbQueryForCentreChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbQueryForCentre</c>
	///</summary>
	public enum BbQueryForCentreChildEntityTypes
	{
		...
		BbQueryTypelkp,
		///<summary>
		/// Collection of <c>BbQueryForCentre</c> as OneToMany for BbQueryForCentreMessageCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbQueryForCentreMessage>))]
		BbQueryForCentreMessageCollection,
	}
	
	#endregion BbQueryForCentreChildEntityTypes
	
	#region BbQueryForCentreFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbQueryForCentreColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryForCentre"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryForCentreFilterBuilder : SqlFilterBuilder<BbQueryForCentreColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryForCentreFilterBuilder class.
		/// </summary>
		public BbQueryForCentreFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryForCentreFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryForCentreFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbQueryForCentreFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryForCentreFilterBuilder
	
	#region BbQueryForCentreParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbQueryForCentreColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryForCentre"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryForCentreParameterBuilder : ParameterizedSqlFilterBuilder<BbQueryForCentreColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryForCentreParameterBuilder class.
		/// </summary>
		public BbQueryForCentreParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryForCentreParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryForCentreParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbQueryForCentreParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryForCentreParameterBuilder
	
	#region BbQueryForCentreSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbQueryForCentreColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryForCentre"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbQueryForCentreSortBuilder : SqlSortBuilder<BbQueryForCentreColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryForCentreSqlSortBuilder class.
		/// </summary>
		public BbQueryForCentreSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbQueryForCentreSortBuilder
