...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbCentrestatusProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbCentrestatusProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbCentrestatus, MHS.Badbir.NetTiers.Entities.BbCentrestatusKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentrestatusKey key)
		{
			return Delete(transactionManager, key.Centrestatusid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_centrestatusid">Status Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Int32 _centrestatusid)
		{
			return Delete(null, _centrestatusid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Int32 _centrestatusid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbCentrestatus Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentrestatusKey key, int start, int pageLength)
		{
			return GetByCentrestatusid(transactionManager, key.Centrestatusid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbCentrestatus index.
		/// </summary>
		/// <param name="_centrestatusid">Status Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentrestatus GetByCentrestatusid(System.Int32 _centrestatusid)
		{
			int count = -1;
			return GetByCentrestatusid(null,_centrestatusid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbCentrestatus index.
		/// </summary>
		/// <param name="_centrestatusid">Status Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentrestatus GetByCentrestatusid(System.Int32 _centrestatusid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentrestatus GetByCentrestatusid(TransactionManager transactionManager, System.Int32 _centrestatusid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentrestatus GetByCentrestatusid(TransactionManager transactionManager, System.Int32 _centrestatusid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentrestatus GetByCentrestatusid(System.Int32 _centrestatusid, int start, int pageLength, out int count)
		{
			return GetByCentrestatusid(null, _centrestatusid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbCentrestatus GetByCentrestatusid(TransactionManager transactionManager, System.Int32 _centrestatusid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbCentrestatus&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbCentrestatus&gt;"/></returns>
		public static TList<BbCentrestatus> Fill(IDataReader reader, TList<BbCentrestatus> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbCentrestatus c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbCentrestatus")
					.Append("|").Append((System.Int32)reader[((int)BbCentrestatusColumn.Centrestatusid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbCentrestatus>(
					key.ToString(), // EntityTrackingKey
					"BbCentrestatus",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbCentrestatus();
				}
					...
					))
				{
					...
					c.Centrestatusid = (System.Int32)reader[((int)BbCentrestatusColumn.Centrestatusid - 1)];
					c.Centrestatus = (reader.IsDBNull(((int)BbCentrestatusColumn.Centrestatus - 1)))?null:(System.String)reader[((int)BbCentrestatusColumn.Centrestatus - 1)];
					c.Createdbyid = (System.Int32)reader[((int)BbCentrestatusColumn.Createdbyid - 1)];
					c.Createdbyname = (System.String)reader[((int)BbCentrestatusColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbCentrestatusColumn.Createddate - 1)];
					c.Lastupdatedbyid = (System.Int32)reader[((int)BbCentrestatusColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (System.String)reader[((int)BbCentrestatusColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbCentrestatusColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbCentrestatus entity)
		{
			if (!reader.Read()) return;
			
			entity.Centrestatusid = (System.Int32)reader[((int)BbCentrestatusColumn.Centrestatusid - 1)];
			entity.Centrestatus = (reader.IsDBNull(((int)BbCentrestatusColumn.Centrestatus - 1)))?null:(System.String)reader[((int)BbCentrestatusColumn.Centrestatus - 1)];
			entity.Createdbyid = (System.Int32)reader[((int)BbCentrestatusColumn.Createdbyid - 1)];
			entity.Createdbyname = (System.String)reader[((int)BbCentrestatusColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbCentrestatusColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (System.Int32)reader[((int)BbCentrestatusColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (System.String)reader[((int)BbCentrestatusColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbCentrestatusColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbCentrestatus entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Centrestatusid = (System.Int32)dataRow["centrestatusid"];
			entity.Centrestatus = Convert.IsDBNull(dataRow["centrestatus"]) ? null : (System.String)dataRow["centrestatus"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCentrestatus"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbCentrestatus Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentrestatus entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByCentrestatusid methods when available
			...
			if (CanDeepLoad(entity, "List<BbCentre>|BbCentreCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbCentreCollection = DataRepository.BbCentreProvider.GetByCentrestatusid(transactionManager, entity.Centrestatusid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbCentrestatus object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbCentrestatus instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbCentrestatus Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentrestatus entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbCentre>
				...
				{	
					...
					{
						if(child.CentrestatusidSource != null)
						{
							child.Centrestatusid = child.CentrestatusidSource.Centrestatusid;
						}
						else
						{
							child.Centrestatusid = entity.Centrestatusid;
						}
	...
	#region BbCentrestatusChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbCentrestatus</c>
	///</summary>
	public enum BbCentrestatusChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbCentrestatus</c> as OneToMany for BbCentreCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbCentre>))]
		BbCentreCollection,
	}
	
	#endregion BbCentrestatusChildEntityTypes
	
	#region BbCentrestatusFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbCentrestatusColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCentrestatus"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbCentrestatusFilterBuilder : SqlFilterBuilder<BbCentrestatusColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCentrestatusFilterBuilder class.
		/// </summary>
		public BbCentrestatusFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbCentrestatusFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbCentrestatusFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbCentrestatusFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbCentrestatusFilterBuilder
	
	#region BbCentrestatusParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbCentrestatusColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCentrestatus"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbCentrestatusParameterBuilder : ParameterizedSqlFilterBuilder<BbCentrestatusColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCentrestatusParameterBuilder class.
		/// </summary>
		public BbCentrestatusParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbCentrestatusParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbCentrestatusParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbCentrestatusParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbCentrestatusParameterBuilder
	
	#region BbCentrestatusSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbCentrestatusColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCentrestatus"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbCentrestatusSortBuilder : SqlSortBuilder<BbCentrestatusColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCentrestatusSqlSortBuilder class.
		/// </summary>
		public BbCentrestatusSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbCentrestatusSortBuilder
