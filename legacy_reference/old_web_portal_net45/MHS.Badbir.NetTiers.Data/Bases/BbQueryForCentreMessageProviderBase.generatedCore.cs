...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbQueryForCentreMessageProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbQueryForCentreMessageProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage, MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessageKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessageKey key)
		{
			return Delete(transactionManager, key.QmId);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_qmId">Unique ID for each row of this table. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _qmId)
		{
			return Delete(null, _qmId);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _qmId);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbQueryForCentreMessage_bbQueryForCentre key.
		///		FK_bbQueryForCentreMessage_bbQueryForCentre Description: Links to the query to which this response belongs to
		/// </summary>
		/// <param name="_qid">Query ID (Foreign Key) to the query this response belongs to</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage objects.</returns>
		public TList<BbQueryForCentreMessage> GetByQid(int _qid)
		{
			int count = -1;
			return GetByQid(_qid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage objects.</returns>
		/// <remarks></remarks>
		public TList<BbQueryForCentreMessage> GetByQid(TransactionManager transactionManager, int _qid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage objects.</returns>
		public TList<BbQueryForCentreMessage> GetByQid(TransactionManager transactionManager, int _qid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbQueryForCentreMessage_bbQueryForCentre key.
		///		fkBbQueryForCentreMessageBbQueryForCentre Description: Links to the query to which this response belongs to
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_qid">Query ID (Foreign Key) to the query this response belongs to</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage objects.</returns>
		public TList<BbQueryForCentreMessage> GetByQid(int _qid, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage objects.</returns>
		public TList<BbQueryForCentreMessage> GetByQid(int _qid, int start, int pageLength,out int count)
		{
			return GetByQid(null, _qid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage objects.</returns>
		public abstract TList<BbQueryForCentreMessage> GetByQid(TransactionManager transactionManager, int _qid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessageKey key, int start, int pageLength)
		{
			return GetByQmId(transactionManager, key.QmId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbQueryForCentreMessage index.
		/// </summary>
		/// <param name="_qmId">Unique ID for each row of this table</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage GetByQmId(int _qmId)
		{
			int count = -1;
			return GetByQmId(null,_qmId, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbQueryForCentreMessage index.
		/// </summary>
		/// <param name="_qmId">Unique ID for each row of this table</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage GetByQmId(int _qmId, int start, int pageLength)
		{
			int count = -1;
			return GetByQmId(null, _qmId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage GetByQmId(TransactionManager transactionManager, int _qmId)
		{
			int count = -1;
			return GetByQmId(transactionManager, _qmId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage GetByQmId(TransactionManager transactionManager, int _qmId, int start, int pageLength)
		{
			int count = -1;
			return GetByQmId(transactionManager, _qmId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage GetByQmId(int _qmId, int start, int pageLength, out int count)
		{
			return GetByQmId(null, _qmId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage GetByQmId(TransactionManager transactionManager, int _qmId, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbQueryForCentreMessage&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbQueryForCentreMessage&gt;"/></returns>
		public static TList<BbQueryForCentreMessage> Fill(IDataReader reader, TList<BbQueryForCentreMessage> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbQueryForCentreMessage")
					.Append("|").Append((int)reader[((int)BbQueryForCentreMessageColumn.QmId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbQueryForCentreMessage>(
					key.ToString(), // EntityTrackingKey
					"BbQueryForCentreMessage",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage();
				}
					...
					))
				{
					...
					c.QmId = (int)reader[((int)BbQueryForCentreMessageColumn.QmId - 1)];
					c.Qid = (int)reader[((int)BbQueryForCentreMessageColumn.Qid - 1)];
					c.Message = (reader.IsDBNull(((int)BbQueryForCentreMessageColumn.Message - 1)))?null:(string)reader[((int)BbQueryForCentreMessageColumn.Message - 1)];
					c.Createdbyid = (int)reader[((int)BbQueryForCentreMessageColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbQueryForCentreMessageColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbQueryForCentreMessageColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbQueryForCentreMessageColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbQueryForCentreMessageColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbQueryForCentreMessageColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage entity)
		{
			if (!reader.Read()) return;
			
			entity.QmId = (int)reader[((int)BbQueryForCentreMessageColumn.QmId - 1)];
			entity.Qid = (int)reader[((int)BbQueryForCentreMessageColumn.Qid - 1)];
			entity.Message = (reader.IsDBNull(((int)BbQueryForCentreMessageColumn.Message - 1)))?null:(string)reader[((int)BbQueryForCentreMessageColumn.Message - 1)];
			entity.Createdbyid = (int)reader[((int)BbQueryForCentreMessageColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbQueryForCentreMessageColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbQueryForCentreMessageColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbQueryForCentreMessageColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbQueryForCentreMessageColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbQueryForCentreMessageColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.QmId = (int)dataRow["QMId"];
			entity.Qid = (int)dataRow["QId"];
			entity.Message = Convert.IsDBNull(dataRow["message"]) ? null : (string)dataRow["message"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region QidSource	
			if (CanDeepLoad(entity, "BbQueryForCentre|QidSource", deepLoadType, innerList) 
				&& entity.QidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.Qid;
				BbQueryForCentre tmpEntity = EntityManager.LocateEntity<BbQueryForCentre>(EntityLocator.ConstructKeyFromPkItems(typeof(BbQueryForCentre), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.QidSource = tmpEntity;
				else
					entity.QidSource = DataRepository.BbQueryForCentreProvider.GetByQid(transactionManager, entity.Qid);		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'QidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.QidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbQueryForCentreProvider.DeepLoad(transactionManager, entity.QidSource, deep, deepLoadType, childTypes, innerList);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region QidSource
			if (CanDeepSave(entity, "BbQueryForCentre|QidSource", deepSaveType, innerList) 
				&& entity.QidSource != null)
			{
				DataRepository.BbQueryForCentreProvider.Save(transactionManager, entity.QidSource);
				entity.Qid = entity.QidSource.Qid;
			}
			#endregion 
	...
	#region BbQueryForCentreMessageChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbQueryForCentreMessage</c>
	///</summary>
	public enum BbQueryForCentreMessageChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbQueryForCentre</c> at QidSource
		///</summary>
		[ChildEntityType(typeof(BbQueryForCentre))]
		BbQueryForCentre,
	}
	
	#endregion BbQueryForCentreMessageChildEntityTypes
	
	#region BbQueryForCentreMessageFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbQueryForCentreMessageColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryForCentreMessage"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryForCentreMessageFilterBuilder : SqlFilterBuilder<BbQueryForCentreMessageColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryForCentreMessageFilterBuilder class.
		/// </summary>
		public BbQueryForCentreMessageFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryForCentreMessageFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryForCentreMessageFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbQueryForCentreMessageFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryForCentreMessageFilterBuilder
	
	#region BbQueryForCentreMessageParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbQueryForCentreMessageColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryForCentreMessage"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryForCentreMessageParameterBuilder : ParameterizedSqlFilterBuilder<BbQueryForCentreMessageColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryForCentreMessageParameterBuilder class.
		/// </summary>
		public BbQueryForCentreMessageParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryForCentreMessageParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryForCentreMessageParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbQueryForCentreMessageParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryForCentreMessageParameterBuilder
	
	#region BbQueryForCentreMessageSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbQueryForCentreMessageColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryForCentreMessage"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbQueryForCentreMessageSortBuilder : SqlSortBuilder<BbQueryForCentreMessageColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryForCentreMessageSqlSortBuilder class.
		/// </summary>
		public BbQueryForCentreMessageSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbQueryForCentreMessageSortBuilder
