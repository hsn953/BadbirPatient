...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbEthnicitylkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbEthnicitylkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbEthnicitylkp, MHS.Badbir.NetTiers.Entities.BbEthnicitylkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbEthnicitylkpKey key)
		{
			return Delete(transactionManager, key.Ethnicityid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_ethnicityid">Ethnicity Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _ethnicityid)
		{
			return Delete(null, _ethnicityid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _ethnicityid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbEthnicitylkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbEthnicitylkpKey key, int start, int pageLength)
		{
			return GetByEthnicityid(transactionManager, key.Ethnicityid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_tklp_ethnicity index.
		/// </summary>
		/// <param name="_ethnicityid">Ethnicity Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbEthnicitylkp GetByEthnicityid(int _ethnicityid)
		{
			int count = -1;
			return GetByEthnicityid(null,_ethnicityid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_tklp_ethnicity index.
		/// </summary>
		/// <param name="_ethnicityid">Ethnicity Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbEthnicitylkp GetByEthnicityid(int _ethnicityid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbEthnicitylkp GetByEthnicityid(TransactionManager transactionManager, int _ethnicityid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbEthnicitylkp GetByEthnicityid(TransactionManager transactionManager, int _ethnicityid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbEthnicitylkp GetByEthnicityid(int _ethnicityid, int start, int pageLength, out int count)
		{
			return GetByEthnicityid(null, _ethnicityid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbEthnicitylkp GetByEthnicityid(TransactionManager transactionManager, int _ethnicityid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbEthnicitylkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbEthnicitylkp&gt;"/></returns>
		public static TList<BbEthnicitylkp> Fill(IDataReader reader, TList<BbEthnicitylkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbEthnicitylkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbEthnicitylkp")
					.Append("|").Append((int)reader[((int)BbEthnicitylkpColumn.Ethnicityid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbEthnicitylkp>(
					key.ToString(), // EntityTrackingKey
					"BbEthnicitylkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbEthnicitylkp();
				}
					...
					))
				{
					...
					c.Ethnicityid = (int)reader[((int)BbEthnicitylkpColumn.Ethnicityid - 1)];
					c.Ethnicity = (reader.IsDBNull(((int)BbEthnicitylkpColumn.Ethnicity - 1)))?null:(string)reader[((int)BbEthnicitylkpColumn.Ethnicity - 1)];
					c.Createdbyid = (int)reader[((int)BbEthnicitylkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbEthnicitylkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbEthnicitylkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbEthnicitylkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbEthnicitylkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbEthnicitylkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbEthnicitylkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Ethnicityid = (int)reader[((int)BbEthnicitylkpColumn.Ethnicityid - 1)];
			entity.Ethnicity = (reader.IsDBNull(((int)BbEthnicitylkpColumn.Ethnicity - 1)))?null:(string)reader[((int)BbEthnicitylkpColumn.Ethnicity - 1)];
			entity.Createdbyid = (int)reader[((int)BbEthnicitylkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbEthnicitylkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbEthnicitylkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbEthnicitylkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbEthnicitylkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbEthnicitylkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbEthnicitylkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Ethnicityid = (int)dataRow["ethnicityid"];
			entity.Ethnicity = Convert.IsDBNull(dataRow["ethnicity"]) ? null : (string)dataRow["ethnicity"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbEthnicitylkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbEthnicitylkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbEthnicitylkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByEthnicityid methods when available
			...
			if (CanDeepLoad(entity, "List<BbPatientLifestyle>|BbPatientLifestyleCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPatientLifestyleCollection = DataRepository.BbPatientLifestyleProvider.GetByEthnicityid(transactionManager, entity.Ethnicityid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbEthnicitylkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbEthnicitylkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbEthnicitylkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbEthnicitylkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbPatientLifestyle>
				...
				{	
					...
					{
						if(child.EthnicityidSource != null)
						{
							child.Ethnicityid = child.EthnicityidSource.Ethnicityid;
						}
						else
						{
							child.Ethnicityid = entity.Ethnicityid;
						}
	...
	#region BbEthnicitylkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbEthnicitylkp</c>
	///</summary>
	public enum BbEthnicitylkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbEthnicitylkp</c> as OneToMany for BbPatientLifestyleCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientLifestyle>))]
		BbPatientLifestyleCollection,
	}
	
	#endregion BbEthnicitylkpChildEntityTypes
	
	#region BbEthnicitylkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbEthnicitylkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbEthnicitylkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbEthnicitylkpFilterBuilder : SqlFilterBuilder<BbEthnicitylkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbEthnicitylkpFilterBuilder class.
		/// </summary>
		public BbEthnicitylkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbEthnicitylkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbEthnicitylkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbEthnicitylkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbEthnicitylkpFilterBuilder
	
	#region BbEthnicitylkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbEthnicitylkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbEthnicitylkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbEthnicitylkpParameterBuilder : ParameterizedSqlFilterBuilder<BbEthnicitylkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbEthnicitylkpParameterBuilder class.
		/// </summary>
		public BbEthnicitylkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbEthnicitylkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbEthnicitylkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbEthnicitylkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbEthnicitylkpParameterBuilder
	
	#region BbEthnicitylkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbEthnicitylkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbEthnicitylkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbEthnicitylkpSortBuilder : SqlSortBuilder<BbEthnicitylkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbEthnicitylkpSqlSortBuilder class.
		/// </summary>
		public BbEthnicitylkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbEthnicitylkpSortBuilder
