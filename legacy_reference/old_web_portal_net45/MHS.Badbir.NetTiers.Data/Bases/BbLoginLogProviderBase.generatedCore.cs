...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbLoginLogProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbLoginLogProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbLoginLog, MHS.Badbir.NetTiers.Entities.BbLoginLogKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbLoginLogKey key)
		{
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _rowId);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbLoginLog Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbLoginLogKey key, int start, int pageLength)
		{
			return GetByRowId(transactionManager, key.RowId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key NonClusteredIndex-20160727-143601 index.
		/// </summary>
		/// <param name="_isOnline"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetByIsOnline(bool _isOnline)
		{
			int count = -1;
			return GetByIsOnline(null,_isOnline, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetByIsOnline(bool _isOnline, int start, int pageLength)
		{
			int count = -1;
			return GetByIsOnline(null, _isOnline, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetByIsOnline(TransactionManager transactionManager, bool _isOnline)
		{
			int count = -1;
			return GetByIsOnline(transactionManager, _isOnline, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetByIsOnline(TransactionManager transactionManager, bool _isOnline, int start, int pageLength)
		{
			int count = -1;
			return GetByIsOnline(transactionManager, _isOnline, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetByIsOnline(bool _isOnline, int start, int pageLength, out int count)
		{
			return GetByIsOnline(null, _isOnline, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public abstract TList<BbLoginLog> GetByIsOnline(TransactionManager transactionManager, bool _isOnline, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key NonClusteredIndex-20160727-143627 index.
		/// </summary>
		/// <param name="_sessionId"></param>
		/// <param name="_logoutTime"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetBySessionIdLogoutTime(string _sessionId, System.DateTime? _logoutTime)
		{
			int count = -1;
			return GetBySessionIdLogoutTime(null,_sessionId, _logoutTime, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetBySessionIdLogoutTime(string _sessionId, System.DateTime? _logoutTime, int start, int pageLength)
		{
			int count = -1;
			return GetBySessionIdLogoutTime(null, _sessionId, _logoutTime, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetBySessionIdLogoutTime(TransactionManager transactionManager, string _sessionId, System.DateTime? _logoutTime)
		{
			int count = -1;
			return GetBySessionIdLogoutTime(transactionManager, _sessionId, _logoutTime, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetBySessionIdLogoutTime(TransactionManager transactionManager, string _sessionId, System.DateTime? _logoutTime, int start, int pageLength)
		{
			int count = -1;
			return GetBySessionIdLogoutTime(transactionManager, _sessionId, _logoutTime, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetBySessionIdLogoutTime(string _sessionId, System.DateTime? _logoutTime, int start, int pageLength, out int count)
		{
			return GetBySessionIdLogoutTime(null, _sessionId, _logoutTime, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public abstract TList<BbLoginLog> GetBySessionIdLogoutTime(TransactionManager transactionManager, string _sessionId, System.DateTime? _logoutTime, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key NonClusteredIndex-20160727-143655 index.
		/// </summary>
		/// <param name="_sessionId"></param>
		/// <param name="_badbirUserId"></param>
		/// <param name="_isOnline"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetBySessionIdBadbirUserIdIsOnline(string _sessionId, System.Int32? _badbirUserId, bool _isOnline)
		{
			int count = -1;
			return GetBySessionIdBadbirUserIdIsOnline(null,_sessionId, _badbirUserId, _isOnline, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetBySessionIdBadbirUserIdIsOnline(string _sessionId, System.Int32? _badbirUserId, bool _isOnline, int start, int pageLength)
		{
			int count = -1;
			return GetBySessionIdBadbirUserIdIsOnline(null, _sessionId, _badbirUserId, _isOnline, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetBySessionIdBadbirUserIdIsOnline(TransactionManager transactionManager, string _sessionId, System.Int32? _badbirUserId, bool _isOnline)
		{
			int count = -1;
			return GetBySessionIdBadbirUserIdIsOnline(transactionManager, _sessionId, _badbirUserId, _isOnline, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetBySessionIdBadbirUserIdIsOnline(TransactionManager transactionManager, string _sessionId, System.Int32? _badbirUserId, bool _isOnline, int start, int pageLength)
		{
			int count = -1;
			return GetBySessionIdBadbirUserIdIsOnline(transactionManager, _sessionId, _badbirUserId, _isOnline, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public TList<BbLoginLog> GetBySessionIdBadbirUserIdIsOnline(string _sessionId, System.Int32? _badbirUserId, bool _isOnline, int start, int pageLength, out int count)
		{
			return GetBySessionIdBadbirUserIdIsOnline(null, _sessionId, _badbirUserId, _isOnline, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbLoginLog&gt;"/> class.</returns>
		public abstract TList<BbLoginLog> GetBySessionIdBadbirUserIdIsOnline(TransactionManager transactionManager, string _sessionId, System.Int32? _badbirUserId, bool _isOnline, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_BbLoginLog index.
		/// </summary>
		/// <param name="_rowId"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbLoginLog GetByRowId(int _rowId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbLoginLog GetByRowId(int _rowId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbLoginLog GetByRowId(TransactionManager transactionManager, int _rowId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbLoginLog GetByRowId(TransactionManager transactionManager, int _rowId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbLoginLog GetByRowId(int _rowId, int start, int pageLength, out int count)
		{
			return GetByRowId(null, _rowId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbLoginLog GetByRowId(TransactionManager transactionManager, int _rowId, int start, int pageLength, out int count);
		...
		public TList<BbLoginLog> LoginLog_getLastTenLoginsByUser(System.Int32? badbiruserid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbLoginLog&gt;"/> instance.</returns>
		public TList<BbLoginLog> LoginLog_getLastTenLoginsByUser(int start, int pageLength, System.Int32? badbiruserid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbLoginLog&gt;"/> instance.</returns>
		public TList<BbLoginLog> LoginLog_getLastTenLoginsByUser(TransactionManager transactionManager, System.Int32? badbiruserid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbLoginLog&gt;"/> instance.</returns>
		public abstract TList<BbLoginLog> LoginLog_getLastTenLoginsByUser(TransactionManager transactionManager, int start, int pageLength , System.Int32? badbiruserid);
		...
		/// <summary>
		/// Fill a TList&lt;BbLoginLog&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbLoginLog&gt;"/></returns>
		public static TList<BbLoginLog> Fill(IDataReader reader, TList<BbLoginLog> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbLoginLog c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbLoginLog")
					.Append("|").Append((int)reader[((int)BbLoginLogColumn.RowId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbLoginLog>(
					key.ToString(), // EntityTrackingKey
					"BbLoginLog",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbLoginLog();
				}
					...
					))
				{
					...
					c.RowId = (int)reader[((int)BbLoginLogColumn.RowId - 1)];
					c.SessionId = (string)reader[((int)BbLoginLogColumn.SessionId - 1)];
					c.BadbirUserId = (reader.IsDBNull(((int)BbLoginLogColumn.BadbirUserId - 1)))?null:(System.Int32?)reader[((int)BbLoginLogColumn.BadbirUserId - 1)];
					c.Ip = (reader.IsDBNull(((int)BbLoginLogColumn.Ip - 1)))?null:(string)reader[((int)BbLoginLogColumn.Ip - 1)];
					c.LoginTime = (System.DateTime)reader[((int)BbLoginLogColumn.LoginTime - 1)];
					c.LogoutTime = (reader.IsDBNull(((int)BbLoginLogColumn.LogoutTime - 1)))?null:(System.DateTime?)reader[((int)BbLoginLogColumn.LogoutTime - 1)];
					c.IsOnline = (bool)reader[((int)BbLoginLogColumn.IsOnline - 1)];
					c.LastReqTime = (reader.IsDBNull(((int)BbLoginLogColumn.LastReqTime - 1)))?null:(System.DateTime?)reader[((int)BbLoginLogColumn.LastReqTime - 1)];
					c.UserAgent = (reader.IsDBNull(((int)BbLoginLogColumn.UserAgent - 1)))?null:(string)reader[((int)BbLoginLogColumn.UserAgent - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbLoginLog entity)
		{
			if (!reader.Read()) return;
			
			entity.RowId = (int)reader[((int)BbLoginLogColumn.RowId - 1)];
			entity.SessionId = (string)reader[((int)BbLoginLogColumn.SessionId - 1)];
			entity.BadbirUserId = (reader.IsDBNull(((int)BbLoginLogColumn.BadbirUserId - 1)))?null:(System.Int32?)reader[((int)BbLoginLogColumn.BadbirUserId - 1)];
			entity.Ip = (reader.IsDBNull(((int)BbLoginLogColumn.Ip - 1)))?null:(string)reader[((int)BbLoginLogColumn.Ip - 1)];
			entity.LoginTime = (System.DateTime)reader[((int)BbLoginLogColumn.LoginTime - 1)];
			entity.LogoutTime = (reader.IsDBNull(((int)BbLoginLogColumn.LogoutTime - 1)))?null:(System.DateTime?)reader[((int)BbLoginLogColumn.LogoutTime - 1)];
			entity.IsOnline = (bool)reader[((int)BbLoginLogColumn.IsOnline - 1)];
			entity.LastReqTime = (reader.IsDBNull(((int)BbLoginLogColumn.LastReqTime - 1)))?null:(System.DateTime?)reader[((int)BbLoginLogColumn.LastReqTime - 1)];
			entity.UserAgent = (reader.IsDBNull(((int)BbLoginLogColumn.UserAgent - 1)))?null:(string)reader[((int)BbLoginLogColumn.UserAgent - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbLoginLog entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.RowId = (int)dataRow["RowID"];
			entity.SessionId = (string)dataRow["SessionID"];
			entity.BadbirUserId = Convert.IsDBNull(dataRow["BadbirUserID"]) ? null : (System.Int32?)dataRow["BadbirUserID"];
			entity.Ip = Convert.IsDBNull(dataRow["IP"]) ? null : (string)dataRow["IP"];
			entity.LoginTime = (System.DateTime)dataRow["LoginTime"];
			entity.LogoutTime = Convert.IsDBNull(dataRow["LogoutTime"]) ? null : (System.DateTime?)dataRow["LogoutTime"];
			entity.IsOnline = (bool)dataRow["isOnline"];
			entity.LastReqTime = Convert.IsDBNull(dataRow["LastReqTime"]) ? null : (System.DateTime?)dataRow["LastReqTime"];
			entity.UserAgent = Convert.IsDBNull(dataRow["UserAgent"]) ? null : (string)dataRow["UserAgent"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbLoginLog"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbLoginLog Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbLoginLog entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbLoginLog object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbLoginLog instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbLoginLog Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbLoginLog entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbLoginLogChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbLoginLog</c>
	///</summary>
	public enum BbLoginLogChildEntityTypes
	{
	}
	
	#endregion BbLoginLogChildEntityTypes
	
	#region BbLoginLogFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbLoginLogColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbLoginLog"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbLoginLogFilterBuilder : SqlFilterBuilder<BbLoginLogColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbLoginLogFilterBuilder class.
		/// </summary>
		public BbLoginLogFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbLoginLogFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbLoginLogFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbLoginLogFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbLoginLogFilterBuilder
	
	#region BbLoginLogParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbLoginLogColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbLoginLog"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbLoginLogParameterBuilder : ParameterizedSqlFilterBuilder<BbLoginLogColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbLoginLogParameterBuilder class.
		/// </summary>
		public BbLoginLogParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbLoginLogParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbLoginLogParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbLoginLogParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbLoginLogParameterBuilder
	
	#region BbLoginLogSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbLoginLogColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbLoginLog"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbLoginLogSortBuilder : SqlSortBuilder<BbLoginLogColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbLoginLogSqlSortBuilder class.
		/// </summary>
		public BbLoginLogSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbLoginLogSortBuilder
