...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPatientCohortTrackingStatuslkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPatientCohortTrackingStatuslkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkpKey key)
		{
			return Delete(transactionManager, key.Ptrackingstatusid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_ptrackingstatusid">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _ptrackingstatusid)
		{
			return Delete(null, _ptrackingstatusid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _ptrackingstatusid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkpKey key, int start, int pageLength)
		{
			return GetByPtrackingstatusid(transactionManager, key.Ptrackingstatusid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbCohortPatientTrackingStatuslkp index.
		/// </summary>
		/// <param name="_ptrackingstatusid"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp GetByPtrackingstatusid(int _ptrackingstatusid)
		{
			int count = -1;
			return GetByPtrackingstatusid(null,_ptrackingstatusid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbCohortPatientTrackingStatuslkp index.
		/// </summary>
		/// <param name="_ptrackingstatusid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp GetByPtrackingstatusid(int _ptrackingstatusid, int start, int pageLength)
		{
			int count = -1;
			return GetByPtrackingstatusid(null, _ptrackingstatusid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp GetByPtrackingstatusid(TransactionManager transactionManager, int _ptrackingstatusid)
		{
			int count = -1;
			return GetByPtrackingstatusid(transactionManager, _ptrackingstatusid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp GetByPtrackingstatusid(TransactionManager transactionManager, int _ptrackingstatusid, int start, int pageLength)
		{
			int count = -1;
			return GetByPtrackingstatusid(transactionManager, _ptrackingstatusid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp GetByPtrackingstatusid(int _ptrackingstatusid, int start, int pageLength, out int count)
		{
			return GetByPtrackingstatusid(null, _ptrackingstatusid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp GetByPtrackingstatusid(TransactionManager transactionManager, int _ptrackingstatusid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbPatientCohortTrackingStatuslkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPatientCohortTrackingStatuslkp&gt;"/></returns>
		public static TList<BbPatientCohortTrackingStatuslkp> Fill(IDataReader reader, TList<BbPatientCohortTrackingStatuslkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPatientCohortTrackingStatuslkp")
					.Append("|").Append((int)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Ptrackingstatusid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPatientCohortTrackingStatuslkp>(
					key.ToString(), // EntityTrackingKey
					"BbPatientCohortTrackingStatuslkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp();
				}
					...
					))
				{
					...
					c.Ptrackingstatusid = (int)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Ptrackingstatusid - 1)];
					c.OriginalPtrackingstatusid = c.Ptrackingstatusid;
					c.Ptrackingstatus = (string)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Ptrackingstatus - 1)];
					c.Createdbyid = (int)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Ptrackingstatusid = (int)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Ptrackingstatusid - 1)];
			entity.OriginalPtrackingstatusid = (int)reader["ptrackingstatusid"];
			entity.Ptrackingstatus = (string)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Ptrackingstatus - 1)];
			entity.Createdbyid = (int)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPatientCohortTrackingStatuslkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Ptrackingstatusid = (int)dataRow["ptrackingstatusid"];
			entity.OriginalPtrackingstatusid = (int)dataRow["ptrackingstatusid"];
			entity.Ptrackingstatus = (string)dataRow["ptrackingstatus"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByPtrackingstatusid methods when available
			...
			if (CanDeepLoad(entity, "List<BbPatientCohortTracking>|BbPatientCohortTrackingCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPatientCohortTrackingCollection = DataRepository.BbPatientCohortTrackingProvider.GetByFupstatus(transactionManager, entity.Ptrackingstatusid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbPatientCohortTracking>
				...
				{	
					...
					{
						if(child.FupstatusSource != null)
						{
							child.Fupstatus = child.FupstatusSource.Ptrackingstatusid;
						}
						else
						{
							child.Fupstatus = entity.Ptrackingstatusid;
						}
	...
	#region BbPatientCohortTrackingStatuslkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingStatuslkp</c>
	///</summary>
	public enum BbPatientCohortTrackingStatuslkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbPatientCohortTrackingStatuslkp</c> as OneToMany for BbPatientCohortTrackingCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientCohortTracking>))]
		BbPatientCohortTrackingCollection,
	}
	
	#endregion BbPatientCohortTrackingStatuslkpChildEntityTypes
	
	#region BbPatientCohortTrackingStatuslkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPatientCohortTrackingStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortTrackingStatuslkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientCohortTrackingStatuslkpFilterBuilder : SqlFilterBuilder<BbPatientCohortTrackingStatuslkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingStatuslkpFilterBuilder class.
		/// </summary>
		public BbPatientCohortTrackingStatuslkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingStatuslkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientCohortTrackingStatuslkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPatientCohortTrackingStatuslkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientCohortTrackingStatuslkpFilterBuilder
	
	#region BbPatientCohortTrackingStatuslkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPatientCohortTrackingStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortTrackingStatuslkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientCohortTrackingStatuslkpParameterBuilder : ParameterizedSqlFilterBuilder<BbPatientCohortTrackingStatuslkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingStatuslkpParameterBuilder class.
		/// </summary>
		public BbPatientCohortTrackingStatuslkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingStatuslkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientCohortTrackingStatuslkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPatientCohortTrackingStatuslkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientCohortTrackingStatuslkpParameterBuilder
	
	#region BbPatientCohortTrackingStatuslkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPatientCohortTrackingStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortTrackingStatuslkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPatientCohortTrackingStatuslkpSortBuilder : SqlSortBuilder<BbPatientCohortTrackingStatuslkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingStatuslkpSqlSortBuilder class.
		/// </summary>
		public BbPatientCohortTrackingStatuslkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPatientCohortTrackingStatuslkpSortBuilder
