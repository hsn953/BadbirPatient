...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbUkcrNregionlkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbUkcrNregionlkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp, MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkpKey key)
		{
			return Delete(transactionManager, key.UkcrNregid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_ukcrNregid">UKCRN region Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Int32 _ukcrNregid)
		{
			return Delete(null, _ukcrNregid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Int32 _ukcrNregid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkpKey key, int start, int pageLength)
		{
			return GetByUkcrNregid(transactionManager, key.UkcrNregid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbUKCRNregionlkp index.
		/// </summary>
		/// <param name="_ukcrNregid">UKCRN region Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp GetByUkcrNregid(System.Int32 _ukcrNregid)
		{
			int count = -1;
			return GetByUkcrNregid(null,_ukcrNregid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbUKCRNregionlkp index.
		/// </summary>
		/// <param name="_ukcrNregid">UKCRN region Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp GetByUkcrNregid(System.Int32 _ukcrNregid, int start, int pageLength)
		{
			int count = -1;
			return GetByUkcrNregid(null, _ukcrNregid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp GetByUkcrNregid(TransactionManager transactionManager, System.Int32 _ukcrNregid)
		{
			int count = -1;
			return GetByUkcrNregid(transactionManager, _ukcrNregid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp GetByUkcrNregid(TransactionManager transactionManager, System.Int32 _ukcrNregid, int start, int pageLength)
		{
			int count = -1;
			return GetByUkcrNregid(transactionManager, _ukcrNregid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp GetByUkcrNregid(System.Int32 _ukcrNregid, int start, int pageLength, out int count)
		{
			return GetByUkcrNregid(null, _ukcrNregid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp GetByUkcrNregid(TransactionManager transactionManager, System.Int32 _ukcrNregid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbUkcrNregionlkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbUkcrNregionlkp&gt;"/></returns>
		public static TList<BbUkcrNregionlkp> Fill(IDataReader reader, TList<BbUkcrNregionlkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbUkcrNregionlkp")
					.Append("|").Append((System.Int32)reader[((int)BbUkcrNregionlkpColumn.UkcrNregid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbUkcrNregionlkp>(
					key.ToString(), // EntityTrackingKey
					"BbUkcrNregionlkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp();
				}
					...
					))
				{
					...
					c.UkcrNregid = (System.Int32)reader[((int)BbUkcrNregionlkpColumn.UkcrNregid - 1)];
					c.UkcrnRegion = (reader.IsDBNull(((int)BbUkcrNregionlkpColumn.UkcrnRegion - 1)))?null:(System.String)reader[((int)BbUkcrNregionlkpColumn.UkcrnRegion - 1)];
					c.Createdbyid = (System.Int32)reader[((int)BbUkcrNregionlkpColumn.Createdbyid - 1)];
					c.Createdbyname = (System.String)reader[((int)BbUkcrNregionlkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbUkcrNregionlkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (System.Int32)reader[((int)BbUkcrNregionlkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (System.String)reader[((int)BbUkcrNregionlkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbUkcrNregionlkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp entity)
		{
			if (!reader.Read()) return;
			
			entity.UkcrNregid = (System.Int32)reader[((int)BbUkcrNregionlkpColumn.UkcrNregid - 1)];
			entity.UkcrnRegion = (reader.IsDBNull(((int)BbUkcrNregionlkpColumn.UkcrnRegion - 1)))?null:(System.String)reader[((int)BbUkcrNregionlkpColumn.UkcrnRegion - 1)];
			entity.Createdbyid = (System.Int32)reader[((int)BbUkcrNregionlkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (System.String)reader[((int)BbUkcrNregionlkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbUkcrNregionlkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (System.Int32)reader[((int)BbUkcrNregionlkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (System.String)reader[((int)BbUkcrNregionlkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbUkcrNregionlkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.UkcrNregid = (System.Int32)dataRow["UKCRNregid"];
			entity.UkcrnRegion = Convert.IsDBNull(dataRow["UKCRNRegion"]) ? null : (System.String)dataRow["UKCRNRegion"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByUkcrNregid methods when available
			...
			if (CanDeepLoad(entity, "List<BbCentre>|BbCentreCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbCentreCollection = DataRepository.BbCentreProvider.GetByUkcrNregionid(transactionManager, entity.UkcrNregid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbCentre>
				...
				{	
					...
					{
						if(child.UkcrNregionidSource != null)
						{
							child.UkcrNregionid = child.UkcrNregionidSource.UkcrNregid;
						}
						else
						{
							child.UkcrNregionid = entity.UkcrNregid;
						}
	...
	#region BbUkcrNregionlkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbUkcrNregionlkp</c>
	///</summary>
	public enum BbUkcrNregionlkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbUkcrNregionlkp</c> as OneToMany for BbCentreCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbCentre>))]
		BbCentreCollection,
	}
	
	#endregion BbUkcrNregionlkpChildEntityTypes
	
	#region BbUkcrNregionlkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbUkcrNregionlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbUkcrNregionlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbUkcrNregionlkpFilterBuilder : SqlFilterBuilder<BbUkcrNregionlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbUkcrNregionlkpFilterBuilder class.
		/// </summary>
		public BbUkcrNregionlkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbUkcrNregionlkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbUkcrNregionlkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbUkcrNregionlkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbUkcrNregionlkpFilterBuilder
	
	#region BbUkcrNregionlkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbUkcrNregionlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbUkcrNregionlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbUkcrNregionlkpParameterBuilder : ParameterizedSqlFilterBuilder<BbUkcrNregionlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbUkcrNregionlkpParameterBuilder class.
		/// </summary>
		public BbUkcrNregionlkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbUkcrNregionlkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbUkcrNregionlkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbUkcrNregionlkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbUkcrNregionlkpParameterBuilder
	
	#region BbUkcrNregionlkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbUkcrNregionlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbUkcrNregionlkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbUkcrNregionlkpSortBuilder : SqlSortBuilder<BbUkcrNregionlkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbUkcrNregionlkpSqlSortBuilder class.
		/// </summary>
		public BbUkcrNregionlkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbUkcrNregionlkpSortBuilder
