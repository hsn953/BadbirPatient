...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPatientLifestyleProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPatientLifestyleProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPatientLifestyle, MHS.Badbir.NetTiers.Entities.BbPatientLifestyleKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientLifestyleKey key)
		{
		...
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Int32 _fupId)
		{
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Int32 _fupId);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatientLifestyle_bbEthnicitylkp key.
		///		FK_bbPatientLifestyle_bbEthnicitylkp Description: 
		/// </summary>
		/// <param name="_ethnicityid">Ethnicity</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		public TList<BbPatientLifestyle> GetByEthnicityid(System.Int32? _ethnicityid)
		{
			int count = -1;
			return GetByEthnicityid(_ethnicityid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		/// <remarks></remarks>
		public TList<BbPatientLifestyle> GetByEthnicityid(TransactionManager transactionManager, System.Int32? _ethnicityid)
		{
			int count = -1;
			return GetByEthnicityid(transactionManager, _ethnicityid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		public TList<BbPatientLifestyle> GetByEthnicityid(TransactionManager transactionManager, System.Int32? _ethnicityid, int start, int pageLength)
		{
			int count = -1;
			return GetByEthnicityid(transactionManager, _ethnicityid, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatientLifestyle_bbEthnicitylkp key.
		///		fkBbPatientLifestyleBbEthnicitylkp Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_ethnicityid">Ethnicity</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		public TList<BbPatientLifestyle> GetByEthnicityid(System.Int32? _ethnicityid, int start, int pageLength)
		{
			int count =  -1;
			return GetByEthnicityid(null, _ethnicityid, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		public TList<BbPatientLifestyle> GetByEthnicityid(System.Int32? _ethnicityid, int start, int pageLength,out int count)
		{
			return GetByEthnicityid(null, _ethnicityid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		public abstract TList<BbPatientLifestyle> GetByEthnicityid(TransactionManager transactionManager, System.Int32? _ethnicityid, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatientlifestyle_bbWorkstatuslkp key.
		///		FK_bbPatientlifestyle_bbWorkstatuslkp Description: 
		/// </summary>
		/// <param name="_workstatusid">Work status</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		public TList<BbPatientLifestyle> GetByWorkstatusid(System.Int32? _workstatusid)
		{
			int count = -1;
			return GetByWorkstatusid(_workstatusid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		/// <remarks></remarks>
		public TList<BbPatientLifestyle> GetByWorkstatusid(TransactionManager transactionManager, System.Int32? _workstatusid)
		{
			int count = -1;
			return GetByWorkstatusid(transactionManager, _workstatusid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		public TList<BbPatientLifestyle> GetByWorkstatusid(TransactionManager transactionManager, System.Int32? _workstatusid, int start, int pageLength)
		{
			int count = -1;
			return GetByWorkstatusid(transactionManager, _workstatusid, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatientlifestyle_bbWorkstatuslkp key.
		///		fkBbPatientlifestyleBbWorkstatuslkp Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_workstatusid">Work status</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		public TList<BbPatientLifestyle> GetByWorkstatusid(System.Int32? _workstatusid, int start, int pageLength)
		{
			int count =  -1;
			return GetByWorkstatusid(null, _workstatusid, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		public TList<BbPatientLifestyle> GetByWorkstatusid(System.Int32? _workstatusid, int start, int pageLength,out int count)
		{
			return GetByWorkstatusid(null, _workstatusid, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientLifestyle objects.</returns>
		public abstract TList<BbPatientLifestyle> GetByWorkstatusid(TransactionManager transactionManager, System.Int32? _workstatusid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbPatientLifestyle Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientLifestyleKey key, int start, int pageLength)
		{
			return GetByFupId(transactionManager, key.FupId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_tblPBQPatientLifestyle index.
		/// </summary>
		/// <param name="_fupId">Follow up Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientLifestyle GetByFupId(System.Int32 _fupId)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_tblPBQPatientLifestyle index.
		/// </summary>
		/// <param name="_fupId">Follow up Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientLifestyle GetByFupId(System.Int32 _fupId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientLifestyle GetByFupId(TransactionManager transactionManager, System.Int32 _fupId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientLifestyle GetByFupId(TransactionManager transactionManager, System.Int32 _fupId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientLifestyle GetByFupId(System.Int32 _fupId, int start, int pageLength, out int count)
		{
			return GetByFupId(null, _fupId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPatientLifestyle GetByFupId(TransactionManager transactionManager, System.Int32 _fupId, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbPatientLifestyle&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPatientLifestyle&gt;"/></returns>
		public static TList<BbPatientLifestyle> Fill(IDataReader reader, TList<BbPatientLifestyle> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPatientLifestyle c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPatientLifestyle")
					.Append("|").Append((System.Int32)reader[((int)BbPatientLifestyleColumn.FupId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPatientLifestyle>(
					key.ToString(), // EntityTrackingKey
					"BbPatientLifestyle",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPatientLifestyle();
				}
					...
					))
				{
					...
					c.FupId = (System.Int32)reader[((int)BbPatientLifestyleColumn.FupId - 1)];
					c.OriginalFupId = c.FupId;
					c.Birthtown = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Birthtown - 1)))?null:(System.String)reader[((int)BbPatientLifestyleColumn.Birthtown - 1)];
					c.Birthcountry = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Birthcountry - 1)))?null:(System.String)reader[((int)BbPatientLifestyleColumn.Birthcountry - 1)];
					c.Workstatusid = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Workstatusid - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Workstatusid - 1)];
					c.Occupation = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Occupation - 1)))?null:(System.String)reader[((int)BbPatientLifestyleColumn.Occupation - 1)];
					c.Ethnicityid = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Ethnicityid - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Ethnicityid - 1)];
					c.Otherethnicity = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Otherethnicity - 1)))?null:(System.String)reader[((int)BbPatientLifestyleColumn.Otherethnicity - 1)];
					c.Outdooroccupation = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Outdooroccupation - 1)))?null:(System.Boolean?)reader[((int)BbPatientLifestyleColumn.Outdooroccupation - 1)];
					c.Livetropical = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Livetropical - 1)))?null:(System.Boolean?)reader[((int)BbPatientLifestyleColumn.Livetropical - 1)];
					c.Eversmoked = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Eversmoked - 1)))?null:(System.Boolean?)reader[((int)BbPatientLifestyleColumn.Eversmoked - 1)];
					c.Eversmokednumbercigsperday = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Eversmokednumbercigsperday - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Eversmokednumbercigsperday - 1)];
					c.Agestart = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Agestart - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Agestart - 1)];
					c.Agestop = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Agestop - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Agestop - 1)];
					c.Currentlysmoke = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Currentlysmoke - 1)))?null:(System.Boolean?)reader[((int)BbPatientLifestyleColumn.Currentlysmoke - 1)];
					c.Currentlysmokenumbercigsperday = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Currentlysmokenumbercigsperday - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Currentlysmokenumbercigsperday - 1)];
					c.Drnkbeeravg = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Drnkbeeravg - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Drnkbeeravg - 1)];
					c.Drnkwineavg = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Drnkwineavg - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Drnkwineavg - 1)];
					c.Drnkspiritsavg = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Drnkspiritsavg - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Drnkspiritsavg - 1)];
					c.Drinkalcohol = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Drinkalcohol - 1)))?null:(System.Boolean?)reader[((int)BbPatientLifestyleColumn.Drinkalcohol - 1)];
					c.Drnkunitsavg = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Drnkunitsavg - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Drnkunitsavg - 1)];
					c.Admittedtohospital = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Admittedtohospital - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Admittedtohospital - 1)];
					c.Newdrugs = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Newdrugs - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Newdrugs - 1)];
					c.Newclinics = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Newclinics - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Newclinics - 1)];
					c.Systolic = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Systolic - 1)))?null:(System.Double?)reader[((int)BbPatientLifestyleColumn.Systolic - 1)];
					c.Diastolic = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Diastolic - 1)))?null:(System.Double?)reader[((int)BbPatientLifestyleColumn.Diastolic - 1)];
					c.Height = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Height - 1)))?null:(System.Double?)reader[((int)BbPatientLifestyleColumn.Height - 1)];
					c.Weight = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Weight - 1)))?null:(System.Double?)reader[((int)BbPatientLifestyleColumn.Weight - 1)];
					c.Waist = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Waist - 1)))?null:(System.Double?)reader[((int)BbPatientLifestyleColumn.Waist - 1)];
					c.Createdbyid = (System.Int32)reader[((int)BbPatientLifestyleColumn.Createdbyid - 1)];
					c.Createdbyname = (System.String)reader[((int)BbPatientLifestyleColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPatientLifestyleColumn.Createddate - 1)];
					c.Lastupdatedbyid = (System.Int32)reader[((int)BbPatientLifestyleColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (System.String)reader[((int)BbPatientLifestyleColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPatientLifestyleColumn.Lastupdateddate - 1)];
					c.WeightMissing = (System.Boolean)reader[((int)BbPatientLifestyleColumn.WeightMissing - 1)];
					c.WaistMissing = (System.Boolean)reader[((int)BbPatientLifestyleColumn.WaistMissing - 1)];
					c.SmokingMissing = (System.Boolean)reader[((int)BbPatientLifestyleColumn.SmokingMissing - 1)];
					c.DrinkingMissing = (System.Boolean)reader[((int)BbPatientLifestyleColumn.DrinkingMissing - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPatientLifestyle entity)
		{
			if (!reader.Read()) return;
			
			entity.FupId = (System.Int32)reader[((int)BbPatientLifestyleColumn.FupId - 1)];
			entity.OriginalFupId = (System.Int32)reader["FupId"];
			entity.Birthtown = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Birthtown - 1)))?null:(System.String)reader[((int)BbPatientLifestyleColumn.Birthtown - 1)];
			entity.Birthcountry = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Birthcountry - 1)))?null:(System.String)reader[((int)BbPatientLifestyleColumn.Birthcountry - 1)];
			entity.Workstatusid = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Workstatusid - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Workstatusid - 1)];
			entity.Occupation = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Occupation - 1)))?null:(System.String)reader[((int)BbPatientLifestyleColumn.Occupation - 1)];
			entity.Ethnicityid = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Ethnicityid - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Ethnicityid - 1)];
			entity.Otherethnicity = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Otherethnicity - 1)))?null:(System.String)reader[((int)BbPatientLifestyleColumn.Otherethnicity - 1)];
			entity.Outdooroccupation = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Outdooroccupation - 1)))?null:(System.Boolean?)reader[((int)BbPatientLifestyleColumn.Outdooroccupation - 1)];
			entity.Livetropical = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Livetropical - 1)))?null:(System.Boolean?)reader[((int)BbPatientLifestyleColumn.Livetropical - 1)];
			entity.Eversmoked = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Eversmoked - 1)))?null:(System.Boolean?)reader[((int)BbPatientLifestyleColumn.Eversmoked - 1)];
			entity.Eversmokednumbercigsperday = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Eversmokednumbercigsperday - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Eversmokednumbercigsperday - 1)];
			entity.Agestart = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Agestart - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Agestart - 1)];
			entity.Agestop = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Agestop - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Agestop - 1)];
			entity.Currentlysmoke = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Currentlysmoke - 1)))?null:(System.Boolean?)reader[((int)BbPatientLifestyleColumn.Currentlysmoke - 1)];
			entity.Currentlysmokenumbercigsperday = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Currentlysmokenumbercigsperday - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Currentlysmokenumbercigsperday - 1)];
			entity.Drnkbeeravg = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Drnkbeeravg - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Drnkbeeravg - 1)];
			entity.Drnkwineavg = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Drnkwineavg - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Drnkwineavg - 1)];
			entity.Drnkspiritsavg = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Drnkspiritsavg - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Drnkspiritsavg - 1)];
			entity.Drinkalcohol = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Drinkalcohol - 1)))?null:(System.Boolean?)reader[((int)BbPatientLifestyleColumn.Drinkalcohol - 1)];
			entity.Drnkunitsavg = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Drnkunitsavg - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Drnkunitsavg - 1)];
			entity.Admittedtohospital = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Admittedtohospital - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Admittedtohospital - 1)];
			entity.Newdrugs = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Newdrugs - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Newdrugs - 1)];
			entity.Newclinics = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Newclinics - 1)))?null:(System.Int32?)reader[((int)BbPatientLifestyleColumn.Newclinics - 1)];
			entity.Systolic = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Systolic - 1)))?null:(System.Double?)reader[((int)BbPatientLifestyleColumn.Systolic - 1)];
			entity.Diastolic = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Diastolic - 1)))?null:(System.Double?)reader[((int)BbPatientLifestyleColumn.Diastolic - 1)];
			entity.Height = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Height - 1)))?null:(System.Double?)reader[((int)BbPatientLifestyleColumn.Height - 1)];
			entity.Weight = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Weight - 1)))?null:(System.Double?)reader[((int)BbPatientLifestyleColumn.Weight - 1)];
			entity.Waist = (reader.IsDBNull(((int)BbPatientLifestyleColumn.Waist - 1)))?null:(System.Double?)reader[((int)BbPatientLifestyleColumn.Waist - 1)];
			entity.Createdbyid = (System.Int32)reader[((int)BbPatientLifestyleColumn.Createdbyid - 1)];
			entity.Createdbyname = (System.String)reader[((int)BbPatientLifestyleColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPatientLifestyleColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (System.Int32)reader[((int)BbPatientLifestyleColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (System.String)reader[((int)BbPatientLifestyleColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPatientLifestyleColumn.Lastupdateddate - 1)];
			entity.WeightMissing = (System.Boolean)reader[((int)BbPatientLifestyleColumn.WeightMissing - 1)];
			entity.WaistMissing = (System.Boolean)reader[((int)BbPatientLifestyleColumn.WaistMissing - 1)];
			entity.SmokingMissing = (System.Boolean)reader[((int)BbPatientLifestyleColumn.SmokingMissing - 1)];
			entity.DrinkingMissing = (System.Boolean)reader[((int)BbPatientLifestyleColumn.DrinkingMissing - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPatientLifestyle entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.FupId = (System.Int32)dataRow["FupId"];
			entity.OriginalFupId = (System.Int32)dataRow["FupId"];
			entity.Birthtown = Convert.IsDBNull(dataRow["birthtown"]) ? null : (System.String)dataRow["birthtown"];
			entity.Birthcountry = Convert.IsDBNull(dataRow["birthcountry"]) ? null : (System.String)dataRow["birthcountry"];
			entity.Workstatusid = Convert.IsDBNull(dataRow["workstatusid"]) ? null : (System.Int32?)dataRow["workstatusid"];
			entity.Occupation = Convert.IsDBNull(dataRow["occupation"]) ? null : (System.String)dataRow["occupation"];
			entity.Ethnicityid = Convert.IsDBNull(dataRow["ethnicityid"]) ? null : (System.Int32?)dataRow["ethnicityid"];
			entity.Otherethnicity = Convert.IsDBNull(dataRow["otherethnicity"]) ? null : (System.String)dataRow["otherethnicity"];
			entity.Outdooroccupation = Convert.IsDBNull(dataRow["outdooroccupation"]) ? null : (System.Boolean?)dataRow["outdooroccupation"];
			entity.Livetropical = Convert.IsDBNull(dataRow["livetropical"]) ? null : (System.Boolean?)dataRow["livetropical"];
			entity.Eversmoked = Convert.IsDBNull(dataRow["eversmoked"]) ? null : (System.Boolean?)dataRow["eversmoked"];
			entity.Eversmokednumbercigsperday = Convert.IsDBNull(dataRow["eversmokednumbercigsperday"]) ? null : (System.Int32?)dataRow["eversmokednumbercigsperday"];
			entity.Agestart = Convert.IsDBNull(dataRow["agestart"]) ? null : (System.Int32?)dataRow["agestart"];
			entity.Agestop = Convert.IsDBNull(dataRow["agestop"]) ? null : (System.Int32?)dataRow["agestop"];
			entity.Currentlysmoke = Convert.IsDBNull(dataRow["currentlysmoke"]) ? null : (System.Boolean?)dataRow["currentlysmoke"];
			entity.Currentlysmokenumbercigsperday = Convert.IsDBNull(dataRow["currentlysmokenumbercigsperday"]) ? null : (System.Int32?)dataRow["currentlysmokenumbercigsperday"];
			entity.Drnkbeeravg = Convert.IsDBNull(dataRow["drnkbeeravg"]) ? null : (System.Int32?)dataRow["drnkbeeravg"];
			entity.Drnkwineavg = Convert.IsDBNull(dataRow["drnkwineavg"]) ? null : (System.Int32?)dataRow["drnkwineavg"];
			entity.Drnkspiritsavg = Convert.IsDBNull(dataRow["drnkspiritsavg"]) ? null : (System.Int32?)dataRow["drnkspiritsavg"];
			entity.Drinkalcohol = Convert.IsDBNull(dataRow["drinkalcohol"]) ? null : (System.Boolean?)dataRow["drinkalcohol"];
			entity.Drnkunitsavg = Convert.IsDBNull(dataRow["drnkunitsavg"]) ? null : (System.Int32?)dataRow["drnkunitsavg"];
			entity.Admittedtohospital = Convert.IsDBNull(dataRow["admittedtohospital"]) ? null : (System.Int32?)dataRow["admittedtohospital"];
			entity.Newdrugs = Convert.IsDBNull(dataRow["newdrugs"]) ? null : (System.Int32?)dataRow["newdrugs"];
			entity.Newclinics = Convert.IsDBNull(dataRow["newclinics"]) ? null : (System.Int32?)dataRow["newclinics"];
			entity.Systolic = Convert.IsDBNull(dataRow["systolic"]) ? null : (System.Double?)dataRow["systolic"];
			entity.Diastolic = Convert.IsDBNull(dataRow["diastolic"]) ? null : (System.Double?)dataRow["diastolic"];
			entity.Height = Convert.IsDBNull(dataRow["height"]) ? null : (System.Double?)dataRow["height"];
			entity.Weight = Convert.IsDBNull(dataRow["weight"]) ? null : (System.Double?)dataRow["weight"];
			entity.Waist = Convert.IsDBNull(dataRow["waist"]) ? null : (System.Double?)dataRow["waist"];
			...
			entity.WeightMissing = (System.Boolean)dataRow["weightMissing"];
			entity.WaistMissing = (System.Boolean)dataRow["waistMissing"];
			entity.SmokingMissing = (System.Boolean)dataRow["smokingMissing"];
			entity.DrinkingMissing = (System.Boolean)dataRow["drinkingMissing"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientLifestyle"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientLifestyle Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientLifestyle entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region EthnicityidSource	
			if (CanDeepLoad(entity, "BbEthnicitylkp|EthnicityidSource", deepLoadType, innerList) 
				&& entity.EthnicityidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.Ethnicityid ?? (int)0);
				BbEthnicitylkp tmpEntity = EntityManager.LocateEntity<BbEthnicitylkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbEthnicitylkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.EthnicityidSource = tmpEntity;
				else
					entity.EthnicityidSource = DataRepository.BbEthnicitylkpProvider.GetByEthnicityid(transactionManager, (entity.Ethnicityid ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'EthnicityidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.EthnicityidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbEthnicitylkpProvider.DeepLoad(transactionManager, entity.EthnicityidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion EthnicityidSource
			...
			#region WorkstatusidSource	
			if (CanDeepLoad(entity, "BbWorkStatuslkp|WorkstatusidSource", deepLoadType, innerList) 
				&& entity.WorkstatusidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.Workstatusid ?? (int)0);
				BbWorkStatuslkp tmpEntity = EntityManager.LocateEntity<BbWorkStatuslkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbWorkStatuslkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.WorkstatusidSource = tmpEntity;
				else
					entity.WorkstatusidSource = DataRepository.BbWorkStatuslkpProvider.GetByWorstatuskid(transactionManager, (entity.Workstatusid ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'WorkstatusidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.WorkstatusidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbWorkStatuslkpProvider.DeepLoad(transactionManager, entity.WorkstatusidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion WorkstatusidSource
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPatientLifestyle object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPatientLifestyle instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientLifestyle Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientLifestyle entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region EthnicityidSource
			if (CanDeepSave(entity, "BbEthnicitylkp|EthnicityidSource", deepSaveType, innerList) 
				&& entity.EthnicityidSource != null)
			{
				DataRepository.BbEthnicitylkpProvider.Save(transactionManager, entity.EthnicityidSource);
				entity.Ethnicityid = entity.EthnicityidSource.Ethnicityid;
			}
			#endregion 
			...
			#region WorkstatusidSource
			if (CanDeepSave(entity, "BbWorkStatuslkp|WorkstatusidSource", deepSaveType, innerList) 
				&& entity.WorkstatusidSource != null)
			{
				DataRepository.BbWorkStatuslkpProvider.Save(transactionManager, entity.WorkstatusidSource);
				entity.Workstatusid = entity.WorkstatusidSource.Worstatuskid;
			}
			#endregion 
	...
	#region BbPatientLifestyleChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPatientLifestyle</c>
	///</summary>
	public enum BbPatientLifestyleChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbEthnicitylkp</c> at EthnicityidSource
		///</summary>
		[ChildEntityType(typeof(BbEthnicitylkp))]
		BbEthnicitylkp,
		...
		///<summary>
		/// Composite Property for <c>BbWorkStatuslkp</c> at WorkstatusidSource
		///</summary>
		[ChildEntityType(typeof(BbWorkStatuslkp))]
		BbWorkStatuslkp,
	}
	
	#endregion BbPatientLifestyleChildEntityTypes
	
	#region BbPatientLifestyleFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPatientLifestyleColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientLifestyle"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientLifestyleFilterBuilder : SqlFilterBuilder<BbPatientLifestyleColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientLifestyleFilterBuilder class.
		/// </summary>
		public BbPatientLifestyleFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientLifestyleFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientLifestyleFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPatientLifestyleFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientLifestyleFilterBuilder
	
	#region BbPatientLifestyleParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPatientLifestyleColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientLifestyle"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientLifestyleParameterBuilder : ParameterizedSqlFilterBuilder<BbPatientLifestyleColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientLifestyleParameterBuilder class.
		/// </summary>
		public BbPatientLifestyleParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientLifestyleParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientLifestyleParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPatientLifestyleParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientLifestyleParameterBuilder
	
	#region BbPatientLifestyleSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPatientLifestyleColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientLifestyle"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPatientLifestyleSortBuilder : SqlSortBuilder<BbPatientLifestyleColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientLifestyleSqlSortBuilder class.
		/// </summary>
		public BbPatientLifestyleSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPatientLifestyleSortBuilder
