...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbQueryTypelkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbQueryTypelkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbQueryTypelkp, MHS.Badbir.NetTiers.Entities.BbQueryTypelkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryTypelkpKey key)
		{
			return Delete(transactionManager, key.QueryTypeId);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_queryTypeId">Query Type Lookup ID. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _queryTypeId)
		{
			return Delete(null, _queryTypeId);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _queryTypeId);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbQueryTypelkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryTypelkpKey key, int start, int pageLength)
		{
			return GetByQueryTypeId(transactionManager, key.QueryTypeId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbQueryTypelkp index.
		/// </summary>
		/// <param name="_queryTypeId">Query Type Lookup ID</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryTypelkp GetByQueryTypeId(int _queryTypeId)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbQueryTypelkp index.
		/// </summary>
		/// <param name="_queryTypeId">Query Type Lookup ID</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryTypelkp GetByQueryTypeId(int _queryTypeId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryTypelkp GetByQueryTypeId(TransactionManager transactionManager, int _queryTypeId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryTypelkp GetByQueryTypeId(TransactionManager transactionManager, int _queryTypeId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryTypelkp GetByQueryTypeId(int _queryTypeId, int start, int pageLength, out int count)
		{
			return GetByQueryTypeId(null, _queryTypeId, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbQueryTypelkp GetByQueryTypeId(TransactionManager transactionManager, int _queryTypeId, int start, int pageLength, out int count);
		...
		/// </summary>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForPV()
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForPV(int start, int pageLength)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForPV(TransactionManager transactionManager)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public abstract TList<BbQueryTypelkp> QueryTypelkp_GetAllForPV(TransactionManager transactionManager, int start, int pageLength );
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForAdmin()
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForAdmin(int start, int pageLength)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForAdmin(TransactionManager transactionManager)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public abstract TList<BbQueryTypelkp> QueryTypelkp_GetAllForAdmin(TransactionManager transactionManager, int start, int pageLength );
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForCentre()
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForCentre(int start, int pageLength)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForCentre(TransactionManager transactionManager)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public abstract TList<BbQueryTypelkp> QueryTypelkp_GetAllForCentre(TransactionManager transactionManager, int start, int pageLength );
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForClinician()
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForClinician(int start, int pageLength)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public TList<BbQueryTypelkp> QueryTypelkp_GetAllForClinician(TransactionManager transactionManager)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQueryTypelkp&gt;"/> instance.</returns>
		public abstract TList<BbQueryTypelkp> QueryTypelkp_GetAllForClinician(TransactionManager transactionManager, int start, int pageLength );
		...
		/// <summary>
		/// Fill a TList&lt;BbQueryTypelkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbQueryTypelkp&gt;"/></returns>
		public static TList<BbQueryTypelkp> Fill(IDataReader reader, TList<BbQueryTypelkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbQueryTypelkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbQueryTypelkp")
					.Append("|").Append((int)reader[((int)BbQueryTypelkpColumn.QueryTypeId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbQueryTypelkp>(
					key.ToString(), // EntityTrackingKey
					"BbQueryTypelkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbQueryTypelkp();
				}
					...
					))
				{
					...
					c.QueryTypeId = (int)reader[((int)BbQueryTypelkpColumn.QueryTypeId - 1)];
					c.QueryType = (reader.IsDBNull(((int)BbQueryTypelkpColumn.QueryType - 1)))?null:(string)reader[((int)BbQueryTypelkpColumn.QueryType - 1)];
					c.Createdbyid = (int)reader[((int)BbQueryTypelkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbQueryTypelkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbQueryTypelkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbQueryTypelkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbQueryTypelkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbQueryTypelkpColumn.Lastupdateddate - 1)];
					c.ShowForCliniciansPages = (reader.IsDBNull(((int)BbQueryTypelkpColumn.ShowForCliniciansPages - 1)))?null:(System.Boolean?)reader[((int)BbQueryTypelkpColumn.ShowForCliniciansPages - 1)];
					c.ShowForPvSystem = (reader.IsDBNull(((int)BbQueryTypelkpColumn.ShowForPvSystem - 1)))?null:(System.Boolean?)reader[((int)BbQueryTypelkpColumn.ShowForPvSystem - 1)];
					c.ShowForAdminQueryPages = (reader.IsDBNull(((int)BbQueryTypelkpColumn.ShowForAdminQueryPages - 1)))?null:(System.Boolean?)reader[((int)BbQueryTypelkpColumn.ShowForAdminQueryPages - 1)];
					c.ShowForCentreQueryPages = (reader.IsDBNull(((int)BbQueryTypelkpColumn.ShowForCentreQueryPages - 1)))?null:(System.Boolean?)reader[((int)BbQueryTypelkpColumn.ShowForCentreQueryPages - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbQueryTypelkp entity)
		{
			if (!reader.Read()) return;
			
			entity.QueryTypeId = (int)reader[((int)BbQueryTypelkpColumn.QueryTypeId - 1)];
			entity.QueryType = (reader.IsDBNull(((int)BbQueryTypelkpColumn.QueryType - 1)))?null:(string)reader[((int)BbQueryTypelkpColumn.QueryType - 1)];
			entity.Createdbyid = (int)reader[((int)BbQueryTypelkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbQueryTypelkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbQueryTypelkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbQueryTypelkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbQueryTypelkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbQueryTypelkpColumn.Lastupdateddate - 1)];
			entity.ShowForCliniciansPages = (reader.IsDBNull(((int)BbQueryTypelkpColumn.ShowForCliniciansPages - 1)))?null:(System.Boolean?)reader[((int)BbQueryTypelkpColumn.ShowForCliniciansPages - 1)];
			entity.ShowForPvSystem = (reader.IsDBNull(((int)BbQueryTypelkpColumn.ShowForPvSystem - 1)))?null:(System.Boolean?)reader[((int)BbQueryTypelkpColumn.ShowForPvSystem - 1)];
			entity.ShowForAdminQueryPages = (reader.IsDBNull(((int)BbQueryTypelkpColumn.ShowForAdminQueryPages - 1)))?null:(System.Boolean?)reader[((int)BbQueryTypelkpColumn.ShowForAdminQueryPages - 1)];
			entity.ShowForCentreQueryPages = (reader.IsDBNull(((int)BbQueryTypelkpColumn.ShowForCentreQueryPages - 1)))?null:(System.Boolean?)reader[((int)BbQueryTypelkpColumn.ShowForCentreQueryPages - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbQueryTypelkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.QueryTypeId = (int)dataRow["QueryTypeId"];
			entity.QueryType = Convert.IsDBNull(dataRow["QueryType"]) ? null : (string)dataRow["QueryType"];
			...
			entity.ShowForCliniciansPages = Convert.IsDBNull(dataRow["showForCliniciansPages"]) ? null : (System.Boolean?)dataRow["showForCliniciansPages"];
			entity.ShowForPvSystem = Convert.IsDBNull(dataRow["showForPVSystem"]) ? null : (System.Boolean?)dataRow["showForPVSystem"];
			entity.ShowForAdminQueryPages = Convert.IsDBNull(dataRow["showForAdminQueryPages"]) ? null : (System.Boolean?)dataRow["showForAdminQueryPages"];
			entity.ShowForCentreQueryPages = Convert.IsDBNull(dataRow["showForCentreQueryPages"]) ? null : (System.Boolean?)dataRow["showForCentreQueryPages"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryTypelkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQueryTypelkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryTypelkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByQueryTypeId methods when available
			...
			if (CanDeepLoad(entity, "List<BbQuery>|BbQueryCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbQueryCollection = DataRepository.BbQueryProvider.GetByQueryTypeId(transactionManager, entity.QueryTypeId);
			...
			if (CanDeepLoad(entity, "List<BbQueryForCentre>|BbQueryForCentreCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbQueryForCentreCollection = DataRepository.BbQueryForCentreProvider.GetByQueryTypeId(transactionManager, entity.QueryTypeId);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbQueryTypelkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbQueryTypelkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQueryTypelkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryTypelkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbQuery>
				...
				{	
					...
					{
						if(child.QueryTypeIdSource != null)
						{
							child.QueryTypeId = child.QueryTypeIdSource.QueryTypeId;
						}
						else
						{
							child.QueryTypeId = entity.QueryTypeId;
						}
	...
	#region BbQueryTypelkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbQueryTypelkp</c>
	///</summary>
	public enum BbQueryTypelkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbQueryTypelkp</c> as OneToMany for BbQueryCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbQuery>))]
		BbQueryCollection,
		///<summary>
		/// Collection of <c>BbQueryTypelkp</c> as OneToMany for BbQueryForCentreCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbQueryForCentre>))]
		BbQueryForCentreCollection,
	}
	
	#endregion BbQueryTypelkpChildEntityTypes
	
	#region BbQueryTypelkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbQueryTypelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryTypelkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryTypelkpFilterBuilder : SqlFilterBuilder<BbQueryTypelkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryTypelkpFilterBuilder class.
		/// </summary>
		public BbQueryTypelkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryTypelkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryTypelkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbQueryTypelkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryTypelkpFilterBuilder
	
	#region BbQueryTypelkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbQueryTypelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryTypelkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryTypelkpParameterBuilder : ParameterizedSqlFilterBuilder<BbQueryTypelkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryTypelkpParameterBuilder class.
		/// </summary>
		public BbQueryTypelkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryTypelkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryTypelkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbQueryTypelkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryTypelkpParameterBuilder
	
	#region BbQueryTypelkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbQueryTypelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryTypelkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbQueryTypelkpSortBuilder : SqlSortBuilder<BbQueryTypelkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryTypelkpSqlSortBuilder class.
		/// </summary>
		public BbQueryTypelkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbQueryTypelkpSortBuilder
