...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPatientStatuslkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPatientStatuslkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp, MHS.Badbir.NetTiers.Entities.BbPatientStatuslkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientStatuslkpKey key)
		{
			return Delete(transactionManager, key.Pstatusid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_pstatusid">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Int32 _pstatusid)
		{
			return Delete(null, _pstatusid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Int32 _pstatusid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientStatuslkpKey key, int start, int pageLength)
		{
			return GetByPstatusid(transactionManager, key.Pstatusid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key pk_PatientStatus_pid index.
		/// </summary>
		/// <param name="_pstatusid"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp GetByPstatusid(System.Int32 _pstatusid)
		{
			int count = -1;
			return GetByPstatusid(null,_pstatusid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the pk_PatientStatus_pid index.
		/// </summary>
		/// <param name="_pstatusid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp GetByPstatusid(System.Int32 _pstatusid, int start, int pageLength)
		{
			int count = -1;
			return GetByPstatusid(null, _pstatusid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp GetByPstatusid(TransactionManager transactionManager, System.Int32 _pstatusid)
		{
			int count = -1;
			return GetByPstatusid(transactionManager, _pstatusid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp GetByPstatusid(TransactionManager transactionManager, System.Int32 _pstatusid, int start, int pageLength)
		{
			int count = -1;
			return GetByPstatusid(transactionManager, _pstatusid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp GetByPstatusid(System.Int32 _pstatusid, int start, int pageLength, out int count)
		{
			return GetByPstatusid(null, _pstatusid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp GetByPstatusid(TransactionManager transactionManager, System.Int32 _pstatusid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbPatientStatuslkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPatientStatuslkp&gt;"/></returns>
		public static TList<BbPatientStatuslkp> Fill(IDataReader reader, TList<BbPatientStatuslkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPatientStatuslkp")
					.Append("|").Append((System.Int32)reader[((int)BbPatientStatuslkpColumn.Pstatusid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPatientStatuslkp>(
					key.ToString(), // EntityTrackingKey
					"BbPatientStatuslkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp();
				}
					...
					))
				{
					...
					c.Pstatusid = (System.Int32)reader[((int)BbPatientStatuslkpColumn.Pstatusid - 1)];
					c.Pstatus = (reader.IsDBNull(((int)BbPatientStatuslkpColumn.Pstatus - 1)))?null:(System.String)reader[((int)BbPatientStatuslkpColumn.Pstatus - 1)];
					c.Createdbyid = (System.Int32)reader[((int)BbPatientStatuslkpColumn.Createdbyid - 1)];
					c.Createdbyname = (System.String)reader[((int)BbPatientStatuslkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPatientStatuslkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (System.Int32)reader[((int)BbPatientStatuslkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (System.String)reader[((int)BbPatientStatuslkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPatientStatuslkpColumn.Lastupdateddate - 1)];
					c.IsValidStatus = (reader.IsDBNull(((int)BbPatientStatuslkpColumn.IsValidStatus - 1)))?null:(System.Int32?)reader[((int)BbPatientStatuslkpColumn.IsValidStatus - 1)];
					c.IsNotLiveStatus = (reader.IsDBNull(((int)BbPatientStatuslkpColumn.IsNotLiveStatus - 1)))?null:(System.Int32?)reader[((int)BbPatientStatuslkpColumn.IsNotLiveStatus - 1)];
					c.IsNotTrainingStatus = (reader.IsDBNull(((int)BbPatientStatuslkpColumn.IsNotTrainingStatus - 1)))?null:(System.Int32?)reader[((int)BbPatientStatuslkpColumn.IsNotTrainingStatus - 1)];
					c.ShowInClinicianList = (reader.IsDBNull(((int)BbPatientStatuslkpColumn.ShowInClinicianList - 1)))?null:(System.Int32?)reader[((int)BbPatientStatuslkpColumn.ShowInClinicianList - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Pstatusid = (System.Int32)reader[((int)BbPatientStatuslkpColumn.Pstatusid - 1)];
			entity.Pstatus = (reader.IsDBNull(((int)BbPatientStatuslkpColumn.Pstatus - 1)))?null:(System.String)reader[((int)BbPatientStatuslkpColumn.Pstatus - 1)];
			entity.Createdbyid = (System.Int32)reader[((int)BbPatientStatuslkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (System.String)reader[((int)BbPatientStatuslkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPatientStatuslkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (System.Int32)reader[((int)BbPatientStatuslkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (System.String)reader[((int)BbPatientStatuslkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPatientStatuslkpColumn.Lastupdateddate - 1)];
			entity.IsValidStatus = (reader.IsDBNull(((int)BbPatientStatuslkpColumn.IsValidStatus - 1)))?null:(System.Int32?)reader[((int)BbPatientStatuslkpColumn.IsValidStatus - 1)];
			entity.IsNotLiveStatus = (reader.IsDBNull(((int)BbPatientStatuslkpColumn.IsNotLiveStatus - 1)))?null:(System.Int32?)reader[((int)BbPatientStatuslkpColumn.IsNotLiveStatus - 1)];
			entity.IsNotTrainingStatus = (reader.IsDBNull(((int)BbPatientStatuslkpColumn.IsNotTrainingStatus - 1)))?null:(System.Int32?)reader[((int)BbPatientStatuslkpColumn.IsNotTrainingStatus - 1)];
			entity.ShowInClinicianList = (reader.IsDBNull(((int)BbPatientStatuslkpColumn.ShowInClinicianList - 1)))?null:(System.Int32?)reader[((int)BbPatientStatuslkpColumn.ShowInClinicianList - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Pstatusid = (System.Int32)dataRow["pstatusid"];
			entity.Pstatus = Convert.IsDBNull(dataRow["pstatus"]) ? null : (System.String)dataRow["pstatus"];
			...
			entity.IsValidStatus = Convert.IsDBNull(dataRow["isValidStatus"]) ? null : (System.Int32?)dataRow["isValidStatus"];
			entity.IsNotLiveStatus = Convert.IsDBNull(dataRow["isNotLiveStatus"]) ? null : (System.Int32?)dataRow["isNotLiveStatus"];
			entity.IsNotTrainingStatus = Convert.IsDBNull(dataRow["isNotTrainingStatus"]) ? null : (System.Int32?)dataRow["isNotTrainingStatus"];
			entity.ShowInClinicianList = Convert.IsDBNull(dataRow["showInClinicianList"]) ? null : (System.Int32?)dataRow["showInClinicianList"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByPstatusid methods when available
			
			#region BbPatientCollection
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbPatient>|BbPatientCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbPatientCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbPatientCollection = DataRepository.BbPatientProvider.GetByStatusid(transactionManager, entity.Pstatusid);

				if (deep && entity.BbPatientCollection.Count > 0)
				{
					deepHandles.Add("BbPatientCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbPatient>) DataRepository.BbPatientProvider.DeepLoad,
						new object[] { transactionManager, entity.BbPatientCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbPatient>
				if (CanDeepSave(entity.BbPatientCollection, "List<BbPatient>|BbPatientCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbPatient child in entity.BbPatientCollection)
					{
						if(child.StatusidSource != null)
						{
							child.Statusid = child.StatusidSource.Pstatusid;
						}
						else
						{
							child.Statusid = entity.Pstatusid;
						}

					}

					if (entity.BbPatientCollection.Count > 0 || entity.BbPatientCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbPatientProvider.Save(transactionManager, entity.BbPatientCollection);
						
						deepHandles.Add("BbPatientCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbPatient >) DataRepository.BbPatientProvider.DeepSave,
							new object[] { transactionManager, entity.BbPatientCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	#region BbPatientStatuslkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPatientStatuslkp</c>
	///</summary>
	public enum BbPatientStatuslkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbPatientStatuslkp</c> as OneToMany for BbPatientCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatient>))]
		BbPatientCollection,
	}
	
	#endregion BbPatientStatuslkpChildEntityTypes
	
	#region BbPatientStatuslkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPatientStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientStatuslkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientStatuslkpFilterBuilder : SqlFilterBuilder<BbPatientStatuslkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientStatuslkpFilterBuilder class.
		/// </summary>
		public BbPatientStatuslkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientStatuslkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientStatuslkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPatientStatuslkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientStatuslkpFilterBuilder
	
	#region BbPatientStatuslkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPatientStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientStatuslkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientStatuslkpParameterBuilder : ParameterizedSqlFilterBuilder<BbPatientStatuslkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientStatuslkpParameterBuilder class.
		/// </summary>
		public BbPatientStatuslkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientStatuslkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientStatuslkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPatientStatuslkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientStatuslkpParameterBuilder
	
	#region BbPatientStatuslkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPatientStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientStatuslkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPatientStatuslkpSortBuilder : SqlSortBuilder<BbPatientStatuslkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientStatuslkpSqlSortBuilder class.
		/// </summary>
		public BbPatientStatuslkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPatientStatuslkpSortBuilder
