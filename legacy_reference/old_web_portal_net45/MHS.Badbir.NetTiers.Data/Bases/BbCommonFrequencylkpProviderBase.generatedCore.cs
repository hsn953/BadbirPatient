...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbCommonFrequencylkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbCommonFrequencylkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp, MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkpKey key)
		{
			return Delete(transactionManager, key.Commonfrequencyid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_commonfrequencyid">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _commonfrequencyid)
		{
			return Delete(null, _commonfrequencyid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _commonfrequencyid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkpKey key, int start, int pageLength)
		{
			return GetByCommonfrequencyid(transactionManager, key.Commonfrequencyid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbCommonFrequency index.
		/// </summary>
		/// <param name="_commonfrequencyid"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp GetByCommonfrequencyid(int _commonfrequencyid)
		{
			int count = -1;
			return GetByCommonfrequencyid(null,_commonfrequencyid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbCommonFrequency index.
		/// </summary>
		/// <param name="_commonfrequencyid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp GetByCommonfrequencyid(int _commonfrequencyid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp GetByCommonfrequencyid(TransactionManager transactionManager, int _commonfrequencyid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp GetByCommonfrequencyid(TransactionManager transactionManager, int _commonfrequencyid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp GetByCommonfrequencyid(int _commonfrequencyid, int start, int pageLength, out int count)
		{
			return GetByCommonfrequencyid(null, _commonfrequencyid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp GetByCommonfrequencyid(TransactionManager transactionManager, int _commonfrequencyid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbCommonFrequencylkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbCommonFrequencylkp&gt;"/></returns>
		public static TList<BbCommonFrequencylkp> Fill(IDataReader reader, TList<BbCommonFrequencylkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbCommonFrequencylkp")
					.Append("|").Append((int)reader[((int)BbCommonFrequencylkpColumn.Commonfrequencyid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbCommonFrequencylkp>(
					key.ToString(), // EntityTrackingKey
					"BbCommonFrequencylkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp();
				}
					...
					))
				{
					...
					c.Commonfrequencyid = (int)reader[((int)BbCommonFrequencylkpColumn.Commonfrequencyid - 1)];
					c.Commonfrequency = (string)reader[((int)BbCommonFrequencylkpColumn.Commonfrequency - 1)];
					c.Displayorder = (int)reader[((int)BbCommonFrequencylkpColumn.Displayorder - 1)];
					c.Createdbyid = (int)reader[((int)BbCommonFrequencylkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbCommonFrequencylkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbCommonFrequencylkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbCommonFrequencylkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbCommonFrequencylkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbCommonFrequencylkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Commonfrequencyid = (int)reader[((int)BbCommonFrequencylkpColumn.Commonfrequencyid - 1)];
			entity.Commonfrequency = (string)reader[((int)BbCommonFrequencylkpColumn.Commonfrequency - 1)];
			entity.Displayorder = (int)reader[((int)BbCommonFrequencylkpColumn.Displayorder - 1)];
			entity.Createdbyid = (int)reader[((int)BbCommonFrequencylkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbCommonFrequencylkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbCommonFrequencylkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbCommonFrequencylkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbCommonFrequencylkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbCommonFrequencylkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Commonfrequencyid = (int)dataRow["commonfrequencyid"];
			entity.Commonfrequency = (string)dataRow["commonfrequency"];
			entity.Displayorder = (int)dataRow["displayorder"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByCommonfrequencyid methods when available
			...
			if (CanDeepLoad(entity, "List<BbPatientdrug>|BbPatientdrugCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPatientdrugCollection = DataRepository.BbPatientdrugProvider.GetByCommonfrequencyid(transactionManager, entity.Commonfrequencyid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbPatientdrug>
				...
				{	
					...
					{
						if(child.CommonfrequencyidSource != null)
						{
							child.Commonfrequencyid = child.CommonfrequencyidSource.Commonfrequencyid;
						}
						else
						{
							child.Commonfrequencyid = entity.Commonfrequencyid;
						}
	...
	#region BbCommonFrequencylkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbCommonFrequencylkp</c>
	///</summary>
	public enum BbCommonFrequencylkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbCommonFrequencylkp</c> as OneToMany for BbPatientdrugCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientdrug>))]
		BbPatientdrugCollection,
	}
	
	#endregion BbCommonFrequencylkpChildEntityTypes
	
	#region BbCommonFrequencylkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbCommonFrequencylkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCommonFrequencylkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbCommonFrequencylkpFilterBuilder : SqlFilterBuilder<BbCommonFrequencylkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCommonFrequencylkpFilterBuilder class.
		/// </summary>
		public BbCommonFrequencylkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbCommonFrequencylkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbCommonFrequencylkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbCommonFrequencylkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbCommonFrequencylkpFilterBuilder
	
	#region BbCommonFrequencylkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbCommonFrequencylkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCommonFrequencylkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbCommonFrequencylkpParameterBuilder : ParameterizedSqlFilterBuilder<BbCommonFrequencylkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCommonFrequencylkpParameterBuilder class.
		/// </summary>
		public BbCommonFrequencylkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbCommonFrequencylkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbCommonFrequencylkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbCommonFrequencylkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbCommonFrequencylkpParameterBuilder
	
	#region BbCommonFrequencylkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbCommonFrequencylkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCommonFrequencylkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbCommonFrequencylkpSortBuilder : SqlSortBuilder<BbCommonFrequencylkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCommonFrequencylkpSqlSortBuilder class.
		/// </summary>
		public BbCommonFrequencylkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbCommonFrequencylkpSortBuilder
