...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbLesionlkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbLesionlkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbLesionlkp, MHS.Badbir.NetTiers.Entities.BbLesionlkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbLesionlkpKey key)
		{
			return Delete(transactionManager, key.Lesionid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_lesionid">Lesion Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _lesionid)
		{
			return Delete(null, _lesionid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _lesionid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbLesionlkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbLesionlkpKey key, int start, int pageLength)
		{
			return GetByLesionid(transactionManager, key.Lesionid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbLesionlkp index.
		/// </summary>
		/// <param name="_lesionid">Lesion Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbLesionlkp GetByLesionid(int _lesionid)
		{
			int count = -1;
			return GetByLesionid(null,_lesionid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbLesionlkp index.
		/// </summary>
		/// <param name="_lesionid">Lesion Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbLesionlkp GetByLesionid(int _lesionid, int start, int pageLength)
		{
			int count = -1;
			return GetByLesionid(null, _lesionid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbLesionlkp GetByLesionid(TransactionManager transactionManager, int _lesionid)
		{
			int count = -1;
			return GetByLesionid(transactionManager, _lesionid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbLesionlkp GetByLesionid(TransactionManager transactionManager, int _lesionid, int start, int pageLength)
		{
			int count = -1;
			return GetByLesionid(transactionManager, _lesionid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbLesionlkp GetByLesionid(int _lesionid, int start, int pageLength, out int count)
		{
			return GetByLesionid(null, _lesionid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbLesionlkp GetByLesionid(TransactionManager transactionManager, int _lesionid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbLesionlkp&gt; From a DataReader.
		/// </summary>
		...
		public static TList<BbLesionlkp> Fill(IDataReader reader, TList<BbLesionlkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbLesionlkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbLesionlkp")
					.Append("|").Append((int)reader[((int)BbLesionlkpColumn.Lesionid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbLesionlkp>(
					key.ToString(), // EntityTrackingKey
					"BbLesionlkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbLesionlkp();
				}
					...
					))
				{
					...
					c.Lesionid = (int)reader[((int)BbLesionlkpColumn.Lesionid - 1)];
					c.Lesiondescription = (reader.IsDBNull(((int)BbLesionlkpColumn.Lesiondescription - 1)))?null:(string)reader[((int)BbLesionlkpColumn.Lesiondescription - 1)];
					c.Createdbyid = (int)reader[((int)BbLesionlkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbLesionlkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbLesionlkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbLesionlkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbLesionlkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbLesionlkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbLesionlkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Lesionid = (int)reader[((int)BbLesionlkpColumn.Lesionid - 1)];
			entity.Lesiondescription = (reader.IsDBNull(((int)BbLesionlkpColumn.Lesiondescription - 1)))?null:(string)reader[((int)BbLesionlkpColumn.Lesiondescription - 1)];
			entity.Createdbyid = (int)reader[((int)BbLesionlkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbLesionlkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbLesionlkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbLesionlkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbLesionlkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbLesionlkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbLesionlkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Lesionid = (int)dataRow["lesionid"];
			entity.Lesiondescription = Convert.IsDBNull(dataRow["lesiondescription"]) ? null : (string)dataRow["lesiondescription"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbLesionlkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbLesionlkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbLesionlkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbLesionlkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbLesionlkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbLesionlkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbLesionlkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbLesionlkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbLesionlkp</c>
	///</summary>
	public enum BbLesionlkpChildEntityTypes
	{
	}
	
	#endregion BbLesionlkpChildEntityTypes
	
	#region BbLesionlkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbLesionlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbLesionlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbLesionlkpFilterBuilder : SqlFilterBuilder<BbLesionlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbLesionlkpFilterBuilder class.
		/// </summary>
		public BbLesionlkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbLesionlkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbLesionlkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbLesionlkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbLesionlkpFilterBuilder
	
	#region BbLesionlkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbLesionlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbLesionlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbLesionlkpParameterBuilder : ParameterizedSqlFilterBuilder<BbLesionlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbLesionlkpParameterBuilder class.
		/// </summary>
		public BbLesionlkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbLesionlkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbLesionlkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbLesionlkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbLesionlkpParameterBuilder
	
	#region BbLesionlkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbLesionlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbLesionlkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbLesionlkpSortBuilder : SqlSortBuilder<BbLesionlkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbLesionlkpSqlSortBuilder class.
		/// </summary>
		public BbLesionlkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbLesionlkpSortBuilder
