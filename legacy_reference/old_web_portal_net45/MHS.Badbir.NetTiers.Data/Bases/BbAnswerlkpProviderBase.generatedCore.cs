...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbAnswerlkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbAnswerlkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbAnswerlkp, MHS.Badbir.NetTiers.Entities.BbAnswerlkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAnswerlkpKey key)
		{
		...
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_answerid">Answer Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _answerid)
		{
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _answerid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbAnswerlkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAnswerlkpKey key, int start, int pageLength)
		{
			return GetByAnswerid(transactionManager, key.Answerid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbAnswerlkp index.
		/// </summary>
		/// <param name="_answerid">Answer Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAnswerlkp GetByAnswerid(int _answerid)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbAnswerlkp index.
		/// </summary>
		/// <param name="_answerid">Answer Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAnswerlkp GetByAnswerid(int _answerid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAnswerlkp GetByAnswerid(TransactionManager transactionManager, int _answerid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAnswerlkp GetByAnswerid(TransactionManager transactionManager, int _answerid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAnswerlkp GetByAnswerid(int _answerid, int start, int pageLength, out int count)
		{
			return GetByAnswerid(null, _answerid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbAnswerlkp GetByAnswerid(TransactionManager transactionManager, int _answerid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbAnswerlkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbAnswerlkp&gt;"/></returns>
		public static TList<BbAnswerlkp> Fill(IDataReader reader, TList<BbAnswerlkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbAnswerlkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbAnswerlkp")
					.Append("|").Append((int)reader[((int)BbAnswerlkpColumn.Answerid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbAnswerlkp>(
					key.ToString(), // EntityTrackingKey
					"BbAnswerlkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbAnswerlkp();
				}
					...
					))
				{
					...
					c.Answerid = (int)reader[((int)BbAnswerlkpColumn.Answerid - 1)];
					c.Answerdescription = (string)reader[((int)BbAnswerlkpColumn.Answerdescription - 1)];
					c.Createdbyid = (int)reader[((int)BbAnswerlkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbAnswerlkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbAnswerlkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbAnswerlkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbAnswerlkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbAnswerlkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbAnswerlkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Answerid = (int)reader[((int)BbAnswerlkpColumn.Answerid - 1)];
			entity.Answerdescription = (string)reader[((int)BbAnswerlkpColumn.Answerdescription - 1)];
			entity.Createdbyid = (int)reader[((int)BbAnswerlkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbAnswerlkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbAnswerlkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbAnswerlkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbAnswerlkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbAnswerlkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbAnswerlkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Answerid = (int)dataRow["answerid"];
			entity.Answerdescription = (string)dataRow["answerdescription"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbAnswerlkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbAnswerlkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAnswerlkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbAnswerlkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbAnswerlkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbAnswerlkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAnswerlkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbAnswerlkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbAnswerlkp</c>
	///</summary>
	public enum BbAnswerlkpChildEntityTypes
	{
	}
	
	#endregion BbAnswerlkpChildEntityTypes
	
	#region BbAnswerlkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbAnswerlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbAnswerlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbAnswerlkpFilterBuilder : SqlFilterBuilder<BbAnswerlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbAnswerlkpFilterBuilder class.
		/// </summary>
		public BbAnswerlkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbAnswerlkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbAnswerlkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbAnswerlkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbAnswerlkpFilterBuilder
	
	#region BbAnswerlkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbAnswerlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbAnswerlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbAnswerlkpParameterBuilder : ParameterizedSqlFilterBuilder<BbAnswerlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbAnswerlkpParameterBuilder class.
		/// </summary>
		public BbAnswerlkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbAnswerlkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbAnswerlkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbAnswerlkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbAnswerlkpParameterBuilder
	
	#region BbAnswerlkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbAnswerlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbAnswerlkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbAnswerlkpSortBuilder : SqlSortBuilder<BbAnswerlkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbAnswerlkpSqlSortBuilder class.
		/// </summary>
		public BbAnswerlkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbAnswerlkpSortBuilder
