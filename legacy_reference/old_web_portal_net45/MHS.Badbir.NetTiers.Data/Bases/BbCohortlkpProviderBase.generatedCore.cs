...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbCohortlkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbCohortlkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbCohortlkp, MHS.Badbir.NetTiers.Entities.BbCohortlkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCohortlkpKey key)
		{
			return Delete(transactionManager, key.Cohortid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_cohortid">Cohort Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _cohortid)
		{
			return Delete(null, _cohortid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _cohortid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbCohortlkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCohortlkpKey key, int start, int pageLength)
		{
			return GetByCohortid(transactionManager, key.Cohortid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbCohortlkp index.
		/// </summary>
		/// <param name="_cohortid">Cohort Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCohortlkp GetByCohortid(int _cohortid)
		{
			int count = -1;
			return GetByCohortid(null,_cohortid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbCohortlkp index.
		/// </summary>
		/// <param name="_cohortid">Cohort Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCohortlkp GetByCohortid(int _cohortid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCohortlkp GetByCohortid(TransactionManager transactionManager, int _cohortid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCohortlkp GetByCohortid(TransactionManager transactionManager, int _cohortid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCohortlkp GetByCohortid(int _cohortid, int start, int pageLength, out int count)
		{
			return GetByCohortid(null, _cohortid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbCohortlkp GetByCohortid(TransactionManager transactionManager, int _cohortid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbCohortlkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbCohortlkp&gt;"/></returns>
		public static TList<BbCohortlkp> Fill(IDataReader reader, TList<BbCohortlkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbCohortlkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbCohortlkp")
					.Append("|").Append((int)reader[((int)BbCohortlkpColumn.Cohortid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbCohortlkp>(
					key.ToString(), // EntityTrackingKey
					"BbCohortlkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbCohortlkp();
				}
					...
					))
				{
					...
					c.Cohortid = (int)reader[((int)BbCohortlkpColumn.Cohortid - 1)];
					c.Cohort = (reader.IsDBNull(((int)BbCohortlkpColumn.Cohort - 1)))?null:(string)reader[((int)BbCohortlkpColumn.Cohort - 1)];
					c.Createdbyid = (int)reader[((int)BbCohortlkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbCohortlkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbCohortlkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbCohortlkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbCohortlkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbCohortlkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbCohortlkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Cohortid = (int)reader[((int)BbCohortlkpColumn.Cohortid - 1)];
			entity.Cohort = (reader.IsDBNull(((int)BbCohortlkpColumn.Cohort - 1)))?null:(string)reader[((int)BbCohortlkpColumn.Cohort - 1)];
			entity.Createdbyid = (int)reader[((int)BbCohortlkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbCohortlkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbCohortlkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbCohortlkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbCohortlkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbCohortlkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbCohortlkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Cohortid = (int)dataRow["cohortid"];
			entity.Cohort = Convert.IsDBNull(dataRow["cohort"]) ? null : (string)dataRow["cohort"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCohortlkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbCohortlkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCohortlkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByCohortid methods when available
			...
			if (CanDeepLoad(entity, "List<BbPatientCohortHistory>|BbPatientCohortHistoryCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPatientCohortHistoryCollection = DataRepository.BbPatientCohortHistoryProvider.GetByCohortid(transactionManager, entity.Cohortid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbCohortlkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbCohortlkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbCohortlkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCohortlkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbPatientCohortHistory>
				...
				{	
					...
					{
						if(child.CohortidSource != null)
						{
							child.Cohortid = child.CohortidSource.Cohortid;
						}
						else
						{
							child.Cohortid = entity.Cohortid;
						}
	...
	#region BbCohortlkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbCohortlkp</c>
	///</summary>
	public enum BbCohortlkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbCohortlkp</c> as OneToMany for BbPatientCohortHistoryCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientCohortHistory>))]
		BbPatientCohortHistoryCollection,
	}
	
	#endregion BbCohortlkpChildEntityTypes
	
	#region BbCohortlkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbCohortlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCohortlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbCohortlkpFilterBuilder : SqlFilterBuilder<BbCohortlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCohortlkpFilterBuilder class.
		/// </summary>
		public BbCohortlkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbCohortlkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbCohortlkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbCohortlkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbCohortlkpFilterBuilder
	
	#region BbCohortlkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbCohortlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCohortlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbCohortlkpParameterBuilder : ParameterizedSqlFilterBuilder<BbCohortlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCohortlkpParameterBuilder class.
		/// </summary>
		public BbCohortlkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbCohortlkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbCohortlkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbCohortlkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbCohortlkpParameterBuilder
	
	#region BbCohortlkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbCohortlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCohortlkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbCohortlkpSortBuilder : SqlSortBuilder<BbCohortlkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCohortlkpSqlSortBuilder class.
		/// </summary>
		public BbCohortlkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbCohortlkpSortBuilder
