...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbSaeClinicianlkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbSaeClinicianlkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp, MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkpKey key)
		{
			return Delete(transactionManager, key.Saeid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_saeid">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _saeid)
		{
			return Delete(null, _saeid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _saeid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkpKey key, int start, int pageLength)
		{
			return GetBySaeid(transactionManager, key.Saeid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbSaeClinicianlkp index.
		/// </summary>
		/// <param name="_saeid"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp GetBySaeid(int _saeid)
		{
			int count = -1;
			return GetBySaeid(null,_saeid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbSaeClinicianlkp index.
		/// </summary>
		/// <param name="_saeid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp GetBySaeid(int _saeid, int start, int pageLength)
		{
			int count = -1;
			return GetBySaeid(null, _saeid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp GetBySaeid(TransactionManager transactionManager, int _saeid)
		{
			int count = -1;
			return GetBySaeid(transactionManager, _saeid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp GetBySaeid(TransactionManager transactionManager, int _saeid, int start, int pageLength)
		{
			int count = -1;
			return GetBySaeid(transactionManager, _saeid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp GetBySaeid(int _saeid, int start, int pageLength, out int count)
		{
			return GetBySaeid(null, _saeid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp GetBySaeid(TransactionManager transactionManager, int _saeid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbSaeClinicianlkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbSaeClinicianlkp&gt;"/></returns>
		public static TList<BbSaeClinicianlkp> Fill(IDataReader reader, TList<BbSaeClinicianlkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbSaeClinicianlkp")
					.Append("|").Append((int)reader[((int)BbSaeClinicianlkpColumn.Saeid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbSaeClinicianlkp>(
					key.ToString(), // EntityTrackingKey
					"BbSaeClinicianlkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp();
				}
					...
					))
				{
					...
					c.Saeid = (int)reader[((int)BbSaeClinicianlkpColumn.Saeid - 1)];
					c.Saecode = (reader.IsDBNull(((int)BbSaeClinicianlkpColumn.Saecode - 1)))?null:(string)reader[((int)BbSaeClinicianlkpColumn.Saecode - 1)];
					c.Createdbyid = (int)reader[((int)BbSaeClinicianlkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbSaeClinicianlkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbSaeClinicianlkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbSaeClinicianlkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbSaeClinicianlkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbSaeClinicianlkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Saeid = (int)reader[((int)BbSaeClinicianlkpColumn.Saeid - 1)];
			entity.Saecode = (reader.IsDBNull(((int)BbSaeClinicianlkpColumn.Saecode - 1)))?null:(string)reader[((int)BbSaeClinicianlkpColumn.Saecode - 1)];
			entity.Createdbyid = (int)reader[((int)BbSaeClinicianlkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbSaeClinicianlkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbSaeClinicianlkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbSaeClinicianlkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbSaeClinicianlkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbSaeClinicianlkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Saeid = (int)dataRow["saeid"];
			entity.Saecode = Convert.IsDBNull(dataRow["saecode"]) ? null : (string)dataRow["saecode"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbSaeClinicianlkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbSaeClinicianlkp</c>
	///</summary>
	public enum BbSaeClinicianlkpChildEntityTypes
	{
	}
	
	#endregion BbSaeClinicianlkpChildEntityTypes
	
	#region BbSaeClinicianlkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbSaeClinicianlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbSaeClinicianlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbSaeClinicianlkpFilterBuilder : SqlFilterBuilder<BbSaeClinicianlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbSaeClinicianlkpFilterBuilder class.
		/// </summary>
		public BbSaeClinicianlkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbSaeClinicianlkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbSaeClinicianlkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbSaeClinicianlkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbSaeClinicianlkpFilterBuilder
	
	#region BbSaeClinicianlkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbSaeClinicianlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbSaeClinicianlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbSaeClinicianlkpParameterBuilder : ParameterizedSqlFilterBuilder<BbSaeClinicianlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbSaeClinicianlkpParameterBuilder class.
		/// </summary>
		public BbSaeClinicianlkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbSaeClinicianlkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbSaeClinicianlkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbSaeClinicianlkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbSaeClinicianlkpParameterBuilder
	
	#region BbSaeClinicianlkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbSaeClinicianlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbSaeClinicianlkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbSaeClinicianlkpSortBuilder : SqlSortBuilder<BbSaeClinicianlkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbSaeClinicianlkpSqlSortBuilder class.
		/// </summary>
		public BbSaeClinicianlkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbSaeClinicianlkpSortBuilder
