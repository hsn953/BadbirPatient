...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbCentreProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbCentreProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbCentre, MHS.Badbir.NetTiers.Entities.BbCentreKey>
	{		
		...
		/// <returns>Returns a typed collection of BbCentre objects.</returns>
		public TList<BbCentre> GetByUseridFromBbAdditionalUserAndCentre(System.Guid _userid)
		{
			int count = -1;
			return GetByUseridFromBbAdditionalUserAndCentre(null,_userid, 0, int.MaxValue, out count);
			
		}
		
		/// <summary>
		///		Gets MHS.Badbir.NetTiers.Entities.BbCentre objects from the datasource by userid in the
		///		bbAdditionalUserAndCentre table. Table bbCentre is related to table bbAdditionalUserDetail
		///		through the (M:N) relationship defined in the bbAdditionalUserAndCentre table.
		/// </summary>
		...
		/// <param name="_userid">User Id</param>
		/// <remarks></remarks>
		/// <returns>Returns a TList of BbCentre objects.</returns>
		public TList<BbCentre> GetByUseridFromBbAdditionalUserAndCentre(System.Guid _userid, int start, int pageLength)
		{
			int count = -1;
			return GetByUseridFromBbAdditionalUserAndCentre(null, _userid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbCentre objects.</returns>
		public TList<BbCentre> GetByUseridFromBbAdditionalUserAndCentre(TransactionManager transactionManager, System.Guid _userid)
		{
			int count = -1;
			return GetByUseridFromBbAdditionalUserAndCentre(transactionManager, _userid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbCentre objects.</returns>
		public TList<BbCentre> GetByUseridFromBbAdditionalUserAndCentre(TransactionManager transactionManager, System.Guid _userid,int start, int pageLength)
		{
			int count = -1;
			return GetByUseridFromBbAdditionalUserAndCentre(transactionManager, _userid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbCentre objects.</returns>
		public TList<BbCentre> GetByUseridFromBbAdditionalUserAndCentre(System.Guid _userid,int start, int pageLength, out int count)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a TList of BbCentre objects.</returns>
		public abstract TList<BbCentre> GetByUseridFromBbAdditionalUserAndCentre(TransactionManager transactionManager,System.Guid _userid, int start, int pageLength, out int count);
		...
		/// <returns>Returns a typed collection of BbCentre objects.</returns>
		public TList<BbCentre> GetByExternalStudyIdFromBbCentreExternalStudyLink(System.Int32 _externalStudyId)
		{
			int count = -1;
			return GetByExternalStudyIdFromBbCentreExternalStudyLink(null,_externalStudyId, 0, int.MaxValue, out count);
			
		}
		
		/// <summary>
		///		Gets MHS.Badbir.NetTiers.Entities.BbCentre objects from the datasource by externalStudyID in the
		///		bbCentreExternalStudyLink table. Table bbCentre is related to table bbExternalStudyLkp
		///		through the (M:N) relationship defined in the bbCentreExternalStudyLink table.
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		...
		/// <remarks></remarks>
		/// <returns>Returns a TList of BbCentre objects.</returns>
		public TList<BbCentre> GetByExternalStudyIdFromBbCentreExternalStudyLink(System.Int32 _externalStudyId, int start, int pageLength)
		{
			int count = -1;
			return GetByExternalStudyIdFromBbCentreExternalStudyLink(null, _externalStudyId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbCentre objects.</returns>
		public TList<BbCentre> GetByExternalStudyIdFromBbCentreExternalStudyLink(TransactionManager transactionManager, System.Int32 _externalStudyId)
		{
			int count = -1;
			return GetByExternalStudyIdFromBbCentreExternalStudyLink(transactionManager, _externalStudyId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbCentre objects.</returns>
		public TList<BbCentre> GetByExternalStudyIdFromBbCentreExternalStudyLink(TransactionManager transactionManager, System.Int32 _externalStudyId,int start, int pageLength)
		{
			int count = -1;
			return GetByExternalStudyIdFromBbCentreExternalStudyLink(transactionManager, _externalStudyId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbCentre objects.</returns>
		public TList<BbCentre> GetByExternalStudyIdFromBbCentreExternalStudyLink(System.Int32 _externalStudyId,int start, int pageLength, out int count)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a TList of BbCentre objects.</returns>
		public abstract TList<BbCentre> GetByExternalStudyIdFromBbCentreExternalStudyLink(TransactionManager transactionManager,System.Int32 _externalStudyId, int start, int pageLength, out int count);
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentreKey key)
		{
			return Delete(transactionManager, key.Centreid);
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Int32 _centreid)
		{
			return Delete(null, _centreid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Int32 _centreid);		
		...
		public TList<BbCentre> GetByCentreregionid(System.Int32? _centreregionid)
		{
			int count = -1;
			return GetByCentreregionid(_centreregionid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		/// <remarks></remarks>
		public TList<BbCentre> GetByCentreregionid(TransactionManager transactionManager, System.Int32? _centreregionid)
		{
			int count = -1;
			return GetByCentreregionid(transactionManager, _centreregionid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByCentreregionid(TransactionManager transactionManager, System.Int32? _centreregionid, int start, int pageLength)
		{
			int count = -1;
			return GetByCentreregionid(transactionManager, _centreregionid, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbCentre_bbCentreRegionlkp key.
		///		fkBbCentreBbCentreRegionlkp Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_centreregionid">Region</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByCentreregionid(System.Int32? _centreregionid, int start, int pageLength)
		{
			int count =  -1;
			return GetByCentreregionid(null, _centreregionid, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByCentreregionid(System.Int32? _centreregionid, int start, int pageLength,out int count)
		{
			return GetByCentreregionid(null, _centreregionid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public abstract TList<BbCentre> GetByCentreregionid(TransactionManager transactionManager, System.Int32? _centreregionid, int start, int pageLength, out int count);
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByCentrestatusid(System.Int32? _centrestatusid)
		{
			int count = -1;
			return GetByCentrestatusid(_centrestatusid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		/// <remarks></remarks>
		public TList<BbCentre> GetByCentrestatusid(TransactionManager transactionManager, System.Int32? _centrestatusid)
		{
			int count = -1;
			return GetByCentrestatusid(transactionManager, _centrestatusid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByCentrestatusid(TransactionManager transactionManager, System.Int32? _centrestatusid, int start, int pageLength)
		{
			int count = -1;
			return GetByCentrestatusid(transactionManager, _centrestatusid, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbCentre_bbCentrestatus key.
		///		fkBbCentreBbCentrestatus Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_centrestatusid">Status</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByCentrestatusid(System.Int32? _centrestatusid, int start, int pageLength)
		{
			int count =  -1;
			return GetByCentrestatusid(null, _centrestatusid, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByCentrestatusid(System.Int32? _centrestatusid, int start, int pageLength,out int count)
		{
			return GetByCentrestatusid(null, _centrestatusid, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public abstract TList<BbCentre> GetByCentrestatusid(TransactionManager transactionManager, System.Int32? _centrestatusid, int start, int pageLength, out int count);
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByUkcrNregionid(System.Int32? _ukcrNregionid)
		{
			int count = -1;
			return GetByUkcrNregionid(_ukcrNregionid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		/// <remarks></remarks>
		public TList<BbCentre> GetByUkcrNregionid(TransactionManager transactionManager, System.Int32? _ukcrNregionid)
		{
			int count = -1;
			return GetByUkcrNregionid(transactionManager, _ukcrNregionid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByUkcrNregionid(TransactionManager transactionManager, System.Int32? _ukcrNregionid, int start, int pageLength)
		{
			int count = -1;
			return GetByUkcrNregionid(transactionManager, _ukcrNregionid, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbCentre_bbUKCRNregionlkp key.
		///		fkBbCentreBbUkcrNregionlkp Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_ukcrNregionid">UKCRN region</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByUkcrNregionid(System.Int32? _ukcrNregionid, int start, int pageLength)
		{
			int count =  -1;
			return GetByUkcrNregionid(null, _ukcrNregionid, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public TList<BbCentre> GetByUkcrNregionid(System.Int32? _ukcrNregionid, int start, int pageLength,out int count)
		{
			return GetByUkcrNregionid(null, _ukcrNregionid, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbCentre objects.</returns>
		public abstract TList<BbCentre> GetByUkcrNregionid(TransactionManager transactionManager, System.Int32? _ukcrNregionid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbCentre Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentreKey key, int start, int pageLength)
		{
			return GetByCentreid(transactionManager, key.Centreid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbCentre index.
		/// </summary>
		...
		public MHS.Badbir.NetTiers.Entities.BbCentre GetByCentreid(System.Int32 _centreid)
		{
			int count = -1;
			return GetByCentreid(null,_centreid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentre GetByCentreid(System.Int32 _centreid, int start, int pageLength)
		{
			int count = -1;
			return GetByCentreid(null, _centreid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentre GetByCentreid(TransactionManager transactionManager, System.Int32 _centreid)
		{
			int count = -1;
			return GetByCentreid(transactionManager, _centreid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentre GetByCentreid(TransactionManager transactionManager, System.Int32 _centreid, int start, int pageLength)
		{
			int count = -1;
			return GetByCentreid(transactionManager, _centreid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentre GetByCentreid(System.Int32 _centreid, int start, int pageLength, out int count)
		{
			return GetByCentreid(null, _centreid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbCentre GetByCentreid(TransactionManager transactionManager, System.Int32 _centreid, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key Uniquealtcentreid index.
		/// </summary>
		/// <param name="_altCentreId"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentre GetByAltCentreId(System.String _altCentreId)
		{
			int count = -1;
			return GetByAltCentreId(null,_altCentreId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentre GetByAltCentreId(System.String _altCentreId, int start, int pageLength)
		{
			int count = -1;
			return GetByAltCentreId(null, _altCentreId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentre GetByAltCentreId(TransactionManager transactionManager, System.String _altCentreId)
		{
			int count = -1;
			return GetByAltCentreId(transactionManager, _altCentreId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentre GetByAltCentreId(TransactionManager transactionManager, System.String _altCentreId, int start, int pageLength)
		{
			int count = -1;
			return GetByAltCentreId(transactionManager, _altCentreId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentre GetByAltCentreId(System.String _altCentreId, int start, int pageLength, out int count)
		{
			return GetByAltCentreId(null, _altCentreId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbCentre GetByAltCentreId(TransactionManager transactionManager, System.String _altCentreId, int start, int pageLength, out int count);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Conventional(System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Conventional(int start, int pageLength, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Conventional(TransactionManager transactionManager, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public abstract DataSet Patientdrug_GetByFupId_Conventional(TransactionManager transactionManager, int start, int pageLength , System.Int32? fupId);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Current(System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Current(int start, int pageLength, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Current(TransactionManager transactionManager, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public abstract DataSet Patientdrug_GetByFupId_Current(TransactionManager transactionManager, int start, int pageLength , System.Int32? fupId);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_SmallMolecule(System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_SmallMolecule(int start, int pageLength, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_SmallMolecule(TransactionManager transactionManager, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public abstract DataSet Patientdrug_GetByFupId_SmallMolecule(TransactionManager transactionManager, int start, int pageLength , System.Int32? fupId);
		...
		public TList<BbCentre> Centre_GetByBADBIRUserid(System.Int32? badbirUserid, System.Int32? isTraining)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbCentre&gt;"/> instance.</returns>
		public TList<BbCentre> Centre_GetByBADBIRUserid(int start, int pageLength, System.Int32? badbirUserid, System.Int32? isTraining)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbCentre&gt;"/> instance.</returns>
		public TList<BbCentre> Centre_GetByBADBIRUserid(TransactionManager transactionManager, System.Int32? badbirUserid, System.Int32? isTraining)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbCentre&gt;"/> instance.</returns>
		public abstract TList<BbCentre> Centre_GetByBADBIRUserid(TransactionManager transactionManager, int start, int pageLength , System.Int32? badbirUserid, System.Int32? isTraining);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbCentre&gt;"/> instance.</returns>
		public TList<BbCentre> Centre_GetByBADBIRUseridAndTraining(System.Int32? badbirUserid, System.Int32? isTraining)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbCentre&gt;"/> instance.</returns>
		public TList<BbCentre> Centre_GetByBADBIRUseridAndTraining(int start, int pageLength, System.Int32? badbirUserid, System.Int32? isTraining)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbCentre&gt;"/> instance.</returns>
		public TList<BbCentre> Centre_GetByBADBIRUseridAndTraining(TransactionManager transactionManager, System.Int32? badbirUserid, System.Int32? isTraining)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbCentre&gt;"/> instance.</returns>
		public abstract TList<BbCentre> Centre_GetByBADBIRUseridAndTraining(TransactionManager transactionManager, int start, int pageLength , System.Int32? badbirUserid, System.Int32? isTraining);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Biologic(System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Biologic(int start, int pageLength, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Biologic(TransactionManager transactionManager, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public abstract DataSet Patientdrug_GetByFupId_Biologic(TransactionManager transactionManager, int start, int pageLength , System.Int32? fupId);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet PatientDrug_GetByFupaeid_DrugsAtTimeOfEvent(System.Int32? fupaeid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet PatientDrug_GetByFupaeid_DrugsAtTimeOfEvent(int start, int pageLength, System.Int32? fupaeid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet PatientDrug_GetByFupaeid_DrugsAtTimeOfEvent(TransactionManager transactionManager, System.Int32? fupaeid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public abstract DataSet PatientDrug_GetByFupaeid_DrugsAtTimeOfEvent(TransactionManager transactionManager, int start, int pageLength , System.Int32? fupaeid);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Concomitant(System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Concomitant(int start, int pageLength, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Concomitant(TransactionManager transactionManager, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public abstract DataSet Patientdrug_GetByFupId_Concomitant(TransactionManager transactionManager, int start, int pageLength , System.Int32? fupId);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Previous(System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Previous(int start, int pageLength, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet Patientdrug_GetByFupId_Previous(TransactionManager transactionManager, System.Int32? fupId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public abstract DataSet Patientdrug_GetByFupId_Previous(TransactionManager transactionManager, int start, int pageLength , System.Int32? fupId);
		...
		/// <summary>
		/// Fill a TList&lt;BbCentre&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbCentre&gt;"/></returns>
		public static TList<BbCentre> Fill(IDataReader reader, TList<BbCentre> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbCentre c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbCentre")
					.Append("|").Append((System.Int32)reader[((int)BbCentreColumn.Centreid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbCentre>(
					key.ToString(), // EntityTrackingKey
					"BbCentre",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbCentre();
				}
					...
					))
				{
					...
					c.Centreid = (System.Int32)reader[((int)BbCentreColumn.Centreid - 1)];
					c.Centrename = (System.String)reader[((int)BbCentreColumn.Centrename - 1)];
					c.Address1 = (reader.IsDBNull(((int)BbCentreColumn.Address1 - 1)))?null:(System.String)reader[((int)BbCentreColumn.Address1 - 1)];
					c.Address2 = (reader.IsDBNull(((int)BbCentreColumn.Address2 - 1)))?null:(System.String)reader[((int)BbCentreColumn.Address2 - 1)];
					c.Address3 = (reader.IsDBNull(((int)BbCentreColumn.Address3 - 1)))?null:(System.String)reader[((int)BbCentreColumn.Address3 - 1)];
					c.Address4 = (reader.IsDBNull(((int)BbCentreColumn.Address4 - 1)))?null:(System.String)reader[((int)BbCentreColumn.Address4 - 1)];
					c.Address5 = (reader.IsDBNull(((int)BbCentreColumn.Address5 - 1)))?null:(System.String)reader[((int)BbCentreColumn.Address5 - 1)];
					c.Postcode = (reader.IsDBNull(((int)BbCentreColumn.Postcode - 1)))?null:(System.String)reader[((int)BbCentreColumn.Postcode - 1)];
					c.Mapref = (reader.IsDBNull(((int)BbCentreColumn.Mapref - 1)))?null:(System.String)reader[((int)BbCentreColumn.Mapref - 1)];
					c.Centreregionid = (reader.IsDBNull(((int)BbCentreColumn.Centreregionid - 1)))?null:(System.Int32?)reader[((int)BbCentreColumn.Centreregionid - 1)];
					c.Centrestatusid = (reader.IsDBNull(((int)BbCentreColumn.Centrestatusid - 1)))?null:(System.Int32?)reader[((int)BbCentreColumn.Centrestatusid - 1)];
					c.Piid = (reader.IsDBNull(((int)BbCentreColumn.Piid - 1)))?null:(System.Int32?)reader[((int)BbCentreColumn.Piid - 1)];
					c.Picontactdate = (reader.IsDBNull(((int)BbCentreColumn.Picontactdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Picontactdate - 1)];
					c.Ssisubmittedrddate = (reader.IsDBNull(((int)BbCentreColumn.Ssisubmittedrddate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Ssisubmittedrddate - 1)];
					c.Lrecapproveddate = (reader.IsDBNull(((int)BbCentreColumn.Lrecapproveddate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Lrecapproveddate - 1)];
					c.Rdapproveddate = (reader.IsDBNull(((int)BbCentreColumn.Rdapproveddate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Rdapproveddate - 1)];
					c.Setupdate = (reader.IsDBNull(((int)BbCentreColumn.Setupdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Setupdate - 1)];
					c.Pat1recruiteddate = (reader.IsDBNull(((int)BbCentreColumn.Pat1recruiteddate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Pat1recruiteddate - 1)];
					c.Financecontact = (reader.IsDBNull(((int)BbCentreColumn.Financecontact - 1)))?null:(System.String)reader[((int)BbCentreColumn.Financecontact - 1)];
					c.Contactdetails = (reader.IsDBNull(((int)BbCentreColumn.Contactdetails - 1)))?null:(System.String)reader[((int)BbCentreColumn.Contactdetails - 1)];
					c.Accountnumber = (reader.IsDBNull(((int)BbCentreColumn.Accountnumber - 1)))?null:(System.String)reader[((int)BbCentreColumn.Accountnumber - 1)];
					c.ClrNstatus = (reader.IsDBNull(((int)BbCentreColumn.ClrNstatus - 1)))?null:(System.String)reader[((int)BbCentreColumn.ClrNstatus - 1)];
					c.UkcrNregionid = (reader.IsDBNull(((int)BbCentreColumn.UkcrNregionid - 1)))?null:(System.Int32?)reader[((int)BbCentreColumn.UkcrNregionid - 1)];
					c.UkcrnContact = (reader.IsDBNull(((int)BbCentreColumn.UkcrnContact - 1)))?null:(System.String)reader[((int)BbCentreColumn.UkcrnContact - 1)];
					c.UkcrnSitecode = (reader.IsDBNull(((int)BbCentreColumn.UkcrnSitecode - 1)))?null:(System.String)reader[((int)BbCentreColumn.UkcrnSitecode - 1)];
					c.UkcrnSitenumber = (reader.IsDBNull(((int)BbCentreColumn.UkcrnSitenumber - 1)))?null:(System.String)reader[((int)BbCentreColumn.UkcrnSitenumber - 1)];
					c.SkipNhsNumber = (reader.IsDBNull(((int)BbCentreColumn.SkipNhsNumber - 1)))?null:(System.Boolean?)reader[((int)BbCentreColumn.SkipNhsNumber - 1)];
					c.Comments = (reader.IsDBNull(((int)BbCentreColumn.Comments - 1)))?null:(System.String)reader[((int)BbCentreColumn.Comments - 1)];
					c.Createdbyid = (System.Int32)reader[((int)BbCentreColumn.Createdbyid - 1)];
					c.Createdbyname = (System.String)reader[((int)BbCentreColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbCentreColumn.Createddate - 1)];
					c.Lastupdatedbyid = (System.Int32)reader[((int)BbCentreColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (System.String)reader[((int)BbCentreColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbCentreColumn.Lastupdateddate - 1)];
					c.Primarycontact = (reader.IsDBNull(((int)BbCentreColumn.Primarycontact - 1)))?null:(System.String)reader[((int)BbCentreColumn.Primarycontact - 1)];
					c.Picontact = (reader.IsDBNull(((int)BbCentreColumn.Picontact - 1)))?null:(System.String)reader[((int)BbCentreColumn.Picontact - 1)];
					c.PiidName = (reader.IsDBNull(((int)BbCentreColumn.PiidName - 1)))?null:(System.String)reader[((int)BbCentreColumn.PiidName - 1)];
					c.Rndcontact = (reader.IsDBNull(((int)BbCentreColumn.Rndcontact - 1)))?null:(System.String)reader[((int)BbCentreColumn.Rndcontact - 1)];
					c.Rndreference = (reader.IsDBNull(((int)BbCentreColumn.Rndreference - 1)))?null:(System.String)reader[((int)BbCentreColumn.Rndreference - 1)];
					c.Teamadditioncomments = (reader.IsDBNull(((int)BbCentreColumn.Teamadditioncomments - 1)))?null:(System.String)reader[((int)BbCentreColumn.Teamadditioncomments - 1)];
					c.Auditstatus = (reader.IsDBNull(((int)BbCentreColumn.Auditstatus - 1)))?null:(System.String)reader[((int)BbCentreColumn.Auditstatus - 1)];
					c.Auditedby = (reader.IsDBNull(((int)BbCentreColumn.Auditedby - 1)))?null:(System.String)reader[((int)BbCentreColumn.Auditedby - 1)];
					c.Auditnotes = (reader.IsDBNull(((int)BbCentreColumn.Auditnotes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Auditnotes - 1)];
					c.Amd7Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Amd7Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd7Sentdate - 1)];
					c.Amd7Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Amd7Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd7Approvaldate - 1)];
					c.Ctamdaug13Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Ctamdaug13Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Ctamdaug13Sentdate - 1)];
					c.Ctamdaug13Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Ctamdaug13Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Ctamdaug13Approvaldate - 1)];
					c.OtherActiveUsers = (reader.IsDBNull(((int)BbCentreColumn.OtherActiveUsers - 1)))?null:(System.String)reader[((int)BbCentreColumn.OtherActiveUsers - 1)];
					c.Audit2status = (reader.IsDBNull(((int)BbCentreColumn.Audit2status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit2status - 1)];
					c.Audit2by = (reader.IsDBNull(((int)BbCentreColumn.Audit2by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit2by - 1)];
					c.Audit2notes = (reader.IsDBNull(((int)BbCentreColumn.Audit2notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit2notes - 1)];
					c.Audit3status = (reader.IsDBNull(((int)BbCentreColumn.Audit3status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit3status - 1)];
					c.Audit3by = (reader.IsDBNull(((int)BbCentreColumn.Audit3by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit3by - 1)];
					c.Audit3notes = (reader.IsDBNull(((int)BbCentreColumn.Audit3notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit3notes - 1)];
					c.Audit4status = (reader.IsDBNull(((int)BbCentreColumn.Audit4status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit4status - 1)];
					c.Audit4by = (reader.IsDBNull(((int)BbCentreColumn.Audit4by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit4by - 1)];
					c.Audit4notes = (reader.IsDBNull(((int)BbCentreColumn.Audit4notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit4notes - 1)];
					c.Audit1Date = (reader.IsDBNull(((int)BbCentreColumn.Audit1Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit1Date - 1)];
					c.Audit2Date = (reader.IsDBNull(((int)BbCentreColumn.Audit2Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit2Date - 1)];
					c.Audit3Date = (reader.IsDBNull(((int)BbCentreColumn.Audit3Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit3Date - 1)];
					c.Audit4Date = (reader.IsDBNull(((int)BbCentreColumn.Audit4Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit4Date - 1)];
					c.Audit1RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit1RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit1RptSentDate - 1)];
					c.Audit2RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit2RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit2RptSentDate - 1)];
					c.Audit3RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit3RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit3RptSentDate - 1)];
					c.Audit4RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit4RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit4RptSentDate - 1)];
					c.Audit1RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit1RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit1RptRcvdDate - 1)];
					c.Audit2RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit2RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit2RptRcvdDate - 1)];
					c.Audit3RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit3RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit3RptRcvdDate - 1)];
					c.Audit4RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit4RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit4RptRcvdDate - 1)];
					c.Amd8Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Amd8Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd8Sentdate - 1)];
					c.Amd8Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Amd8Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd8Approvaldate - 1)];
					c.Amd9Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Amd9Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd9Sentdate - 1)];
					c.Amd9Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Amd9Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd9Approvaldate - 1)];
					c.AltCentreId = (reader.IsDBNull(((int)BbCentreColumn.AltCentreId - 1)))?null:(System.String)reader[((int)BbCentreColumn.AltCentreId - 1)];
					c.IsTrainingCentre = (reader.IsDBNull(((int)BbCentreColumn.IsTrainingCentre - 1)))?null:(System.Int32?)reader[((int)BbCentreColumn.IsTrainingCentre - 1)];
					c.Audit5status = (reader.IsDBNull(((int)BbCentreColumn.Audit5status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit5status - 1)];
					c.Audit5by = (reader.IsDBNull(((int)BbCentreColumn.Audit5by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit5by - 1)];
					c.Audit5notes = (reader.IsDBNull(((int)BbCentreColumn.Audit5notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit5notes - 1)];
					c.Audit5Date = (reader.IsDBNull(((int)BbCentreColumn.Audit5Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit5Date - 1)];
					c.Audit5RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit5RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit5RptSentDate - 1)];
					c.Audit5RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit5RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit5RptRcvdDate - 1)];
					c.Audit6status = (reader.IsDBNull(((int)BbCentreColumn.Audit6status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit6status - 1)];
					c.Audit6by = (reader.IsDBNull(((int)BbCentreColumn.Audit6by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit6by - 1)];
					c.Audit6notes = (reader.IsDBNull(((int)BbCentreColumn.Audit6notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit6notes - 1)];
					c.Audit6Date = (reader.IsDBNull(((int)BbCentreColumn.Audit6Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit6Date - 1)];
					c.Audit6RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit6RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit6RptSentDate - 1)];
					c.Audit6RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit6RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit6RptRcvdDate - 1)];
					c.Audit7status = (reader.IsDBNull(((int)BbCentreColumn.Audit7status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit7status - 1)];
					c.Audit7by = (reader.IsDBNull(((int)BbCentreColumn.Audit7by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit7by - 1)];
					c.Audit7notes = (reader.IsDBNull(((int)BbCentreColumn.Audit7notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit7notes - 1)];
					c.Audit7Date = (reader.IsDBNull(((int)BbCentreColumn.Audit7Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit7Date - 1)];
					c.Audit7RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit7RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit7RptSentDate - 1)];
					c.Audit7RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit7RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit7RptRcvdDate - 1)];
					c.Audit8status = (reader.IsDBNull(((int)BbCentreColumn.Audit8status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit8status - 1)];
					c.Audit8by = (reader.IsDBNull(((int)BbCentreColumn.Audit8by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit8by - 1)];
					c.Audit8notes = (reader.IsDBNull(((int)BbCentreColumn.Audit8notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit8notes - 1)];
					c.Audit8Date = (reader.IsDBNull(((int)BbCentreColumn.Audit8Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit8Date - 1)];
					c.Audit8RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit8RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit8RptSentDate - 1)];
					c.Audit8RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit8RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit8RptRcvdDate - 1)];
					c.Amd10Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Amd10Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd10Sentdate - 1)];
					c.Amd10Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Amd10Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd10Approvaldate - 1)];
					c.Amd11Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Amd11Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd11Sentdate - 1)];
					c.Amd11Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Amd11Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd11Approvaldate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbCentre entity)
		{
			if (!reader.Read()) return;
			
			entity.Centreid = (System.Int32)reader[((int)BbCentreColumn.Centreid - 1)];
			entity.Centrename = (System.String)reader[((int)BbCentreColumn.Centrename - 1)];
			entity.Address1 = (reader.IsDBNull(((int)BbCentreColumn.Address1 - 1)))?null:(System.String)reader[((int)BbCentreColumn.Address1 - 1)];
			entity.Address2 = (reader.IsDBNull(((int)BbCentreColumn.Address2 - 1)))?null:(System.String)reader[((int)BbCentreColumn.Address2 - 1)];
			entity.Address3 = (reader.IsDBNull(((int)BbCentreColumn.Address3 - 1)))?null:(System.String)reader[((int)BbCentreColumn.Address3 - 1)];
			entity.Address4 = (reader.IsDBNull(((int)BbCentreColumn.Address4 - 1)))?null:(System.String)reader[((int)BbCentreColumn.Address4 - 1)];
			entity.Address5 = (reader.IsDBNull(((int)BbCentreColumn.Address5 - 1)))?null:(System.String)reader[((int)BbCentreColumn.Address5 - 1)];
			entity.Postcode = (reader.IsDBNull(((int)BbCentreColumn.Postcode - 1)))?null:(System.String)reader[((int)BbCentreColumn.Postcode - 1)];
			entity.Mapref = (reader.IsDBNull(((int)BbCentreColumn.Mapref - 1)))?null:(System.String)reader[((int)BbCentreColumn.Mapref - 1)];
			entity.Centreregionid = (reader.IsDBNull(((int)BbCentreColumn.Centreregionid - 1)))?null:(System.Int32?)reader[((int)BbCentreColumn.Centreregionid - 1)];
			entity.Centrestatusid = (reader.IsDBNull(((int)BbCentreColumn.Centrestatusid - 1)))?null:(System.Int32?)reader[((int)BbCentreColumn.Centrestatusid - 1)];
			entity.Piid = (reader.IsDBNull(((int)BbCentreColumn.Piid - 1)))?null:(System.Int32?)reader[((int)BbCentreColumn.Piid - 1)];
			entity.Picontactdate = (reader.IsDBNull(((int)BbCentreColumn.Picontactdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Picontactdate - 1)];
			entity.Ssisubmittedrddate = (reader.IsDBNull(((int)BbCentreColumn.Ssisubmittedrddate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Ssisubmittedrddate - 1)];
			entity.Lrecapproveddate = (reader.IsDBNull(((int)BbCentreColumn.Lrecapproveddate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Lrecapproveddate - 1)];
			entity.Rdapproveddate = (reader.IsDBNull(((int)BbCentreColumn.Rdapproveddate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Rdapproveddate - 1)];
			entity.Setupdate = (reader.IsDBNull(((int)BbCentreColumn.Setupdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Setupdate - 1)];
			entity.Pat1recruiteddate = (reader.IsDBNull(((int)BbCentreColumn.Pat1recruiteddate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Pat1recruiteddate - 1)];
			entity.Financecontact = (reader.IsDBNull(((int)BbCentreColumn.Financecontact - 1)))?null:(System.String)reader[((int)BbCentreColumn.Financecontact - 1)];
			entity.Contactdetails = (reader.IsDBNull(((int)BbCentreColumn.Contactdetails - 1)))?null:(System.String)reader[((int)BbCentreColumn.Contactdetails - 1)];
			entity.Accountnumber = (reader.IsDBNull(((int)BbCentreColumn.Accountnumber - 1)))?null:(System.String)reader[((int)BbCentreColumn.Accountnumber - 1)];
			entity.ClrNstatus = (reader.IsDBNull(((int)BbCentreColumn.ClrNstatus - 1)))?null:(System.String)reader[((int)BbCentreColumn.ClrNstatus - 1)];
			entity.UkcrNregionid = (reader.IsDBNull(((int)BbCentreColumn.UkcrNregionid - 1)))?null:(System.Int32?)reader[((int)BbCentreColumn.UkcrNregionid - 1)];
			entity.UkcrnContact = (reader.IsDBNull(((int)BbCentreColumn.UkcrnContact - 1)))?null:(System.String)reader[((int)BbCentreColumn.UkcrnContact - 1)];
			entity.UkcrnSitecode = (reader.IsDBNull(((int)BbCentreColumn.UkcrnSitecode - 1)))?null:(System.String)reader[((int)BbCentreColumn.UkcrnSitecode - 1)];
			entity.UkcrnSitenumber = (reader.IsDBNull(((int)BbCentreColumn.UkcrnSitenumber - 1)))?null:(System.String)reader[((int)BbCentreColumn.UkcrnSitenumber - 1)];
			entity.SkipNhsNumber = (reader.IsDBNull(((int)BbCentreColumn.SkipNhsNumber - 1)))?null:(System.Boolean?)reader[((int)BbCentreColumn.SkipNhsNumber - 1)];
			entity.Comments = (reader.IsDBNull(((int)BbCentreColumn.Comments - 1)))?null:(System.String)reader[((int)BbCentreColumn.Comments - 1)];
			entity.Createdbyid = (System.Int32)reader[((int)BbCentreColumn.Createdbyid - 1)];
			entity.Createdbyname = (System.String)reader[((int)BbCentreColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbCentreColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (System.Int32)reader[((int)BbCentreColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (System.String)reader[((int)BbCentreColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbCentreColumn.Lastupdateddate - 1)];
			entity.Primarycontact = (reader.IsDBNull(((int)BbCentreColumn.Primarycontact - 1)))?null:(System.String)reader[((int)BbCentreColumn.Primarycontact - 1)];
			entity.Picontact = (reader.IsDBNull(((int)BbCentreColumn.Picontact - 1)))?null:(System.String)reader[((int)BbCentreColumn.Picontact - 1)];
			entity.PiidName = (reader.IsDBNull(((int)BbCentreColumn.PiidName - 1)))?null:(System.String)reader[((int)BbCentreColumn.PiidName - 1)];
			entity.Rndcontact = (reader.IsDBNull(((int)BbCentreColumn.Rndcontact - 1)))?null:(System.String)reader[((int)BbCentreColumn.Rndcontact - 1)];
			entity.Rndreference = (reader.IsDBNull(((int)BbCentreColumn.Rndreference - 1)))?null:(System.String)reader[((int)BbCentreColumn.Rndreference - 1)];
			entity.Teamadditioncomments = (reader.IsDBNull(((int)BbCentreColumn.Teamadditioncomments - 1)))?null:(System.String)reader[((int)BbCentreColumn.Teamadditioncomments - 1)];
			entity.Auditstatus = (reader.IsDBNull(((int)BbCentreColumn.Auditstatus - 1)))?null:(System.String)reader[((int)BbCentreColumn.Auditstatus - 1)];
			entity.Auditedby = (reader.IsDBNull(((int)BbCentreColumn.Auditedby - 1)))?null:(System.String)reader[((int)BbCentreColumn.Auditedby - 1)];
			entity.Auditnotes = (reader.IsDBNull(((int)BbCentreColumn.Auditnotes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Auditnotes - 1)];
			entity.Amd7Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Amd7Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd7Sentdate - 1)];
			entity.Amd7Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Amd7Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd7Approvaldate - 1)];
			entity.Ctamdaug13Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Ctamdaug13Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Ctamdaug13Sentdate - 1)];
			entity.Ctamdaug13Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Ctamdaug13Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Ctamdaug13Approvaldate - 1)];
			entity.OtherActiveUsers = (reader.IsDBNull(((int)BbCentreColumn.OtherActiveUsers - 1)))?null:(System.String)reader[((int)BbCentreColumn.OtherActiveUsers - 1)];
			entity.Audit2status = (reader.IsDBNull(((int)BbCentreColumn.Audit2status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit2status - 1)];
			entity.Audit2by = (reader.IsDBNull(((int)BbCentreColumn.Audit2by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit2by - 1)];
			entity.Audit2notes = (reader.IsDBNull(((int)BbCentreColumn.Audit2notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit2notes - 1)];
			entity.Audit3status = (reader.IsDBNull(((int)BbCentreColumn.Audit3status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit3status - 1)];
			entity.Audit3by = (reader.IsDBNull(((int)BbCentreColumn.Audit3by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit3by - 1)];
			entity.Audit3notes = (reader.IsDBNull(((int)BbCentreColumn.Audit3notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit3notes - 1)];
			entity.Audit4status = (reader.IsDBNull(((int)BbCentreColumn.Audit4status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit4status - 1)];
			entity.Audit4by = (reader.IsDBNull(((int)BbCentreColumn.Audit4by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit4by - 1)];
			entity.Audit4notes = (reader.IsDBNull(((int)BbCentreColumn.Audit4notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit4notes - 1)];
			entity.Audit1Date = (reader.IsDBNull(((int)BbCentreColumn.Audit1Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit1Date - 1)];
			entity.Audit2Date = (reader.IsDBNull(((int)BbCentreColumn.Audit2Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit2Date - 1)];
			entity.Audit3Date = (reader.IsDBNull(((int)BbCentreColumn.Audit3Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit3Date - 1)];
			entity.Audit4Date = (reader.IsDBNull(((int)BbCentreColumn.Audit4Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit4Date - 1)];
			entity.Audit1RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit1RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit1RptSentDate - 1)];
			entity.Audit2RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit2RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit2RptSentDate - 1)];
			entity.Audit3RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit3RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit3RptSentDate - 1)];
			entity.Audit4RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit4RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit4RptSentDate - 1)];
			entity.Audit1RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit1RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit1RptRcvdDate - 1)];
			entity.Audit2RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit2RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit2RptRcvdDate - 1)];
			entity.Audit3RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit3RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit3RptRcvdDate - 1)];
			entity.Audit4RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit4RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit4RptRcvdDate - 1)];
			entity.Amd8Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Amd8Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd8Sentdate - 1)];
			entity.Amd8Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Amd8Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd8Approvaldate - 1)];
			entity.Amd9Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Amd9Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd9Sentdate - 1)];
			entity.Amd9Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Amd9Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd9Approvaldate - 1)];
			entity.AltCentreId = (reader.IsDBNull(((int)BbCentreColumn.AltCentreId - 1)))?null:(System.String)reader[((int)BbCentreColumn.AltCentreId - 1)];
			entity.IsTrainingCentre = (reader.IsDBNull(((int)BbCentreColumn.IsTrainingCentre - 1)))?null:(System.Int32?)reader[((int)BbCentreColumn.IsTrainingCentre - 1)];
			entity.Audit5status = (reader.IsDBNull(((int)BbCentreColumn.Audit5status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit5status - 1)];
			entity.Audit5by = (reader.IsDBNull(((int)BbCentreColumn.Audit5by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit5by - 1)];
			entity.Audit5notes = (reader.IsDBNull(((int)BbCentreColumn.Audit5notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit5notes - 1)];
			entity.Audit5Date = (reader.IsDBNull(((int)BbCentreColumn.Audit5Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit5Date - 1)];
			entity.Audit5RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit5RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit5RptSentDate - 1)];
			entity.Audit5RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit5RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit5RptRcvdDate - 1)];
			entity.Audit6status = (reader.IsDBNull(((int)BbCentreColumn.Audit6status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit6status - 1)];
			entity.Audit6by = (reader.IsDBNull(((int)BbCentreColumn.Audit6by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit6by - 1)];
			entity.Audit6notes = (reader.IsDBNull(((int)BbCentreColumn.Audit6notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit6notes - 1)];
			entity.Audit6Date = (reader.IsDBNull(((int)BbCentreColumn.Audit6Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit6Date - 1)];
			entity.Audit6RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit6RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit6RptSentDate - 1)];
			entity.Audit6RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit6RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit6RptRcvdDate - 1)];
			entity.Audit7status = (reader.IsDBNull(((int)BbCentreColumn.Audit7status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit7status - 1)];
			entity.Audit7by = (reader.IsDBNull(((int)BbCentreColumn.Audit7by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit7by - 1)];
			entity.Audit7notes = (reader.IsDBNull(((int)BbCentreColumn.Audit7notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit7notes - 1)];
			entity.Audit7Date = (reader.IsDBNull(((int)BbCentreColumn.Audit7Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit7Date - 1)];
			entity.Audit7RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit7RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit7RptSentDate - 1)];
			entity.Audit7RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit7RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit7RptRcvdDate - 1)];
			entity.Audit8status = (reader.IsDBNull(((int)BbCentreColumn.Audit8status - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit8status - 1)];
			entity.Audit8by = (reader.IsDBNull(((int)BbCentreColumn.Audit8by - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit8by - 1)];
			entity.Audit8notes = (reader.IsDBNull(((int)BbCentreColumn.Audit8notes - 1)))?null:(System.String)reader[((int)BbCentreColumn.Audit8notes - 1)];
			entity.Audit8Date = (reader.IsDBNull(((int)BbCentreColumn.Audit8Date - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit8Date - 1)];
			entity.Audit8RptSentDate = (reader.IsDBNull(((int)BbCentreColumn.Audit8RptSentDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit8RptSentDate - 1)];
			entity.Audit8RptRcvdDate = (reader.IsDBNull(((int)BbCentreColumn.Audit8RptRcvdDate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Audit8RptRcvdDate - 1)];
			entity.Amd10Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Amd10Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd10Sentdate - 1)];
			entity.Amd10Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Amd10Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd10Approvaldate - 1)];
			entity.Amd11Sentdate = (reader.IsDBNull(((int)BbCentreColumn.Amd11Sentdate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd11Sentdate - 1)];
			entity.Amd11Approvaldate = (reader.IsDBNull(((int)BbCentreColumn.Amd11Approvaldate - 1)))?null:(System.DateTime?)reader[((int)BbCentreColumn.Amd11Approvaldate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbCentre entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Centreid = (System.Int32)dataRow["centreid"];
			entity.Centrename = (System.String)dataRow["centrename"];
			...
			entity.Address4 = Convert.IsDBNull(dataRow["address4"]) ? null : (System.String)dataRow["address4"];
			entity.Address5 = Convert.IsDBNull(dataRow["address5"]) ? null : (System.String)dataRow["address5"];
			entity.Postcode = Convert.IsDBNull(dataRow["postcode"]) ? null : (System.String)dataRow["postcode"];
			entity.Mapref = Convert.IsDBNull(dataRow["mapref"]) ? null : (System.String)dataRow["mapref"];
			entity.Centreregionid = Convert.IsDBNull(dataRow["centreregionid"]) ? null : (System.Int32?)dataRow["centreregionid"];
			entity.Centrestatusid = Convert.IsDBNull(dataRow["centrestatusid"]) ? null : (System.Int32?)dataRow["centrestatusid"];
			entity.Piid = Convert.IsDBNull(dataRow["piid"]) ? null : (System.Int32?)dataRow["piid"];
			entity.Picontactdate = Convert.IsDBNull(dataRow["picontactdate"]) ? null : (System.DateTime?)dataRow["picontactdate"];
			entity.Ssisubmittedrddate = Convert.IsDBNull(dataRow["ssisubmittedrddate"]) ? null : (System.DateTime?)dataRow["ssisubmittedrddate"];
			entity.Lrecapproveddate = Convert.IsDBNull(dataRow["lrecapproveddate"]) ? null : (System.DateTime?)dataRow["lrecapproveddate"];
			entity.Rdapproveddate = Convert.IsDBNull(dataRow["rdapproveddate"]) ? null : (System.DateTime?)dataRow["rdapproveddate"];
			entity.Setupdate = Convert.IsDBNull(dataRow["setupdate"]) ? null : (System.DateTime?)dataRow["setupdate"];
			entity.Pat1recruiteddate = Convert.IsDBNull(dataRow["pat1recruiteddate"]) ? null : (System.DateTime?)dataRow["pat1recruiteddate"];
			entity.Financecontact = Convert.IsDBNull(dataRow["financecontact"]) ? null : (System.String)dataRow["financecontact"];
			entity.Contactdetails = Convert.IsDBNull(dataRow["contactdetails"]) ? null : (System.String)dataRow["contactdetails"];
			entity.Accountnumber = Convert.IsDBNull(dataRow["accountnumber"]) ? null : (System.String)dataRow["accountnumber"];
			entity.ClrNstatus = Convert.IsDBNull(dataRow["CLRNstatus"]) ? null : (System.String)dataRow["CLRNstatus"];
			entity.UkcrNregionid = Convert.IsDBNull(dataRow["UKCRNregionid"]) ? null : (System.Int32?)dataRow["UKCRNregionid"];
			entity.UkcrnContact = Convert.IsDBNull(dataRow["UKCRN_contact"]) ? null : (System.String)dataRow["UKCRN_contact"];
			entity.UkcrnSitecode = Convert.IsDBNull(dataRow["UKCRN_sitecode"]) ? null : (System.String)dataRow["UKCRN_sitecode"];
			entity.UkcrnSitenumber = Convert.IsDBNull(dataRow["UKCRN_sitenumber"]) ? null : (System.String)dataRow["UKCRN_sitenumber"];
			entity.SkipNhsNumber = Convert.IsDBNull(dataRow["skip_nhs_number"]) ? null : (System.Boolean?)dataRow["skip_nhs_number"];
			entity.Comments = Convert.IsDBNull(dataRow["comments"]) ? null : (System.String)dataRow["comments"];
			entity.Createdbyid = (System.Int32)dataRow["createdbyid"];
			entity.Createdbyname = (System.String)dataRow["createdbyname"];
			entity.Createddate = (System.DateTime)dataRow["createddate"];
			entity.Lastupdatedbyid = (System.Int32)dataRow["lastupdatedbyid"];
			entity.Lastupdatedbyname = (System.String)dataRow["lastupdatedbyname"];
			entity.Lastupdateddate = (System.DateTime)dataRow["lastupdateddate"];
			entity.Primarycontact = Convert.IsDBNull(dataRow["primarycontact"]) ? null : (System.String)dataRow["primarycontact"];
			entity.Picontact = Convert.IsDBNull(dataRow["picontact"]) ? null : (System.String)dataRow["picontact"];
			entity.PiidName = Convert.IsDBNull(dataRow["piidName"]) ? null : (System.String)dataRow["piidName"];
			entity.Rndcontact = Convert.IsDBNull(dataRow["rndcontact"]) ? null : (System.String)dataRow["rndcontact"];
			entity.Rndreference = Convert.IsDBNull(dataRow["rndreference"]) ? null : (System.String)dataRow["rndreference"];
			entity.Teamadditioncomments = Convert.IsDBNull(dataRow["teamadditioncomments"]) ? null : (System.String)dataRow["teamadditioncomments"];
			entity.Auditstatus = Convert.IsDBNull(dataRow["auditstatus"]) ? null : (System.String)dataRow["auditstatus"];
			entity.Auditedby = Convert.IsDBNull(dataRow["auditedby"]) ? null : (System.String)dataRow["auditedby"];
			entity.Auditnotes = Convert.IsDBNull(dataRow["auditnotes"]) ? null : (System.String)dataRow["auditnotes"];
			entity.Amd7Sentdate = Convert.IsDBNull(dataRow["amd7_sentdate"]) ? null : (System.DateTime?)dataRow["amd7_sentdate"];
			entity.Amd7Approvaldate = Convert.IsDBNull(dataRow["amd7_approvaldate"]) ? null : (System.DateTime?)dataRow["amd7_approvaldate"];
			entity.Ctamdaug13Sentdate = Convert.IsDBNull(dataRow["ctamdaug13_sentdate"]) ? null : (System.DateTime?)dataRow["ctamdaug13_sentdate"];
			entity.Ctamdaug13Approvaldate = Convert.IsDBNull(dataRow["ctamdaug13_approvaldate"]) ? null : (System.DateTime?)dataRow["ctamdaug13_approvaldate"];
			entity.OtherActiveUsers = Convert.IsDBNull(dataRow["otherActiveUsers"]) ? null : (System.String)dataRow["otherActiveUsers"];
			entity.Audit2status = Convert.IsDBNull(dataRow["audit2status"]) ? null : (System.String)dataRow["audit2status"];
			entity.Audit2by = Convert.IsDBNull(dataRow["audit2by"]) ? null : (System.String)dataRow["audit2by"];
			entity.Audit2notes = Convert.IsDBNull(dataRow["audit2notes"]) ? null : (System.String)dataRow["audit2notes"];
			entity.Audit3status = Convert.IsDBNull(dataRow["audit3status"]) ? null : (System.String)dataRow["audit3status"];
			entity.Audit3by = Convert.IsDBNull(dataRow["audit3by"]) ? null : (System.String)dataRow["audit3by"];
			entity.Audit3notes = Convert.IsDBNull(dataRow["audit3notes"]) ? null : (System.String)dataRow["audit3notes"];
			entity.Audit4status = Convert.IsDBNull(dataRow["audit4status"]) ? null : (System.String)dataRow["audit4status"];
			entity.Audit4by = Convert.IsDBNull(dataRow["audit4by"]) ? null : (System.String)dataRow["audit4by"];
			entity.Audit4notes = Convert.IsDBNull(dataRow["audit4notes"]) ? null : (System.String)dataRow["audit4notes"];
			entity.Audit1Date = Convert.IsDBNull(dataRow["audit1Date"]) ? null : (System.DateTime?)dataRow["audit1Date"];
			entity.Audit2Date = Convert.IsDBNull(dataRow["audit2Date"]) ? null : (System.DateTime?)dataRow["audit2Date"];
			entity.Audit3Date = Convert.IsDBNull(dataRow["audit3Date"]) ? null : (System.DateTime?)dataRow["audit3Date"];
			entity.Audit4Date = Convert.IsDBNull(dataRow["audit4Date"]) ? null : (System.DateTime?)dataRow["audit4Date"];
			entity.Audit1RptSentDate = Convert.IsDBNull(dataRow["audit1RptSentDate"]) ? null : (System.DateTime?)dataRow["audit1RptSentDate"];
			entity.Audit2RptSentDate = Convert.IsDBNull(dataRow["audit2RptSentDate"]) ? null : (System.DateTime?)dataRow["audit2RptSentDate"];
			entity.Audit3RptSentDate = Convert.IsDBNull(dataRow["audit3RptSentDate"]) ? null : (System.DateTime?)dataRow["audit3RptSentDate"];
			entity.Audit4RptSentDate = Convert.IsDBNull(dataRow["audit4RptSentDate"]) ? null : (System.DateTime?)dataRow["audit4RptSentDate"];
			entity.Audit1RptRcvdDate = Convert.IsDBNull(dataRow["audit1RptRcvdDate"]) ? null : (System.DateTime?)dataRow["audit1RptRcvdDate"];
			entity.Audit2RptRcvdDate = Convert.IsDBNull(dataRow["audit2RptRcvdDate"]) ? null : (System.DateTime?)dataRow["audit2RptRcvdDate"];
			entity.Audit3RptRcvdDate = Convert.IsDBNull(dataRow["audit3RptRcvdDate"]) ? null : (System.DateTime?)dataRow["audit3RptRcvdDate"];
			entity.Audit4RptRcvdDate = Convert.IsDBNull(dataRow["audit4RptRcvdDate"]) ? null : (System.DateTime?)dataRow["audit4RptRcvdDate"];
			entity.Amd8Sentdate = Convert.IsDBNull(dataRow["amd8_sentdate"]) ? null : (System.DateTime?)dataRow["amd8_sentdate"];
			entity.Amd8Approvaldate = Convert.IsDBNull(dataRow["amd8_approvaldate"]) ? null : (System.DateTime?)dataRow["amd8_approvaldate"];
			entity.Amd9Sentdate = Convert.IsDBNull(dataRow["amd9_sentdate"]) ? null : (System.DateTime?)dataRow["amd9_sentdate"];
			entity.Amd9Approvaldate = Convert.IsDBNull(dataRow["amd9_approvaldate"]) ? null : (System.DateTime?)dataRow["amd9_approvaldate"];
			entity.AltCentreId = Convert.IsDBNull(dataRow["altCentreID"]) ? null : (System.String)dataRow["altCentreID"];
			entity.IsTrainingCentre = Convert.IsDBNull(dataRow["isTrainingCentre"]) ? null : (System.Int32?)dataRow["isTrainingCentre"];
			entity.Audit5status = Convert.IsDBNull(dataRow["audit5status"]) ? null : (System.String)dataRow["audit5status"];
			entity.Audit5by = Convert.IsDBNull(dataRow["audit5by"]) ? null : (System.String)dataRow["audit5by"];
			entity.Audit5notes = Convert.IsDBNull(dataRow["audit5notes"]) ? null : (System.String)dataRow["audit5notes"];
			entity.Audit5Date = Convert.IsDBNull(dataRow["audit5Date"]) ? null : (System.DateTime?)dataRow["audit5Date"];
			entity.Audit5RptSentDate = Convert.IsDBNull(dataRow["audit5RptSentDate"]) ? null : (System.DateTime?)dataRow["audit5RptSentDate"];
			entity.Audit5RptRcvdDate = Convert.IsDBNull(dataRow["audit5RptRcvdDate"]) ? null : (System.DateTime?)dataRow["audit5RptRcvdDate"];
			entity.Audit6status = Convert.IsDBNull(dataRow["audit6status"]) ? null : (System.String)dataRow["audit6status"];
			entity.Audit6by = Convert.IsDBNull(dataRow["audit6by"]) ? null : (System.String)dataRow["audit6by"];
			entity.Audit6notes = Convert.IsDBNull(dataRow["audit6notes"]) ? null : (System.String)dataRow["audit6notes"];
			entity.Audit6Date = Convert.IsDBNull(dataRow["audit6Date"]) ? null : (System.DateTime?)dataRow["audit6Date"];
			entity.Audit6RptSentDate = Convert.IsDBNull(dataRow["audit6RptSentDate"]) ? null : (System.DateTime?)dataRow["audit6RptSentDate"];
			entity.Audit6RptRcvdDate = Convert.IsDBNull(dataRow["audit6RptRcvdDate"]) ? null : (System.DateTime?)dataRow["audit6RptRcvdDate"];
			entity.Audit7status = Convert.IsDBNull(dataRow["audit7status"]) ? null : (System.String)dataRow["audit7status"];
			entity.Audit7by = Convert.IsDBNull(dataRow["audit7by"]) ? null : (System.String)dataRow["audit7by"];
			entity.Audit7notes = Convert.IsDBNull(dataRow["audit7notes"]) ? null : (System.String)dataRow["audit7notes"];
			entity.Audit7Date = Convert.IsDBNull(dataRow["audit7Date"]) ? null : (System.DateTime?)dataRow["audit7Date"];
			entity.Audit7RptSentDate = Convert.IsDBNull(dataRow["audit7RptSentDate"]) ? null : (System.DateTime?)dataRow["audit7RptSentDate"];
			entity.Audit7RptRcvdDate = Convert.IsDBNull(dataRow["audit7RptRcvdDate"]) ? null : (System.DateTime?)dataRow["audit7RptRcvdDate"];
			entity.Audit8status = Convert.IsDBNull(dataRow["audit8status"]) ? null : (System.String)dataRow["audit8status"];
			entity.Audit8by = Convert.IsDBNull(dataRow["audit8by"]) ? null : (System.String)dataRow["audit8by"];
			entity.Audit8notes = Convert.IsDBNull(dataRow["audit8notes"]) ? null : (System.String)dataRow["audit8notes"];
			entity.Audit8Date = Convert.IsDBNull(dataRow["audit8Date"]) ? null : (System.DateTime?)dataRow["audit8Date"];
			entity.Audit8RptSentDate = Convert.IsDBNull(dataRow["audit8RptSentDate"]) ? null : (System.DateTime?)dataRow["audit8RptSentDate"];
			entity.Audit8RptRcvdDate = Convert.IsDBNull(dataRow["audit8RptRcvdDate"]) ? null : (System.DateTime?)dataRow["audit8RptRcvdDate"];
			entity.Amd10Sentdate = Convert.IsDBNull(dataRow["amd10_sentdate"]) ? null : (System.DateTime?)dataRow["amd10_sentdate"];
			entity.Amd10Approvaldate = Convert.IsDBNull(dataRow["amd10_approvaldate"]) ? null : (System.DateTime?)dataRow["amd10_approvaldate"];
			entity.Amd11Sentdate = Convert.IsDBNull(dataRow["amd11_sentdate"]) ? null : (System.DateTime?)dataRow["amd11_sentdate"];
			entity.Amd11Approvaldate = Convert.IsDBNull(dataRow["amd11_approvaldate"]) ? null : (System.DateTime?)dataRow["amd11_approvaldate"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCentre"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbCentre Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentre entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region CentreregionidSource	
			if (CanDeepLoad(entity, "BbCentreRegionlkp|CentreregionidSource", deepLoadType, innerList) 
				&& entity.CentreregionidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.Centreregionid ?? (int)0);
				BbCentreRegionlkp tmpEntity = EntityManager.LocateEntity<BbCentreRegionlkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbCentreRegionlkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.CentreregionidSource = tmpEntity;
				else
					entity.CentreregionidSource = DataRepository.BbCentreRegionlkpProvider.GetByCentreregid(transactionManager, (entity.Centreregionid ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'CentreregionidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.CentreregionidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbCentreRegionlkpProvider.DeepLoad(transactionManager, entity.CentreregionidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion CentreregionidSource

			#region CentrestatusidSource	
			if (CanDeepLoad(entity, "BbCentrestatus|CentrestatusidSource", deepLoadType, innerList) 
				&& entity.CentrestatusidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.Centrestatusid ?? (int)0);
				BbCentrestatus tmpEntity = EntityManager.LocateEntity<BbCentrestatus>(EntityLocator.ConstructKeyFromPkItems(typeof(BbCentrestatus), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.CentrestatusidSource = tmpEntity;
				else
					entity.CentrestatusidSource = DataRepository.BbCentrestatusProvider.GetByCentrestatusid(transactionManager, (entity.Centrestatusid ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'CentrestatusidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.CentrestatusidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbCentrestatusProvider.DeepLoad(transactionManager, entity.CentrestatusidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion CentrestatusidSource

			#region UkcrNregionidSource	
			if (CanDeepLoad(entity, "BbUkcrNregionlkp|UkcrNregionidSource", deepLoadType, innerList) 
				&& entity.UkcrNregionidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.UkcrNregionid ?? (int)0);
				BbUkcrNregionlkp tmpEntity = EntityManager.LocateEntity<BbUkcrNregionlkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbUkcrNregionlkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.UkcrNregionidSource = tmpEntity;
				else
					entity.UkcrNregionidSource = DataRepository.BbUkcrNregionlkpProvider.GetByUkcrNregid(transactionManager, (entity.UkcrNregionid ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'UkcrNregionidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.UkcrNregionidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbUkcrNregionlkpProvider.DeepLoad(transactionManager, entity.UkcrNregionidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion UkcrNregionidSource
			
			//used to hold DeepLoad method delegates and fire after all the local children have been loaded.
			Dictionary<string, KeyValuePair<Delegate, object>> deepHandles = new Dictionary<string, KeyValuePair<Delegate, object>>();
			// Deep load child collections  - Call GetByCentreid methods when available
			
			#region BbPatientCohortHistoryCollection
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbPatientCohortHistory>|BbPatientCohortHistoryCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbPatientCohortHistoryCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbPatientCohortHistoryCollection = DataRepository.BbPatientCohortHistoryProvider.GetByRegcentreid(transactionManager, entity.Centreid);

				if (deep && entity.BbPatientCohortHistoryCollection.Count > 0)
				{
					deepHandles.Add("BbPatientCohortHistoryCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbPatientCohortHistory>) DataRepository.BbPatientCohortHistoryProvider.DeepLoad,
						new object[] { transactionManager, entity.BbPatientCohortHistoryCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
			...
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbQuery>|BbQueryCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbQueryCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbQueryCollection = DataRepository.BbQueryProvider.GetByCentreid(transactionManager, entity.Centreid);

				if (deep && entity.BbQueryCollection.Count > 0)
				{
					deepHandles.Add("BbQueryCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbQuery>) DataRepository.BbQueryProvider.DeepLoad,
						new object[] { transactionManager, entity.BbQueryCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
			...
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbPatientCohortTracking>|BbPatientCohortTrackingCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbPatientCohortTrackingCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbPatientCohortTrackingCollection = DataRepository.BbPatientCohortTrackingProvider.GetByCentreidcurrent(transactionManager, entity.Centreid);

				if (deep && entity.BbPatientCohortTrackingCollection.Count > 0)
				{
					deepHandles.Add("BbPatientCohortTrackingCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbPatientCohortTracking>) DataRepository.BbPatientCohortTrackingProvider.DeepLoad,
						new object[] { transactionManager, entity.BbPatientCohortTrackingCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
			...
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbQueryForCentre>|BbQueryForCentreCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbQueryForCentreCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbQueryForCentreCollection = DataRepository.BbQueryForCentreProvider.GetByCentreid(transactionManager, entity.Centreid);

				if (deep && entity.BbQueryForCentreCollection.Count > 0)
				{
					deepHandles.Add("BbQueryForCentreCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbQueryForCentre>) DataRepository.BbQueryForCentreProvider.DeepLoad,
						new object[] { transactionManager, entity.BbQueryForCentreCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbCentre object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbCentre instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbCentre Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentre entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region CentreregionidSource
			if (CanDeepSave(entity, "BbCentreRegionlkp|CentreregionidSource", deepSaveType, innerList) 
				&& entity.CentreregionidSource != null)
			{
				DataRepository.BbCentreRegionlkpProvider.Save(transactionManager, entity.CentreregionidSource);
				entity.Centreregionid = entity.CentreregionidSource.Centreregid;
			}
			#endregion 
			
			#region CentrestatusidSource
			if (CanDeepSave(entity, "BbCentrestatus|CentrestatusidSource", deepSaveType, innerList) 
				&& entity.CentrestatusidSource != null)
			{
				DataRepository.BbCentrestatusProvider.Save(transactionManager, entity.CentrestatusidSource);
				entity.Centrestatusid = entity.CentrestatusidSource.Centrestatusid;
			}
			#endregion 
			
			#region UkcrNregionidSource
			if (CanDeepSave(entity, "BbUkcrNregionlkp|UkcrNregionidSource", deepSaveType, innerList) 
				&& entity.UkcrNregionidSource != null)
			{
				DataRepository.BbUkcrNregionlkpProvider.Save(transactionManager, entity.UkcrNregionidSource);
				entity.UkcrNregionid = entity.UkcrNregionidSource.UkcrNregid;
			}
			#endregion 
			...
			#region List<BbPatientCohortHistory>
				if (CanDeepSave(entity.BbPatientCohortHistoryCollection, "List<BbPatientCohortHistory>|BbPatientCohortHistoryCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbPatientCohortHistory child in entity.BbPatientCohortHistoryCollection)
					{
						if(child.RegcentreidSource != null)
						{
							child.Regcentreid = child.RegcentreidSource.Centreid;
						}
						else
						{
							child.Regcentreid = entity.Centreid;
						}

					}

					if (entity.BbPatientCohortHistoryCollection.Count > 0 || entity.BbPatientCohortHistoryCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbPatientCohortHistoryProvider.Save(transactionManager, entity.BbPatientCohortHistoryCollection);
						
						deepHandles.Add("BbPatientCohortHistoryCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbPatientCohortHistory >) DataRepository.BbPatientCohortHistoryProvider.DeepSave,
							new object[] { transactionManager, entity.BbPatientCohortHistoryCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
			...
			#region List<BbQuery>
				if (CanDeepSave(entity.BbQueryCollection, "List<BbQuery>|BbQueryCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbQuery child in entity.BbQueryCollection)
					{
						if(child.CentreidSource != null)
						{
							child.Centreid = child.CentreidSource.Centreid;
						}
						else
						{
							child.Centreid = entity.Centreid;
						}

					}

					if (entity.BbQueryCollection.Count > 0 || entity.BbQueryCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbQueryProvider.Save(transactionManager, entity.BbQueryCollection);
						
						deepHandles.Add("BbQueryCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbQuery >) DataRepository.BbQueryProvider.DeepSave,
							new object[] { transactionManager, entity.BbQueryCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
			...
			#region List<BbPatientCohortTracking>
				if (CanDeepSave(entity.BbPatientCohortTrackingCollection, "List<BbPatientCohortTracking>|BbPatientCohortTrackingCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbPatientCohortTracking child in entity.BbPatientCohortTrackingCollection)
					{
						if(child.CentreidcurrentSource != null)
						{
							child.Centreidcurrent = child.CentreidcurrentSource.Centreid;
						}
						else
						{
							child.Centreidcurrent = entity.Centreid;
						}

					}

					if (entity.BbPatientCohortTrackingCollection.Count > 0 || entity.BbPatientCohortTrackingCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbPatientCohortTrackingProvider.Save(transactionManager, entity.BbPatientCohortTrackingCollection);
						
						deepHandles.Add("BbPatientCohortTrackingCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbPatientCohortTracking >) DataRepository.BbPatientCohortTrackingProvider.DeepSave,
							new object[] { transactionManager, entity.BbPatientCohortTrackingCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
			...
			#region List<BbQueryForCentre>
				if (CanDeepSave(entity.BbQueryForCentreCollection, "List<BbQueryForCentre>|BbQueryForCentreCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbQueryForCentre child in entity.BbQueryForCentreCollection)
					{
						if(child.CentreidSource != null)
						{
							child.Centreid = child.CentreidSource.Centreid;
					...
					if (entity.BbQueryForCentreCollection.Count > 0 || entity.BbQueryForCentreCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbQueryForCentreProvider.Save(transactionManager, entity.BbQueryForCentreCollection);
						
						deepHandles.Add("BbQueryForCentreCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbQueryForCentre >) DataRepository.BbQueryForCentreProvider.DeepSave,
							new object[] { transactionManager, entity.BbQueryForCentreCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	#region BbCentreChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbCentre</c>
	///</summary>
	public enum BbCentreChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbCentreRegionlkp</c> at CentreregionidSource
		///</summary>
		[ChildEntityType(typeof(BbCentreRegionlkp))]
		BbCentreRegionlkp,
		
		///<summary>
		/// Composite Property for <c>BbCentrestatus</c> at CentrestatusidSource
		///</summary>
		[ChildEntityType(typeof(BbCentrestatus))]
		BbCentrestatus,
		
		///<summary>
		/// Composite Property for <c>BbUkcrNregionlkp</c> at UkcrNregionidSource
		///</summary>
		[ChildEntityType(typeof(BbUkcrNregionlkp))]
		BbUkcrNregionlkp,
		///<summary>
		/// Collection of <c>BbCentre</c> as OneToMany for BbPatientCohortHistoryCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientCohortHistory>))]
		BbPatientCohortHistoryCollection,
		///<summary>
		/// Collection of <c>BbCentre</c> as OneToMany for BbQueryCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbQuery>))]
		BbQueryCollection,
		///<summary>
		/// Collection of <c>BbCentre</c> as OneToMany for BbPatientCohortTrackingCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientCohortTracking>))]
		BbPatientCohortTrackingCollection,
		///<summary>
		/// Collection of <c>BbCentre</c> as OneToMany for BbQueryForCentreCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbQueryForCentre>))]
		BbQueryForCentreCollection,
	}
	
	#endregion BbCentreChildEntityTypes
	
	#region BbCentreFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbCentreColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCentre"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbCentreFilterBuilder : SqlFilterBuilder<BbCentreColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCentreFilterBuilder class.
		/// </summary>
		public BbCentreFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbCentreFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbCentreFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbCentreFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbCentreFilterBuilder
	
	#region BbCentreParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbCentreColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCentre"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbCentreParameterBuilder : ParameterizedSqlFilterBuilder<BbCentreColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCentreParameterBuilder class.
		/// </summary>
		public BbCentreParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbCentreParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbCentreParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbCentreParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbCentreParameterBuilder
	
	#region BbCentreSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbCentreColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCentre"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbCentreSortBuilder : SqlSortBuilder<BbCentreColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCentreSqlSortBuilder class.
		/// </summary>
		public BbCentreSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbCentreSortBuilder
