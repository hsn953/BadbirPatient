...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbWorkStatuslkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbWorkStatuslkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp, MHS.Badbir.NetTiers.Entities.BbWorkStatuslkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbWorkStatuslkpKey key)
		{
			return Delete(transactionManager, key.Worstatuskid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_worstatuskid">Work status Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _worstatuskid)
		{
			return Delete(null, _worstatuskid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _worstatuskid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbWorkStatuslkpKey key, int start, int pageLength)
		{
			return GetByWorstatuskid(transactionManager, key.Worstatuskid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_tblWorkstatus_lookup index.
		/// </summary>
		/// <param name="_worstatuskid">Work status Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp GetByWorstatuskid(int _worstatuskid)
		{
			int count = -1;
			return GetByWorstatuskid(null,_worstatuskid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_tblWorkstatus_lookup index.
		/// </summary>
		/// <param name="_worstatuskid">Work status Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp GetByWorstatuskid(int _worstatuskid, int start, int pageLength)
		{
			int count = -1;
			return GetByWorstatuskid(null, _worstatuskid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp GetByWorstatuskid(TransactionManager transactionManager, int _worstatuskid)
		{
			int count = -1;
			return GetByWorstatuskid(transactionManager, _worstatuskid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp GetByWorstatuskid(TransactionManager transactionManager, int _worstatuskid, int start, int pageLength)
		{
			int count = -1;
			return GetByWorstatuskid(transactionManager, _worstatuskid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp GetByWorstatuskid(int _worstatuskid, int start, int pageLength, out int count)
		{
			return GetByWorstatuskid(null, _worstatuskid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp GetByWorstatuskid(TransactionManager transactionManager, int _worstatuskid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbWorkStatuslkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbWorkStatuslkp&gt;"/></returns>
		public static TList<BbWorkStatuslkp> Fill(IDataReader reader, TList<BbWorkStatuslkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbWorkStatuslkp")
					.Append("|").Append((int)reader[((int)BbWorkStatuslkpColumn.Worstatuskid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbWorkStatuslkp>(
					key.ToString(), // EntityTrackingKey
					"BbWorkStatuslkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp();
				}
					...
					))
				{
					...
					c.Worstatuskid = (int)reader[((int)BbWorkStatuslkpColumn.Worstatuskid - 1)];
					c.Workstatus = (reader.IsDBNull(((int)BbWorkStatuslkpColumn.Workstatus - 1)))?null:(string)reader[((int)BbWorkStatuslkpColumn.Workstatus - 1)];
					c.Createdbyid = (int)reader[((int)BbWorkStatuslkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbWorkStatuslkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbWorkStatuslkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbWorkStatuslkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbWorkStatuslkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbWorkStatuslkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Worstatuskid = (int)reader[((int)BbWorkStatuslkpColumn.Worstatuskid - 1)];
			entity.Workstatus = (reader.IsDBNull(((int)BbWorkStatuslkpColumn.Workstatus - 1)))?null:(string)reader[((int)BbWorkStatuslkpColumn.Workstatus - 1)];
			entity.Createdbyid = (int)reader[((int)BbWorkStatuslkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbWorkStatuslkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbWorkStatuslkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbWorkStatuslkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbWorkStatuslkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbWorkStatuslkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Worstatuskid = (int)dataRow["worstatuskid"];
			entity.Workstatus = Convert.IsDBNull(dataRow["workstatus"]) ? null : (string)dataRow["workstatus"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByWorstatuskid methods when available
			
			#region BbPatientLifestyleCollection
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbPatientLifestyle>|BbPatientLifestyleCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbPatientLifestyleCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbPatientLifestyleCollection = DataRepository.BbPatientLifestyleProvider.GetByWorkstatusid(transactionManager, entity.Worstatuskid);

				if (deep && entity.BbPatientLifestyleCollection.Count > 0)
				{
					deepHandles.Add("BbPatientLifestyleCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbPatientLifestyle>) DataRepository.BbPatientLifestyleProvider.DeepLoad,
						new object[] { transactionManager, entity.BbPatientLifestyleCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
			...
			if (CanDeepLoad(entity, "List<BbPappPatientLifestyle>|BbPappPatientLifestyleCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPappPatientLifestyleCollection = DataRepository.BbPappPatientLifestyleProvider.GetByWorkstatusid(transactionManager, entity.Worstatuskid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbPatientLifestyle>
				if (CanDeepSave(entity.BbPatientLifestyleCollection, "List<BbPatientLifestyle>|BbPatientLifestyleCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbPatientLifestyle child in entity.BbPatientLifestyleCollection)
					{
						if(child.WorkstatusidSource != null)
						{
							child.Workstatusid = child.WorkstatusidSource.Worstatuskid;
						}
						else
						{
							child.Workstatusid = entity.Worstatuskid;
						}

					}

					if (entity.BbPatientLifestyleCollection.Count > 0 || entity.BbPatientLifestyleCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbPatientLifestyleProvider.Save(transactionManager, entity.BbPatientLifestyleCollection);
						
						deepHandles.Add("BbPatientLifestyleCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbPatientLifestyle >) DataRepository.BbPatientLifestyleProvider.DeepSave,
							new object[] { transactionManager, entity.BbPatientLifestyleCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	#region BbWorkStatuslkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbWorkStatuslkp</c>
	///</summary>
	public enum BbWorkStatuslkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbWorkStatuslkp</c> as OneToMany for BbPatientLifestyleCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientLifestyle>))]
		BbPatientLifestyleCollection,
		///<summary>
		/// Collection of <c>BbWorkStatuslkp</c> as OneToMany for BbPappPatientLifestyleCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPappPatientLifestyle>))]
		BbPappPatientLifestyleCollection,
	}
	
	#endregion BbWorkStatuslkpChildEntityTypes
	
	#region BbWorkStatuslkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbWorkStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbWorkStatuslkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbWorkStatuslkpFilterBuilder : SqlFilterBuilder<BbWorkStatuslkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbWorkStatuslkpFilterBuilder class.
		/// </summary>
		public BbWorkStatuslkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbWorkStatuslkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbWorkStatuslkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbWorkStatuslkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbWorkStatuslkpFilterBuilder
	
	#region BbWorkStatuslkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbWorkStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbWorkStatuslkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbWorkStatuslkpParameterBuilder : ParameterizedSqlFilterBuilder<BbWorkStatuslkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbWorkStatuslkpParameterBuilder class.
		/// </summary>
		public BbWorkStatuslkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbWorkStatuslkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbWorkStatuslkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbWorkStatuslkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbWorkStatuslkpParameterBuilder
	
	#region BbWorkStatuslkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbWorkStatuslkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbWorkStatuslkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbWorkStatuslkpSortBuilder : SqlSortBuilder<BbWorkStatuslkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbWorkStatuslkpSqlSortBuilder class.
		/// </summary>
		public BbWorkStatuslkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbWorkStatuslkpSortBuilder
