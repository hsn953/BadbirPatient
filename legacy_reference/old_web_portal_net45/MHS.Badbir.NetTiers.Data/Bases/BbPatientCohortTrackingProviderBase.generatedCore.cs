...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPatientCohortTrackingProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPatientCohortTrackingProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingKey key)
		{
			return Delete(transactionManager, key.FupId);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_fupId">Follow up Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _fupId)
		{
			return Delete(null, _fupId);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _fupId);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatientCohortTracking_bbCentre key.
		///		FK_bbPatientCohortTracking_bbCentre Description: 
		/// </summary>
		/// <param name="_centreidcurrent"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByCentreidcurrent(System.Int32? _centreidcurrent)
		{
			int count = -1;
			return GetByCentreidcurrent(_centreidcurrent, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		/// <remarks></remarks>
		public TList<BbPatientCohortTracking> GetByCentreidcurrent(TransactionManager transactionManager, System.Int32? _centreidcurrent)
		{
			int count = -1;
			return GetByCentreidcurrent(transactionManager, _centreidcurrent, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByCentreidcurrent(TransactionManager transactionManager, System.Int32? _centreidcurrent, int start, int pageLength)
		{
			int count = -1;
			return GetByCentreidcurrent(transactionManager, _centreidcurrent, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatientCohortTracking_bbCentre key.
		///		fkBbPatientCohortTrackingBbCentre Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_centreidcurrent"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByCentreidcurrent(System.Int32? _centreidcurrent, int start, int pageLength)
		{
			int count =  -1;
			return GetByCentreidcurrent(null, _centreidcurrent, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByCentreidcurrent(System.Int32? _centreidcurrent, int start, int pageLength,out int count)
		{
			return GetByCentreidcurrent(null, _centreidcurrent, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public abstract TList<BbPatientCohortTracking> GetByCentreidcurrent(TransactionManager transactionManager, System.Int32? _centreidcurrent, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatientCohortTracking_bbPatientCohortTrackingStatuslkp key.
		///		FK_bbPatientCohortTracking_bbPatientCohortTrackingStatuslkp Description: 
		/// </summary>
		/// <param name="_fupstatus">Follow up status</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByFupstatus(System.Int32? _fupstatus)
		{
			int count = -1;
			return GetByFupstatus(_fupstatus, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		/// <remarks></remarks>
		public TList<BbPatientCohortTracking> GetByFupstatus(TransactionManager transactionManager, System.Int32? _fupstatus)
		{
			int count = -1;
			return GetByFupstatus(transactionManager, _fupstatus, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByFupstatus(TransactionManager transactionManager, System.Int32? _fupstatus, int start, int pageLength)
		{
			int count = -1;
			return GetByFupstatus(transactionManager, _fupstatus, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatientCohortTracking_bbPatientCohortTrackingStatuslkp key.
		///		fkBbPatientCohortTrackingBbPatientCohortTrackingStatuslkp Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_fupstatus">Follow up status</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByFupstatus(System.Int32? _fupstatus, int start, int pageLength)
		{
			int count =  -1;
			return GetByFupstatus(null, _fupstatus, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByFupstatus(System.Int32? _fupstatus, int start, int pageLength,out int count)
		{
			return GetByFupstatus(null, _fupstatus, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public abstract TList<BbPatientCohortTracking> GetByFupstatus(TransactionManager transactionManager, System.Int32? _fupstatus, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatientCohortTracking_clinicAttendance key.
		///		FK_bbPatientCohortTracking_clinicAttendance Description: 
		/// </summary>
		/// <param name="_clinicAttendance"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByClinicAttendance(System.Int32? _clinicAttendance)
		{
			int count = -1;
			return GetByClinicAttendance(_clinicAttendance, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		/// <remarks></remarks>
		public TList<BbPatientCohortTracking> GetByClinicAttendance(TransactionManager transactionManager, System.Int32? _clinicAttendance)
		{
			int count = -1;
			return GetByClinicAttendance(transactionManager, _clinicAttendance, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByClinicAttendance(TransactionManager transactionManager, System.Int32? _clinicAttendance, int start, int pageLength)
		{
			int count = -1;
			return GetByClinicAttendance(transactionManager, _clinicAttendance, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPatientCohortTracking_clinicAttendance key.
		///		fkBbPatientCohortTrackingClinicAttendance Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_clinicAttendance"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByClinicAttendance(System.Int32? _clinicAttendance, int start, int pageLength)
		{
			int count =  -1;
			return GetByClinicAttendance(null, _clinicAttendance, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public TList<BbPatientCohortTracking> GetByClinicAttendance(System.Int32? _clinicAttendance, int start, int pageLength,out int count)
		{
			return GetByClinicAttendance(null, _clinicAttendance, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking objects.</returns>
		public abstract TList<BbPatientCohortTracking> GetByClinicAttendance(TransactionManager transactionManager, System.Int32? _clinicAttendance, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingKey key, int start, int pageLength)
		{
			return GetByFupId(transactionManager, key.FupId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key IX_bbPatientCohortTracking index.
		/// </summary>
		/// <param name="_chid">Cohort history Id</param>
		/// <param name="_fupcode">Follow up code</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByChidFupcode(int _chid, int _fupcode)
		{
			int count = -1;
			return GetByChidFupcode(null,_chid, _fupcode, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the IX_bbPatientCohortTracking index.
		/// </summary>
		/// <param name="_chid">Cohort history Id</param>
		/// <param name="_fupcode">Follow up code</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByChidFupcode(int _chid, int _fupcode, int start, int pageLength)
		{
			int count = -1;
			return GetByChidFupcode(null, _chid, _fupcode, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByChidFupcode(TransactionManager transactionManager, int _chid, int _fupcode)
		{
			int count = -1;
			return GetByChidFupcode(transactionManager, _chid, _fupcode, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByChidFupcode(TransactionManager transactionManager, int _chid, int _fupcode, int start, int pageLength)
		{
			int count = -1;
			return GetByChidFupcode(transactionManager, _chid, _fupcode, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByChidFupcode(int _chid, int _fupcode, int start, int pageLength, out int count)
		{
			return GetByChidFupcode(null, _chid, _fupcode, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByChidFupcode(TransactionManager transactionManager, int _chid, int _fupcode, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key NK_chidNonUnique index.
		/// </summary>
		/// <param name="_chid">Cohort history Id</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByChid(int _chid)
		{
			int count = -1;
			return GetByChid(null,_chid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the NK_chidNonUnique index.
		/// </summary>
		/// <param name="_chid">Cohort history Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByChid(int _chid, int start, int pageLength)
		{
			int count = -1;
			return GetByChid(null, _chid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByChid(TransactionManager transactionManager, int _chid)
		{
			int count = -1;
			return GetByChid(transactionManager, _chid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength)
		{
			int count = -1;
			return GetByChid(transactionManager, _chid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByChid(int _chid, int start, int pageLength, out int count)
		{
			return GetByChid(null, _chid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public abstract TList<BbPatientCohortTracking> GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key NK_dateentered index.
		/// </summary>
		/// <param name="_dateentered"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByDateentered(System.DateTime? _dateentered)
		{
			int count = -1;
			return GetByDateentered(null,_dateentered, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the NK_dateentered index.
		/// </summary>
		/// <param name="_dateentered"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByDateentered(System.DateTime? _dateentered, int start, int pageLength)
		{
			int count = -1;
			return GetByDateentered(null, _dateentered, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByDateentered(TransactionManager transactionManager, System.DateTime? _dateentered)
		{
			int count = -1;
			return GetByDateentered(transactionManager, _dateentered, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByDateentered(TransactionManager transactionManager, System.DateTime? _dateentered, int start, int pageLength)
		{
			int count = -1;
			return GetByDateentered(transactionManager, _dateentered, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByDateentered(System.DateTime? _dateentered, int start, int pageLength, out int count)
		{
			return GetByDateentered(null, _dateentered, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public abstract TList<BbPatientCohortTracking> GetByDateentered(TransactionManager transactionManager, System.DateTime? _dateentered, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key NK_editwindowfrom_to index.
		/// </summary>
		/// <param name="_editWindowFrom"></param>
		/// <param name="_editWindowTo"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByEditWindowFromEditWindowTo(System.DateTime? _editWindowFrom, System.DateTime? _editWindowTo)
		{
			int count = -1;
			return GetByEditWindowFromEditWindowTo(null,_editWindowFrom, _editWindowTo, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the NK_editwindowfrom_to index.
		/// </summary>
		/// <param name="_editWindowFrom"></param>
		/// <param name="_editWindowTo"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByEditWindowFromEditWindowTo(System.DateTime? _editWindowFrom, System.DateTime? _editWindowTo, int start, int pageLength)
		{
			int count = -1;
			return GetByEditWindowFromEditWindowTo(null, _editWindowFrom, _editWindowTo, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByEditWindowFromEditWindowTo(TransactionManager transactionManager, System.DateTime? _editWindowFrom, System.DateTime? _editWindowTo)
		{
			int count = -1;
			return GetByEditWindowFromEditWindowTo(transactionManager, _editWindowFrom, _editWindowTo, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByEditWindowFromEditWindowTo(TransactionManager transactionManager, System.DateTime? _editWindowFrom, System.DateTime? _editWindowTo, int start, int pageLength)
		{
			int count = -1;
			return GetByEditWindowFromEditWindowTo(transactionManager, _editWindowFrom, _editWindowTo, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByEditWindowFromEditWindowTo(System.DateTime? _editWindowFrom, System.DateTime? _editWindowTo, int start, int pageLength, out int count)
		{
			return GetByEditWindowFromEditWindowTo(null, _editWindowFrom, _editWindowTo, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public abstract TList<BbPatientCohortTracking> GetByEditWindowFromEditWindowTo(TransactionManager transactionManager, System.DateTime? _editWindowFrom, System.DateTime? _editWindowTo, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key NK_editwindowto index.
		/// </summary>
		/// <param name="_editWindowTo"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByEditWindowTo(System.DateTime? _editWindowTo)
		{
			int count = -1;
			return GetByEditWindowTo(null,_editWindowTo, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the NK_editwindowto index.
		/// </summary>
		/// <param name="_editWindowTo"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByEditWindowTo(System.DateTime? _editWindowTo, int start, int pageLength)
		{
			int count = -1;
			return GetByEditWindowTo(null, _editWindowTo, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByEditWindowTo(TransactionManager transactionManager, System.DateTime? _editWindowTo)
		{
			int count = -1;
			return GetByEditWindowTo(transactionManager, _editWindowTo, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByEditWindowTo(TransactionManager transactionManager, System.DateTime? _editWindowTo, int start, int pageLength)
		{
			int count = -1;
			return GetByEditWindowTo(transactionManager, _editWindowTo, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public TList<BbPatientCohortTracking> GetByEditWindowTo(System.DateTime? _editWindowTo, int start, int pageLength, out int count)
		{
			return GetByEditWindowTo(null, _editWindowTo, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortTracking&gt;"/> class.</returns>
		public abstract TList<BbPatientCohortTracking> GetByEditWindowTo(TransactionManager transactionManager, System.DateTime? _editWindowTo, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbCohortPatientTracking index.
		/// </summary>
		/// <param name="_fupId">Follow up Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByFupId(int _fupId)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbCohortPatientTracking index.
		/// </summary>
		/// <param name="_fupId">Follow up Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByFupId(int _fupId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByFupId(TransactionManager transactionManager, int _fupId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByFupId(TransactionManager transactionManager, int _fupId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByFupId(int _fupId, int start, int pageLength, out int count)
		{
			return GetByFupId(null, _fupId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking GetByFupId(TransactionManager transactionManager, int _fupId, int start, int pageLength, out int count);
		...
		/// <param name="patientid"> A <c>System.Int32?</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public TList<BbPatientCohortTracking> Patient_GetNextFupByPatientid(System.Int32? patientid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public TList<BbPatientCohortTracking> Patient_GetNextFupByPatientid(int start, int pageLength, System.Int32? patientid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public TList<BbPatientCohortTracking> Patient_GetNextFupByPatientid(TransactionManager transactionManager, System.Int32? patientid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public abstract TList<BbPatientCohortTracking> Patient_GetNextFupByPatientid(TransactionManager transactionManager, int start, int pageLength , System.Int32? patientid);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public TList<BbPatientCohortTracking> PatientCohortTracking_ClearFupData(System.Int32? fupid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public TList<BbPatientCohortTracking> PatientCohortTracking_ClearFupData(int start, int pageLength, System.Int32? fupid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public TList<BbPatientCohortTracking> PatientCohortTracking_ClearFupData(TransactionManager transactionManager, System.Int32? fupid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public abstract TList<BbPatientCohortTracking> PatientCohortTracking_ClearFupData(TransactionManager transactionManager, int start, int pageLength , System.Int32? fupid);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public TList<BbPatientCohortTracking> PatientCohortTracking_FupSwitch(System.Int32? srcfupid, System.Int32? targetfupid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public TList<BbPatientCohortTracking> PatientCohortTracking_FupSwitch(int start, int pageLength, System.Int32? srcfupid, System.Int32? targetfupid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public TList<BbPatientCohortTracking> PatientCohortTracking_FupSwitch(TransactionManager transactionManager, System.Int32? srcfupid, System.Int32? targetfupid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortTracking&gt;"/> instance.</returns>
		public abstract TList<BbPatientCohortTracking> PatientCohortTracking_FupSwitch(TransactionManager transactionManager, int start, int pageLength , System.Int32? srcfupid, System.Int32? targetfupid);
		...
		/// <summary>
		/// Fill a TList&lt;BbPatientCohortTracking&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPatientCohortTracking&gt;"/></returns>
		public static TList<BbPatientCohortTracking> Fill(IDataReader reader, TList<BbPatientCohortTracking> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPatientCohortTracking")
					.Append("|").Append((int)reader[((int)BbPatientCohortTrackingColumn.FupId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPatientCohortTracking>(
					key.ToString(), // EntityTrackingKey
					"BbPatientCohortTracking",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking();
				}
					...
					))
				{
					...
					c.FupId = (int)reader[((int)BbPatientCohortTrackingColumn.FupId - 1)];
					c.Chid = (int)reader[((int)BbPatientCohortTrackingColumn.Chid - 1)];
					c.Fupcode = (int)reader[((int)BbPatientCohortTrackingColumn.Fupcode - 1)];
					c.Studynocurrent = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Studynocurrent - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Studynocurrent - 1)];
					c.Centreidcurrent = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Centreidcurrent - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Centreidcurrent - 1)];
					c.Consultantidcurrent = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Consultantidcurrent - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Consultantidcurrent - 1)];
					c.ClinicVisitdate = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.ClinicVisitdate - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.ClinicVisitdate - 1)];
					c.Duedate = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Duedate - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.Duedate - 1)];
					c.EditWindowFrom = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.EditWindowFrom - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.EditWindowFrom - 1)];
					c.EditWindowTo = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.EditWindowTo - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.EditWindowTo - 1)];
					c.Fupstatus = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Fupstatus - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Fupstatus - 1)];
					c.Datavalid = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Datavalid - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Datavalid - 1)];
					c.Feedbackstatus = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Feedbackstatus - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Feedbackstatus - 1)];
					c.Comments = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Comments - 1)))?null:(string)reader[((int)BbPatientCohortTrackingColumn.Comments - 1)];
					c.Dateentered = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Dateentered - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.Dateentered - 1)];
					c.Hasnocurrenttherapy = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnocurrenttherapy - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnocurrenttherapy - 1)];
					c.Hasnobiologictherapy = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnobiologictherapy - 1)];
					c.Hasnoconventionaltherapy = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnoconventionaltherapy - 1)];
					c.Hasnoprevioustherapy = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnoprevioustherapy - 1)];
					c.Hasnocomorbidities = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnocomorbidities - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnocomorbidities - 1)];
					c.Hasnolesions = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnolesions - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnolesions - 1)];
					c.Hasnouvtherapy = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnouvtherapy - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnouvtherapy - 1)];
					c.Hasnolabvalues = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnolabvalues - 1)];
					c.Hasnoadverseevents = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnoadverseevents - 1)];
					c.Hasnodiseaseseverity = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnodiseaseseverity - 1)];
					c.Hasnopasi = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnopasi - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnopasi - 1)];
					c.Hasnoadditionalinfo = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnoadditionalinfo - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnoadditionalinfo - 1)];
					c.Hasnomedicalproblems = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnomedicalproblems - 1)];
					c.Hasnodlqi = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnodlqi - 1)];
					c.Hasnolifestylefactors = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnolifestylefactors - 1)];
					c.Cageinapplicable = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Cageinapplicable - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Cageinapplicable - 1)];
					c.Haqinapplicable = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Haqinapplicable - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Haqinapplicable - 1)];
					c.Discontinuedbiotherapy = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Discontinuedbiotherapy - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Discontinuedbiotherapy - 1)];
					c.Checkedbyid = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Checkedbyid - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Checkedbyid - 1)];
					c.Checkedbydate = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Checkedbydate - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.Checkedbydate - 1)];
					c.Haspreviousantipsoriaticdrugs = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Haspreviousantipsoriaticdrugs - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Haspreviousantipsoriaticdrugs - 1)];
					c.Haschangedbiologictherapy = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Haschangedbiologictherapy - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Haschangedbiologictherapy - 1)];
					c.Hasnewadverseevents = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnewadverseevents - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnewadverseevents - 1)];
					c.Createdbyid = (int)reader[((int)BbPatientCohortTrackingColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPatientCohortTrackingColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPatientCohortTrackingColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPatientCohortTrackingColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPatientCohortTrackingColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPatientCohortTrackingColumn.Lastupdateddate - 1)];
					c.Haspsoriaticarthiritis = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Haspsoriaticarthiritis - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Haspsoriaticarthiritis - 1)];
					c.Hasinflamatoryarthiritis = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasinflamatoryarthiritis - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasinflamatoryarthiritis - 1)];
					c.Psoriaticarthiritisonset = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Psoriaticarthiritisonset - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Psoriaticarthiritisonset - 1)];
					c.TruncatedFupApplicable = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.TruncatedFupApplicable - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.TruncatedFupApplicable - 1)];
					c.Psoriaticarthiritisonsetdate = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Psoriaticarthiritisonsetdate - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.Psoriaticarthiritisonsetdate - 1)];
					c.HasnoSmiTherapy = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.HasnoSmiTherapy - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.HasnoSmiTherapy - 1)];
					c.ClinicAttendance = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.ClinicAttendance - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.ClinicAttendance - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking entity)
		{
			if (!reader.Read()) return;
			
			entity.FupId = (int)reader[((int)BbPatientCohortTrackingColumn.FupId - 1)];
			entity.Chid = (int)reader[((int)BbPatientCohortTrackingColumn.Chid - 1)];
			entity.Fupcode = (int)reader[((int)BbPatientCohortTrackingColumn.Fupcode - 1)];
			entity.Studynocurrent = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Studynocurrent - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Studynocurrent - 1)];
			entity.Centreidcurrent = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Centreidcurrent - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Centreidcurrent - 1)];
			entity.Consultantidcurrent = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Consultantidcurrent - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Consultantidcurrent - 1)];
			entity.ClinicVisitdate = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.ClinicVisitdate - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.ClinicVisitdate - 1)];
			entity.Duedate = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Duedate - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.Duedate - 1)];
			entity.EditWindowFrom = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.EditWindowFrom - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.EditWindowFrom - 1)];
			entity.EditWindowTo = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.EditWindowTo - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.EditWindowTo - 1)];
			entity.Fupstatus = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Fupstatus - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Fupstatus - 1)];
			entity.Datavalid = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Datavalid - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Datavalid - 1)];
			entity.Feedbackstatus = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Feedbackstatus - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Feedbackstatus - 1)];
			entity.Comments = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Comments - 1)))?null:(string)reader[((int)BbPatientCohortTrackingColumn.Comments - 1)];
			entity.Dateentered = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Dateentered - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.Dateentered - 1)];
			entity.Hasnocurrenttherapy = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnocurrenttherapy - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnocurrenttherapy - 1)];
			entity.Hasnobiologictherapy = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnobiologictherapy - 1)];
			entity.Hasnoconventionaltherapy = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnoconventionaltherapy - 1)];
			entity.Hasnoprevioustherapy = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnoprevioustherapy - 1)];
			entity.Hasnocomorbidities = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnocomorbidities - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnocomorbidities - 1)];
			entity.Hasnolesions = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnolesions - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnolesions - 1)];
			entity.Hasnouvtherapy = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnouvtherapy - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnouvtherapy - 1)];
			entity.Hasnolabvalues = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnolabvalues - 1)];
			entity.Hasnoadverseevents = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnoadverseevents - 1)];
			entity.Hasnodiseaseseverity = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnodiseaseseverity - 1)];
			entity.Hasnopasi = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnopasi - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnopasi - 1)];
			entity.Hasnoadditionalinfo = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnoadditionalinfo - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnoadditionalinfo - 1)];
			entity.Hasnomedicalproblems = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnomedicalproblems - 1)];
			entity.Hasnodlqi = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnodlqi - 1)];
			entity.Hasnolifestylefactors = (bool)reader[((int)BbPatientCohortTrackingColumn.Hasnolifestylefactors - 1)];
			entity.Cageinapplicable = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Cageinapplicable - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Cageinapplicable - 1)];
			entity.Haqinapplicable = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Haqinapplicable - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Haqinapplicable - 1)];
			entity.Discontinuedbiotherapy = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Discontinuedbiotherapy - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Discontinuedbiotherapy - 1)];
			entity.Checkedbyid = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Checkedbyid - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Checkedbyid - 1)];
			entity.Checkedbydate = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Checkedbydate - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.Checkedbydate - 1)];
			entity.Haspreviousantipsoriaticdrugs = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Haspreviousantipsoriaticdrugs - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Haspreviousantipsoriaticdrugs - 1)];
			entity.Haschangedbiologictherapy = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Haschangedbiologictherapy - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Haschangedbiologictherapy - 1)];
			entity.Hasnewadverseevents = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasnewadverseevents - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasnewadverseevents - 1)];
			entity.Createdbyid = (int)reader[((int)BbPatientCohortTrackingColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPatientCohortTrackingColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPatientCohortTrackingColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPatientCohortTrackingColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPatientCohortTrackingColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPatientCohortTrackingColumn.Lastupdateddate - 1)];
			entity.Haspsoriaticarthiritis = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Haspsoriaticarthiritis - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Haspsoriaticarthiritis - 1)];
			entity.Hasinflamatoryarthiritis = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Hasinflamatoryarthiritis - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.Hasinflamatoryarthiritis - 1)];
			entity.Psoriaticarthiritisonset = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Psoriaticarthiritisonset - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.Psoriaticarthiritisonset - 1)];
			entity.TruncatedFupApplicable = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.TruncatedFupApplicable - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.TruncatedFupApplicable - 1)];
			entity.Psoriaticarthiritisonsetdate = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.Psoriaticarthiritisonsetdate - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortTrackingColumn.Psoriaticarthiritisonsetdate - 1)];
			entity.HasnoSmiTherapy = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.HasnoSmiTherapy - 1)))?null:(System.Boolean?)reader[((int)BbPatientCohortTrackingColumn.HasnoSmiTherapy - 1)];
			entity.ClinicAttendance = (reader.IsDBNull(((int)BbPatientCohortTrackingColumn.ClinicAttendance - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortTrackingColumn.ClinicAttendance - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.FupId = (int)dataRow["FupId"];
			entity.Chid = (int)dataRow["chid"];
			entity.Fupcode = (int)dataRow["fupcode"];
			entity.Studynocurrent = Convert.IsDBNull(dataRow["studynocurrent"]) ? null : (System.Int32?)dataRow["studynocurrent"];
			entity.Centreidcurrent = Convert.IsDBNull(dataRow["centreidcurrent"]) ? null : (System.Int32?)dataRow["centreidcurrent"];
			entity.Consultantidcurrent = Convert.IsDBNull(dataRow["consultantidcurrent"]) ? null : (System.Int32?)dataRow["consultantidcurrent"];
			entity.ClinicVisitdate = Convert.IsDBNull(dataRow["clinicVisitdate"]) ? null : (System.DateTime?)dataRow["clinicVisitdate"];
			entity.Duedate = Convert.IsDBNull(dataRow["duedate"]) ? null : (System.DateTime?)dataRow["duedate"];
			entity.EditWindowFrom = Convert.IsDBNull(dataRow["editWindowFrom"]) ? null : (System.DateTime?)dataRow["editWindowFrom"];
			entity.EditWindowTo = Convert.IsDBNull(dataRow["editWindowTo"]) ? null : (System.DateTime?)dataRow["editWindowTo"];
			entity.Fupstatus = Convert.IsDBNull(dataRow["fupstatus"]) ? null : (System.Int32?)dataRow["fupstatus"];
			entity.Datavalid = Convert.IsDBNull(dataRow["datavalid"]) ? null : (System.Int32?)dataRow["datavalid"];
			entity.Feedbackstatus = Convert.IsDBNull(dataRow["feedbackstatus"]) ? null : (System.Int32?)dataRow["feedbackstatus"];
			entity.Comments = Convert.IsDBNull(dataRow["comments"]) ? null : (string)dataRow["comments"];
			entity.Dateentered = Convert.IsDBNull(dataRow["dateentered"]) ? null : (System.DateTime?)dataRow["dateentered"];
			entity.Hasnocurrenttherapy = Convert.IsDBNull(dataRow["hasnocurrenttherapy"]) ? null : (System.Boolean?)dataRow["hasnocurrenttherapy"];
			entity.Hasnobiologictherapy = (bool)dataRow["hasnobiologictherapy"];
			entity.Hasnoconventionaltherapy = (bool)dataRow["hasnoconventionaltherapy"];
			entity.Hasnoprevioustherapy = (bool)dataRow["hasnoprevioustherapy"];
			entity.Hasnocomorbidities = Convert.IsDBNull(dataRow["hasnocomorbidities"]) ? null : (System.Boolean?)dataRow["hasnocomorbidities"];
			entity.Hasnolesions = Convert.IsDBNull(dataRow["hasnolesions"]) ? null : (System.Boolean?)dataRow["hasnolesions"];
			entity.Hasnouvtherapy = Convert.IsDBNull(dataRow["hasnouvtherapy"]) ? null : (System.Boolean?)dataRow["hasnouvtherapy"];
			entity.Hasnolabvalues = (bool)dataRow["hasnolabvalues"];
			entity.Hasnoadverseevents = (bool)dataRow["hasnoadverseevents"];
			entity.Hasnodiseaseseverity = (bool)dataRow["hasnodiseaseseverity"];
			entity.Hasnopasi = Convert.IsDBNull(dataRow["hasnopasi"]) ? null : (System.Boolean?)dataRow["hasnopasi"];
			entity.Hasnoadditionalinfo = Convert.IsDBNull(dataRow["hasnoadditionalinfo"]) ? null : (System.Boolean?)dataRow["hasnoadditionalinfo"];
			entity.Hasnomedicalproblems = (bool)dataRow["hasnomedicalproblems"];
			entity.Hasnodlqi = (bool)dataRow["hasnodlqi"];
			entity.Hasnolifestylefactors = (bool)dataRow["hasnolifestylefactors"];
			entity.Cageinapplicable = Convert.IsDBNull(dataRow["cageinapplicable"]) ? null : (System.Boolean?)dataRow["cageinapplicable"];
			entity.Haqinapplicable = Convert.IsDBNull(dataRow["haqinapplicable"]) ? null : (System.Boolean?)dataRow["haqinapplicable"];
			entity.Discontinuedbiotherapy = Convert.IsDBNull(dataRow["discontinuedbiotherapy"]) ? null : (System.Boolean?)dataRow["discontinuedbiotherapy"];
			entity.Checkedbyid = Convert.IsDBNull(dataRow["checkedbyid"]) ? null : (System.Int32?)dataRow["checkedbyid"];
			entity.Checkedbydate = Convert.IsDBNull(dataRow["checkedbydate"]) ? null : (System.DateTime?)dataRow["checkedbydate"];
			entity.Haspreviousantipsoriaticdrugs = Convert.IsDBNull(dataRow["haspreviousantipsoriaticdrugs"]) ? null : (System.Boolean?)dataRow["haspreviousantipsoriaticdrugs"];
			entity.Haschangedbiologictherapy = Convert.IsDBNull(dataRow["haschangedbiologictherapy"]) ? null : (System.Boolean?)dataRow["haschangedbiologictherapy"];
			entity.Hasnewadverseevents = Convert.IsDBNull(dataRow["hasnewadverseevents"]) ? null : (System.Boolean?)dataRow["hasnewadverseevents"];
			...
			entity.Haspsoriaticarthiritis = Convert.IsDBNull(dataRow["haspsoriaticarthiritis"]) ? null : (System.Boolean?)dataRow["haspsoriaticarthiritis"];
			entity.Hasinflamatoryarthiritis = Convert.IsDBNull(dataRow["hasinflamatoryarthiritis"]) ? null : (System.Boolean?)dataRow["hasinflamatoryarthiritis"];
			entity.Psoriaticarthiritisonset = Convert.IsDBNull(dataRow["psoriaticarthiritisonset"]) ? null : (System.Int32?)dataRow["psoriaticarthiritisonset"];
			entity.TruncatedFupApplicable = Convert.IsDBNull(dataRow["truncated_fup_applicable"]) ? null : (System.Int32?)dataRow["truncated_fup_applicable"];
			entity.Psoriaticarthiritisonsetdate = Convert.IsDBNull(dataRow["psoriaticarthiritisonsetdate"]) ? null : (System.DateTime?)dataRow["psoriaticarthiritisonsetdate"];
			entity.HasnoSmiTherapy = Convert.IsDBNull(dataRow["hasnoSMITherapy"]) ? null : (System.Boolean?)dataRow["hasnoSMITherapy"];
			entity.ClinicAttendance = Convert.IsDBNull(dataRow["clinicAttendance"]) ? null : (System.Int32?)dataRow["clinicAttendance"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region ChidSource	
			if (CanDeepLoad(entity, "BbPatientCohortHistory|ChidSource", deepLoadType, innerList) 
				&& entity.ChidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.Chid;
				BbPatientCohortHistory tmpEntity = EntityManager.LocateEntity<BbPatientCohortHistory>(EntityLocator.ConstructKeyFromPkItems(typeof(BbPatientCohortHistory), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.ChidSource = tmpEntity;
				else
					entity.ChidSource = DataRepository.BbPatientCohortHistoryProvider.GetByChid(transactionManager, entity.Chid);		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'ChidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.ChidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbPatientCohortHistoryProvider.DeepLoad(transactionManager, entity.ChidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion ChidSource

			#region CentreidcurrentSource	
			if (CanDeepLoad(entity, "BbCentre|CentreidcurrentSource", deepLoadType, innerList) 
				&& entity.CentreidcurrentSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.Centreidcurrent ?? (int)0);
				BbCentre tmpEntity = EntityManager.LocateEntity<BbCentre>(EntityLocator.ConstructKeyFromPkItems(typeof(BbCentre), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.CentreidcurrentSource = tmpEntity;
				else
					entity.CentreidcurrentSource = DataRepository.BbCentreProvider.GetByCentreid(transactionManager, (entity.Centreidcurrent ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'CentreidcurrentSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.CentreidcurrentSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbCentreProvider.DeepLoad(transactionManager, entity.CentreidcurrentSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion CentreidcurrentSource

			#region FupstatusSource	
			if (CanDeepLoad(entity, "BbPatientCohortTrackingStatuslkp|FupstatusSource", deepLoadType, innerList) 
				&& entity.FupstatusSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.Fupstatus ?? (int)0);
				BbPatientCohortTrackingStatuslkp tmpEntity = EntityManager.LocateEntity<BbPatientCohortTrackingStatuslkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbPatientCohortTrackingStatuslkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.FupstatusSource = tmpEntity;
				else
					entity.FupstatusSource = DataRepository.BbPatientCohortTrackingStatuslkpProvider.GetByPtrackingstatusid(transactionManager, (entity.Fupstatus ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'FupstatusSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.FupstatusSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbPatientCohortTrackingStatuslkpProvider.DeepLoad(transactionManager, entity.FupstatusSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion FupstatusSource

			#region ClinicAttendanceSource	
			if (CanDeepLoad(entity, "BbPatientCohortTrackingClinicAttendanceLkp|ClinicAttendanceSource", deepLoadType, innerList) 
				&& entity.ClinicAttendanceSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.ClinicAttendance ?? (int)0);
				BbPatientCohortTrackingClinicAttendanceLkp tmpEntity = EntityManager.LocateEntity<BbPatientCohortTrackingClinicAttendanceLkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbPatientCohortTrackingClinicAttendanceLkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.ClinicAttendanceSource = tmpEntity;
				else
					entity.ClinicAttendanceSource = DataRepository.BbPatientCohortTrackingClinicAttendanceLkpProvider.GetByClinicAttendanceId(transactionManager, (entity.ClinicAttendance ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'ClinicAttendanceSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.ClinicAttendanceSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbPatientCohortTrackingClinicAttendanceLkpProvider.DeepLoad(transactionManager, entity.ClinicAttendanceSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion ClinicAttendanceSource
			
			//used to hold DeepLoad method delegates and fire after all the local children have been loaded.
			Dictionary<string, KeyValuePair<Delegate, object>> deepHandles = new Dictionary<string, KeyValuePair<Delegate, object>>();
			// Deep load child collections  - Call GetByFupId methods when available
			
			#region BbPatientdrugCollection
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbPatientdrug>|BbPatientdrugCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbPatientdrugCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbPatientdrugCollection = DataRepository.BbPatientdrugProvider.GetByFupId(transactionManager, entity.FupId);

				if (deep && entity.BbPatientdrugCollection.Count > 0)
				{
					deepHandles.Add("BbPatientdrugCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbPatientdrug>) DataRepository.BbPatientdrugProvider.DeepLoad,
						new object[] { transactionManager, entity.BbPatientdrugCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
			...
			if (CanDeepLoad(entity, "BbPatientLifestyle|BbPatientLifestyle", deepLoadType, innerList))
			{
				entity.BbPatientLifestyle = DataRepository.BbPatientLifestyleProvider.GetByFupId(transactionManager, entity.FupId);
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbPatientLifestyle' loaded. key " + entity.EntityTrackingKey);
				#endif 

				if (deep && entity.BbPatientLifestyle != null)
				{
					deepHandles.Add("BbPatientLifestyle",
						new KeyValuePair<Delegate, object>((DeepLoadSingleHandle< BbPatientLifestyle >) DataRepository.BbPatientLifestyleProvider.DeepLoad,
						new object[] { transactionManager, entity.BbPatientLifestyle, deep, deepLoadType, childTypes, innerList }
					));
				}
			}
			#endregion 
			...
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbPappPatientCohortTracking>|BbPappPatientCohortTrackingCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbPappPatientCohortTrackingCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbPappPatientCohortTrackingCollection = DataRepository.BbPappPatientCohortTrackingProvider.GetByImportedFupId(transactionManager, entity.FupId);

				if (deep && entity.BbPappPatientCohortTrackingCollection.Count > 0)
				{
					deepHandles.Add("BbPappPatientCohortTrackingCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbPappPatientCohortTracking>) DataRepository.BbPappPatientCohortTrackingProvider.DeepLoad,
						new object[] { transactionManager, entity.BbPappPatientCohortTrackingCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region ChidSource
			if (CanDeepSave(entity, "BbPatientCohortHistory|ChidSource", deepSaveType, innerList) 
				&& entity.ChidSource != null)
			{
				DataRepository.BbPatientCohortHistoryProvider.Save(transactionManager, entity.ChidSource);
				entity.Chid = entity.ChidSource.Chid;
			}
			#endregion 
			
			#region CentreidcurrentSource
			if (CanDeepSave(entity, "BbCentre|CentreidcurrentSource", deepSaveType, innerList) 
				&& entity.CentreidcurrentSource != null)
			{
				DataRepository.BbCentreProvider.Save(transactionManager, entity.CentreidcurrentSource);
				entity.Centreidcurrent = entity.CentreidcurrentSource.Centreid;
			}
			#endregion 
			
			#region FupstatusSource
			if (CanDeepSave(entity, "BbPatientCohortTrackingStatuslkp|FupstatusSource", deepSaveType, innerList) 
				&& entity.FupstatusSource != null)
			{
				DataRepository.BbPatientCohortTrackingStatuslkpProvider.Save(transactionManager, entity.FupstatusSource);
				entity.Fupstatus = entity.FupstatusSource.Ptrackingstatusid;
			}
			#endregion 
			
			#region ClinicAttendanceSource
			if (CanDeepSave(entity, "BbPatientCohortTrackingClinicAttendanceLkp|ClinicAttendanceSource", deepSaveType, innerList) 
				&& entity.ClinicAttendanceSource != null)
			{
				DataRepository.BbPatientCohortTrackingClinicAttendanceLkpProvider.Save(transactionManager, entity.ClinicAttendanceSource);
				entity.ClinicAttendance = entity.ClinicAttendanceSource.ClinicAttendanceId;
			}
			#endregion 
			...
			#region BbPatientLifestyle
			if (CanDeepSave(entity.BbPatientLifestyle, "BbPatientLifestyle|BbPatientLifestyle", deepSaveType, innerList))
			{

				if (entity.BbPatientLifestyle != null)
				{
					// update each child parent id with the real parent id (mostly used on insert)

					entity.BbPatientLifestyle.FupId = entity.FupId;
					//DataRepository.BbPatientLifestyleProvider.Save(transactionManager, entity.BbPatientLifestyle);
					deepHandles.Add("BbPatientLifestyle",
						new KeyValuePair<Delegate, object>((DeepSaveSingleHandle< BbPatientLifestyle >) DataRepository.BbPatientLifestyleProvider.DeepSave,
						new object[] { transactionManager, entity.BbPatientLifestyle, deepSaveType, childTypes, innerList }
					));
				}
			} 
			#endregion 
	
			#region List<BbPatientdrug>
				if (CanDeepSave(entity.BbPatientdrugCollection, "List<BbPatientdrug>|BbPatientdrugCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbPatientdrug child in entity.BbPatientdrugCollection)
					{
						if(child.FupIdSource != null)
						{
							child.FupId = child.FupIdSource.FupId;
						}
						else
						{
							child.FupId = entity.FupId;
						}

					}

					if (entity.BbPatientdrugCollection.Count > 0 || entity.BbPatientdrugCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbPatientdrugProvider.Save(transactionManager, entity.BbPatientdrugCollection);
						
						deepHandles.Add("BbPatientdrugCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbPatientdrug >) DataRepository.BbPatientdrugProvider.DeepSave,
							new object[] { transactionManager, entity.BbPatientdrugCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
			...
			#region List<BbPappPatientCohortTracking>
				if (CanDeepSave(entity.BbPappPatientCohortTrackingCollection, "List<BbPappPatientCohortTracking>|BbPappPatientCohortTrackingCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbPappPatientCohortTracking child in entity.BbPappPatientCohortTrackingCollection)
					{
						if(child.ImportedFupIdSource != null)
						{
							child.ImportedFupId = child.ImportedFupIdSource.FupId;
						}
						else
						{
							child.ImportedFupId = entity.FupId;
						}

					}

					if (entity.BbPappPatientCohortTrackingCollection.Count > 0 || entity.BbPappPatientCohortTrackingCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbPappPatientCohortTrackingProvider.Save(transactionManager, entity.BbPappPatientCohortTrackingCollection);
						
						deepHandles.Add("BbPappPatientCohortTrackingCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbPappPatientCohortTracking >) DataRepository.BbPappPatientCohortTrackingProvider.DeepSave,
							new object[] { transactionManager, entity.BbPappPatientCohortTrackingCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	#region BbPatientCohortTrackingChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPatientCohortTracking</c>
	///</summary>
	public enum BbPatientCohortTrackingChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbPatientCohortHistory</c> at ChidSource
		///</summary>
		[ChildEntityType(typeof(BbPatientCohortHistory))]
		BbPatientCohortHistory,
		
		///<summary>
		/// Composite Property for <c>BbCentre</c> at CentreidcurrentSource
		///</summary>
		[ChildEntityType(typeof(BbCentre))]
		BbCentre,
		
		///<summary>
		/// Composite Property for <c>BbPatientCohortTrackingStatuslkp</c> at FupstatusSource
		///</summary>
		[ChildEntityType(typeof(BbPatientCohortTrackingStatuslkp))]
		BbPatientCohortTrackingStatuslkp,
		
		///<summary>
		/// Composite Property for <c>BbPatientCohortTrackingClinicAttendanceLkp</c> at ClinicAttendanceSource
		///</summary>
		[ChildEntityType(typeof(BbPatientCohortTrackingClinicAttendanceLkp))]
		BbPatientCohortTrackingClinicAttendanceLkp,
		///<summary>
		/// Collection of <c>BbPatientCohortTracking</c> as OneToMany for BbPatientdrugCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientdrug>))]
		BbPatientdrugCollection,
		///<summary>
		/// Entity <c>BbPatientLifestyle</c> as OneToOne for BbPatientLifestyle
		///</summary>
		[ChildEntityType(typeof(BbPatientLifestyle))]
		BbPatientLifestyle,
		///<summary>
		/// Collection of <c>BbPatientCohortTracking</c> as OneToMany for BbPappPatientCohortTrackingCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPappPatientCohortTracking>))]
		BbPappPatientCohortTrackingCollection,
	}
	
	#endregion BbPatientCohortTrackingChildEntityTypes
	
	#region BbPatientCohortTrackingFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPatientCohortTrackingColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortTracking"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientCohortTrackingFilterBuilder : SqlFilterBuilder<BbPatientCohortTrackingColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingFilterBuilder class.
		/// </summary>
		public BbPatientCohortTrackingFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientCohortTrackingFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPatientCohortTrackingFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientCohortTrackingFilterBuilder
	
	#region BbPatientCohortTrackingParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPatientCohortTrackingColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortTracking"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientCohortTrackingParameterBuilder : ParameterizedSqlFilterBuilder<BbPatientCohortTrackingColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingParameterBuilder class.
		/// </summary>
		public BbPatientCohortTrackingParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientCohortTrackingParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPatientCohortTrackingParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientCohortTrackingParameterBuilder
	
	#region BbPatientCohortTrackingSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPatientCohortTrackingColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortTracking"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPatientCohortTrackingSortBuilder : SqlSortBuilder<BbPatientCohortTrackingColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingSqlSortBuilder class.
		/// </summary>
		public BbPatientCohortTrackingSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPatientCohortTrackingSortBuilder
