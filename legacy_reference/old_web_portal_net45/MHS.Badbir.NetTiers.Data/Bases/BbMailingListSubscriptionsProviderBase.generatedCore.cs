...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbMailingListSubscriptionsProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbMailingListSubscriptionsProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions, MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptionsKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptionsKey key)
		{
			return Delete(transactionManager, key.BbMlSid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_bbMlSid">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Int32 _bbMlSid)
		{
			return Delete(null, _bbMlSid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Int32 _bbMlSid);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbMailingListSubscriptions_bbMailingLists key.
		///		FK_bbMailingListSubscriptions_bbMailingLists Description: 
		/// </summary>
		/// <param name="_bbMlid"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions objects.</returns>
		public TList<BbMailingListSubscriptions> GetByBbMlid(System.Int32 _bbMlid)
		{
			int count = -1;
			return GetByBbMlid(_bbMlid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions objects.</returns>
		/// <remarks></remarks>
		public TList<BbMailingListSubscriptions> GetByBbMlid(TransactionManager transactionManager, System.Int32 _bbMlid)
		{
			int count = -1;
			return GetByBbMlid(transactionManager, _bbMlid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions objects.</returns>
		public TList<BbMailingListSubscriptions> GetByBbMlid(TransactionManager transactionManager, System.Int32 _bbMlid, int start, int pageLength)
		{
			int count = -1;
			return GetByBbMlid(transactionManager, _bbMlid, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbMailingListSubscriptions_bbMailingLists key.
		///		fkBbMailingListSubscriptionsBbMailingLists Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_bbMlid"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions objects.</returns>
		public TList<BbMailingListSubscriptions> GetByBbMlid(System.Int32 _bbMlid, int start, int pageLength)
		{
			int count =  -1;
			return GetByBbMlid(null, _bbMlid, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions objects.</returns>
		public TList<BbMailingListSubscriptions> GetByBbMlid(System.Int32 _bbMlid, int start, int pageLength,out int count)
		{
			return GetByBbMlid(null, _bbMlid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions objects.</returns>
		public abstract TList<BbMailingListSubscriptions> GetByBbMlid(TransactionManager transactionManager, System.Int32 _bbMlid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptionsKey key, int start, int pageLength)
		{
			return GetByBbMlSid(transactionManager, key.BbMlSid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key CentreIdIndex index.
		/// </summary>
		/// <param name="_subsCentreid"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public TList<BbMailingListSubscriptions> GetBySubsCentreid(System.Int32? _subsCentreid)
		{
			int count = -1;
			return GetBySubsCentreid(null,_subsCentreid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the CentreIdIndex index.
		/// </summary>
		/// <param name="_subsCentreid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public TList<BbMailingListSubscriptions> GetBySubsCentreid(System.Int32? _subsCentreid, int start, int pageLength)
		{
			int count = -1;
			return GetBySubsCentreid(null, _subsCentreid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public TList<BbMailingListSubscriptions> GetBySubsCentreid(TransactionManager transactionManager, System.Int32? _subsCentreid)
		{
			int count = -1;
			return GetBySubsCentreid(transactionManager, _subsCentreid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public TList<BbMailingListSubscriptions> GetBySubsCentreid(TransactionManager transactionManager, System.Int32? _subsCentreid, int start, int pageLength)
		{
			int count = -1;
			return GetBySubsCentreid(transactionManager, _subsCentreid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public TList<BbMailingListSubscriptions> GetBySubsCentreid(System.Int32? _subsCentreid, int start, int pageLength, out int count)
		{
			return GetBySubsCentreid(null, _subsCentreid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public abstract TList<BbMailingListSubscriptions> GetBySubsCentreid(TransactionManager transactionManager, System.Int32? _subsCentreid, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key IX_bbMailingListSubscriptions index.
		/// </summary>
		/// <param name="_userName"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public TList<BbMailingListSubscriptions> GetByUserName(System.String _userName)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the IX_bbMailingListSubscriptions index.
		/// </summary>
		/// <param name="_userName"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public TList<BbMailingListSubscriptions> GetByUserName(System.String _userName, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public TList<BbMailingListSubscriptions> GetByUserName(TransactionManager transactionManager, System.String _userName)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public TList<BbMailingListSubscriptions> GetByUserName(TransactionManager transactionManager, System.String _userName, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public TList<BbMailingListSubscriptions> GetByUserName(System.String _userName, int start, int pageLength, out int count)
		{
			return GetByUserName(null, _userName, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbMailingListSubscriptions&gt;"/> class.</returns>
		public abstract TList<BbMailingListSubscriptions> GetByUserName(TransactionManager transactionManager, System.String _userName, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbMailingListSubscriptions index.
		/// </summary>
		/// <param name="_bbMlSid"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions GetByBbMlSid(System.Int32 _bbMlSid)
		{
			int count = -1;
			return GetByBbMlSid(null,_bbMlSid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbMailingListSubscriptions index.
		/// </summary>
		/// <param name="_bbMlSid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions GetByBbMlSid(System.Int32 _bbMlSid, int start, int pageLength)
		{
			int count = -1;
			return GetByBbMlSid(null, _bbMlSid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions GetByBbMlSid(TransactionManager transactionManager, System.Int32 _bbMlSid)
		{
			int count = -1;
			return GetByBbMlSid(transactionManager, _bbMlSid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions GetByBbMlSid(TransactionManager transactionManager, System.Int32 _bbMlSid, int start, int pageLength)
		{
			int count = -1;
			return GetByBbMlSid(transactionManager, _bbMlSid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions GetByBbMlSid(System.Int32 _bbMlSid, int start, int pageLength, out int count)
		{
			return GetByBbMlSid(null, _bbMlSid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions GetByBbMlSid(TransactionManager transactionManager, System.Int32 _bbMlSid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbMailingListSubscriptions&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbMailingListSubscriptions&gt;"/></returns>
		public static TList<BbMailingListSubscriptions> Fill(IDataReader reader, TList<BbMailingListSubscriptions> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbMailingListSubscriptions")
					.Append("|").Append((System.Int32)reader[((int)BbMailingListSubscriptionsColumn.BbMlSid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbMailingListSubscriptions>(
					key.ToString(), // EntityTrackingKey
					"BbMailingListSubscriptions",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions();
				}
					...
					))
				{
					...
					c.BbMlSid = (System.Int32)reader[((int)BbMailingListSubscriptionsColumn.BbMlSid - 1)];
					c.BbMlid = (System.Int32)reader[((int)BbMailingListSubscriptionsColumn.BbMlid - 1)];
					c.UserName = (reader.IsDBNull(((int)BbMailingListSubscriptionsColumn.UserName - 1)))?null:(System.String)reader[((int)BbMailingListSubscriptionsColumn.UserName - 1)];
					c.EmailAddress = (System.String)reader[((int)BbMailingListSubscriptionsColumn.EmailAddress - 1)];
					c.Createdbyid = (System.Int32)reader[((int)BbMailingListSubscriptionsColumn.Createdbyid - 1)];
					c.Createdbyname = (System.String)reader[((int)BbMailingListSubscriptionsColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbMailingListSubscriptionsColumn.Createddate - 1)];
					c.Lastupdatedbyid = (System.Int32)reader[((int)BbMailingListSubscriptionsColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (System.String)reader[((int)BbMailingListSubscriptionsColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbMailingListSubscriptionsColumn.Lastupdateddate - 1)];
					c.SubsCentreid = (reader.IsDBNull(((int)BbMailingListSubscriptionsColumn.SubsCentreid - 1)))?null:(System.Int32?)reader[((int)BbMailingListSubscriptionsColumn.SubsCentreid - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions entity)
		{
			if (!reader.Read()) return;
			
			entity.BbMlSid = (System.Int32)reader[((int)BbMailingListSubscriptionsColumn.BbMlSid - 1)];
			entity.BbMlid = (System.Int32)reader[((int)BbMailingListSubscriptionsColumn.BbMlid - 1)];
			entity.UserName = (reader.IsDBNull(((int)BbMailingListSubscriptionsColumn.UserName - 1)))?null:(System.String)reader[((int)BbMailingListSubscriptionsColumn.UserName - 1)];
			entity.EmailAddress = (System.String)reader[((int)BbMailingListSubscriptionsColumn.EmailAddress - 1)];
			entity.Createdbyid = (System.Int32)reader[((int)BbMailingListSubscriptionsColumn.Createdbyid - 1)];
			entity.Createdbyname = (System.String)reader[((int)BbMailingListSubscriptionsColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbMailingListSubscriptionsColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (System.Int32)reader[((int)BbMailingListSubscriptionsColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (System.String)reader[((int)BbMailingListSubscriptionsColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbMailingListSubscriptionsColumn.Lastupdateddate - 1)];
			entity.SubsCentreid = (reader.IsDBNull(((int)BbMailingListSubscriptionsColumn.SubsCentreid - 1)))?null:(System.Int32?)reader[((int)BbMailingListSubscriptionsColumn.SubsCentreid - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.BbMlSid = (System.Int32)dataRow["bbMLSid"];
			entity.BbMlid = (System.Int32)dataRow["bbMLid"];
			...
			entity.SubsCentreid = Convert.IsDBNull(dataRow["subsCentreid"]) ? null : (System.Int32?)dataRow["subsCentreid"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region BbMlidSource	
			if (CanDeepLoad(entity, "BbMailingLists|BbMlidSource", deepLoadType, innerList) 
				&& entity.BbMlidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.BbMlid;
				BbMailingLists tmpEntity = EntityManager.LocateEntity<BbMailingLists>(EntityLocator.ConstructKeyFromPkItems(typeof(BbMailingLists), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.BbMlidSource = tmpEntity;
				else
					entity.BbMlidSource = DataRepository.BbMailingListsProvider.GetByBbMlid(transactionManager, entity.BbMlid);		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbMlidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.BbMlidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbMailingListsProvider.DeepLoad(transactionManager, entity.BbMlidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion BbMlidSource
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region BbMlidSource
			if (CanDeepSave(entity, "BbMailingLists|BbMlidSource", deepSaveType, innerList) 
				&& entity.BbMlidSource != null)
			{
				DataRepository.BbMailingListsProvider.Save(transactionManager, entity.BbMlidSource);
				entity.BbMlid = entity.BbMlidSource.BbMlid;
			}
			#endregion 
	...
	#region BbMailingListSubscriptionsChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbMailingListSubscriptions</c>
	///</summary>
	public enum BbMailingListSubscriptionsChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbMailingLists</c> at BbMlidSource
		///</summary>
		[ChildEntityType(typeof(BbMailingLists))]
		BbMailingLists,
	}
	
	#endregion BbMailingListSubscriptionsChildEntityTypes
	
	#region BbMailingListSubscriptionsFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbMailingListSubscriptionsColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbMailingListSubscriptions"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbMailingListSubscriptionsFilterBuilder : SqlFilterBuilder<BbMailingListSubscriptionsColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbMailingListSubscriptionsFilterBuilder class.
		/// </summary>
		public BbMailingListSubscriptionsFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbMailingListSubscriptionsFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbMailingListSubscriptionsFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbMailingListSubscriptionsFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbMailingListSubscriptionsFilterBuilder
	
	#region BbMailingListSubscriptionsParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbMailingListSubscriptionsColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbMailingListSubscriptions"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbMailingListSubscriptionsParameterBuilder : ParameterizedSqlFilterBuilder<BbMailingListSubscriptionsColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbMailingListSubscriptionsParameterBuilder class.
		/// </summary>
		public BbMailingListSubscriptionsParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbMailingListSubscriptionsParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbMailingListSubscriptionsParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbMailingListSubscriptionsParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbMailingListSubscriptionsParameterBuilder
	
	#region BbMailingListSubscriptionsSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbMailingListSubscriptionsColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbMailingListSubscriptions"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbMailingListSubscriptionsSortBuilder : SqlSortBuilder<BbMailingListSubscriptionsColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbMailingListSubscriptionsSqlSortBuilder class.
		/// </summary>
		public BbMailingListSubscriptionsSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbMailingListSubscriptionsSortBuilder
