...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbTitlelkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbTitlelkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbTitlelkp, MHS.Badbir.NetTiers.Entities.BbTitlelkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbTitlelkpKey key)
		{
			return Delete(transactionManager, key.Titleid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_titleid">Title Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _titleid)
		{
			return Delete(null, _titleid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _titleid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbTitlelkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbTitlelkpKey key, int start, int pageLength)
		{
			return GetByTitleid(transactionManager, key.Titleid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_tblTitle_lookup index.
		/// </summary>
		/// <param name="_titleid">Title Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbTitlelkp GetByTitleid(int _titleid)
		{
			int count = -1;
			return GetByTitleid(null,_titleid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_tblTitle_lookup index.
		/// </summary>
		/// <param name="_titleid">Title Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbTitlelkp GetByTitleid(int _titleid, int start, int pageLength)
		{
			int count = -1;
			return GetByTitleid(null, _titleid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbTitlelkp GetByTitleid(TransactionManager transactionManager, int _titleid)
		{
			int count = -1;
			return GetByTitleid(transactionManager, _titleid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbTitlelkp GetByTitleid(TransactionManager transactionManager, int _titleid, int start, int pageLength)
		{
			int count = -1;
			return GetByTitleid(transactionManager, _titleid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbTitlelkp GetByTitleid(int _titleid, int start, int pageLength, out int count)
		{
			return GetByTitleid(null, _titleid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbTitlelkp GetByTitleid(TransactionManager transactionManager, int _titleid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbTitlelkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbTitlelkp&gt;"/></returns>
		public static TList<BbTitlelkp> Fill(IDataReader reader, TList<BbTitlelkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbTitlelkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbTitlelkp")
					.Append("|").Append((int)reader[((int)BbTitlelkpColumn.Titleid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbTitlelkp>(
					key.ToString(), // EntityTrackingKey
					"BbTitlelkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbTitlelkp();
				}
					...
					))
				{
					...
					c.Titleid = (int)reader[((int)BbTitlelkpColumn.Titleid - 1)];
					c.OriginalTitleid = c.Titleid;
					c.Title = (reader.IsDBNull(((int)BbTitlelkpColumn.Title - 1)))?null:(string)reader[((int)BbTitlelkpColumn.Title - 1)];
					c.Createdbyid = (int)reader[((int)BbTitlelkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbTitlelkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbTitlelkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbTitlelkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbTitlelkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbTitlelkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbTitlelkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Titleid = (int)reader[((int)BbTitlelkpColumn.Titleid - 1)];
			entity.OriginalTitleid = (int)reader["titleid"];
			entity.Title = (reader.IsDBNull(((int)BbTitlelkpColumn.Title - 1)))?null:(string)reader[((int)BbTitlelkpColumn.Title - 1)];
			entity.Createdbyid = (int)reader[((int)BbTitlelkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbTitlelkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbTitlelkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbTitlelkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbTitlelkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbTitlelkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbTitlelkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Titleid = (int)dataRow["titleid"];
			entity.OriginalTitleid = (int)dataRow["titleid"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbTitlelkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbTitlelkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbTitlelkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbTitlelkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbTitlelkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbTitlelkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbTitlelkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbTitlelkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbTitlelkp</c>
	///</summary>
	public enum BbTitlelkpChildEntityTypes
	{
	}
	
	#endregion BbTitlelkpChildEntityTypes
	
	#region BbTitlelkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbTitlelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbTitlelkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbTitlelkpFilterBuilder : SqlFilterBuilder<BbTitlelkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbTitlelkpFilterBuilder class.
		/// </summary>
		public BbTitlelkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbTitlelkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbTitlelkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbTitlelkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbTitlelkpFilterBuilder
	
	#region BbTitlelkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbTitlelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbTitlelkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbTitlelkpParameterBuilder : ParameterizedSqlFilterBuilder<BbTitlelkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbTitlelkpParameterBuilder class.
		/// </summary>
		public BbTitlelkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbTitlelkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbTitlelkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbTitlelkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbTitlelkpParameterBuilder
	
	#region BbTitlelkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbTitlelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbTitlelkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbTitlelkpSortBuilder : SqlSortBuilder<BbTitlelkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbTitlelkpSqlSortBuilder class.
		/// </summary>
		public BbTitlelkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbTitlelkpSortBuilder
