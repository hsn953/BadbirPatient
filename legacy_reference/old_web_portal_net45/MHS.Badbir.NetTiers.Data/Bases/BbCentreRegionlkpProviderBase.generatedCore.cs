...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbCentreRegionlkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbCentreRegionlkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp, MHS.Badbir.NetTiers.Entities.BbCentreRegionlkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentreRegionlkpKey key)
		{
			return Delete(transactionManager, key.Centreregid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_centreregid">Region Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Int32 _centreregid)
		{
			return Delete(null, _centreregid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Int32 _centreregid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentreRegionlkpKey key, int start, int pageLength)
		{
			return GetByCentreregid(transactionManager, key.Centreregid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbCentreRegionlkp index.
		/// </summary>
		/// <param name="_centreregid">Region Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp GetByCentreregid(System.Int32 _centreregid)
		{
			int count = -1;
			return GetByCentreregid(null,_centreregid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbCentreRegionlkp index.
		/// </summary>
		/// <param name="_centreregid">Region Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp GetByCentreregid(System.Int32 _centreregid, int start, int pageLength)
		{
			int count = -1;
			return GetByCentreregid(null, _centreregid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp GetByCentreregid(TransactionManager transactionManager, System.Int32 _centreregid)
		{
			int count = -1;
			return GetByCentreregid(transactionManager, _centreregid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp GetByCentreregid(TransactionManager transactionManager, System.Int32 _centreregid, int start, int pageLength)
		{
			int count = -1;
			return GetByCentreregid(transactionManager, _centreregid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp GetByCentreregid(System.Int32 _centreregid, int start, int pageLength, out int count)
		{
			return GetByCentreregid(null, _centreregid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp GetByCentreregid(TransactionManager transactionManager, System.Int32 _centreregid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbCentreRegionlkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbCentreRegionlkp&gt;"/></returns>
		public static TList<BbCentreRegionlkp> Fill(IDataReader reader, TList<BbCentreRegionlkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbCentreRegionlkp")
					.Append("|").Append((System.Int32)reader[((int)BbCentreRegionlkpColumn.Centreregid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbCentreRegionlkp>(
					key.ToString(), // EntityTrackingKey
					"BbCentreRegionlkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp();
				}
					...
					))
				{
					...
					c.Centreregid = (System.Int32)reader[((int)BbCentreRegionlkpColumn.Centreregid - 1)];
					c.Centrereregion = (reader.IsDBNull(((int)BbCentreRegionlkpColumn.Centrereregion - 1)))?null:(System.String)reader[((int)BbCentreRegionlkpColumn.Centrereregion - 1)];
					c.Createdbyid = (System.Int32)reader[((int)BbCentreRegionlkpColumn.Createdbyid - 1)];
					c.Createdbyname = (System.String)reader[((int)BbCentreRegionlkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbCentreRegionlkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (System.Int32)reader[((int)BbCentreRegionlkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (System.String)reader[((int)BbCentreRegionlkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbCentreRegionlkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Centreregid = (System.Int32)reader[((int)BbCentreRegionlkpColumn.Centreregid - 1)];
			entity.Centrereregion = (reader.IsDBNull(((int)BbCentreRegionlkpColumn.Centrereregion - 1)))?null:(System.String)reader[((int)BbCentreRegionlkpColumn.Centrereregion - 1)];
			entity.Createdbyid = (System.Int32)reader[((int)BbCentreRegionlkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (System.String)reader[((int)BbCentreRegionlkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbCentreRegionlkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (System.Int32)reader[((int)BbCentreRegionlkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (System.String)reader[((int)BbCentreRegionlkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbCentreRegionlkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Centreregid = (System.Int32)dataRow["centreregid"];
			entity.Centrereregion = Convert.IsDBNull(dataRow["centrereregion"]) ? null : (System.String)dataRow["centrereregion"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByCentreregid methods when available
			
			#region BbCentreCollection
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbCentre>|BbCentreCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbCentreCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbCentreCollection = DataRepository.BbCentreProvider.GetByCentreregionid(transactionManager, entity.Centreregid);

				if (deep && entity.BbCentreCollection.Count > 0)
				{
					deepHandles.Add("BbCentreCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbCentre>) DataRepository.BbCentreProvider.DeepLoad,
						new object[] { transactionManager, entity.BbCentreCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbCentre>
				if (CanDeepSave(entity.BbCentreCollection, "List<BbCentre>|BbCentreCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbCentre child in entity.BbCentreCollection)
					{
						if(child.CentreregionidSource != null)
						{
							child.Centreregionid = child.CentreregionidSource.Centreregid;
						}
						else
						{
							child.Centreregionid = entity.Centreregid;
						}

					}

					if (entity.BbCentreCollection.Count > 0 || entity.BbCentreCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbCentreProvider.Save(transactionManager, entity.BbCentreCollection);
						
						deepHandles.Add("BbCentreCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbCentre >) DataRepository.BbCentreProvider.DeepSave,
							new object[] { transactionManager, entity.BbCentreCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	#region BbCentreRegionlkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbCentreRegionlkp</c>
	///</summary>
	public enum BbCentreRegionlkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbCentreRegionlkp</c> as OneToMany for BbCentreCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbCentre>))]
		BbCentreCollection,
	}
	
	#endregion BbCentreRegionlkpChildEntityTypes
	
	#region BbCentreRegionlkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbCentreRegionlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCentreRegionlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbCentreRegionlkpFilterBuilder : SqlFilterBuilder<BbCentreRegionlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCentreRegionlkpFilterBuilder class.
		/// </summary>
		public BbCentreRegionlkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbCentreRegionlkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbCentreRegionlkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbCentreRegionlkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbCentreRegionlkpFilterBuilder
	
	#region BbCentreRegionlkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbCentreRegionlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCentreRegionlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbCentreRegionlkpParameterBuilder : ParameterizedSqlFilterBuilder<BbCentreRegionlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCentreRegionlkpParameterBuilder class.
		/// </summary>
		public BbCentreRegionlkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbCentreRegionlkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbCentreRegionlkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbCentreRegionlkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbCentreRegionlkpParameterBuilder
	
	#region BbCentreRegionlkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbCentreRegionlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbCentreRegionlkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbCentreRegionlkpSortBuilder : SqlSortBuilder<BbCentreRegionlkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbCentreRegionlkpSqlSortBuilder class.
		/// </summary>
		public BbCentreRegionlkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbCentreRegionlkpSortBuilder
