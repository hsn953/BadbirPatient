...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbQueryMessageProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbQueryMessageProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbQueryMessage, MHS.Badbir.NetTiers.Entities.BbQueryMessageKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryMessageKey key)
		{
		...
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_qmId">Query Message ID. Primary Key.</param>
		...
		public override MHS.Badbir.NetTiers.Entities.BbQueryMessage Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryMessageKey key, int start, int pageLength)
		{
			return GetByQmId(transactionManager, key.QmId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key FK_Qid index.
		/// </summary>
		/// <param name="_qid">Query ID</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQueryMessage&gt;"/> class.</returns>
		public TList<BbQueryMessage> GetByQid(int _qid)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_Qid index.
		/// </summary>
		/// <param name="_qid">Query ID</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQueryMessage&gt;"/> class.</returns>
		public TList<BbQueryMessage> GetByQid(int _qid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQueryMessage&gt;"/> class.</returns>
		public TList<BbQueryMessage> GetByQid(TransactionManager transactionManager, int _qid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQueryMessage&gt;"/> class.</returns>
		public TList<BbQueryMessage> GetByQid(TransactionManager transactionManager, int _qid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQueryMessage&gt;"/> class.</returns>
		public TList<BbQueryMessage> GetByQid(int _qid, int start, int pageLength, out int count)
		{
			return GetByQid(null, _qid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQueryMessage&gt;"/> class.</returns>
		public abstract TList<BbQueryMessage> GetByQid(TransactionManager transactionManager, int _qid, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbQueryMessage index.
		/// </summary>
		/// <param name="_qmId">Query Message ID</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryMessage GetByQmId(int _qmId)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbQueryMessage index.
		/// </summary>
		/// <param name="_qmId">Query Message ID</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryMessage GetByQmId(int _qmId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryMessage GetByQmId(TransactionManager transactionManager, int _qmId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryMessage GetByQmId(TransactionManager transactionManager, int _qmId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQueryMessage GetByQmId(int _qmId, int start, int pageLength, out int count)
		{
			return GetByQmId(null, _qmId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbQueryMessage GetByQmId(TransactionManager transactionManager, int _qmId, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbQueryMessage&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbQueryMessage&gt;"/></returns>
		public static TList<BbQueryMessage> Fill(IDataReader reader, TList<BbQueryMessage> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbQueryMessage c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbQueryMessage")
					.Append("|").Append((int)reader[((int)BbQueryMessageColumn.QmId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbQueryMessage>(
					key.ToString(), // EntityTrackingKey
					"BbQueryMessage",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbQueryMessage();
				}
					...
					))
				{
					...
					c.QmId = (int)reader[((int)BbQueryMessageColumn.QmId - 1)];
					c.Qid = (int)reader[((int)BbQueryMessageColumn.Qid - 1)];
					c.Message = (reader.IsDBNull(((int)BbQueryMessageColumn.Message - 1)))?null:(string)reader[((int)BbQueryMessageColumn.Message - 1)];
					c.Createdbyid = (int)reader[((int)BbQueryMessageColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbQueryMessageColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbQueryMessageColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbQueryMessageColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbQueryMessageColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbQueryMessageColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbQueryMessage entity)
		{
			if (!reader.Read()) return;
			
			entity.QmId = (int)reader[((int)BbQueryMessageColumn.QmId - 1)];
			entity.Qid = (int)reader[((int)BbQueryMessageColumn.Qid - 1)];
			entity.Message = (reader.IsDBNull(((int)BbQueryMessageColumn.Message - 1)))?null:(string)reader[((int)BbQueryMessageColumn.Message - 1)];
			entity.Createdbyid = (int)reader[((int)BbQueryMessageColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbQueryMessageColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbQueryMessageColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbQueryMessageColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbQueryMessageColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbQueryMessageColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbQueryMessage entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQueryMessage"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQueryMessage Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryMessage entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region QidSource	
			if (CanDeepLoad(entity, "BbQuery|QidSource", deepLoadType, innerList) 
				&& entity.QidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.Qid;
				BbQuery tmpEntity = EntityManager.LocateEntity<BbQuery>(EntityLocator.ConstructKeyFromPkItems(typeof(BbQuery), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.QidSource = tmpEntity;
				else
					entity.QidSource = DataRepository.BbQueryProvider.GetByQid(transactionManager, entity.Qid);		
				...
				if (deep && entity.QidSource != null)
				{
					...
					DataRepository.BbQueryProvider.DeepLoad(transactionManager, entity.QidSource, deep, deepLoadType, childTypes, innerList);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbQueryMessage object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbQueryMessage instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQueryMessage Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryMessage entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region QidSource
			if (CanDeepSave(entity, "BbQuery|QidSource", deepSaveType, innerList) 
				&& entity.QidSource != null)
			{
				DataRepository.BbQueryProvider.Save(transactionManager, entity.QidSource);
	...
	#region BbQueryMessageChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbQueryMessage</c>
	///</summary>
	public enum BbQueryMessageChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbQuery</c> at QidSource
		///</summary>
		[ChildEntityType(typeof(BbQuery))]
		BbQuery,
	}
	
	#endregion BbQueryMessageChildEntityTypes
	
	#region BbQueryMessageFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbQueryMessageColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryMessage"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryMessageFilterBuilder : SqlFilterBuilder<BbQueryMessageColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryMessageFilterBuilder class.
		/// </summary>
		public BbQueryMessageFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryMessageFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryMessageFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbQueryMessageFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryMessageFilterBuilder
	
	#region BbQueryMessageParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbQueryMessageColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryMessage"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryMessageParameterBuilder : ParameterizedSqlFilterBuilder<BbQueryMessageColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryMessageParameterBuilder class.
		/// </summary>
		public BbQueryMessageParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryMessageParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryMessageParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbQueryMessageParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryMessageParameterBuilder
	
	#region BbQueryMessageSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbQueryMessageColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQueryMessage"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbQueryMessageSortBuilder : SqlSortBuilder<BbQueryMessageColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryMessageSqlSortBuilder class.
		/// </summary>
		public BbQueryMessageSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbQueryMessageSortBuilder
