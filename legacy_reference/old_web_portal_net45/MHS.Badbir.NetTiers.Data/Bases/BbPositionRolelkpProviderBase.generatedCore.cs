...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPositionRolelkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPositionRolelkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPositionRolelkp, MHS.Badbir.NetTiers.Entities.BbPositionRolelkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPositionRolelkpKey key)
		{
			return Delete(transactionManager, key.Positionid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_positionid">Position Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _positionid)
		{
			return Delete(null, _positionid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _positionid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbPositionRolelkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPositionRolelkpKey key, int start, int pageLength)
		{
			return GetByPositionid(transactionManager, key.Positionid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbPositionlkp index.
		/// </summary>
		/// <param name="_positionid">Position Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPositionRolelkp GetByPositionid(int _positionid)
		{
			int count = -1;
			return GetByPositionid(null,_positionid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbPositionlkp index.
		/// </summary>
		/// <param name="_positionid">Position Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPositionRolelkp GetByPositionid(int _positionid, int start, int pageLength)
		{
			int count = -1;
			return GetByPositionid(null, _positionid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPositionRolelkp GetByPositionid(TransactionManager transactionManager, int _positionid)
		{
			int count = -1;
			return GetByPositionid(transactionManager, _positionid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPositionRolelkp GetByPositionid(TransactionManager transactionManager, int _positionid, int start, int pageLength)
		{
			int count = -1;
			return GetByPositionid(transactionManager, _positionid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPositionRolelkp GetByPositionid(int _positionid, int start, int pageLength, out int count)
		{
			return GetByPositionid(null, _positionid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPositionRolelkp GetByPositionid(TransactionManager transactionManager, int _positionid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbPositionRolelkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPositionRolelkp&gt;"/></returns>
		public static TList<BbPositionRolelkp> Fill(IDataReader reader, TList<BbPositionRolelkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPositionRolelkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPositionRolelkp")
					.Append("|").Append((int)reader[((int)BbPositionRolelkpColumn.Positionid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPositionRolelkp>(
					key.ToString(), // EntityTrackingKey
					"BbPositionRolelkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPositionRolelkp();
				}
					...
					))
				{
					...
					c.Positionid = (int)reader[((int)BbPositionRolelkpColumn.Positionid - 1)];
					c.Position = (reader.IsDBNull(((int)BbPositionRolelkpColumn.Position - 1)))?null:(string)reader[((int)BbPositionRolelkpColumn.Position - 1)];
					c.Createdbyid = (int)reader[((int)BbPositionRolelkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPositionRolelkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPositionRolelkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPositionRolelkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPositionRolelkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPositionRolelkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPositionRolelkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Positionid = (int)reader[((int)BbPositionRolelkpColumn.Positionid - 1)];
			entity.Position = (reader.IsDBNull(((int)BbPositionRolelkpColumn.Position - 1)))?null:(string)reader[((int)BbPositionRolelkpColumn.Position - 1)];
			entity.Createdbyid = (int)reader[((int)BbPositionRolelkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPositionRolelkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPositionRolelkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPositionRolelkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPositionRolelkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPositionRolelkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPositionRolelkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Positionid = (int)dataRow["positionid"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPositionRolelkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPositionRolelkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPositionRolelkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPositionRolelkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPositionRolelkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPositionRolelkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPositionRolelkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbPositionRolelkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPositionRolelkp</c>
	///</summary>
	public enum BbPositionRolelkpChildEntityTypes
	{
	}
	
	#endregion BbPositionRolelkpChildEntityTypes
	
	#region BbPositionRolelkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPositionRolelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPositionRolelkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPositionRolelkpFilterBuilder : SqlFilterBuilder<BbPositionRolelkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPositionRolelkpFilterBuilder class.
		/// </summary>
		public BbPositionRolelkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPositionRolelkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPositionRolelkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPositionRolelkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPositionRolelkpFilterBuilder
	
	#region BbPositionRolelkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPositionRolelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPositionRolelkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPositionRolelkpParameterBuilder : ParameterizedSqlFilterBuilder<BbPositionRolelkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPositionRolelkpParameterBuilder class.
		/// </summary>
		public BbPositionRolelkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPositionRolelkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPositionRolelkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPositionRolelkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPositionRolelkpParameterBuilder
	
	#region BbPositionRolelkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPositionRolelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPositionRolelkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPositionRolelkpSortBuilder : SqlSortBuilder<BbPositionRolelkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPositionRolelkpSqlSortBuilder class.
		/// </summary>
		public BbPositionRolelkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPositionRolelkpSortBuilder
