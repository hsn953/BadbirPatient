...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbGenderlkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbGenderlkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbGenderlkp, MHS.Badbir.NetTiers.Entities.BbGenderlkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbGenderlkpKey key)
		{
			return Delete(transactionManager, key.Genderid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_genderid">gender id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _genderid)
		{
			return Delete(null, _genderid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _genderid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbGenderlkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbGenderlkpKey key, int start, int pageLength)
		{
			return GetByGenderid(transactionManager, key.Genderid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_tblGender_lookup index.
		/// </summary>
		/// <param name="_genderid">gender id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbGenderlkp GetByGenderid(int _genderid)
		{
			int count = -1;
			return GetByGenderid(null,_genderid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_tblGender_lookup index.
		/// </summary>
		/// <param name="_genderid">gender id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbGenderlkp GetByGenderid(int _genderid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbGenderlkp GetByGenderid(TransactionManager transactionManager, int _genderid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbGenderlkp GetByGenderid(TransactionManager transactionManager, int _genderid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbGenderlkp GetByGenderid(int _genderid, int start, int pageLength, out int count)
		{
			return GetByGenderid(null, _genderid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbGenderlkp GetByGenderid(TransactionManager transactionManager, int _genderid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbGenderlkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbGenderlkp&gt;"/></returns>
		public static TList<BbGenderlkp> Fill(IDataReader reader, TList<BbGenderlkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbGenderlkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbGenderlkp")
					.Append("|").Append((int)reader[((int)BbGenderlkpColumn.Genderid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbGenderlkp>(
					key.ToString(), // EntityTrackingKey
					"BbGenderlkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbGenderlkp();
				}
					...
					))
				{
					...
					c.Genderid = (int)reader[((int)BbGenderlkpColumn.Genderid - 1)];
					c.Gender = (reader.IsDBNull(((int)BbGenderlkpColumn.Gender - 1)))?null:(string)reader[((int)BbGenderlkpColumn.Gender - 1)];
					c.Createdbyid = (int)reader[((int)BbGenderlkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbGenderlkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbGenderlkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbGenderlkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbGenderlkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbGenderlkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbGenderlkp entity)
		{
			if (!reader.Read()) return;
			
			entity.Genderid = (int)reader[((int)BbGenderlkpColumn.Genderid - 1)];
			entity.Gender = (reader.IsDBNull(((int)BbGenderlkpColumn.Gender - 1)))?null:(string)reader[((int)BbGenderlkpColumn.Gender - 1)];
			entity.Createdbyid = (int)reader[((int)BbGenderlkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbGenderlkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbGenderlkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbGenderlkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbGenderlkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbGenderlkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbGenderlkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Genderid = (int)dataRow["genderid"];
			entity.Gender = Convert.IsDBNull(dataRow["gender"]) ? null : (string)dataRow["gender"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbGenderlkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbGenderlkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbGenderlkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByGenderid methods when available
			...
			if (CanDeepLoad(entity, "List<BbPatient>|BbPatientCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPatientCollection = DataRepository.BbPatientProvider.GetByGenderid(transactionManager, entity.Genderid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbGenderlkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbGenderlkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbGenderlkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbGenderlkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbPatient>
				...
				{	
					...
					{
						if(child.GenderidSource != null)
						{
							child.Genderid = child.GenderidSource.Genderid;
						}
						else
						{
	...
	#region BbGenderlkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbGenderlkp</c>
	///</summary>
	public enum BbGenderlkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbGenderlkp</c> as OneToMany for BbPatientCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatient>))]
		BbPatientCollection,
	}
	
	#endregion BbGenderlkpChildEntityTypes
	
	#region BbGenderlkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbGenderlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbGenderlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbGenderlkpFilterBuilder : SqlFilterBuilder<BbGenderlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbGenderlkpFilterBuilder class.
		/// </summary>
		public BbGenderlkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbGenderlkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbGenderlkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbGenderlkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbGenderlkpFilterBuilder
	
	#region BbGenderlkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbGenderlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbGenderlkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbGenderlkpParameterBuilder : ParameterizedSqlFilterBuilder<BbGenderlkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbGenderlkpParameterBuilder class.
		/// </summary>
		public BbGenderlkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbGenderlkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbGenderlkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbGenderlkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbGenderlkpParameterBuilder
	
	#region BbGenderlkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbGenderlkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbGenderlkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbGenderlkpSortBuilder : SqlSortBuilder<BbGenderlkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbGenderlkpSqlSortBuilder class.
		/// </summary>
		public BbGenderlkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbGenderlkpSortBuilder
