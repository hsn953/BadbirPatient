...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbNotificationTypelkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbNotificationTypelkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp, MHS.Badbir.NetTiers.Entities.BbNotificationTypelkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbNotificationTypelkpKey key)
		{
			return Delete(transactionManager, key.NtypeId);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_ntypeId">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _ntypeId)
		{
			return Delete(null, _ntypeId);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _ntypeId);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbNotificationTypelkpKey key, int start, int pageLength)
		{
			return GetByNtypeId(transactionManager, key.NtypeId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbNotificationTypelkp index.
		/// </summary>
		/// <param name="_ntypeId"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp GetByNtypeId(int _ntypeId)
		{
			int count = -1;
			return GetByNtypeId(null,_ntypeId, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbNotificationTypelkp index.
		/// </summary>
		/// <param name="_ntypeId"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp GetByNtypeId(int _ntypeId, int start, int pageLength)
		{
			int count = -1;
			return GetByNtypeId(null, _ntypeId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp GetByNtypeId(TransactionManager transactionManager, int _ntypeId)
		{
			int count = -1;
			return GetByNtypeId(transactionManager, _ntypeId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp GetByNtypeId(TransactionManager transactionManager, int _ntypeId, int start, int pageLength)
		{
			int count = -1;
			return GetByNtypeId(transactionManager, _ntypeId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp GetByNtypeId(int _ntypeId, int start, int pageLength, out int count)
		{
			return GetByNtypeId(null, _ntypeId, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp GetByNtypeId(TransactionManager transactionManager, int _ntypeId, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbNotificationTypelkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbNotificationTypelkp&gt;"/></returns>
		public static TList<BbNotificationTypelkp> Fill(IDataReader reader, TList<BbNotificationTypelkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbNotificationTypelkp")
					.Append("|").Append((int)reader[((int)BbNotificationTypelkpColumn.NtypeId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbNotificationTypelkp>(
					key.ToString(), // EntityTrackingKey
					"BbNotificationTypelkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp();
				}
					...
					))
				{
					...
					c.NtypeId = (int)reader[((int)BbNotificationTypelkpColumn.NtypeId - 1)];
					c.Ntype = (reader.IsDBNull(((int)BbNotificationTypelkpColumn.Ntype - 1)))?null:(string)reader[((int)BbNotificationTypelkpColumn.Ntype - 1)];
					c.Createdbyid = (int)reader[((int)BbNotificationTypelkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbNotificationTypelkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbNotificationTypelkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbNotificationTypelkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbNotificationTypelkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbNotificationTypelkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp entity)
		{
			if (!reader.Read()) return;
			
			entity.NtypeId = (int)reader[((int)BbNotificationTypelkpColumn.NtypeId - 1)];
			entity.Ntype = (reader.IsDBNull(((int)BbNotificationTypelkpColumn.Ntype - 1)))?null:(string)reader[((int)BbNotificationTypelkpColumn.Ntype - 1)];
			entity.Createdbyid = (int)reader[((int)BbNotificationTypelkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbNotificationTypelkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbNotificationTypelkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbNotificationTypelkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbNotificationTypelkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbNotificationTypelkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.NtypeId = (int)dataRow["NTypeID"];
			entity.Ntype = Convert.IsDBNull(dataRow["NType"]) ? null : (string)dataRow["NType"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByNtypeId methods when available
			
			#region BbNotificationCollection
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbNotification>|BbNotificationCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbNotificationCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbNotificationCollection = DataRepository.BbNotificationProvider.GetByTypeId(transactionManager, entity.NtypeId);

				if (deep && entity.BbNotificationCollection.Count > 0)
				{
					deepHandles.Add("BbNotificationCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbNotification>) DataRepository.BbNotificationProvider.DeepLoad,
						new object[] { transactionManager, entity.BbNotificationCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbNotification>
				if (CanDeepSave(entity.BbNotificationCollection, "List<BbNotification>|BbNotificationCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbNotification child in entity.BbNotificationCollection)
					{
						if(child.TypeIdSource != null)
						{
							child.TypeId = child.TypeIdSource.NtypeId;
						}
						else
						{
							child.TypeId = entity.NtypeId;
						}

					}

					if (entity.BbNotificationCollection.Count > 0 || entity.BbNotificationCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbNotificationProvider.Save(transactionManager, entity.BbNotificationCollection);
						
						deepHandles.Add("BbNotificationCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbNotification >) DataRepository.BbNotificationProvider.DeepSave,
							new object[] { transactionManager, entity.BbNotificationCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	#region BbNotificationTypelkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbNotificationTypelkp</c>
	///</summary>
	public enum BbNotificationTypelkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbNotificationTypelkp</c> as OneToMany for BbNotificationCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbNotification>))]
		BbNotificationCollection,
	}
	
	#endregion BbNotificationTypelkpChildEntityTypes
	
	#region BbNotificationTypelkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbNotificationTypelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbNotificationTypelkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbNotificationTypelkpFilterBuilder : SqlFilterBuilder<BbNotificationTypelkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbNotificationTypelkpFilterBuilder class.
		/// </summary>
		public BbNotificationTypelkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbNotificationTypelkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbNotificationTypelkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbNotificationTypelkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbNotificationTypelkpFilterBuilder
	
	#region BbNotificationTypelkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbNotificationTypelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbNotificationTypelkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbNotificationTypelkpParameterBuilder : ParameterizedSqlFilterBuilder<BbNotificationTypelkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbNotificationTypelkpParameterBuilder class.
		/// </summary>
		public BbNotificationTypelkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbNotificationTypelkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbNotificationTypelkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbNotificationTypelkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbNotificationTypelkpParameterBuilder
	
	#region BbNotificationTypelkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbNotificationTypelkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbNotificationTypelkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbNotificationTypelkpSortBuilder : SqlSortBuilder<BbNotificationTypelkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbNotificationTypelkpSqlSortBuilder class.
		/// </summary>
		public BbNotificationTypelkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbNotificationTypelkpSortBuilder
