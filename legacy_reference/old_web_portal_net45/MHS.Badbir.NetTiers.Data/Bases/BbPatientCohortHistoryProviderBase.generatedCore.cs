...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPatientCohortHistoryProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPatientCohortHistoryProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory, MHS.Badbir.NetTiers.Entities.BbPatientCohortHistoryKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortHistoryKey key)
		{
			return Delete(transactionManager, key.Chid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_chid">Cohort history Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _chid)
		{
			return Delete(null, _chid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _chid);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbCohorthistory_bbCohortlkp key.
		///		FK_bbCohorthistory_bbCohortlkp Description: 
		/// </summary>
		/// <param name="_cohortid">Cohort Id</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory objects.</returns>
		public TList<BbPatientCohortHistory> GetByCohortid(int _cohortid)
		{
			int count = -1;
			return GetByCohortid(_cohortid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory objects.</returns>
		/// <remarks></remarks>
		public TList<BbPatientCohortHistory> GetByCohortid(TransactionManager transactionManager, int _cohortid)
		{
			int count = -1;
			return GetByCohortid(transactionManager, _cohortid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory objects.</returns>
		public TList<BbPatientCohortHistory> GetByCohortid(TransactionManager transactionManager, int _cohortid, int start, int pageLength)
		{
			int count = -1;
			return GetByCohortid(transactionManager, _cohortid, start, pageLength, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbCohorthistory_bbCohortlkp key.
		///		fkBbCohorthistoryBbCohortlkp Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_cohortid">Cohort Id</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory objects.</returns>
		public TList<BbPatientCohortHistory> GetByCohortid(int _cohortid, int start, int pageLength)
		{
			int count =  -1;
			return GetByCohortid(null, _cohortid, start, pageLength,out count);	
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory objects.</returns>
		public TList<BbPatientCohortHistory> GetByCohortid(int _cohortid, int start, int pageLength,out int count)
		{
			return GetByCohortid(null, _cohortid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory objects.</returns>
		public abstract TList<BbPatientCohortHistory> GetByCohortid(TransactionManager transactionManager, int _cohortid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortHistoryKey key, int start, int pageLength)
		{
			return GetByChid(transactionManager, key.Chid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key FK_patientid index.
		/// </summary>
		/// <param name="_patientid"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByPatientid(int _patientid)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_patientid index.
		/// </summary>
		/// <param name="_patientid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByPatientid(int _patientid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByPatientid(TransactionManager transactionManager, int _patientid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByPatientid(TransactionManager transactionManager, int _patientid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByPatientid(int _patientid, int start, int pageLength, out int count)
		{
			return GetByPatientid(null, _patientid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public abstract TList<BbPatientCohortHistory> GetByPatientid(TransactionManager transactionManager, int _patientid, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key FK_regcentreid index.
		/// </summary>
		/// <param name="_regcentreid"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByRegcentreid(System.Int32? _regcentreid)
		{
			int count = -1;
			return GetByRegcentreid(null,_regcentreid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_regcentreid index.
		/// </summary>
		/// <param name="_regcentreid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByRegcentreid(System.Int32? _regcentreid, int start, int pageLength)
		{
			int count = -1;
			return GetByRegcentreid(null, _regcentreid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByRegcentreid(TransactionManager transactionManager, System.Int32? _regcentreid)
		{
			int count = -1;
			return GetByRegcentreid(transactionManager, _regcentreid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByRegcentreid(TransactionManager transactionManager, System.Int32? _regcentreid, int start, int pageLength)
		{
			int count = -1;
			return GetByRegcentreid(transactionManager, _regcentreid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByRegcentreid(System.Int32? _regcentreid, int start, int pageLength, out int count)
		{
			return GetByRegcentreid(null, _regcentreid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public abstract TList<BbPatientCohortHistory> GetByRegcentreid(TransactionManager transactionManager, System.Int32? _regcentreid, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key NK_studyno index.
		/// </summary>
		/// <param name="_studyno"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByStudyno(System.Int32? _studyno)
		{
			int count = -1;
			return GetByStudyno(null,_studyno, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the NK_studyno index.
		/// </summary>
		/// <param name="_studyno"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByStudyno(System.Int32? _studyno, int start, int pageLength)
		{
			int count = -1;
			return GetByStudyno(null, _studyno, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByStudyno(TransactionManager transactionManager, System.Int32? _studyno)
		{
			int count = -1;
			return GetByStudyno(transactionManager, _studyno, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByStudyno(TransactionManager transactionManager, System.Int32? _studyno, int start, int pageLength)
		{
			int count = -1;
			return GetByStudyno(transactionManager, _studyno, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public TList<BbPatientCohortHistory> GetByStudyno(System.Int32? _studyno, int start, int pageLength, out int count)
		{
			return GetByStudyno(null, _studyno, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientCohortHistory&gt;"/> class.</returns>
		public abstract TList<BbPatientCohortHistory> GetByStudyno(TransactionManager transactionManager, System.Int32? _studyno, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbCohorthistory index.
		/// </summary>
		/// <param name="_chid">Cohort history Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory GetByChid(int _chid)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbCohorthistory index.
		/// </summary>
		/// <param name="_chid">Cohort history Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory GetByChid(int _chid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory GetByChid(TransactionManager transactionManager, int _chid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory GetByChid(int _chid, int start, int pageLength, out int count)
		{
			return GetByChid(null, _chid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength, out int count);
		...
		/// <param name="patientid"> A <c>System.Int32?</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortHistory&gt;"/> instance.</returns>
		public TList<BbPatientCohortHistory> PatientCohortHistory_GetMostRecentbyPatientId(System.Int32? patientid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortHistory&gt;"/> instance.</returns>
		public TList<BbPatientCohortHistory> PatientCohortHistory_GetMostRecentbyPatientId(int start, int pageLength, System.Int32? patientid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortHistory&gt;"/> instance.</returns>
		public TList<BbPatientCohortHistory> PatientCohortHistory_GetMostRecentbyPatientId(TransactionManager transactionManager, System.Int32? patientid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientCohortHistory&gt;"/> instance.</returns>
		public abstract TList<BbPatientCohortHistory> PatientCohortHistory_GetMostRecentbyPatientId(TransactionManager transactionManager, int start, int pageLength , System.Int32? patientid);
		...
		/// <summary>
		/// Fill a TList&lt;BbPatientCohortHistory&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPatientCohortHistory&gt;"/></returns>
		public static TList<BbPatientCohortHistory> Fill(IDataReader reader, TList<BbPatientCohortHistory> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPatientCohortHistory")
					.Append("|").Append((int)reader[((int)BbPatientCohortHistoryColumn.Chid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPatientCohortHistory>(
					key.ToString(), // EntityTrackingKey
					"BbPatientCohortHistory",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory();
				}
					...
					))
				{
					...
					c.Chid = (int)reader[((int)BbPatientCohortHistoryColumn.Chid - 1)];
					c.Patientid = (int)reader[((int)BbPatientCohortHistoryColumn.Patientid - 1)];
					c.Studyno = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.Studyno - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortHistoryColumn.Studyno - 1)];
					c.Cohortid = (int)reader[((int)BbPatientCohortHistoryColumn.Cohortid - 1)];
					c.Datefrom = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.Datefrom - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortHistoryColumn.Datefrom - 1)];
					c.Dateto = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.Dateto - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortHistoryColumn.Dateto - 1)];
					c.DatetoFup = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.DatetoFup - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortHistoryColumn.DatetoFup - 1)];
					c.Regcentreid = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.Regcentreid - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortHistoryColumn.Regcentreid - 1)];
					c.Consentversion = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.Consentversion - 1)))?null:(string)reader[((int)BbPatientCohortHistoryColumn.Consentversion - 1)];
					c.Createdbyid = (int)reader[((int)BbPatientCohortHistoryColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPatientCohortHistoryColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPatientCohortHistoryColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPatientCohortHistoryColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPatientCohortHistoryColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPatientCohortHistoryColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory entity)
		{
			if (!reader.Read()) return;
			
			entity.Chid = (int)reader[((int)BbPatientCohortHistoryColumn.Chid - 1)];
			entity.Patientid = (int)reader[((int)BbPatientCohortHistoryColumn.Patientid - 1)];
			entity.Studyno = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.Studyno - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortHistoryColumn.Studyno - 1)];
			entity.Cohortid = (int)reader[((int)BbPatientCohortHistoryColumn.Cohortid - 1)];
			entity.Datefrom = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.Datefrom - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortHistoryColumn.Datefrom - 1)];
			entity.Dateto = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.Dateto - 1)))?null:(System.DateTime?)reader[((int)BbPatientCohortHistoryColumn.Dateto - 1)];
			entity.DatetoFup = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.DatetoFup - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortHistoryColumn.DatetoFup - 1)];
			entity.Regcentreid = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.Regcentreid - 1)))?null:(System.Int32?)reader[((int)BbPatientCohortHistoryColumn.Regcentreid - 1)];
			entity.Consentversion = (reader.IsDBNull(((int)BbPatientCohortHistoryColumn.Consentversion - 1)))?null:(string)reader[((int)BbPatientCohortHistoryColumn.Consentversion - 1)];
			entity.Createdbyid = (int)reader[((int)BbPatientCohortHistoryColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPatientCohortHistoryColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPatientCohortHistoryColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPatientCohortHistoryColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPatientCohortHistoryColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPatientCohortHistoryColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Chid = (int)dataRow["chid"];
			entity.Patientid = (int)dataRow["patientid"];
			entity.Studyno = Convert.IsDBNull(dataRow["studyno"]) ? null : (System.Int32?)dataRow["studyno"];
			entity.Cohortid = (int)dataRow["cohortid"];
			entity.Datefrom = Convert.IsDBNull(dataRow["datefrom"]) ? null : (System.DateTime?)dataRow["datefrom"];
			entity.Dateto = Convert.IsDBNull(dataRow["dateto"]) ? null : (System.DateTime?)dataRow["dateto"];
			entity.DatetoFup = Convert.IsDBNull(dataRow["datetoFUP"]) ? null : (System.Int32?)dataRow["datetoFUP"];
			entity.Regcentreid = Convert.IsDBNull(dataRow["regcentreid"]) ? null : (System.Int32?)dataRow["regcentreid"];
			entity.Consentversion = Convert.IsDBNull(dataRow["consentversion"]) ? null : (string)dataRow["consentversion"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region CohortidSource	
			if (CanDeepLoad(entity, "BbCohortlkp|CohortidSource", deepLoadType, innerList) 
				&& entity.CohortidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.Cohortid;
				BbCohortlkp tmpEntity = EntityManager.LocateEntity<BbCohortlkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbCohortlkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.CohortidSource = tmpEntity;
				else
					entity.CohortidSource = DataRepository.BbCohortlkpProvider.GetByCohortid(transactionManager, entity.Cohortid);		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'CohortidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.CohortidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbCohortlkpProvider.DeepLoad(transactionManager, entity.CohortidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion CohortidSource

			#region PatientidSource	
			if (CanDeepLoad(entity, "BbPatient|PatientidSource", deepLoadType, innerList) 
				&& entity.PatientidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.Patientid;
				BbPatient tmpEntity = EntityManager.LocateEntity<BbPatient>(EntityLocator.ConstructKeyFromPkItems(typeof(BbPatient), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.PatientidSource = tmpEntity;
				else
					entity.PatientidSource = DataRepository.BbPatientProvider.GetByPatientid(transactionManager, entity.Patientid);		
				...
				{
					innerList.SkipChildren = true;
					DataRepository.BbPatientProvider.DeepLoad(transactionManager, entity.PatientidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
			...
			#region RegcentreidSource	
			if (CanDeepLoad(entity, "BbCentre|RegcentreidSource", deepLoadType, innerList) 
				&& entity.RegcentreidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.Regcentreid ?? (int)0);
				...
				if (tmpEntity != null)
					entity.RegcentreidSource = tmpEntity;
				else
					entity.RegcentreidSource = DataRepository.BbCentreProvider.GetByCentreid(transactionManager, (entity.Regcentreid ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'RegcentreidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.RegcentreidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbCentreProvider.DeepLoad(transactionManager, entity.RegcentreidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion RegcentreidSource
			
			//used to hold DeepLoad method delegates and fire after all the local children have been loaded.
			Dictionary<string, KeyValuePair<Delegate, object>> deepHandles = new Dictionary<string, KeyValuePair<Delegate, object>>();
			// Deep load child collections  - Call GetByChid methods when available
			
			#region BbPappPatientLifestyleCollection
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbPappPatientLifestyle>|BbPappPatientLifestyleCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbPappPatientLifestyleCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbPappPatientLifestyleCollection = DataRepository.BbPappPatientLifestyleProvider.GetByChid(transactionManager, entity.Chid);

				if (deep && entity.BbPappPatientLifestyleCollection.Count > 0)
				{
					deepHandles.Add("BbPappPatientLifestyleCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbPappPatientLifestyle>) DataRepository.BbPappPatientLifestyleProvider.DeepLoad,
						new object[] { transactionManager, entity.BbPappPatientLifestyleCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
			...
			if (CanDeepLoad(entity, "List<BbPatientCohortTracking>|BbPatientCohortTrackingCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPatientCohortTrackingCollection = DataRepository.BbPatientCohortTrackingProvider.GetByChid(transactionManager, entity.Chid);
			...
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbPappPatientMedProblemFup>|BbPappPatientMedProblemFupCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbPappPatientMedProblemFupCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbPappPatientMedProblemFupCollection = DataRepository.BbPappPatientMedProblemFupProvider.GetByChid(transactionManager, entity.Chid);

				if (deep && entity.BbPappPatientMedProblemFupCollection.Count > 0)
				{
					deepHandles.Add("BbPappPatientMedProblemFupCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbPappPatientMedProblemFup>) DataRepository.BbPappPatientMedProblemFupProvider.DeepLoad,
						new object[] { transactionManager, entity.BbPappPatientMedProblemFupCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
			...
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbPappPatientDlqi>|BbPappPatientDlqiCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbPappPatientDlqiCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbPappPatientDlqiCollection = DataRepository.BbPappPatientDlqiProvider.GetByChid(transactionManager, entity.Chid);

				if (deep && entity.BbPappPatientDlqiCollection.Count > 0)
				{
					deepHandles.Add("BbPappPatientDlqiCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbPappPatientDlqi>) DataRepository.BbPappPatientDlqiProvider.DeepLoad,
						new object[] { transactionManager, entity.BbPappPatientDlqiCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
			...
			if (CanDeepLoad(entity, "List<BbQuery>|BbQueryCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbQueryCollection = DataRepository.BbQueryProvider.GetByChid(transactionManager, entity.Chid);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region CohortidSource
			if (CanDeepSave(entity, "BbCohortlkp|CohortidSource", deepSaveType, innerList) 
				&& entity.CohortidSource != null)
			{
				DataRepository.BbCohortlkpProvider.Save(transactionManager, entity.CohortidSource);
				entity.Cohortid = entity.CohortidSource.Cohortid;
			}
			#endregion 
			
			#region PatientidSource
			if (CanDeepSave(entity, "BbPatient|PatientidSource", deepSaveType, innerList) 
				&& entity.PatientidSource != null)
			{
				DataRepository.BbPatientProvider.Save(transactionManager, entity.PatientidSource);
				entity.Patientid = entity.PatientidSource.Patientid;
			}
			#endregion 
			
			#region RegcentreidSource
			if (CanDeepSave(entity, "BbCentre|RegcentreidSource", deepSaveType, innerList) 
				&& entity.RegcentreidSource != null)
			{
				DataRepository.BbCentreProvider.Save(transactionManager, entity.RegcentreidSource);
				entity.Regcentreid = entity.RegcentreidSource.Centreid;
			}
			#endregion 
			...
			#region List<BbPappPatientLifestyle>
				if (CanDeepSave(entity.BbPappPatientLifestyleCollection, "List<BbPappPatientLifestyle>|BbPappPatientLifestyleCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbPappPatientLifestyle child in entity.BbPappPatientLifestyleCollection)
					{
						if(child.ChidSource != null)
						{
							child.Chid = child.ChidSource.Chid;
						}
						else
						{
							child.Chid = entity.Chid;
						}

					}

					if (entity.BbPappPatientLifestyleCollection.Count > 0 || entity.BbPappPatientLifestyleCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbPappPatientLifestyleProvider.Save(transactionManager, entity.BbPappPatientLifestyleCollection);
						
						deepHandles.Add("BbPappPatientLifestyleCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbPappPatientLifestyle >) DataRepository.BbPappPatientLifestyleProvider.DeepSave,
							new object[] { transactionManager, entity.BbPappPatientLifestyleCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
			...
			#region List<BbPappPatientMedProblemFup>
				if (CanDeepSave(entity.BbPappPatientMedProblemFupCollection, "List<BbPappPatientMedProblemFup>|BbPappPatientMedProblemFupCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbPappPatientMedProblemFup child in entity.BbPappPatientMedProblemFupCollection)
					{
						if(child.ChidSource != null)
						{
							child.Chid = child.ChidSource.Chid;
					...
					if (entity.BbPappPatientMedProblemFupCollection.Count > 0 || entity.BbPappPatientMedProblemFupCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbPappPatientMedProblemFupProvider.Save(transactionManager, entity.BbPappPatientMedProblemFupCollection);
						
						deepHandles.Add("BbPappPatientMedProblemFupCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbPappPatientMedProblemFup >) DataRepository.BbPappPatientMedProblemFupProvider.DeepSave,
							new object[] { transactionManager, entity.BbPappPatientMedProblemFupCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
			...
			#region List<BbPappPatientDlqi>
				if (CanDeepSave(entity.BbPappPatientDlqiCollection, "List<BbPappPatientDlqi>|BbPappPatientDlqiCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbPappPatientDlqi child in entity.BbPappPatientDlqiCollection)
					{
						if(child.ChidSource != null)
						{
							child.Chid = child.ChidSource.Chid;
					...
					if (entity.BbPappPatientDlqiCollection.Count > 0 || entity.BbPappPatientDlqiCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbPappPatientDlqiProvider.Save(transactionManager, entity.BbPappPatientDlqiCollection);
						
						deepHandles.Add("BbPappPatientDlqiCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbPappPatientDlqi >) DataRepository.BbPappPatientDlqiProvider.DeepSave,
							new object[] { transactionManager, entity.BbPappPatientDlqiCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	#region BbPatientCohortHistoryChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPatientCohortHistory</c>
	///</summary>
	public enum BbPatientCohortHistoryChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbCohortlkp</c> at CohortidSource
		///</summary>
		[ChildEntityType(typeof(BbCohortlkp))]
		BbCohortlkp,
		
		///<summary>
		/// Composite Property for <c>BbPatient</c> at PatientidSource
		///</summary>
		[ChildEntityType(typeof(BbPatient))]
		BbPatient,
		
		///<summary>
		/// Composite Property for <c>BbCentre</c> at RegcentreidSource
		///</summary>
		[ChildEntityType(typeof(BbCentre))]
		BbCentre,
		///<summary>
		/// Collection of <c>BbPatientCohortHistory</c> as OneToMany for BbPappPatientLifestyleCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPappPatientLifestyle>))]
		BbPappPatientLifestyleCollection,
		///<summary>
		/// Collection of <c>BbPatientCohortHistory</c> as OneToMany for BbPatientCohortTrackingCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientCohortTracking>))]
		BbPatientCohortTrackingCollection,
		///<summary>
		/// Collection of <c>BbPatientCohortHistory</c> as OneToMany for BbPappPatientMedProblemFupCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPappPatientMedProblemFup>))]
		BbPappPatientMedProblemFupCollection,
		///<summary>
		/// Collection of <c>BbPatientCohortHistory</c> as OneToMany for BbPappPatientDlqiCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPappPatientDlqi>))]
		BbPappPatientDlqiCollection,
		///<summary>
		/// Collection of <c>BbPatientCohortHistory</c> as OneToMany for BbQueryCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbQuery>))]
		BbQueryCollection,
	}
	
	#endregion BbPatientCohortHistoryChildEntityTypes
	
	#region BbPatientCohortHistoryFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPatientCohortHistoryColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortHistory"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientCohortHistoryFilterBuilder : SqlFilterBuilder<BbPatientCohortHistoryColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortHistoryFilterBuilder class.
		/// </summary>
		public BbPatientCohortHistoryFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortHistoryFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientCohortHistoryFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPatientCohortHistoryFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientCohortHistoryFilterBuilder
	
	#region BbPatientCohortHistoryParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPatientCohortHistoryColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortHistory"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientCohortHistoryParameterBuilder : ParameterizedSqlFilterBuilder<BbPatientCohortHistoryColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortHistoryParameterBuilder class.
		/// </summary>
		public BbPatientCohortHistoryParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortHistoryParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientCohortHistoryParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPatientCohortHistoryParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientCohortHistoryParameterBuilder
	
	#region BbPatientCohortHistorySortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPatientCohortHistoryColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortHistory"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPatientCohortHistorySortBuilder : SqlSortBuilder<BbPatientCohortHistoryColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortHistorySqlSortBuilder class.
		/// </summary>
		public BbPatientCohortHistorySortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPatientCohortHistorySortBuilder
