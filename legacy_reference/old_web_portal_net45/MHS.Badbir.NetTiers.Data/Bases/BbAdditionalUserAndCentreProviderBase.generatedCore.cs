...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbAdditionalUserAndCentreProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbAdditionalUserAndCentreProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre, MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentreKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentreKey key)
		{
			return Delete(transactionManager, key.Userid, key.Centreid);
		}
		...
		/// <param name="_centreid">Centre. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Guid _userid, int _centreid)
		{
			return Delete(null, _userid, _centreid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Guid _userid, int _centreid);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbAdditionalUserAndCentre_bbAdditionalUserDetail key.
		///		FK_bbAdditionalUserAndCentre_bbAdditionalUserDetail Description: 
		/// </summary>
		/// <param name="_userid">User Id</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		public TList<BbAdditionalUserAndCentre> GetByUserid(System.Guid _userid)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		/// <remarks></remarks>
		public TList<BbAdditionalUserAndCentre> GetByUserid(TransactionManager transactionManager, System.Guid _userid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		public TList<BbAdditionalUserAndCentre> GetByUserid(TransactionManager transactionManager, System.Guid _userid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbAdditionalUserAndCentre_bbAdditionalUserDetail key.
		///		fkBbAdditionalUserAndCentreBbAdditionalUserDetail Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_userid">User Id</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		public TList<BbAdditionalUserAndCentre> GetByUserid(System.Guid _userid, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		public TList<BbAdditionalUserAndCentre> GetByUserid(System.Guid _userid, int start, int pageLength,out int count)
		{
			return GetByUserid(null, _userid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		public abstract TList<BbAdditionalUserAndCentre> GetByUserid(TransactionManager transactionManager, System.Guid _userid, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbAdditionalUserAndCentre_bbCentre key.
		///		FK_bbAdditionalUserAndCentre_bbCentre Description: 
		/// </summary>
		/// <param name="_centreid">Centre</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		public TList<BbAdditionalUserAndCentre> GetByCentreid(int _centreid)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		/// <remarks></remarks>
		public TList<BbAdditionalUserAndCentre> GetByCentreid(TransactionManager transactionManager, int _centreid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		public TList<BbAdditionalUserAndCentre> GetByCentreid(TransactionManager transactionManager, int _centreid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbAdditionalUserAndCentre_bbCentre key.
		///		fkBbAdditionalUserAndCentreBbCentre Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_centreid">Centre</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		public TList<BbAdditionalUserAndCentre> GetByCentreid(int _centreid, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		public TList<BbAdditionalUserAndCentre> GetByCentreid(int _centreid, int start, int pageLength,out int count)
		{
			return GetByCentreid(null, _centreid, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre objects.</returns>
		public abstract TList<BbAdditionalUserAndCentre> GetByCentreid(TransactionManager transactionManager, int _centreid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentreKey key, int start, int pageLength)
		{
			return GetByUseridCentreid(transactionManager, key.Userid, key.Centreid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbAdditionalUserAndCentre index.
		/// </summary>
		/// <param name="_userid">User Id</param>
		/// <param name="_centreid">Centre</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre GetByUseridCentreid(System.Guid _userid, int _centreid)
		{
			int count = -1;
			return GetByUseridCentreid(null,_userid, _centreid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbAdditionalUserAndCentre index.
		/// </summary>
		/// <param name="_userid">User Id</param>
		/// <param name="_centreid">Centre</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre GetByUseridCentreid(System.Guid _userid, int _centreid, int start, int pageLength)
		{
			int count = -1;
			return GetByUseridCentreid(null, _userid, _centreid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre GetByUseridCentreid(TransactionManager transactionManager, System.Guid _userid, int _centreid)
		{
			int count = -1;
			return GetByUseridCentreid(transactionManager, _userid, _centreid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre GetByUseridCentreid(TransactionManager transactionManager, System.Guid _userid, int _centreid, int start, int pageLength)
		{
			int count = -1;
			return GetByUseridCentreid(transactionManager, _userid, _centreid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre GetByUseridCentreid(System.Guid _userid, int _centreid, int start, int pageLength, out int count)
		{
			return GetByUseridCentreid(null, _userid, _centreid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre GetByUseridCentreid(TransactionManager transactionManager, System.Guid _userid, int _centreid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbAdditionalUserAndCentre&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbAdditionalUserAndCentre&gt;"/></returns>
		public static TList<BbAdditionalUserAndCentre> Fill(IDataReader reader, TList<BbAdditionalUserAndCentre> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbAdditionalUserAndCentre")
					.Append("|").Append((System.Guid)reader[((int)BbAdditionalUserAndCentreColumn.Userid - 1)])
					.Append("|").Append((int)reader[((int)BbAdditionalUserAndCentreColumn.Centreid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbAdditionalUserAndCentre>(
					key.ToString(), // EntityTrackingKey
					"BbAdditionalUserAndCentre",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre();
				}
					...
					))
				{
					...
					c.Userid = (System.Guid)reader[((int)BbAdditionalUserAndCentreColumn.Userid - 1)];
					c.OriginalUserid = c.Userid;
					c.Centreid = (int)reader[((int)BbAdditionalUserAndCentreColumn.Centreid - 1)];
					c.OriginalCentreid = c.Centreid;
					c.Createdbyid = (int)reader[((int)BbAdditionalUserAndCentreColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbAdditionalUserAndCentreColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbAdditionalUserAndCentreColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbAdditionalUserAndCentreColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbAdditionalUserAndCentreColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbAdditionalUserAndCentreColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre entity)
		{
			if (!reader.Read()) return;
			
			entity.Userid = (System.Guid)reader[((int)BbAdditionalUserAndCentreColumn.Userid - 1)];
			entity.OriginalUserid = (System.Guid)reader["userid"];
			entity.Centreid = (int)reader[((int)BbAdditionalUserAndCentreColumn.Centreid - 1)];
			entity.OriginalCentreid = (int)reader["Centreid"];
			entity.Createdbyid = (int)reader[((int)BbAdditionalUserAndCentreColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbAdditionalUserAndCentreColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbAdditionalUserAndCentreColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbAdditionalUserAndCentreColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbAdditionalUserAndCentreColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbAdditionalUserAndCentreColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre entity)
		{
			...
			entity.OriginalCentreid = (int)dataRow["Centreid"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region UseridSource	
			if (CanDeepLoad(entity, "BbAdditionalUserDetail|UseridSource", deepLoadType, innerList) 
				&& entity.UseridSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.Userid;
				BbAdditionalUserDetail tmpEntity = EntityManager.LocateEntity<BbAdditionalUserDetail>(EntityLocator.ConstructKeyFromPkItems(typeof(BbAdditionalUserDetail), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.UseridSource = tmpEntity;
				else
					entity.UseridSource = DataRepository.BbAdditionalUserDetailProvider.GetByUserid(transactionManager, entity.Userid);		
				...
				if (deep && entity.UseridSource != null)
				{
					...
					DataRepository.BbAdditionalUserDetailProvider.DeepLoad(transactionManager, entity.UseridSource, deep, deepLoadType, childTypes, innerList);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region UseridSource
			if (CanDeepSave(entity, "BbAdditionalUserDetail|UseridSource", deepSaveType, innerList) 
				&& entity.UseridSource != null)
			{
				DataRepository.BbAdditionalUserDetailProvider.Save(transactionManager, entity.UseridSource);
	...
	#region BbAdditionalUserAndCentreChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbAdditionalUserAndCentre</c>
	///</summary>
	public enum BbAdditionalUserAndCentreChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbAdditionalUserDetail</c> at UseridSource
		///</summary>
		[ChildEntityType(typeof(BbAdditionalUserDetail))]
		BbAdditionalUserDetail,
	}
	
	#endregion BbAdditionalUserAndCentreChildEntityTypes
	
	#region BbAdditionalUserAndCentreFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbAdditionalUserAndCentreColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbAdditionalUserAndCentre"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbAdditionalUserAndCentreFilterBuilder : SqlFilterBuilder<BbAdditionalUserAndCentreColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbAdditionalUserAndCentreFilterBuilder class.
		/// </summary>
		public BbAdditionalUserAndCentreFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbAdditionalUserAndCentreFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbAdditionalUserAndCentreFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbAdditionalUserAndCentreFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbAdditionalUserAndCentreFilterBuilder
	
	#region BbAdditionalUserAndCentreParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbAdditionalUserAndCentreColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbAdditionalUserAndCentre"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbAdditionalUserAndCentreParameterBuilder : ParameterizedSqlFilterBuilder<BbAdditionalUserAndCentreColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbAdditionalUserAndCentreParameterBuilder class.
		/// </summary>
		public BbAdditionalUserAndCentreParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbAdditionalUserAndCentreParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbAdditionalUserAndCentreParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbAdditionalUserAndCentreParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbAdditionalUserAndCentreParameterBuilder
	
	#region BbAdditionalUserAndCentreSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbAdditionalUserAndCentreColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbAdditionalUserAndCentre"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbAdditionalUserAndCentreSortBuilder : SqlSortBuilder<BbAdditionalUserAndCentreColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbAdditionalUserAndCentreSqlSortBuilder class.
		/// </summary>
		public BbAdditionalUserAndCentreSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbAdditionalUserAndCentreSortBuilder
