...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPatientCohortTrackingClinicAttendanceLkpProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPatientCohortTrackingClinicAttendanceLkpProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkpKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkpKey key)
		{
			return Delete(transactionManager, key.ClinicAttendanceId);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_clinicAttendanceId">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _clinicAttendanceId)
		{
			return Delete(null, _clinicAttendanceId);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _clinicAttendanceId);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkpKey key, int start, int pageLength)
		{
			return GetByClinicAttendanceId(transactionManager, key.ClinicAttendanceId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_clinicAttendanceId index.
		/// </summary>
		/// <param name="_clinicAttendanceId"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp GetByClinicAttendanceId(int _clinicAttendanceId)
		{
			int count = -1;
			return GetByClinicAttendanceId(null,_clinicAttendanceId, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_clinicAttendanceId index.
		/// </summary>
		/// <param name="_clinicAttendanceId"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp GetByClinicAttendanceId(int _clinicAttendanceId, int start, int pageLength)
		{
			int count = -1;
			return GetByClinicAttendanceId(null, _clinicAttendanceId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp GetByClinicAttendanceId(TransactionManager transactionManager, int _clinicAttendanceId)
		{
			int count = -1;
			return GetByClinicAttendanceId(transactionManager, _clinicAttendanceId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp GetByClinicAttendanceId(TransactionManager transactionManager, int _clinicAttendanceId, int start, int pageLength)
		{
			int count = -1;
			return GetByClinicAttendanceId(transactionManager, _clinicAttendanceId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp GetByClinicAttendanceId(int _clinicAttendanceId, int start, int pageLength, out int count)
		{
			return GetByClinicAttendanceId(null, _clinicAttendanceId, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp GetByClinicAttendanceId(TransactionManager transactionManager, int _clinicAttendanceId, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbPatientCohortTrackingClinicAttendanceLkp&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPatientCohortTrackingClinicAttendanceLkp&gt;"/></returns>
		public static TList<BbPatientCohortTrackingClinicAttendanceLkp> Fill(IDataReader reader, TList<BbPatientCohortTrackingClinicAttendanceLkp> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPatientCohortTrackingClinicAttendanceLkp")
					.Append("|").Append((int)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.ClinicAttendanceId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPatientCohortTrackingClinicAttendanceLkp>(
					key.ToString(), // EntityTrackingKey
					"BbPatientCohortTrackingClinicAttendanceLkp",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp();
				}
					...
					))
				{
					...
					c.ClinicAttendanceId = (int)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.ClinicAttendanceId - 1)];
					c.ClinicAttendanceText = (reader.IsDBNull(((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.ClinicAttendanceText - 1)))?null:(string)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.ClinicAttendanceText - 1)];
					c.Createdbyid = (int)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp entity)
		{
			if (!reader.Read()) return;
			
			entity.ClinicAttendanceId = (int)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.ClinicAttendanceId - 1)];
			entity.ClinicAttendanceText = (reader.IsDBNull(((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.ClinicAttendanceText - 1)))?null:(string)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.ClinicAttendanceText - 1)];
			entity.Createdbyid = (int)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPatientCohortTrackingClinicAttendanceLkpColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.ClinicAttendanceId = (int)dataRow["clinicAttendanceId"];
			entity.ClinicAttendanceText = Convert.IsDBNull(dataRow["clinicAttendanceText"]) ? null : (string)dataRow["clinicAttendanceText"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			// Deep load child collections  - Call GetByClinicAttendanceId methods when available
			...
			if (CanDeepLoad(entity, "List<BbPappPatientCohortTracking>|BbPappPatientCohortTrackingCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPappPatientCohortTrackingCollection = DataRepository.BbPappPatientCohortTrackingProvider.GetByClinicAttendance(transactionManager, entity.ClinicAttendanceId);
			...
			if (CanDeepLoad(entity, "List<BbPatientCohortTracking>|BbPatientCohortTrackingCollection", deepLoadType, innerList)) 
			{
				...
				entity.BbPatientCohortTrackingCollection = DataRepository.BbPatientCohortTrackingProvider.GetByClinicAttendance(transactionManager, entity.ClinicAttendanceId);
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region List<BbPappPatientCohortTracking>
				...
				{	
					...
					{
						if(child.ClinicAttendanceSource != null)
						{
							child.ClinicAttendance = child.ClinicAttendanceSource.ClinicAttendanceId;
						}
						else
						{
							child.ClinicAttendance = entity.ClinicAttendanceId;
						}
	...
	#region BbPatientCohortTrackingClinicAttendanceLkpChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPatientCohortTrackingClinicAttendanceLkp</c>
	///</summary>
	public enum BbPatientCohortTrackingClinicAttendanceLkpChildEntityTypes
	{
		///<summary>
		/// Collection of <c>BbPatientCohortTrackingClinicAttendanceLkp</c> as OneToMany for BbPappPatientCohortTrackingCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPappPatientCohortTracking>))]
		BbPappPatientCohortTrackingCollection,
		///<summary>
		/// Collection of <c>BbPatientCohortTrackingClinicAttendanceLkp</c> as OneToMany for BbPatientCohortTrackingCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbPatientCohortTracking>))]
		BbPatientCohortTrackingCollection,
	}
	
	#endregion BbPatientCohortTrackingClinicAttendanceLkpChildEntityTypes
	
	#region BbPatientCohortTrackingClinicAttendanceLkpFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPatientCohortTrackingClinicAttendanceLkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortTrackingClinicAttendanceLkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientCohortTrackingClinicAttendanceLkpFilterBuilder : SqlFilterBuilder<BbPatientCohortTrackingClinicAttendanceLkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingClinicAttendanceLkpFilterBuilder class.
		/// </summary>
		public BbPatientCohortTrackingClinicAttendanceLkpFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingClinicAttendanceLkpFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientCohortTrackingClinicAttendanceLkpFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPatientCohortTrackingClinicAttendanceLkpFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientCohortTrackingClinicAttendanceLkpFilterBuilder
	
	#region BbPatientCohortTrackingClinicAttendanceLkpParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPatientCohortTrackingClinicAttendanceLkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortTrackingClinicAttendanceLkp"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientCohortTrackingClinicAttendanceLkpParameterBuilder : ParameterizedSqlFilterBuilder<BbPatientCohortTrackingClinicAttendanceLkpColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingClinicAttendanceLkpParameterBuilder class.
		/// </summary>
		public BbPatientCohortTrackingClinicAttendanceLkpParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingClinicAttendanceLkpParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientCohortTrackingClinicAttendanceLkpParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPatientCohortTrackingClinicAttendanceLkpParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientCohortTrackingClinicAttendanceLkpParameterBuilder
	
	#region BbPatientCohortTrackingClinicAttendanceLkpSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPatientCohortTrackingClinicAttendanceLkpColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientCohortTrackingClinicAttendanceLkp"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPatientCohortTrackingClinicAttendanceLkpSortBuilder : SqlSortBuilder<BbPatientCohortTrackingClinicAttendanceLkpColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientCohortTrackingClinicAttendanceLkpSqlSortBuilder class.
		/// </summary>
		public BbPatientCohortTrackingClinicAttendanceLkpSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPatientCohortTrackingClinicAttendanceLkpSortBuilder
