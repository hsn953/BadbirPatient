...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbConfigFactoryProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbConfigFactoryProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbConfigFactory, MHS.Badbir.NetTiers.Entities.BbConfigFactoryKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbConfigFactoryKey key)
		{
			return Delete(transactionManager, key.Configid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_configid">. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _configid)
		{
			return Delete(null, _configid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _configid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbConfigFactory Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbConfigFactoryKey key, int start, int pageLength)
		{
			return GetByConfigid(transactionManager, key.Configid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key Index_inuse index.
		/// </summary>
		/// <param name="_inuse"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public TList<BbConfigFactory> GetByInuse(bool _inuse)
		{
			int count = -1;
			return GetByInuse(null,_inuse, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the Index_inuse index.
		/// </summary>
		/// <param name="_inuse"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public TList<BbConfigFactory> GetByInuse(bool _inuse, int start, int pageLength)
		{
			int count = -1;
			return GetByInuse(null, _inuse, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public TList<BbConfigFactory> GetByInuse(TransactionManager transactionManager, bool _inuse)
		{
			int count = -1;
			return GetByInuse(transactionManager, _inuse, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public TList<BbConfigFactory> GetByInuse(TransactionManager transactionManager, bool _inuse, int start, int pageLength)
		{
			int count = -1;
			return GetByInuse(transactionManager, _inuse, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public TList<BbConfigFactory> GetByInuse(bool _inuse, int start, int pageLength, out int count)
		{
			return GetByInuse(null, _inuse, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public abstract TList<BbConfigFactory> GetByInuse(TransactionManager transactionManager, bool _inuse, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key Index_inuseWithType index.
		/// </summary>
		/// <param name="_typeId"></param>
		/// <param name="_inuse"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public TList<BbConfigFactory> GetByTypeIdInuse(byte _typeId, bool _inuse)
		{
			int count = -1;
			return GetByTypeIdInuse(null,_typeId, _inuse, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the Index_inuseWithType index.
		/// </summary>
		/// <param name="_typeId"></param>
		/// <param name="_inuse"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public TList<BbConfigFactory> GetByTypeIdInuse(byte _typeId, bool _inuse, int start, int pageLength)
		{
			int count = -1;
			return GetByTypeIdInuse(null, _typeId, _inuse, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public TList<BbConfigFactory> GetByTypeIdInuse(TransactionManager transactionManager, byte _typeId, bool _inuse)
		{
			int count = -1;
			return GetByTypeIdInuse(transactionManager, _typeId, _inuse, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public TList<BbConfigFactory> GetByTypeIdInuse(TransactionManager transactionManager, byte _typeId, bool _inuse, int start, int pageLength)
		{
			int count = -1;
			return GetByTypeIdInuse(transactionManager, _typeId, _inuse, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public TList<BbConfigFactory> GetByTypeIdInuse(byte _typeId, bool _inuse, int start, int pageLength, out int count)
		{
			return GetByTypeIdInuse(null, _typeId, _inuse, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbConfigFactory&gt;"/> class.</returns>
		public abstract TList<BbConfigFactory> GetByTypeIdInuse(TransactionManager transactionManager, byte _typeId, bool _inuse, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbConfigFactory index.
		/// </summary>
		/// <param name="_configid"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbConfigFactory GetByConfigid(int _configid)
		{
			int count = -1;
			return GetByConfigid(null,_configid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbConfigFactory index.
		/// </summary>
		/// <param name="_configid"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbConfigFactory GetByConfigid(int _configid, int start, int pageLength)
		{
			int count = -1;
			return GetByConfigid(null, _configid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbConfigFactory GetByConfigid(TransactionManager transactionManager, int _configid)
		{
			int count = -1;
			return GetByConfigid(transactionManager, _configid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbConfigFactory GetByConfigid(TransactionManager transactionManager, int _configid, int start, int pageLength)
		{
			int count = -1;
			return GetByConfigid(transactionManager, _configid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbConfigFactory GetByConfigid(int _configid, int start, int pageLength, out int count)
		{
			return GetByConfigid(null, _configid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbConfigFactory GetByConfigid(TransactionManager transactionManager, int _configid, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbConfigFactory&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbConfigFactory&gt;"/></returns>
		public static TList<BbConfigFactory> Fill(IDataReader reader, TList<BbConfigFactory> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbConfigFactory c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbConfigFactory")
					.Append("|").Append((int)reader[((int)BbConfigFactoryColumn.Configid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbConfigFactory>(
					key.ToString(), // EntityTrackingKey
					"BbConfigFactory",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbConfigFactory();
				}
					...
					))
				{
					...
					c.Configid = (int)reader[((int)BbConfigFactoryColumn.Configid - 1)];
					c.Configname = (string)reader[((int)BbConfigFactoryColumn.Configname - 1)];
					c.TypeId = (byte)reader[((int)BbConfigFactoryColumn.TypeId - 1)];
					c.TextVal = (reader.IsDBNull(((int)BbConfigFactoryColumn.TextVal - 1)))?null:(string)reader[((int)BbConfigFactoryColumn.TextVal - 1)];
					c.IntVal = (reader.IsDBNull(((int)BbConfigFactoryColumn.IntVal - 1)))?null:(System.Int32?)reader[((int)BbConfigFactoryColumn.IntVal - 1)];
					c.FloatVal = (reader.IsDBNull(((int)BbConfigFactoryColumn.FloatVal - 1)))?null:(System.Double?)reader[((int)BbConfigFactoryColumn.FloatVal - 1)];
					c.Inuse = (bool)reader[((int)BbConfigFactoryColumn.Inuse - 1)];
					c.Createdbyid = (int)reader[((int)BbConfigFactoryColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbConfigFactoryColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbConfigFactoryColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbConfigFactoryColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbConfigFactoryColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbConfigFactoryColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbConfigFactory entity)
		{
			if (!reader.Read()) return;
			
			entity.Configid = (int)reader[((int)BbConfigFactoryColumn.Configid - 1)];
			entity.Configname = (string)reader[((int)BbConfigFactoryColumn.Configname - 1)];
			entity.TypeId = (byte)reader[((int)BbConfigFactoryColumn.TypeId - 1)];
			entity.TextVal = (reader.IsDBNull(((int)BbConfigFactoryColumn.TextVal - 1)))?null:(string)reader[((int)BbConfigFactoryColumn.TextVal - 1)];
			entity.IntVal = (reader.IsDBNull(((int)BbConfigFactoryColumn.IntVal - 1)))?null:(System.Int32?)reader[((int)BbConfigFactoryColumn.IntVal - 1)];
			entity.FloatVal = (reader.IsDBNull(((int)BbConfigFactoryColumn.FloatVal - 1)))?null:(System.Double?)reader[((int)BbConfigFactoryColumn.FloatVal - 1)];
			entity.Inuse = (bool)reader[((int)BbConfigFactoryColumn.Inuse - 1)];
			entity.Createdbyid = (int)reader[((int)BbConfigFactoryColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbConfigFactoryColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbConfigFactoryColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbConfigFactoryColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbConfigFactoryColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbConfigFactoryColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbConfigFactory entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Configid = (int)dataRow["configid"];
			entity.Configname = (string)dataRow["configname"];
			entity.TypeId = (byte)dataRow["typeID"];
			entity.TextVal = Convert.IsDBNull(dataRow["textVal"]) ? null : (string)dataRow["textVal"];
			entity.IntVal = Convert.IsDBNull(dataRow["intVal"]) ? null : (System.Int32?)dataRow["intVal"];
			entity.FloatVal = Convert.IsDBNull(dataRow["floatVal"]) ? null : (System.Double?)dataRow["floatVal"];
			entity.Inuse = (bool)dataRow["inuse"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbConfigFactory"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbConfigFactory Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbConfigFactory entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbConfigFactory object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbConfigFactory instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbConfigFactory Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbConfigFactory entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbConfigFactoryChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbConfigFactory</c>
	///</summary>
	public enum BbConfigFactoryChildEntityTypes
	{
	}
	
	#endregion BbConfigFactoryChildEntityTypes
	
	#region BbConfigFactoryFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbConfigFactoryColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbConfigFactory"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbConfigFactoryFilterBuilder : SqlFilterBuilder<BbConfigFactoryColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbConfigFactoryFilterBuilder class.
		/// </summary>
		public BbConfigFactoryFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbConfigFactoryFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbConfigFactoryFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbConfigFactoryFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbConfigFactoryFilterBuilder
	
	#region BbConfigFactoryParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbConfigFactoryColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbConfigFactory"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbConfigFactoryParameterBuilder : ParameterizedSqlFilterBuilder<BbConfigFactoryColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbConfigFactoryParameterBuilder class.
		/// </summary>
		public BbConfigFactoryParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbConfigFactoryParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbConfigFactoryParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbConfigFactoryParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbConfigFactoryParameterBuilder
	
	#region BbConfigFactorySortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbConfigFactoryColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbConfigFactory"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbConfigFactorySortBuilder : SqlSortBuilder<BbConfigFactoryColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbConfigFactorySqlSortBuilder class.
		/// </summary>
		public BbConfigFactorySortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbConfigFactorySortBuilder
