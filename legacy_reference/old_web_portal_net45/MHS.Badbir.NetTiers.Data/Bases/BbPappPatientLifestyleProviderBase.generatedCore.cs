...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPappPatientLifestyleProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPappPatientLifestyleProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle, MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyleKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyleKey key)
		{
		...
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _formId)
		{
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _formId);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappFupPatientLifestyle_bbWorkstatuslkp key.
		///		FK_bbPappFupPatientLifestyle_bbWorkstatuslkp Description: 
		/// </summary>
		/// <param name="_workstatusid"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		public TList<BbPappPatientLifestyle> GetByWorkstatusid(System.Int32? _workstatusid)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		/// <remarks></remarks>
		public TList<BbPappPatientLifestyle> GetByWorkstatusid(TransactionManager transactionManager, System.Int32? _workstatusid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		public TList<BbPappPatientLifestyle> GetByWorkstatusid(TransactionManager transactionManager, System.Int32? _workstatusid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappFupPatientLifestyle_bbWorkstatuslkp key.
		///		fkBbPappFupPatientLifestyleBbWorkstatuslkp Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_workstatusid"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		public TList<BbPappPatientLifestyle> GetByWorkstatusid(System.Int32? _workstatusid, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		public TList<BbPappPatientLifestyle> GetByWorkstatusid(System.Int32? _workstatusid, int start, int pageLength,out int count)
		{
			return GetByWorkstatusid(null, _workstatusid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		public abstract TList<BbPappPatientLifestyle> GetByWorkstatusid(TransactionManager transactionManager, System.Int32? _workstatusid, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappPatientLifestyle_bbPatientCohortHistory key.
		///		FK_bbPappPatientLifestyle_bbPatientCohortHistory Description: 
		/// </summary>
		/// <param name="_chid"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		public TList<BbPappPatientLifestyle> GetByChid(int _chid)
		{
			int count = -1;
			return GetByChid(_chid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		/// <remarks></remarks>
		public TList<BbPappPatientLifestyle> GetByChid(TransactionManager transactionManager, int _chid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		public TList<BbPappPatientLifestyle> GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappPatientLifestyle_bbPatientCohortHistory key.
		///		fkBbPappPatientLifestyleBbPatientCohortHistory Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_chid"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		public TList<BbPappPatientLifestyle> GetByChid(int _chid, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		public TList<BbPappPatientLifestyle> GetByChid(int _chid, int start, int pageLength,out int count)
		{
			return GetByChid(null, _chid, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle objects.</returns>
		public abstract TList<BbPappPatientLifestyle> GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyleKey key, int start, int pageLength)
		{
			return GetByFormId(transactionManager, key.FormId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbPappFupPatientLifestyle index.
		/// </summary>
		/// <param name="_formId"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle GetByFormId(int _formId)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbPappFupPatientLifestyle index.
		/// </summary>
		/// <param name="_formId"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle GetByFormId(int _formId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle GetByFormId(TransactionManager transactionManager, int _formId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle GetByFormId(TransactionManager transactionManager, int _formId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle GetByFormId(int _formId, int start, int pageLength, out int count)
		{
			return GetByFormId(null, _formId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle GetByFormId(TransactionManager transactionManager, int _formId, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbPappPatientLifestyle&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPappPatientLifestyle&gt;"/></returns>
		public static TList<BbPappPatientLifestyle> Fill(IDataReader reader, TList<BbPappPatientLifestyle> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPappPatientLifestyle")
					.Append("|").Append((int)reader[((int)BbPappPatientLifestyleColumn.FormId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPappPatientLifestyle>(
					key.ToString(), // EntityTrackingKey
					"BbPappPatientLifestyle",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle();
				}
					...
					))
				{
					...
					c.FormId = (int)reader[((int)BbPappPatientLifestyleColumn.FormId - 1)];
					c.OriginalFormId = c.FormId;
					c.Chid = (int)reader[((int)BbPappPatientLifestyleColumn.Chid - 1)];
					c.PappFupId = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.PappFupId - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.PappFupId - 1)];
					c.Admittedtohospital = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Admittedtohospital - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Admittedtohospital - 1)];
					c.Newdrugs = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Newdrugs - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Newdrugs - 1)];
					c.Newclinics = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Newclinics - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Newclinics - 1)];
					c.Workstatusid = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Workstatusid - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Workstatusid - 1)];
					c.Occupation = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Occupation - 1)))?null:(string)reader[((int)BbPappPatientLifestyleColumn.Occupation - 1)];
					c.SmokingMissing = (bool)reader[((int)BbPappPatientLifestyleColumn.SmokingMissing - 1)];
					c.Currentlysmoke = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Currentlysmoke - 1)))?null:(System.Boolean?)reader[((int)BbPappPatientLifestyleColumn.Currentlysmoke - 1)];
					c.Currentlysmokenumbercigsperday = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Currentlysmokenumbercigsperday - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Currentlysmokenumbercigsperday - 1)];
					c.DrinkingMissing = (bool)reader[((int)BbPappPatientLifestyleColumn.DrinkingMissing - 1)];
					c.Drinkalcohol = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Drinkalcohol - 1)))?null:(System.Boolean?)reader[((int)BbPappPatientLifestyleColumn.Drinkalcohol - 1)];
					c.Drnkunitsavg = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Drnkunitsavg - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Drnkunitsavg - 1)];
					c.Datecompleted = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Datecompleted - 1)))?null:(System.DateTime?)reader[((int)BbPappPatientLifestyleColumn.Datecompleted - 1)];
					c.Createdbyid = (int)reader[((int)BbPappPatientLifestyleColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPappPatientLifestyleColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPappPatientLifestyleColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPappPatientLifestyleColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPappPatientLifestyleColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPappPatientLifestyleColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle entity)
		{
			if (!reader.Read()) return;
			
			entity.FormId = (int)reader[((int)BbPappPatientLifestyleColumn.FormId - 1)];
			entity.OriginalFormId = (int)reader["FormID"];
			entity.Chid = (int)reader[((int)BbPappPatientLifestyleColumn.Chid - 1)];
			entity.PappFupId = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.PappFupId - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.PappFupId - 1)];
			entity.Admittedtohospital = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Admittedtohospital - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Admittedtohospital - 1)];
			entity.Newdrugs = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Newdrugs - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Newdrugs - 1)];
			entity.Newclinics = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Newclinics - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Newclinics - 1)];
			entity.Workstatusid = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Workstatusid - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Workstatusid - 1)];
			entity.Occupation = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Occupation - 1)))?null:(string)reader[((int)BbPappPatientLifestyleColumn.Occupation - 1)];
			entity.SmokingMissing = (bool)reader[((int)BbPappPatientLifestyleColumn.SmokingMissing - 1)];
			entity.Currentlysmoke = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Currentlysmoke - 1)))?null:(System.Boolean?)reader[((int)BbPappPatientLifestyleColumn.Currentlysmoke - 1)];
			entity.Currentlysmokenumbercigsperday = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Currentlysmokenumbercigsperday - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Currentlysmokenumbercigsperday - 1)];
			entity.DrinkingMissing = (bool)reader[((int)BbPappPatientLifestyleColumn.DrinkingMissing - 1)];
			entity.Drinkalcohol = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Drinkalcohol - 1)))?null:(System.Boolean?)reader[((int)BbPappPatientLifestyleColumn.Drinkalcohol - 1)];
			entity.Drnkunitsavg = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Drnkunitsavg - 1)))?null:(System.Int32?)reader[((int)BbPappPatientLifestyleColumn.Drnkunitsavg - 1)];
			entity.Datecompleted = (reader.IsDBNull(((int)BbPappPatientLifestyleColumn.Datecompleted - 1)))?null:(System.DateTime?)reader[((int)BbPappPatientLifestyleColumn.Datecompleted - 1)];
			entity.Createdbyid = (int)reader[((int)BbPappPatientLifestyleColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPappPatientLifestyleColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPappPatientLifestyleColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPappPatientLifestyleColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPappPatientLifestyleColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPappPatientLifestyleColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.FormId = (int)dataRow["FormID"];
			entity.OriginalFormId = (int)dataRow["FormID"];
			entity.Chid = (int)dataRow["chid"];
			entity.PappFupId = Convert.IsDBNull(dataRow["PappFupId"]) ? null : (System.Int32?)dataRow["PappFupId"];
			...
			entity.Occupation = Convert.IsDBNull(dataRow["occupation"]) ? null : (string)dataRow["occupation"];
			entity.SmokingMissing = (bool)dataRow["smokingMissing"];
			...
			entity.DrinkingMissing = (bool)dataRow["drinkingMissing"];
			...
			entity.Datecompleted = Convert.IsDBNull(dataRow["datecompleted"]) ? null : (System.DateTime?)dataRow["datecompleted"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbPappPatientLifestyleChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPappPatientLifestyle</c>
	///</summary>
	public enum BbPappPatientLifestyleChildEntityTypes
	{
	...
	#endregion BbPappPatientLifestyleChildEntityTypes
	
	#region BbPappPatientLifestyleFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPappPatientLifestyleColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientLifestyle"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPappPatientLifestyleFilterBuilder : SqlFilterBuilder<BbPappPatientLifestyleColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientLifestyleFilterBuilder class.
		/// </summary>
		public BbPappPatientLifestyleFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPappPatientLifestyleFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPappPatientLifestyleFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPappPatientLifestyleFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPappPatientLifestyleFilterBuilder
	
	#region BbPappPatientLifestyleParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPappPatientLifestyleColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientLifestyle"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPappPatientLifestyleParameterBuilder : ParameterizedSqlFilterBuilder<BbPappPatientLifestyleColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientLifestyleParameterBuilder class.
		/// </summary>
		public BbPappPatientLifestyleParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPappPatientLifestyleParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPappPatientLifestyleParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPappPatientLifestyleParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPappPatientLifestyleParameterBuilder
	
	#region BbPappPatientLifestyleSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPappPatientLifestyleColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientLifestyle"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPappPatientLifestyleSortBuilder : SqlSortBuilder<BbPappPatientLifestyleColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientLifestyleSqlSortBuilder class.
		/// </summary>
		public BbPappPatientLifestyleSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPappPatientLifestyleSortBuilder
