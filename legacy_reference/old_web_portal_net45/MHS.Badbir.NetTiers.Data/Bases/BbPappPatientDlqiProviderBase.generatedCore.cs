...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPappPatientDlqiProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPappPatientDlqiProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi, MHS.Badbir.NetTiers.Entities.BbPappPatientDlqiKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientDlqiKey key)
		{
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbpappPatientDLQI_bbPatientCohortHistory key.
		///		FK_bbpappPatientDLQI_bbPatientCohortHistory Description: 
		/// </summary>
		/// <param name="_chid"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi objects.</returns>
		public TList<BbPappPatientDlqi> GetByChid(int _chid)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi objects.</returns>
		/// <remarks></remarks>
		public TList<BbPappPatientDlqi> GetByChid(TransactionManager transactionManager, int _chid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi objects.</returns>
		public TList<BbPappPatientDlqi> GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbpappPatientDLQI_bbPatientCohortHistory key.
		///		fkBbpappPatientDlqiBbPatientCohortHistory Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_chid"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi objects.</returns>
		public TList<BbPappPatientDlqi> GetByChid(int _chid, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi objects.</returns>
		public TList<BbPappPatientDlqi> GetByChid(int _chid, int start, int pageLength,out int count)
		{
			return GetByChid(null, _chid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi objects.</returns>
		public abstract TList<BbPappPatientDlqi> GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientDlqiKey key, int start, int pageLength)
		{
			return GetByFormId(transactionManager, key.FormId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_pappDLQI index.
		/// </summary>
		/// <param name="_formId"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi GetByFormId(int _formId)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_pappDLQI index.
		/// </summary>
		/// <param name="_formId"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi GetByFormId(int _formId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi GetByFormId(TransactionManager transactionManager, int _formId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi GetByFormId(TransactionManager transactionManager, int _formId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi GetByFormId(int _formId, int start, int pageLength, out int count)
		{
			return GetByFormId(null, _formId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi GetByFormId(TransactionManager transactionManager, int _formId, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbPappPatientDlqi&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPappPatientDlqi&gt;"/></returns>
		public static TList<BbPappPatientDlqi> Fill(IDataReader reader, TList<BbPappPatientDlqi> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPappPatientDlqi")
					.Append("|").Append((int)reader[((int)BbPappPatientDlqiColumn.FormId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPappPatientDlqi>(
					key.ToString(), // EntityTrackingKey
					"BbPappPatientDlqi",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi();
				}
					...
					))
				{
					...
					c.FormId = (int)reader[((int)BbPappPatientDlqiColumn.FormId - 1)];
					c.OriginalFormId = c.FormId;
					c.Chid = (int)reader[((int)BbPappPatientDlqiColumn.Chid - 1)];
					c.PappFupId = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.PappFupId - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.PappFupId - 1)];
					c.Diagnosis = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.Diagnosis - 1)))?null:(string)reader[((int)BbPappPatientDlqiColumn.Diagnosis - 1)];
					c.ItchsoreScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.ItchsoreScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.ItchsoreScore - 1)];
					c.EmbscScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.EmbscScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.EmbscScore - 1)];
					c.ShophgScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.ShophgScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.ShophgScore - 1)];
					c.ClothesScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.ClothesScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.ClothesScore - 1)];
					c.SocleisScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.SocleisScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.SocleisScore - 1)];
					c.SportScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.SportScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.SportScore - 1)];
					c.WorkstudScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.WorkstudScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.WorkstudScore - 1)];
					c.WorkstudnoScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.WorkstudnoScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.WorkstudnoScore - 1)];
					c.PartcrfScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.PartcrfScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.PartcrfScore - 1)];
					c.SexdifScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.SexdifScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.SexdifScore - 1)];
					c.TreatmentScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.TreatmentScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.TreatmentScore - 1)];
					c.TotalScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.TotalScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.TotalScore - 1)];
					c.Datecomp = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.Datecomp - 1)))?null:(System.DateTime?)reader[((int)BbPappPatientDlqiColumn.Datecomp - 1)];
					c.Createdbyid = (int)reader[((int)BbPappPatientDlqiColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPappPatientDlqiColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPappPatientDlqiColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPappPatientDlqiColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPappPatientDlqiColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPappPatientDlqiColumn.Lastupdateddate - 1)];
					c.SkipBreakup = (int)reader[((int)BbPappPatientDlqiColumn.SkipBreakup - 1)];
					c.DlqiMissing = (bool)reader[((int)BbPappPatientDlqiColumn.DlqiMissing - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi entity)
		{
			if (!reader.Read()) return;
			
			entity.FormId = (int)reader[((int)BbPappPatientDlqiColumn.FormId - 1)];
			entity.OriginalFormId = (int)reader["FormID"];
			entity.Chid = (int)reader[((int)BbPappPatientDlqiColumn.Chid - 1)];
			entity.PappFupId = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.PappFupId - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.PappFupId - 1)];
			entity.Diagnosis = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.Diagnosis - 1)))?null:(string)reader[((int)BbPappPatientDlqiColumn.Diagnosis - 1)];
			entity.ItchsoreScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.ItchsoreScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.ItchsoreScore - 1)];
			entity.EmbscScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.EmbscScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.EmbscScore - 1)];
			entity.ShophgScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.ShophgScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.ShophgScore - 1)];
			entity.ClothesScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.ClothesScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.ClothesScore - 1)];
			entity.SocleisScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.SocleisScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.SocleisScore - 1)];
			entity.SportScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.SportScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.SportScore - 1)];
			entity.WorkstudScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.WorkstudScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.WorkstudScore - 1)];
			entity.WorkstudnoScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.WorkstudnoScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.WorkstudnoScore - 1)];
			entity.PartcrfScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.PartcrfScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.PartcrfScore - 1)];
			entity.SexdifScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.SexdifScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.SexdifScore - 1)];
			entity.TreatmentScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.TreatmentScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.TreatmentScore - 1)];
			entity.TotalScore = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.TotalScore - 1)))?null:(System.Int32?)reader[((int)BbPappPatientDlqiColumn.TotalScore - 1)];
			entity.Datecomp = (reader.IsDBNull(((int)BbPappPatientDlqiColumn.Datecomp - 1)))?null:(System.DateTime?)reader[((int)BbPappPatientDlqiColumn.Datecomp - 1)];
			entity.Createdbyid = (int)reader[((int)BbPappPatientDlqiColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPappPatientDlqiColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPappPatientDlqiColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPappPatientDlqiColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPappPatientDlqiColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPappPatientDlqiColumn.Lastupdateddate - 1)];
			entity.SkipBreakup = (int)reader[((int)BbPappPatientDlqiColumn.SkipBreakup - 1)];
			entity.DlqiMissing = (bool)reader[((int)BbPappPatientDlqiColumn.DlqiMissing - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi entity)
		{
			...
			entity.Diagnosis = Convert.IsDBNull(dataRow["diagnosis"]) ? null : (string)dataRow["diagnosis"];
			entity.ItchsoreScore = Convert.IsDBNull(dataRow["itchsore_score"]) ? null : (System.Int32?)dataRow["itchsore_score"];
			entity.EmbscScore = Convert.IsDBNull(dataRow["embsc_score"]) ? null : (System.Int32?)dataRow["embsc_score"];
			entity.ShophgScore = Convert.IsDBNull(dataRow["shophg_score"]) ? null : (System.Int32?)dataRow["shophg_score"];
			entity.ClothesScore = Convert.IsDBNull(dataRow["clothes_score"]) ? null : (System.Int32?)dataRow["clothes_score"];
			entity.SocleisScore = Convert.IsDBNull(dataRow["socleis_score"]) ? null : (System.Int32?)dataRow["socleis_score"];
			entity.SportScore = Convert.IsDBNull(dataRow["sport_score"]) ? null : (System.Int32?)dataRow["sport_score"];
			entity.WorkstudScore = Convert.IsDBNull(dataRow["workstud_score"]) ? null : (System.Int32?)dataRow["workstud_score"];
			entity.WorkstudnoScore = Convert.IsDBNull(dataRow["workstudno_score"]) ? null : (System.Int32?)dataRow["workstudno_score"];
			entity.PartcrfScore = Convert.IsDBNull(dataRow["partcrf_score"]) ? null : (System.Int32?)dataRow["partcrf_score"];
			entity.SexdifScore = Convert.IsDBNull(dataRow["sexdif_score"]) ? null : (System.Int32?)dataRow["sexdif_score"];
			entity.TreatmentScore = Convert.IsDBNull(dataRow["treatment_score"]) ? null : (System.Int32?)dataRow["treatment_score"];
			entity.TotalScore = Convert.IsDBNull(dataRow["total_score"]) ? null : (System.Int32?)dataRow["total_score"];
			entity.Datecomp = Convert.IsDBNull(dataRow["datecomp"]) ? null : (System.DateTime?)dataRow["datecomp"];
			...
			entity.SkipBreakup = (int)dataRow["skipBreakup"];
			entity.DlqiMissing = (bool)dataRow["dlqiMissing"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbPappPatientDlqiChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPappPatientDlqi</c>
	///</summary>
	public enum BbPappPatientDlqiChildEntityTypes
	{
	...
	#endregion BbPappPatientDlqiChildEntityTypes
	
	#region BbPappPatientDlqiFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPappPatientDlqiColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientDlqi"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPappPatientDlqiFilterBuilder : SqlFilterBuilder<BbPappPatientDlqiColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientDlqiFilterBuilder class.
		/// </summary>
		public BbPappPatientDlqiFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPappPatientDlqiFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPappPatientDlqiFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPappPatientDlqiFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPappPatientDlqiFilterBuilder
	
	#region BbPappPatientDlqiParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPappPatientDlqiColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientDlqi"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPappPatientDlqiParameterBuilder : ParameterizedSqlFilterBuilder<BbPappPatientDlqiColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientDlqiParameterBuilder class.
		/// </summary>
		public BbPappPatientDlqiParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPappPatientDlqiParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPappPatientDlqiParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPappPatientDlqiParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPappPatientDlqiParameterBuilder
	
	#region BbPappPatientDlqiSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPappPatientDlqiColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientDlqi"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPappPatientDlqiSortBuilder : SqlSortBuilder<BbPappPatientDlqiColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientDlqiSqlSortBuilder class.
		/// </summary>
		public BbPappPatientDlqiSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPappPatientDlqiSortBuilder
