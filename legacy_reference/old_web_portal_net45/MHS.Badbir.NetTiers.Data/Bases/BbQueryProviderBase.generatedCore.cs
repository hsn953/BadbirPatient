...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbQueryProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbQueryProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbQuery, MHS.Badbir.NetTiers.Entities.BbQueryKey>
	{		
		#region Get from Many To Many Relationship Functions
		#region GetByFupaeidFromBbAdverseEventQueryLink
		
		/// <summary>
		///		Gets bbQuery objects from the datasource by fupaeid in the
		///		BbAdverseEventQueryLink table. Table bbQuery is related to table bbAdverseEventFup
		///		through the (M:N) relationship defined in the BbAdverseEventQueryLink table.
		/// </summary>
		/// <param name="_fupaeid"></param>
		/// <returns>Returns a typed collection of BbQuery objects.</returns>
		public TList<BbQuery> GetByFupaeidFromBbAdverseEventQueryLink(System.Int32 _fupaeid)
		{
			int count = -1;
			return GetByFupaeidFromBbAdverseEventQueryLink(null,_fupaeid, 0, int.MaxValue, out count);
			
		}
		
		/// <summary>
		///		Gets MHS.Badbir.NetTiers.Entities.BbQuery objects from the datasource by fupaeid in the
		///		BbAdverseEventQueryLink table. Table bbQuery is related to table bbAdverseEventFup
		///		through the (M:N) relationship defined in the BbAdverseEventQueryLink table.
		/// </summary>
		...
		/// <param name="_fupaeid"></param>
		/// <remarks></remarks>
		/// <returns>Returns a TList of BbQuery objects.</returns>
		public TList<BbQuery> GetByFupaeidFromBbAdverseEventQueryLink(System.Int32 _fupaeid, int start, int pageLength)
		{
			int count = -1;
			return GetByFupaeidFromBbAdverseEventQueryLink(null, _fupaeid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbQuery objects.</returns>
		public TList<BbQuery> GetByFupaeidFromBbAdverseEventQueryLink(TransactionManager transactionManager, System.Int32 _fupaeid)
		{
			int count = -1;
			return GetByFupaeidFromBbAdverseEventQueryLink(transactionManager, _fupaeid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbQuery objects.</returns>
		public TList<BbQuery> GetByFupaeidFromBbAdverseEventQueryLink(TransactionManager transactionManager, System.Int32 _fupaeid,int start, int pageLength)
		{
			int count = -1;
			return GetByFupaeidFromBbAdverseEventQueryLink(transactionManager, _fupaeid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of bbQuery objects.</returns>
		public TList<BbQuery> GetByFupaeidFromBbAdverseEventQueryLink(System.Int32 _fupaeid,int start, int pageLength, out int count)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a TList of BbQuery objects.</returns>
		public abstract TList<BbQuery> GetByFupaeidFromBbAdverseEventQueryLink(TransactionManager transactionManager,System.Int32 _fupaeid, int start, int pageLength, out int count);
		
		#endregion GetByFupaeidFromBbAdverseEventQueryLink
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryKey key)
		{
			return Delete(transactionManager, key.Qid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_qid">Follow up Id. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _qid)
		{
			return Delete(null, _qid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _qid);		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbQuery_bbCentre key.
		///		FK_bbQuery_bbCentre Description: 
		/// </summary>
		/// <param name="_centreid"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQuery objects.</returns>
		public TList<BbQuery> GetByCentreid(int _centreid)
		{
			int count = -1;
			return GetByCentreid(_centreid, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQuery objects.</returns>
		/// <remarks></remarks>
		public TList<BbQuery> GetByCentreid(TransactionManager transactionManager, int _centreid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQuery objects.</returns>
		public TList<BbQuery> GetByCentreid(TransactionManager transactionManager, int _centreid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQuery objects.</returns>
		public TList<BbQuery> GetByCentreid(int _centreid, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQuery objects.</returns>
		public TList<BbQuery> GetByCentreid(int _centreid, int start, int pageLength,out int count)
		{
			return GetByCentreid(null, _centreid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbQuery objects.</returns>
		public abstract TList<BbQuery> GetByCentreid(TransactionManager transactionManager, int _centreid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbQuery Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQueryKey key, int start, int pageLength)
		{
			return GetByQid(transactionManager, key.Qid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key FK_Chid index.
		/// </summary>
		/// <param name="_chid">Ch ID (for StudyNo)</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByChid(int _chid)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_Chid index.
		/// </summary>
		/// <param name="_chid">Ch ID (for StudyNo)</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByChid(int _chid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByChid(TransactionManager transactionManager, int _chid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByChid(int _chid, int start, int pageLength, out int count)
		{
			return GetByChid(null, _chid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public abstract TList<BbQuery> GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key FK_Chid_Fupno index.
		/// </summary>
		/// <param name="_chid">Ch ID (for StudyNo)</param>
		/// <param name="_fupnumber">Follow Up Number</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByChidFupnumber(int _chid, System.Int32? _fupnumber)
		{
			int count = -1;
			return GetByChidFupnumber(null,_chid, _fupnumber, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_Chid_Fupno index.
		/// </summary>
		/// <param name="_chid">Ch ID (for StudyNo)</param>
		/// <param name="_fupnumber">Follow Up Number</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByChidFupnumber(int _chid, System.Int32? _fupnumber, int start, int pageLength)
		{
			int count = -1;
			return GetByChidFupnumber(null, _chid, _fupnumber, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByChidFupnumber(TransactionManager transactionManager, int _chid, System.Int32? _fupnumber)
		{
			int count = -1;
			return GetByChidFupnumber(transactionManager, _chid, _fupnumber, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByChidFupnumber(TransactionManager transactionManager, int _chid, System.Int32? _fupnumber, int start, int pageLength)
		{
			int count = -1;
			return GetByChidFupnumber(transactionManager, _chid, _fupnumber, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByChidFupnumber(int _chid, System.Int32? _fupnumber, int start, int pageLength, out int count)
		{
			return GetByChidFupnumber(null, _chid, _fupnumber, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public abstract TList<BbQuery> GetByChidFupnumber(TransactionManager transactionManager, int _chid, System.Int32? _fupnumber, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key FK_QueryStatusID index.
		/// </summary>
		/// <param name="_queryStatusId">QueryStatusId</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByQueryStatusId(int _queryStatusId)
		{
			int count = -1;
			return GetByQueryStatusId(null,_queryStatusId, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_QueryStatusID index.
		/// </summary>
		/// <param name="_queryStatusId">QueryStatusId</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByQueryStatusId(int _queryStatusId, int start, int pageLength)
		{
			int count = -1;
			return GetByQueryStatusId(null, _queryStatusId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByQueryStatusId(TransactionManager transactionManager, int _queryStatusId)
		{
			int count = -1;
			return GetByQueryStatusId(transactionManager, _queryStatusId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByQueryStatusId(TransactionManager transactionManager, int _queryStatusId, int start, int pageLength)
		{
			int count = -1;
			return GetByQueryStatusId(transactionManager, _queryStatusId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByQueryStatusId(int _queryStatusId, int start, int pageLength, out int count)
		{
			return GetByQueryStatusId(null, _queryStatusId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public abstract TList<BbQuery> GetByQueryStatusId(TransactionManager transactionManager, int _queryStatusId, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key FK_QueryTypeID index.
		/// </summary>
		/// <param name="_queryTypeId">QueryTypeId</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByQueryTypeId(int _queryTypeId)
		{
			int count = -1;
			return GetByQueryTypeId(null,_queryTypeId, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_QueryTypeID index.
		/// </summary>
		/// <param name="_queryTypeId">QueryTypeId</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByQueryTypeId(int _queryTypeId, int start, int pageLength)
		{
			int count = -1;
			return GetByQueryTypeId(null, _queryTypeId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByQueryTypeId(TransactionManager transactionManager, int _queryTypeId)
		{
			int count = -1;
			return GetByQueryTypeId(transactionManager, _queryTypeId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByQueryTypeId(TransactionManager transactionManager, int _queryTypeId, int start, int pageLength)
		{
			int count = -1;
			return GetByQueryTypeId(transactionManager, _queryTypeId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public TList<BbQuery> GetByQueryTypeId(int _queryTypeId, int start, int pageLength, out int count)
		{
			return GetByQueryTypeId(null, _queryTypeId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbQuery&gt;"/> class.</returns>
		public abstract TList<BbQuery> GetByQueryTypeId(TransactionManager transactionManager, int _queryTypeId, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbQuery index.
		/// </summary>
		/// <param name="_qid">Follow up Id</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQuery GetByQid(int _qid)
		{
			int count = -1;
			return GetByQid(null,_qid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbQuery index.
		/// </summary>
		/// <param name="_qid">Follow up Id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQuery GetByQid(int _qid, int start, int pageLength)
		{
			int count = -1;
			return GetByQid(null, _qid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQuery GetByQid(TransactionManager transactionManager, int _qid)
		{
			int count = -1;
			return GetByQid(transactionManager, _qid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQuery GetByQid(TransactionManager transactionManager, int _qid, int start, int pageLength)
		{
			int count = -1;
			return GetByQid(transactionManager, _qid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbQuery GetByQid(int _qid, int start, int pageLength, out int count)
		{
			return GetByQid(null, _qid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbQuery GetByQid(TransactionManager transactionManager, int _qid, int start, int pageLength, out int count);
		...
		/// <param name="patientid"> A <c>System.Int32?</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByPatientID_ExcludeSolvedAndExcluded(System.Int32? patientid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByPatientID_ExcludeSolvedAndExcluded(int start, int pageLength, System.Int32? patientid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByPatientID_ExcludeSolvedAndExcluded(TransactionManager transactionManager, System.Int32? patientid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public abstract TList<BbQuery> Query_GetByPatientID_ExcludeSolvedAndExcluded(TransactionManager transactionManager, int start, int pageLength , System.Int32? patientid);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByChid_AllFeedback(System.Int32? chid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByChid_AllFeedback(int start, int pageLength, System.Int32? chid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByChid_AllFeedback(TransactionManager transactionManager, System.Int32? chid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public abstract TList<BbQuery> Query_GetByChid_AllFeedback(TransactionManager transactionManager, int start, int pageLength , System.Int32? chid);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByChid_ExcludeSolvedAndExcluded(System.Int32? chid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByChid_ExcludeSolvedAndExcluded(int start, int pageLength, System.Int32? chid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByChid_ExcludeSolvedAndExcluded(TransactionManager transactionManager, System.Int32? chid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public abstract TList<BbQuery> Query_GetByChid_ExcludeSolvedAndExcluded(TransactionManager transactionManager, int start, int pageLength , System.Int32? chid);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByChid_SolvedQueries(System.Int32? chid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByChid_SolvedQueries(int start, int pageLength, System.Int32? chid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetByChid_SolvedQueries(TransactionManager transactionManager, System.Int32? chid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public abstract TList<BbQuery> Query_GetByChid_SolvedQueries(TransactionManager transactionManager, int start, int pageLength , System.Int32? chid);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetRelatedQueriesByFupAEID(System.Int32? fupaeid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetRelatedQueriesByFupAEID(int start, int pageLength, System.Int32? fupaeid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public TList<BbQuery> Query_GetRelatedQueriesByFupAEID(TransactionManager transactionManager, System.Int32? fupaeid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbQuery&gt;"/> instance.</returns>
		public abstract TList<BbQuery> Query_GetRelatedQueriesByFupAEID(TransactionManager transactionManager, int start, int pageLength , System.Int32? fupaeid);
		...
		/// <summary>
		/// Fill a TList&lt;BbQuery&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbQuery&gt;"/></returns>
		public static TList<BbQuery> Fill(IDataReader reader, TList<BbQuery> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbQuery c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbQuery")
					.Append("|").Append((int)reader[((int)BbQueryColumn.Qid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbQuery>(
					key.ToString(), // EntityTrackingKey
					"BbQuery",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbQuery();
				}
					...
					))
				{
					...
					c.Qid = (int)reader[((int)BbQueryColumn.Qid - 1)];
					c.Chid = (int)reader[((int)BbQueryColumn.Chid - 1)];
					c.Fupnumber = (reader.IsDBNull(((int)BbQueryColumn.Fupnumber - 1)))?null:(System.Int32?)reader[((int)BbQueryColumn.Fupnumber - 1)];
					c.Centreid = (int)reader[((int)BbQueryColumn.Centreid - 1)];
					c.Messagecount = (int)reader[((int)BbQueryColumn.Messagecount - 1)];
					c.Adminunread = (bool)reader[((int)BbQueryColumn.Adminunread - 1)];
					c.Clinicianunread = (bool)reader[((int)BbQueryColumn.Clinicianunread - 1)];
					c.QueryTypeId = (int)reader[((int)BbQueryColumn.QueryTypeId - 1)];
					c.QueryStatusId = (int)reader[((int)BbQueryColumn.QueryStatusId - 1)];
					c.Include = (bool)reader[((int)BbQueryColumn.Include - 1)];
					c.Createdbyid = (int)reader[((int)BbQueryColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbQueryColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbQueryColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbQueryColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbQueryColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbQueryColumn.Lastupdateddate - 1)];
					c.Subject = (reader.IsDBNull(((int)BbQueryColumn.Subject - 1)))?null:(string)reader[((int)BbQueryColumn.Subject - 1)];
					c.SecondRequest = (reader.IsDBNull(((int)BbQueryColumn.SecondRequest - 1)))?null:(System.Boolean?)reader[((int)BbQueryColumn.SecondRequest - 1)];
					c.IsAuditQuery = (bool)reader[((int)BbQueryColumn.IsAuditQuery - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbQuery entity)
		{
			if (!reader.Read()) return;
			
			entity.Qid = (int)reader[((int)BbQueryColumn.Qid - 1)];
			entity.Chid = (int)reader[((int)BbQueryColumn.Chid - 1)];
			entity.Fupnumber = (reader.IsDBNull(((int)BbQueryColumn.Fupnumber - 1)))?null:(System.Int32?)reader[((int)BbQueryColumn.Fupnumber - 1)];
			entity.Centreid = (int)reader[((int)BbQueryColumn.Centreid - 1)];
			entity.Messagecount = (int)reader[((int)BbQueryColumn.Messagecount - 1)];
			entity.Adminunread = (bool)reader[((int)BbQueryColumn.Adminunread - 1)];
			entity.Clinicianunread = (bool)reader[((int)BbQueryColumn.Clinicianunread - 1)];
			entity.QueryTypeId = (int)reader[((int)BbQueryColumn.QueryTypeId - 1)];
			entity.QueryStatusId = (int)reader[((int)BbQueryColumn.QueryStatusId - 1)];
			entity.Include = (bool)reader[((int)BbQueryColumn.Include - 1)];
			entity.Createdbyid = (int)reader[((int)BbQueryColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbQueryColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbQueryColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbQueryColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbQueryColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbQueryColumn.Lastupdateddate - 1)];
			entity.Subject = (reader.IsDBNull(((int)BbQueryColumn.Subject - 1)))?null:(string)reader[((int)BbQueryColumn.Subject - 1)];
			entity.SecondRequest = (reader.IsDBNull(((int)BbQueryColumn.SecondRequest - 1)))?null:(System.Boolean?)reader[((int)BbQueryColumn.SecondRequest - 1)];
			entity.IsAuditQuery = (bool)reader[((int)BbQueryColumn.IsAuditQuery - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbQuery entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Qid = (int)dataRow["QId"];
			entity.Chid = (int)dataRow["chid"];
			entity.Fupnumber = Convert.IsDBNull(dataRow["fupnumber"]) ? null : (System.Int32?)dataRow["fupnumber"];
			entity.Centreid = (int)dataRow["centreid"];
			entity.Messagecount = (int)dataRow["messagecount"];
			entity.Adminunread = (bool)dataRow["adminunread"];
			entity.Clinicianunread = (bool)dataRow["clinicianunread"];
			entity.QueryTypeId = (int)dataRow["QueryTypeId"];
			entity.QueryStatusId = (int)dataRow["QueryStatusId"];
			entity.Include = (bool)dataRow["include"];
			...
			entity.Subject = Convert.IsDBNull(dataRow["subject"]) ? null : (string)dataRow["subject"];
			entity.SecondRequest = Convert.IsDBNull(dataRow["secondRequest"]) ? null : (System.Boolean?)dataRow["secondRequest"];
			entity.IsAuditQuery = (bool)dataRow["isAuditQuery"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbQuery"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQuery Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQuery entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region CentreidSource	
			if (CanDeepLoad(entity, "BbCentre|CentreidSource", deepLoadType, innerList) 
				&& entity.CentreidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.Centreid;
				...
				if (tmpEntity != null)
					entity.CentreidSource = tmpEntity;
				else
					entity.CentreidSource = DataRepository.BbCentreProvider.GetByCentreid(transactionManager, entity.Centreid);		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'CentreidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.CentreidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbCentreProvider.DeepLoad(transactionManager, entity.CentreidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion CentreidSource
			...
			#region QueryStatusIdSource	
			if (CanDeepLoad(entity, "BbQueryStatuslkp|QueryStatusIdSource", deepLoadType, innerList) 
				&& entity.QueryStatusIdSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.QueryStatusId;
				BbQueryStatuslkp tmpEntity = EntityManager.LocateEntity<BbQueryStatuslkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbQueryStatuslkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.QueryStatusIdSource = tmpEntity;
				else
					entity.QueryStatusIdSource = DataRepository.BbQueryStatuslkpProvider.GetByQueryStatusId(transactionManager, entity.QueryStatusId);		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'QueryStatusIdSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.QueryStatusIdSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbQueryStatuslkpProvider.DeepLoad(transactionManager, entity.QueryStatusIdSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion QueryStatusIdSource

			#region QueryTypeIdSource	
			if (CanDeepLoad(entity, "BbQueryTypelkp|QueryTypeIdSource", deepLoadType, innerList) 
				&& entity.QueryTypeIdSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.QueryTypeId;
				BbQueryTypelkp tmpEntity = EntityManager.LocateEntity<BbQueryTypelkp>(EntityLocator.ConstructKeyFromPkItems(typeof(BbQueryTypelkp), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.QueryTypeIdSource = tmpEntity;
				else
					entity.QueryTypeIdSource = DataRepository.BbQueryTypelkpProvider.GetByQueryTypeId(transactionManager, entity.QueryTypeId);		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'QueryTypeIdSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.QueryTypeIdSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbQueryTypelkpProvider.DeepLoad(transactionManager, entity.QueryTypeIdSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion QueryTypeIdSource
			
			//used to hold DeepLoad method delegates and fire after all the local children have been loaded.
			Dictionary<string, KeyValuePair<Delegate, object>> deepHandles = new Dictionary<string, KeyValuePair<Delegate, object>>();
			// Deep load child collections  - Call GetByQid methods when available
			
			#region BbQueryMessageCollection
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<BbQueryMessage>|BbQueryMessageCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'BbQueryMessageCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.BbQueryMessageCollection = DataRepository.BbQueryMessageProvider.GetByQid(transactionManager, entity.Qid);

				if (deep && entity.BbQueryMessageCollection.Count > 0)
				{
					deepHandles.Add("BbQueryMessageCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<BbQueryMessage>) DataRepository.BbQueryMessageProvider.DeepLoad,
						new object[] { transactionManager, entity.BbQueryMessageCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbQuery object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbQuery instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbQuery Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbQuery entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region CentreidSource
			if (CanDeepSave(entity, "BbCentre|CentreidSource", deepSaveType, innerList) 
				&& entity.CentreidSource != null)
			{
				DataRepository.BbCentreProvider.Save(transactionManager, entity.CentreidSource);
				entity.Centreid = entity.CentreidSource.Centreid;
			}
			#endregion 
			...
			#region QueryStatusIdSource
			if (CanDeepSave(entity, "BbQueryStatuslkp|QueryStatusIdSource", deepSaveType, innerList) 
				&& entity.QueryStatusIdSource != null)
			{
				DataRepository.BbQueryStatuslkpProvider.Save(transactionManager, entity.QueryStatusIdSource);
				entity.QueryStatusId = entity.QueryStatusIdSource.QueryStatusId;
			}
			#endregion 
			
			#region QueryTypeIdSource
			if (CanDeepSave(entity, "BbQueryTypelkp|QueryTypeIdSource", deepSaveType, innerList) 
				&& entity.QueryTypeIdSource != null)
			{
				DataRepository.BbQueryTypelkpProvider.Save(transactionManager, entity.QueryTypeIdSource);
				entity.QueryTypeId = entity.QueryTypeIdSource.QueryTypeId;
			}
			#endregion 
			...
			#region List<BbQueryMessage>
				if (CanDeepSave(entity.BbQueryMessageCollection, "List<BbQueryMessage>|BbQueryMessageCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(BbQueryMessage child in entity.BbQueryMessageCollection)
					{
						if(child.QidSource != null)
						{
							child.Qid = child.QidSource.Qid;
						}
						else
						{
							child.Qid = entity.Qid;
						}

					}

					if (entity.BbQueryMessageCollection.Count > 0 || entity.BbQueryMessageCollection.DeletedItems.Count > 0)
					{
						//DataRepository.BbQueryMessageProvider.Save(transactionManager, entity.BbQueryMessageCollection);
						
						deepHandles.Add("BbQueryMessageCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< BbQueryMessage >) DataRepository.BbQueryMessageProvider.DeepSave,
							new object[] { transactionManager, entity.BbQueryMessageCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	#region BbQueryChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbQuery</c>
	///</summary>
	public enum BbQueryChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbCentre</c> at CentreidSource
		///</summary>
		...
		///<summary>
		/// Composite Property for <c>BbQueryStatuslkp</c> at QueryStatusIdSource
		///</summary>
		[ChildEntityType(typeof(BbQueryStatuslkp))]
		BbQueryStatuslkp,
		
		///<summary>
		/// Composite Property for <c>BbQueryTypelkp</c> at QueryTypeIdSource
		///</summary>
		[ChildEntityType(typeof(BbQueryTypelkp))]
		BbQueryTypelkp,
		///<summary>
		/// Collection of <c>BbQuery</c> as OneToMany for BbQueryMessageCollection
		///</summary>
		[ChildEntityType(typeof(TList<BbQueryMessage>))]
		BbQueryMessageCollection,
	}
	
	#endregion BbQueryChildEntityTypes
	
	#region BbQueryFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbQueryColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQuery"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryFilterBuilder : SqlFilterBuilder<BbQueryColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryFilterBuilder class.
		/// </summary>
		public BbQueryFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbQueryFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryFilterBuilder
	
	#region BbQueryParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbQueryColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQuery"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbQueryParameterBuilder : ParameterizedSqlFilterBuilder<BbQueryColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQueryParameterBuilder class.
		/// </summary>
		public BbQueryParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbQueryParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbQueryParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbQueryParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbQueryParameterBuilder
	
	#region BbQuerySortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbQueryColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbQuery"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbQuerySortBuilder : SqlSortBuilder<BbQueryColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbQuerySqlSortBuilder class.
		/// </summary>
		public BbQuerySortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbQuerySortBuilder
