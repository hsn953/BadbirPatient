...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbPatientdrugdoseProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbPatientdrugdoseProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPatientdrugdose, MHS.Badbir.NetTiers.Entities.BbPatientdrugdoseKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientdrugdoseKey key)
		{
			return Delete(transactionManager, key.Doseid);
		}
		
		/// <summary>
		/// 	Deletes a row from the DataSource.
		/// </summary>
		/// <param name="_doseid">Dose ID. Primary Key.</param>
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _doseid)
		{
			return Delete(null, _doseid);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _doseid);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbPatientdrugdose Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientdrugdoseKey key, int start, int pageLength)
		{
			return GetByDoseid(transactionManager, key.Doseid, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key FK_patdrugid index.
		/// </summary>
		/// <param name="_patdrugid">Patient drug id</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientdrugdose&gt;"/> class.</returns>
		public TList<BbPatientdrugdose> GetByPatdrugid(int _patdrugid)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_patdrugid index.
		/// </summary>
		/// <param name="_patdrugid">Patient drug id</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientdrugdose&gt;"/> class.</returns>
		public TList<BbPatientdrugdose> GetByPatdrugid(int _patdrugid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientdrugdose&gt;"/> class.</returns>
		public TList<BbPatientdrugdose> GetByPatdrugid(TransactionManager transactionManager, int _patdrugid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientdrugdose&gt;"/> class.</returns>
		public TList<BbPatientdrugdose> GetByPatdrugid(TransactionManager transactionManager, int _patdrugid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientdrugdose&gt;"/> class.</returns>
		public TList<BbPatientdrugdose> GetByPatdrugid(int _patdrugid, int start, int pageLength, out int count)
		{
			return GetByPatdrugid(null, _patdrugid, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="TList&lt;BbPatientdrugdose&gt;"/> class.</returns>
		public abstract TList<BbPatientdrugdose> GetByPatdrugid(TransactionManager transactionManager, int _patdrugid, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbPatientdrugdose index.
		/// </summary>
		/// <param name="_doseid">Dose ID</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientdrugdose GetByDoseid(int _doseid)
		{
			int count = -1;
			return GetByDoseid(null,_doseid, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbPatientdrugdose index.
		/// </summary>
		/// <param name="_doseid">Dose ID</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientdrugdose GetByDoseid(int _doseid, int start, int pageLength)
		{
			int count = -1;
			return GetByDoseid(null, _doseid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientdrugdose GetByDoseid(TransactionManager transactionManager, int _doseid)
		{
			int count = -1;
			return GetByDoseid(transactionManager, _doseid, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientdrugdose GetByDoseid(TransactionManager transactionManager, int _doseid, int start, int pageLength)
		{
			int count = -1;
			return GetByDoseid(transactionManager, _doseid, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPatientdrugdose GetByDoseid(int _doseid, int start, int pageLength, out int count)
		{
			return GetByDoseid(null, _doseid, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPatientdrugdose GetByDoseid(TransactionManager transactionManager, int _doseid, int start, int pageLength, out int count);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientdrugdose&gt;"/> instance.</returns>
		public TList<BbPatientdrugdose> PatientDrug_GetPreviousDoses(System.Int32? patdrugid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientdrugdose&gt;"/> instance.</returns>
		public TList<BbPatientdrugdose> PatientDrug_GetPreviousDoses(int start, int pageLength, System.Int32? patdrugid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientdrugdose&gt;"/> instance.</returns>
		public TList<BbPatientdrugdose> PatientDrug_GetPreviousDoses(TransactionManager transactionManager, System.Int32? patdrugid)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbPatientdrugdose&gt;"/> instance.</returns>
		public abstract TList<BbPatientdrugdose> PatientDrug_GetPreviousDoses(TransactionManager transactionManager, int start, int pageLength , System.Int32? patdrugid);
		...
		/// <summary>
		/// Fill a TList&lt;BbPatientdrugdose&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPatientdrugdose&gt;"/></returns>
		public static TList<BbPatientdrugdose> Fill(IDataReader reader, TList<BbPatientdrugdose> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPatientdrugdose c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPatientdrugdose")
					.Append("|").Append((int)reader[((int)BbPatientdrugdoseColumn.Doseid - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPatientdrugdose>(
					key.ToString(), // EntityTrackingKey
					"BbPatientdrugdose",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPatientdrugdose();
				}
					...
					))
				{
					...
					c.Doseid = (int)reader[((int)BbPatientdrugdoseColumn.Doseid - 1)];
					c.Patdrugid = (int)reader[((int)BbPatientdrugdoseColumn.Patdrugid - 1)];
					c.Doseday = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Doseday - 1)))?null:(System.Int32?)reader[((int)BbPatientdrugdoseColumn.Doseday - 1)];
					c.Dosemonth = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Dosemonth - 1)))?null:(System.Int32?)reader[((int)BbPatientdrugdoseColumn.Dosemonth - 1)];
					c.Doseyear = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Doseyear - 1)))?null:(System.Int32?)reader[((int)BbPatientdrugdoseColumn.Doseyear - 1)];
					c.Dosedate = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Dosedate - 1)))?null:(System.DateTime?)reader[((int)BbPatientdrugdoseColumn.Dosedate - 1)];
					c.Dose = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Dose - 1)))?null:(string)reader[((int)BbPatientdrugdoseColumn.Dose - 1)];
					c.Dateadded = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Dateadded - 1)))?null:(System.DateTime?)reader[((int)BbPatientdrugdoseColumn.Dateadded - 1)];
					c.Createdbyid = (int)reader[((int)BbPatientdrugdoseColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPatientdrugdoseColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPatientdrugdoseColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPatientdrugdoseColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPatientdrugdoseColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPatientdrugdoseColumn.Lastupdateddate - 1)];
					c.Batch = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Batch - 1)))?null:(string)reader[((int)BbPatientdrugdoseColumn.Batch - 1)];
					c.ManualEntry = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.ManualEntry - 1)))?null:(System.Boolean?)reader[((int)BbPatientdrugdoseColumn.ManualEntry - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPatientdrugdose entity)
		{
			if (!reader.Read()) return;
			
			entity.Doseid = (int)reader[((int)BbPatientdrugdoseColumn.Doseid - 1)];
			entity.Patdrugid = (int)reader[((int)BbPatientdrugdoseColumn.Patdrugid - 1)];
			entity.Doseday = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Doseday - 1)))?null:(System.Int32?)reader[((int)BbPatientdrugdoseColumn.Doseday - 1)];
			entity.Dosemonth = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Dosemonth - 1)))?null:(System.Int32?)reader[((int)BbPatientdrugdoseColumn.Dosemonth - 1)];
			entity.Doseyear = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Doseyear - 1)))?null:(System.Int32?)reader[((int)BbPatientdrugdoseColumn.Doseyear - 1)];
			entity.Dosedate = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Dosedate - 1)))?null:(System.DateTime?)reader[((int)BbPatientdrugdoseColumn.Dosedate - 1)];
			entity.Dose = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Dose - 1)))?null:(string)reader[((int)BbPatientdrugdoseColumn.Dose - 1)];
			entity.Dateadded = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Dateadded - 1)))?null:(System.DateTime?)reader[((int)BbPatientdrugdoseColumn.Dateadded - 1)];
			entity.Createdbyid = (int)reader[((int)BbPatientdrugdoseColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPatientdrugdoseColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPatientdrugdoseColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPatientdrugdoseColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPatientdrugdoseColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPatientdrugdoseColumn.Lastupdateddate - 1)];
			entity.Batch = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.Batch - 1)))?null:(string)reader[((int)BbPatientdrugdoseColumn.Batch - 1)];
			entity.ManualEntry = (reader.IsDBNull(((int)BbPatientdrugdoseColumn.ManualEntry - 1)))?null:(System.Boolean?)reader[((int)BbPatientdrugdoseColumn.ManualEntry - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPatientdrugdose entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Doseid = (int)dataRow["doseid"];
			entity.Patdrugid = (int)dataRow["patdrugid"];
			entity.Doseday = Convert.IsDBNull(dataRow["doseday"]) ? null : (System.Int32?)dataRow["doseday"];
			entity.Dosemonth = Convert.IsDBNull(dataRow["dosemonth"]) ? null : (System.Int32?)dataRow["dosemonth"];
			entity.Doseyear = Convert.IsDBNull(dataRow["doseyear"]) ? null : (System.Int32?)dataRow["doseyear"];
			entity.Dosedate = Convert.IsDBNull(dataRow["dosedate"]) ? null : (System.DateTime?)dataRow["dosedate"];
			entity.Dose = Convert.IsDBNull(dataRow["dose"]) ? null : (string)dataRow["dose"];
			...
			entity.Batch = Convert.IsDBNull(dataRow["batch"]) ? null : (string)dataRow["batch"];
			entity.ManualEntry = Convert.IsDBNull(dataRow["manualEntry"]) ? null : (System.Boolean?)dataRow["manualEntry"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPatientdrugdose"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientdrugdose Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientdrugdose entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;

			#region PatdrugidSource	
			if (CanDeepLoad(entity, "BbPatientdrug|PatdrugidSource", deepLoadType, innerList) 
				&& entity.PatdrugidSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = entity.Patdrugid;
				BbPatientdrug tmpEntity = EntityManager.LocateEntity<BbPatientdrug>(EntityLocator.ConstructKeyFromPkItems(typeof(BbPatientdrug), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.PatdrugidSource = tmpEntity;
				else
					entity.PatdrugidSource = DataRepository.BbPatientdrugProvider.GetByPatdrugid(transactionManager, entity.Patdrugid);		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'PatdrugidSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.PatdrugidSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.BbPatientdrugProvider.DeepLoad(transactionManager, entity.PatdrugidSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion PatdrugidSource
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPatientdrugdose object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPatientdrugdose instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPatientdrugdose Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPatientdrugdose entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
			...
			#region PatdrugidSource
			if (CanDeepSave(entity, "BbPatientdrug|PatdrugidSource", deepSaveType, innerList) 
				&& entity.PatdrugidSource != null)
			{
				DataRepository.BbPatientdrugProvider.Save(transactionManager, entity.PatdrugidSource);
				entity.Patdrugid = entity.PatdrugidSource.Patdrugid;
			}
			#endregion 
	...
	#region BbPatientdrugdoseChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPatientdrugdose</c>
	///</summary>
	public enum BbPatientdrugdoseChildEntityTypes
	{
		
		///<summary>
		/// Composite Property for <c>BbPatientdrug</c> at PatdrugidSource
		///</summary>
		[ChildEntityType(typeof(BbPatientdrug))]
		BbPatientdrug,
	}
	
	#endregion BbPatientdrugdoseChildEntityTypes
	
	#region BbPatientdrugdoseFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPatientdrugdoseColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientdrugdose"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientdrugdoseFilterBuilder : SqlFilterBuilder<BbPatientdrugdoseColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientdrugdoseFilterBuilder class.
		/// </summary>
		public BbPatientdrugdoseFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientdrugdoseFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientdrugdoseFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPatientdrugdoseFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientdrugdoseFilterBuilder
	
	#region BbPatientdrugdoseParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPatientdrugdoseColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientdrugdose"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPatientdrugdoseParameterBuilder : ParameterizedSqlFilterBuilder<BbPatientdrugdoseColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientdrugdoseParameterBuilder class.
		/// </summary>
		public BbPatientdrugdoseParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPatientdrugdoseParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPatientdrugdoseParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPatientdrugdoseParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPatientdrugdoseParameterBuilder
	
	#region BbPatientdrugdoseSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPatientdrugdoseColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPatientdrugdose"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPatientdrugdoseSortBuilder : SqlSortBuilder<BbPatientdrugdoseColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPatientdrugdoseSqlSortBuilder class.
		/// </summary>
		public BbPatientdrugdoseSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPatientdrugdoseSortBuilder
