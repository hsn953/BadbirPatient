...
{	
	...
	///</summary>
	public abstract partial class BbPappPatientMedProblemFupProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup, MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFupKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFupKey key)
		{
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappPatientMedProblemFup_bbPatientCohortHistory key.
		///		FK_bbPappPatientMedProblemFup_bbPatientCohortHistory Description: 
		/// </summary>
		/// <param name="_chid"></param>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup objects.</returns>
		public TList<BbPappPatientMedProblemFup> GetByChid(int _chid)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup objects.</returns>
		/// <remarks></remarks>
		public TList<BbPappPatientMedProblemFup> GetByChid(TransactionManager transactionManager, int _chid)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup objects.</returns>
		public TList<BbPappPatientMedProblemFup> GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_bbPappPatientMedProblemFup_bbPatientCohortHistory key.
		///		fkBbPappPatientMedProblemFupBbPatientCohortHistory Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_chid"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup objects.</returns>
		public TList<BbPappPatientMedProblemFup> GetByChid(int _chid, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup objects.</returns>
		public TList<BbPappPatientMedProblemFup> GetByChid(int _chid, int start, int pageLength,out int count)
		{
			return GetByChid(null, _chid, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup objects.</returns>
		public abstract TList<BbPappPatientMedProblemFup> GetByChid(TransactionManager transactionManager, int _chid, int start, int pageLength, out int count);
		...
		public override MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFupKey key, int start, int pageLength)
		{
			return GetByFormId(transactionManager, key.FormId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbPappPatientMedProblemFup index.
		/// </summary>
		/// <param name="_formId"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup GetByFormId(int _formId)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbPappPatientMedProblemFup index.
		/// </summary>
		/// <param name="_formId"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup GetByFormId(int _formId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup GetByFormId(TransactionManager transactionManager, int _formId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup GetByFormId(TransactionManager transactionManager, int _formId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup GetByFormId(int _formId, int start, int pageLength, out int count)
		{
			return GetByFormId(null, _formId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup GetByFormId(TransactionManager transactionManager, int _formId, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a TList&lt;BbPappPatientMedProblemFup&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbPappPatientMedProblemFup&gt;"/></returns>
		public static TList<BbPappPatientMedProblemFup> Fill(IDataReader reader, TList<BbPappPatientMedProblemFup> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbPappPatientMedProblemFup")
					.Append("|").Append((int)reader[((int)BbPappPatientMedProblemFupColumn.FormId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbPappPatientMedProblemFup>(
					key.ToString(), // EntityTrackingKey
					"BbPappPatientMedProblemFup",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup();
				}
					...
					))
				{
					...
					c.FormId = (int)reader[((int)BbPappPatientMedProblemFupColumn.FormId - 1)];
					c.OriginalFormId = c.FormId;
					c.Chid = (int)reader[((int)BbPappPatientMedProblemFupColumn.Chid - 1)];
					c.PappFupId = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.PappFupId - 1)))?null:(System.Int32?)reader[((int)BbPappPatientMedProblemFupColumn.PappFupId - 1)];
					c.Occupation = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.Occupation - 1)))?null:(string)reader[((int)BbPappPatientMedProblemFupColumn.Occupation - 1)];
					c.Employmentstatus = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.Employmentstatus - 1)))?null:(System.Int32?)reader[((int)BbPappPatientMedProblemFupColumn.Employmentstatus - 1)];
					c.Hospitaladmissions = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.Hospitaladmissions - 1)))?null:(System.Int32?)reader[((int)BbPappPatientMedProblemFupColumn.Hospitaladmissions - 1)];
					c.Newdrugs = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.Newdrugs - 1)))?null:(System.Int32?)reader[((int)BbPappPatientMedProblemFupColumn.Newdrugs - 1)];
					c.Newclinics = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.Newclinics - 1)))?null:(System.Int32?)reader[((int)BbPappPatientMedProblemFupColumn.Newclinics - 1)];
					c.Createdbyid = (int)reader[((int)BbPappPatientMedProblemFupColumn.Createdbyid - 1)];
					c.Createdbyname = (string)reader[((int)BbPappPatientMedProblemFupColumn.Createdbyname - 1)];
					c.Createddate = (System.DateTime)reader[((int)BbPappPatientMedProblemFupColumn.Createddate - 1)];
					c.Lastupdatedbyid = (int)reader[((int)BbPappPatientMedProblemFupColumn.Lastupdatedbyid - 1)];
					c.Lastupdatedbyname = (string)reader[((int)BbPappPatientMedProblemFupColumn.Lastupdatedbyname - 1)];
					c.Lastupdateddate = (System.DateTime)reader[((int)BbPappPatientMedProblemFupColumn.Lastupdateddate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup entity)
		{
			if (!reader.Read()) return;
			
			entity.FormId = (int)reader[((int)BbPappPatientMedProblemFupColumn.FormId - 1)];
			entity.OriginalFormId = (int)reader["FormID"];
			entity.Chid = (int)reader[((int)BbPappPatientMedProblemFupColumn.Chid - 1)];
			entity.PappFupId = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.PappFupId - 1)))?null:(System.Int32?)reader[((int)BbPappPatientMedProblemFupColumn.PappFupId - 1)];
			entity.Occupation = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.Occupation - 1)))?null:(string)reader[((int)BbPappPatientMedProblemFupColumn.Occupation - 1)];
			entity.Employmentstatus = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.Employmentstatus - 1)))?null:(System.Int32?)reader[((int)BbPappPatientMedProblemFupColumn.Employmentstatus - 1)];
			entity.Hospitaladmissions = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.Hospitaladmissions - 1)))?null:(System.Int32?)reader[((int)BbPappPatientMedProblemFupColumn.Hospitaladmissions - 1)];
			entity.Newdrugs = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.Newdrugs - 1)))?null:(System.Int32?)reader[((int)BbPappPatientMedProblemFupColumn.Newdrugs - 1)];
			entity.Newclinics = (reader.IsDBNull(((int)BbPappPatientMedProblemFupColumn.Newclinics - 1)))?null:(System.Int32?)reader[((int)BbPappPatientMedProblemFupColumn.Newclinics - 1)];
			entity.Createdbyid = (int)reader[((int)BbPappPatientMedProblemFupColumn.Createdbyid - 1)];
			entity.Createdbyname = (string)reader[((int)BbPappPatientMedProblemFupColumn.Createdbyname - 1)];
			entity.Createddate = (System.DateTime)reader[((int)BbPappPatientMedProblemFupColumn.Createddate - 1)];
			entity.Lastupdatedbyid = (int)reader[((int)BbPappPatientMedProblemFupColumn.Lastupdatedbyid - 1)];
			entity.Lastupdatedbyname = (string)reader[((int)BbPappPatientMedProblemFupColumn.Lastupdatedbyname - 1)];
			entity.Lastupdateddate = (System.DateTime)reader[((int)BbPappPatientMedProblemFupColumn.Lastupdateddate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup entity)
		{
			...
			entity.Employmentstatus = Convert.IsDBNull(dataRow["employmentstatus"]) ? null : (System.Int32?)dataRow["employmentstatus"];
			entity.Hospitaladmissions = Convert.IsDBNull(dataRow["hospitaladmissions"]) ? null : (System.Int32?)dataRow["hospitaladmissions"];
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbPappPatientMedProblemFupChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbPappPatientMedProblemFup</c>
	///</summary>
	public enum BbPappPatientMedProblemFupChildEntityTypes
	{
	...
	#endregion BbPappPatientMedProblemFupChildEntityTypes
	
	#region BbPappPatientMedProblemFupFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbPappPatientMedProblemFupColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientMedProblemFup"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPappPatientMedProblemFupFilterBuilder : SqlFilterBuilder<BbPappPatientMedProblemFupColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientMedProblemFupFilterBuilder class.
		/// </summary>
		public BbPappPatientMedProblemFupFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPappPatientMedProblemFupFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPappPatientMedProblemFupFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbPappPatientMedProblemFupFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPappPatientMedProblemFupFilterBuilder
	
	#region BbPappPatientMedProblemFupParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbPappPatientMedProblemFupColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientMedProblemFup"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbPappPatientMedProblemFupParameterBuilder : ParameterizedSqlFilterBuilder<BbPappPatientMedProblemFupColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientMedProblemFupParameterBuilder class.
		/// </summary>
		public BbPappPatientMedProblemFupParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbPappPatientMedProblemFupParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbPappPatientMedProblemFupParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbPappPatientMedProblemFupParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbPappPatientMedProblemFupParameterBuilder
	
	#region BbPappPatientMedProblemFupSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbPappPatientMedProblemFupColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbPappPatientMedProblemFup"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbPappPatientMedProblemFupSortBuilder : SqlSortBuilder<BbPappPatientMedProblemFupColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbPappPatientMedProblemFupSqlSortBuilder class.
		/// </summary>
		public BbPappPatientMedProblemFupSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbPappPatientMedProblemFupSortBuilder
