...
{	
	///<summary>
	/// This class is the base class for any <see cref="BbFileStorageProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract partial class BbFileStorageProviderBaseCore : EntityProviderBase<MHS.Badbir.NetTiers.Entities.BbFileStorage, MHS.Badbir.NetTiers.Entities.BbFileStorageKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbFileStorageKey key)
		{
		...
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(int _fileId)
		{
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, int _fileId);		
		...
		public override MHS.Badbir.NetTiers.Entities.BbFileStorage Get(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbFileStorageKey key, int start, int pageLength)
		{
			return GetByFileId(transactionManager, key.FileId, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key NonClusteredIndex-20141223-151231 index.
		/// </summary>
		/// <param name="_foreignKey"></param>
		/// <param name="_foreignKeyType"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbFileStorage&gt;"/> class.</returns>
		public TList<BbFileStorage> GetByForeignKeyForeignKeyType(int _foreignKey, int _foreignKeyType)
		{
			int count = -1;
			return GetByForeignKeyForeignKeyType(null,_foreignKey, _foreignKeyType, 0, int.MaxValue, out count);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the NonClusteredIndex-20141223-151231 index.
		/// </summary>
		/// <param name="_foreignKey"></param>
		/// <param name="_foreignKeyType"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbFileStorage&gt;"/> class.</returns>
		public TList<BbFileStorage> GetByForeignKeyForeignKeyType(int _foreignKey, int _foreignKeyType, int start, int pageLength)
		{
			int count = -1;
			return GetByForeignKeyForeignKeyType(null, _foreignKey, _foreignKeyType, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbFileStorage&gt;"/> class.</returns>
		public TList<BbFileStorage> GetByForeignKeyForeignKeyType(TransactionManager transactionManager, int _foreignKey, int _foreignKeyType)
		{
			int count = -1;
			return GetByForeignKeyForeignKeyType(transactionManager, _foreignKey, _foreignKeyType, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbFileStorage&gt;"/> class.</returns>
		public TList<BbFileStorage> GetByForeignKeyForeignKeyType(TransactionManager transactionManager, int _foreignKey, int _foreignKeyType, int start, int pageLength)
		{
			int count = -1;
			return GetByForeignKeyForeignKeyType(transactionManager, _foreignKey, _foreignKeyType, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;BbFileStorage&gt;"/> class.</returns>
		public TList<BbFileStorage> GetByForeignKeyForeignKeyType(int _foreignKey, int _foreignKeyType, int start, int pageLength, out int count)
		{
			return GetByForeignKeyForeignKeyType(null, _foreignKey, _foreignKeyType, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="TList&lt;BbFileStorage&gt;"/> class.</returns>
		public abstract TList<BbFileStorage> GetByForeignKeyForeignKeyType(TransactionManager transactionManager, int _foreignKey, int _foreignKeyType, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK_bbFileStorage index.
		/// </summary>
		/// <param name="_fileId"></param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbFileStorage GetByFileId(int _fileId)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK_bbFileStorage index.
		/// </summary>
		/// <param name="_fileId"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbFileStorage GetByFileId(int _fileId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbFileStorage GetByFileId(TransactionManager transactionManager, int _fileId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbFileStorage GetByFileId(TransactionManager transactionManager, int _fileId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> class.</returns>
		public MHS.Badbir.NetTiers.Entities.BbFileStorage GetByFileId(int _fileId, int start, int pageLength, out int count)
		{
			return GetByFileId(null, _fileId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> class.</returns>
		public abstract MHS.Badbir.NetTiers.Entities.BbFileStorage GetByFileId(TransactionManager transactionManager, int _fileId, int start, int pageLength, out int count);
		...
		/// <param name="patientId"> A <c>System.Int32?</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbFileStorage&gt;"/> instance.</returns>
		public TList<BbFileStorage> FileStorage_GetByPatientID(System.Int32? patientId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbFileStorage&gt;"/> instance.</returns>
		public TList<BbFileStorage> FileStorage_GetByPatientID(int start, int pageLength, System.Int32? patientId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbFileStorage&gt;"/> instance.</returns>
		public TList<BbFileStorage> FileStorage_GetByPatientID(TransactionManager transactionManager, System.Int32? patientId)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;BbFileStorage&gt;"/> instance.</returns>
		public abstract TList<BbFileStorage> FileStorage_GetByPatientID(TransactionManager transactionManager, int start, int pageLength , System.Int32? patientId);
		...
		/// <summary>
		/// Fill a TList&lt;BbFileStorage&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="TList&lt;BbFileStorage&gt;"/></returns>
		public static TList<BbFileStorage> Fill(IDataReader reader, TList<BbFileStorage> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				MHS.Badbir.NetTiers.Entities.BbFileStorage c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("BbFileStorage")
					.Append("|").Append((int)reader[((int)BbFileStorageColumn.FileId - 1)]).ToString();
					c = EntityManager.LocateOrCreate<BbFileStorage>(
					key.ToString(), // EntityTrackingKey
					"BbFileStorage",  //Creational Type
					entityCreationFactoryType,  //Factory used to create entity
					enableEntityTracking); // Track this entity?
				}
				else
				{
					c = new MHS.Badbir.NetTiers.Entities.BbFileStorage();
				}
					...
					))
				{
					...
					c.FileId = (int)reader[((int)BbFileStorageColumn.FileId - 1)];
					c.FileName = (string)reader[((int)BbFileStorageColumn.FileName - 1)];
					c.FileCaption = (reader.IsDBNull(((int)BbFileStorageColumn.FileCaption - 1)))?null:(string)reader[((int)BbFileStorageColumn.FileCaption - 1)];
					c.FileSize = (int)reader[((int)BbFileStorageColumn.FileSize - 1)];
					c.UploadDate = (reader.IsDBNull(((int)BbFileStorageColumn.UploadDate - 1)))?null:(System.DateTime?)reader[((int)BbFileStorageColumn.UploadDate - 1)];
					c.UploadedById = (reader.IsDBNull(((int)BbFileStorageColumn.UploadedById - 1)))?null:(System.Int32?)reader[((int)BbFileStorageColumn.UploadedById - 1)];
					c.UploadedByName = (reader.IsDBNull(((int)BbFileStorageColumn.UploadedByName - 1)))?null:(string)reader[((int)BbFileStorageColumn.UploadedByName - 1)];
					c.ForeignKey = (int)reader[((int)BbFileStorageColumn.ForeignKey - 1)];
					c.ForeignKeyType = (int)reader[((int)BbFileStorageColumn.ForeignKeyType - 1)];
					c.ForeignKeyTypeDescription = (reader.IsDBNull(((int)BbFileStorageColumn.ForeignKeyTypeDescription - 1)))?null:(string)reader[((int)BbFileStorageColumn.ForeignKeyTypeDescription - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, MHS.Badbir.NetTiers.Entities.BbFileStorage entity)
		{
			if (!reader.Read()) return;
			
			entity.FileId = (int)reader[((int)BbFileStorageColumn.FileId - 1)];
			entity.FileName = (string)reader[((int)BbFileStorageColumn.FileName - 1)];
			entity.FileCaption = (reader.IsDBNull(((int)BbFileStorageColumn.FileCaption - 1)))?null:(string)reader[((int)BbFileStorageColumn.FileCaption - 1)];
			entity.FileSize = (int)reader[((int)BbFileStorageColumn.FileSize - 1)];
			entity.UploadDate = (reader.IsDBNull(((int)BbFileStorageColumn.UploadDate - 1)))?null:(System.DateTime?)reader[((int)BbFileStorageColumn.UploadDate - 1)];
			entity.UploadedById = (reader.IsDBNull(((int)BbFileStorageColumn.UploadedById - 1)))?null:(System.Int32?)reader[((int)BbFileStorageColumn.UploadedById - 1)];
			entity.UploadedByName = (reader.IsDBNull(((int)BbFileStorageColumn.UploadedByName - 1)))?null:(string)reader[((int)BbFileStorageColumn.UploadedByName - 1)];
			entity.ForeignKey = (int)reader[((int)BbFileStorageColumn.ForeignKey - 1)];
			entity.ForeignKeyType = (int)reader[((int)BbFileStorageColumn.ForeignKeyType - 1)];
			entity.ForeignKeyTypeDescription = (reader.IsDBNull(((int)BbFileStorageColumn.ForeignKeyTypeDescription - 1)))?null:(string)reader[((int)BbFileStorageColumn.ForeignKeyTypeDescription - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, MHS.Badbir.NetTiers.Entities.BbFileStorage entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.FileId = (int)dataRow["fileID"];
			entity.FileName = (string)dataRow["fileName"];
			entity.FileCaption = Convert.IsDBNull(dataRow["fileCaption"]) ? null : (string)dataRow["fileCaption"];
			entity.FileSize = (int)dataRow["FileSize"];
			entity.UploadDate = Convert.IsDBNull(dataRow["UploadDate"]) ? null : (System.DateTime?)dataRow["UploadDate"];
			entity.UploadedById = Convert.IsDBNull(dataRow["UploadedByID"]) ? null : (System.Int32?)dataRow["UploadedByID"];
			entity.UploadedByName = Convert.IsDBNull(dataRow["UploadedByName"]) ? null : (string)dataRow["UploadedByName"];
			entity.ForeignKey = (int)dataRow["ForeignKey"];
			entity.ForeignKeyType = (int)dataRow["ForeignKeyType"];
			entity.ForeignKeyTypeDescription = Convert.IsDBNull(dataRow["ForeignKeyTypeDescription"]) ? null : (string)dataRow["ForeignKeyTypeDescription"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="MHS.Badbir.NetTiers.Entities.BbFileStorage"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbFileStorage Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbFileStorage entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the MHS.Badbir.NetTiers.Entities.BbFileStorage object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">MHS.Badbir.NetTiers.Entities.BbFileStorage instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MHS.Badbir.NetTiers.Entities.BbFileStorage Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, MHS.Badbir.NetTiers.Entities.BbFileStorage entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	#region BbFileStorageChildEntityTypes
	
	///<summary>
	/// Enumeration used to expose the different child entity types 
	/// for child properties in <c>MHS.Badbir.NetTiers.Entities.BbFileStorage</c>
	///</summary>
	public enum BbFileStorageChildEntityTypes
	{
	}
	
	#endregion BbFileStorageChildEntityTypes
	
	#region BbFileStorageFilterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="SqlFilterBuilder&lt;BbFileStorageColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbFileStorage"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbFileStorageFilterBuilder : SqlFilterBuilder<BbFileStorageColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbFileStorageFilterBuilder class.
		/// </summary>
		public BbFileStorageFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbFileStorageFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbFileStorageFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public BbFileStorageFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbFileStorageFilterBuilder
	
	#region BbFileStorageParameterBuilder
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ParameterizedSqlFilterBuilder&lt;BbFileStorageColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbFileStorage"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class BbFileStorageParameterBuilder : ParameterizedSqlFilterBuilder<BbFileStorageColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbFileStorageParameterBuilder class.
		/// </summary>
		public BbFileStorageParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the BbFileStorageParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public BbFileStorageParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public BbFileStorageParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion BbFileStorageParameterBuilder
	
	#region BbFileStorageSortBuilder
    
    /// <summary>
    /// A strongly-typed instance of the <see cref="SqlSortBuilder&lt;BbFileStorageColumn&gt;"/> class
	/// that is used exclusively with a <see cref="BbFileStorage"/> object.
    /// </summary>
    [CLSCompliant(true)]
    public class BbFileStorageSortBuilder : SqlSortBuilder<BbFileStorageColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the BbFileStorageSqlSortBuilder class.
		/// </summary>
		public BbFileStorageSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion BbFileStorageSortBuilder
